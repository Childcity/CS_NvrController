...
namespace NVRCsharpDemo {
	...
	public class CHCNetSDK {
		...
		public const int DEV_TYPE_NAME_LEN = 24;      //Éè±¸ÀàĞÍÃû³Æ³¤¶È
		public const int MAX_NAMELEN = 16;//DVR±¾µØµÇÂ½Ãû
		public const int MAX_RIGHT = 32;//Éè±¸Ö§³ÖµÄÈ¨ÏŞ£¨1-12±íÊ¾±¾µØÈ¨ÏŞ£¬13-32±íÊ¾Ô¶³ÌÈ¨ÏŞ£©
		public const int SERIALNO_LEN = 48;//ĞòÁĞºÅ³¤¶È
		public const int MACADDR_LEN = 6;//macµØÖ·³¤¶È
		public const int MAX_ETHERNET = 2;//Éè±¸¿ÉÅäÒÔÌ«ÍøÂç
		public const int MAX_NETWORK_CARD = 4; //Éè±¸¿ÉÅä×î´óÍø¿¨ÊıÄ¿
		...
		public const int MAX_TIMESEGMENT_V30 = 8;//9000Éè±¸×î´óÊ±¼ä¶ÎÊı
		public const int MAX_TIMESEGMENT = 4;//8000Éè±¸×î´óÊ±¼ä¶ÎÊı
		public const int MAX_ICR_NUM = 8;   //×¥ÅÄ»úºìÍâÂË¹âÆ¬Ô¤ÖÃµãÊı

		public const int MAX_SHELTERNUM = 4;//8000Éè±¸×î´óÕÚµ²ÇøÓòÊı
		public const int PHONENUMBER_LEN = 32;//pppoe²¦ºÅºÅÂë×î´ó³¤¶È

		public const int MAX_DISKNUM = 16;//8000Éè±¸×î´óÓ²ÅÌÊı
		public const int MAX_DISKNUM_V10 = 8;//1.2°æ±¾Ö®Ç°°æ±¾

		public const int MAX_WINDOW_V30 = 32;//9000Éè±¸±¾µØÏÔÊ¾×î´ó²¥·Å´°¿ÚÊı
		public const int MAX_WINDOW = 16;//8000Éè±¸×î´óÓ²ÅÌÊı
		public const int MAX_VGA_V30 = 4;//9000Éè±¸×î´ó¿É½ÓVGAÊı
		public const int MAX_VGA = 1;//8000Éè±¸×î´ó¿É½ÓVGAÊı

		public const int MAX_USERNUM_V30 = 32;//9000Éè±¸×î´óÓÃ»§Êı
		public const int MAX_USERNUM = 16;//8000Éè±¸×î´óÓÃ»§Êı
		public const int MAX_EXCEPTIONNUM_V30 = 32;//9000Éè±¸×î´óÒì³£´¦ÀíÊı
		public const int MAX_EXCEPTIONNUM = 16;//8000Éè±¸×î´óÒì³£´¦ÀíÊı
		public const int MAX_LINK = 6;//8000Éè±¸µ¥Í¨µÀ×î´óÊÓÆµÁ÷Á¬½ÓÊı
		public const int MAX_ITC_EXCEPTIONOUT = 32;//×¥ÅÄ»ú×î´ó±¨¾¯Êä³ö

		public const int MAX_DECPOOLNUM = 4;//µ¥Â·½âÂëÆ÷Ã¿¸ö½âÂëÍ¨µÀ×î´ó¿ÉÑ­»·½âÂëÊı
		public const int MAX_DECNUM = 4;//µ¥Â·½âÂëÆ÷µÄ×î´ó½âÂëÍ¨µÀÊı£¨Êµ¼ÊÖ»ÓĞÒ»¸ö£¬ÆäËûÈı¸ö±£Áô£©
		public const int MAX_TRANSPARENTNUM = 2;//µ¥Â·½âÂëÆ÷¿ÉÅäÖÃ×î´óÍ¸Ã÷Í¨µÀÊı
		public const int MAX_CYCLE_CHAN = 16; //µ¥Â·½âÂëÆ÷×î´óÂÖÑ­Í¨µÀÊı
		public const int MAX_CYCLE_CHAN_V30 = 64;//×î´óÂÖÑ¯Í¨µÀÊı£¨À©Õ¹£©
		public const int MAX_DIRNAME_LENGTH = 80;//×î´óÄ¿Â¼³¤¶È

		public const int MAX_STRINGNUM_V30 = 8;//9000Éè±¸×î´óOSD×Ö·ûĞĞÊıÊı
		public const int MAX_STRINGNUM = 4;//8000Éè±¸×î´óOSD×Ö·ûĞĞÊıÊı
		public const int MAX_STRINGNUM_EX = 8;//8000¶¨ÖÆÀ©Õ¹
		public const int MAX_AUXOUT_V30 = 16;//9000Éè±¸×î´ó¸¨ÖúÊä³öÊı
		public const int MAX_AUXOUT = 4;//8000Éè±¸×î´ó¸¨ÖúÊä³öÊı
		public const int MAX_HD_GROUP = 16;//9000Éè±¸×î´óÓ²ÅÌ×éÊı
		public const int MAX_NFS_DISK = 8; //8000Éè±¸×î´óNFSÓ²ÅÌÊı

		public const int IW_ESSID_MAX_SIZE = 32;//WIFIµÄSSIDºÅ³¤¶È
		public const int IW_ENCODING_TOKEN_MAX = 32;//WIFIÃÜËø×î´ó×Ö½ÚÊı
		...
		public const int MAX_SERIAL_NUM = 64;//×î¶àÖ§³ÖµÄÍ¸Ã÷Í¨µÀÂ·Êı
		public const int MAX_DDNS_NUMS = 10;//9000Éè±¸×î´ó¿ÉÅäddnsÊı
		...
		public const int MAX_SERIALNUM = 2;//8000Éè±¸Ö§³ÖµÄ´®¿ÚÊı 1-232£¬ 2-485
		public const int CARDNUM_LEN = 20;//¿¨ºÅ³¤¶È
		public const int CARDNUM_LEN_OUT = 32; //Íâ²¿½á¹¹Ìå¿¨ºÅ³¤¶È
		public const int MAX_VIDEOOUT_V30 = 4;//9000Éè±¸µÄÊÓÆµÊä³öÊı
		public const int MAX_VIDEOOUT = 2;//8000Éè±¸µÄÊÓÆµÊä³öÊı

		public const int MAX_PRESET_V30 = 256;// 9000Éè±¸Ö§³ÖµÄÔÆÌ¨Ô¤ÖÃµãÊı
		public const int MAX_TRACK_V30 = 256;// 9000Éè±¸Ö§³ÖµÄÔÆÌ¨¹ì¼£Êı
		public const int MAX_CRUISE_V30 = 256;// 9000Éè±¸Ö§³ÖµÄÔÆÌ¨Ñ²º½Êı
		public const int MAX_PRESET = 128;// 8000Éè±¸Ö§³ÖµÄÔÆÌ¨Ô¤ÖÃµãÊı 
		public const int MAX_TRACK = 128;// 8000Éè±¸Ö§³ÖµÄÔÆÌ¨¹ì¼£Êı
		public const int MAX_CRUISE = 128;// 8000Éè±¸Ö§³ÖµÄÔÆÌ¨Ñ²º½Êı 

		public const int CRUISE_MAX_PRESET_NUMS = 32;// Ò»ÌõÑ²º½×î¶àµÄÑ²º½µã 

		public const int MAX_SERIAL_PORT = 8;//9000Éè±¸Ö§³Ö232´®¿ÚÊı
		public const int MAX_PREVIEW_MODE = 8;// Éè±¸Ö§³Ö×î´óÔ¤ÀÀÄ£Ê½ÊıÄ¿ 1»­Ãæ,4»­Ãæ,9»­Ãæ,16»­Ãæ.... 
		public const int MAX_MATRIXOUT = 16;// ×î´óÄ£Äâ¾ØÕóÊä³ö¸öÊı 
		public const int LOG_INFO_LEN = 11840; // ÈÕÖ¾¸½¼ÓĞÅÏ¢ 
		public const int DESC_LEN = 16;// ÔÆÌ¨ÃèÊö×Ö·û´®³¤¶È 
		public const int PTZ_PROTOCOL_NUM = 200;// 9000×î´óÖ§³ÖµÄÔÆÌ¨Ğ­ÒéÊı 

		public const int MAX_AUDIO = 1;//8000ÓïÒô¶Ô½²Í¨µÀÊı
		public const int MAX_AUDIO_V30 = 2;//9000ÓïÒô¶Ô½²Í¨µÀÊı
		public const int MAX_CHANNUM = 16;//8000Éè±¸×î´óÍ¨µÀÊı
		public const int MAX_ALARMIN = 16;//8000Éè±¸×î´ó±¨¾¯ÊäÈëÊı
		public const int MAX_ALARMOUT = 4;//8000Éè±¸×î´ó±¨¾¯Êä³öÊı
										  //9000 IPC½ÓÈë
		...
		public const int MAX_IP_DEVICE = 32;//ÔÊĞí½ÓÈëµÄ×î´óIPÉè±¸Êı
		public const int MAX_IP_DEVICE_V40 = 64;//ÔÊĞí½ÓÈëµÄ×î´óIPÉè±¸Êı
		public const int MAX_IP_CHANNEL = 32;//ÔÊĞí¼ÓÈëµÄ×î¶àIPÍ¨µÀÊı
		public const int MAX_IP_ALARMIN = 128;//ÔÊĞí¼ÓÈëµÄ×î¶à±¨¾¯ÊäÈëÊı
		public const int MAX_IP_ALARMOUT = 64;//ÔÊĞí¼ÓÈëµÄ×î¶à±¨¾¯Êä³öÊı
		public const int MAX_IP_ALARMIN_V40 = 4096;    //ÔÊĞí¼ÓÈëµÄ×î¶à±¨¾¯ÊäÈëÊı
		public const int MAX_IP_ALARMOUT_V40 = 4096;    //ÔÊĞí¼ÓÈëµÄ×î¶à±¨¾¯Êä³öÊı

		public const int MAX_RECORD_FILE_NUM = 20;      // Ã¿´ÎÉ¾³ı»òÕß¿ÌÂ¼µÄ×î´óÎÄ¼şÊı
		...
		public const int MAX_HUMAN_PICTURE_NUM = 10;   //×î´óÕÕÆ¬Êı
		public const int MAX_HUMAN_BIRTHDATE_LEN = 10;

		public const int MAX_LAYERNUMS = 32;

		public const int MAX_ROIDETECT_NUM = 8;    //Ö§³ÖµÄROIÇøÓòÊı
		public const int MAX_LANERECT_NUM = 5;    //×î´ó³µÅÆÊ¶±ğÇøÓòÊı
		public const int MAX_FORTIFY_NUM = 10;   //×î´ó²¼·À¸öÊı
		public const int MAX_INTERVAL_NUM = 4;    //×î´óÊ±¼ä¼ä¸ô¸öÊı
		public const int MAX_CHJC_NUM = 3;    //×î´ó³µÁ¾Ê¡·İ¼ò³Æ×Ö·û¸öÊı
		public const int MAX_VL_NUM = 5;    //×î´óĞéÄâÏßÈ¦¸öÊı
		public const int MAX_DRIVECHAN_NUM = 16;   //×î´ó³µµÀÊı
		public const int MAX_COIL_NUM = 3;    //×î´óÏßÈ¦¸öÊı
		public const int MAX_SIGNALLIGHT_NUM = 6;   //×î´óĞÅºÅµÆ¸öÊı
		public const int LEN_32 = 32;
		public const int LEN_31 = 31;
		public const int MAX_CABINET_COUNT = 8;    //×î´óÖ§³Ö»ú¹ñÊıÁ¿
		public const int MAX_ID_LEN = 48;
		public const int MAX_PARKNO_LEN = 16;
		public const int MAX_ALARMREASON_LEN = 32;
		public const int MAX_UPGRADE_INFO_LEN = 48; //»ñÈ¡Éı¼¶ÎÄ¼şÆ¥ÅäĞÅÏ¢(Ä£ºıÉı¼¶)
		public const int MAX_CUSTOMDIR_LEN = 32; //×Ô¶¨ÒåÄ¿Â¼³¤¶È

		public const int MAX_TRANSPARENT_CHAN_NUM = 4;   //Ã¿¸ö´®¿ÚÔÊĞí½¨Á¢µÄ×î´óÍ¸Ã÷Í¨µÀÊı
		public const int MAX_TRANSPARENT_ACCESS_NUM = 4;   //Ã¿¸ö¼àÌı¶Ë¿ÚÔÊĞí½ÓÈëµÄ×î´óÖ÷»úÊı

		//ITS
		public const int MAX_PARKING_STATUS = 8;    //³µÎ»×´Ì¬ 0´ú±íÎŞ³µ£¬1´ú±íÓĞ³µ£¬2´ú±íÑ¹Ïß(ÓÅÏÈ¼¶×î¸ß), 3ÌØÊâ³µÎ» 
		public const int MAX_PARKING_NUM = 4;    //Ò»¸öÍ¨µÀ×î´ó4¸ö³µÎ» (´Ó×óµ½ÓÒ³µÎ» Êı×é0¡«3)

		public const int MAX_ITS_SCENE_NUM = 16;   //×î´ó³¡¾°ÊıÁ¿
		public const int MAX_SCENE_TIMESEG_NUM = 16;   //×î´ó³¡¾°Ê±¼ä¶ÎÊıÁ¿
		public const int MAX_IVMS_IP_CHANNEL = 128;  //×î´óIPÍ¨µÀÊı
		public const int DEVICE_ID_LEN = 48;   //Éè±¸±àºÅ³¤¶È
		public const int MONITORSITE_ID_LEN = 48;   //¼à²âµã±àºÅ³¤¶È
		public const int MAX_AUXAREA_NUM = 16;   //¸¨ÖúÇøÓò×î´óÊıÄ¿
		public const int MAX_SLAVE_CHANNEL_NUM = 16;   //×î´ó´ÓÍ¨µÀÊıÁ¿

		public const int MAX_SCH_TASKS_NUM = 10;

		public const int MAX_SERVERID_LEN = 64; //×î´ó·şÎñÆ÷IDµÄ³¤¶È
		public const int MAX_SERVERDOMAIN_LEN = 128; //·şÎñÆ÷ÓòÃû×î´ó³¤¶È
		public const int MAX_AUTHENTICATEID_LEN = 64; //ÈÏÖ¤ID×î´ó³¤¶È
		public const int MAX_AUTHENTICATEPASSWD_LEN = 32; //ÈÏÖ¤ÃÜÂë×î´ó³¤¶È
		public const int MAX_SERVERNAME_LEN = 64; //×î´ó·şÎñÆ÷ÓÃ»§Ãû 
		public const int MAX_COMPRESSIONID_LEN = 64; //±àÂëIDµÄ×î´ó³¤¶È
		public const int MAX_SIPSERVER_ADDRESS_LEN = 128; //SIP·şÎñÆ÷µØÖ·Ö§³ÖÓòÃûºÍIPµØÖ·
														  //Ñ¹Ïß±¨¾¯
		public const int MAX_PlATE_NO_LEN = 32;   //³µÅÆºÅÂë×î´ó³¤¶È 2013-09-27
		public const int UPNP_PORT_NUM = 12;      //upnp¶Ë¿ÚÓ³Éä¶Ë¿ÚÊıÄ¿


		public const int MAX_LOCAL_ADDR_LEN = 96;       //SOCKS×î´ó±¾µØÍø¶Î¸öÊı
		public const int MAX_COUNTRY_NAME_LEN = 4;      //¹ú¼Ò¼òĞ´Ãû³Æ³¤¶È
		...
		/*******************È«¾Ö´íÎóÂë begin**********************/
		public const int NET_DVR_NOERROR = 0;//Ã»ÓĞ´íÎó
		public const int NET_DVR_PASSWORD_ERROR = 1;//ÓÃ»§ÃûÃÜÂë´íÎó
		public const int NET_DVR_NOENOUGHPRI = 2;//È¨ÏŞ²»×ã
		public const int NET_DVR_NOINIT = 3;//Ã»ÓĞ³õÊ¼»¯
		public const int NET_DVR_CHANNEL_ERROR = 4;//Í¨µÀºÅ´íÎó
		public const int NET_DVR_OVER_MAXLINK = 5;//Á¬½Óµ½DVRµÄ¿Í»§¶Ë¸öÊı³¬¹ı×î´ó
		public const int NET_DVR_VERSIONNOMATCH = 6;//°æ±¾²»Æ¥Åä
		public const int NET_DVR_NETWORK_FAIL_CONNECT = 7;//Á¬½Ó·şÎñÆ÷Ê§°Ü
		public const int NET_DVR_NETWORK_SEND_ERROR = 8;//Ïò·şÎñÆ÷·¢ËÍÊ§°Ü
		public const int NET_DVR_NETWORK_RECV_ERROR = 9;//´Ó·şÎñÆ÷½ÓÊÕÊı¾İÊ§°Ü
		public const int NET_DVR_NETWORK_RECV_TIMEOUT = 10;//´Ó·şÎñÆ÷½ÓÊÕÊı¾İ³¬Ê±
		public const int NET_DVR_NETWORK_ERRORDATA = 11;//´«ËÍµÄÊı¾İÓĞÎó
		public const int NET_DVR_ORDER_ERROR = 12;//µ÷ÓÃ´ÎĞò´íÎó
		public const int NET_DVR_OPERNOPERMIT = 13;//ÎŞ´ËÈ¨ÏŞ
		public const int NET_DVR_COMMANDTIMEOUT = 14;//DVRÃüÁîÖ´ĞĞ³¬Ê±
		public const int NET_DVR_ERRORSERIALPORT = 15;//´®¿ÚºÅ´íÎó
		public const int NET_DVR_ERRORALARMPORT = 16;//±¨¾¯¶Ë¿Ú´íÎó
		public const int NET_DVR_PARAMETER_ERROR = 17;//²ÎÊı´íÎó
		public const int NET_DVR_CHAN_EXCEPTION = 18;//·şÎñÆ÷Í¨µÀ´¦ÓÚ´íÎó×´Ì¬
		public const int NET_DVR_NODISK = 19;//Ã»ÓĞÓ²ÅÌ
		public const int NET_DVR_ERRORDISKNUM = 20;//Ó²ÅÌºÅ´íÎó
		public const int NET_DVR_DISK_FULL = 21;//·şÎñÆ÷Ó²ÅÌÂú
		public const int NET_DVR_DISK_ERROR = 22;//·şÎñÆ÷Ó²ÅÌ³ö´í
		public const int NET_DVR_NOSUPPORT = 23;//·şÎñÆ÷²»Ö§³Ö
		public const int NET_DVR_BUSY = 24;//·şÎñÆ÷Ã¦
		public const int NET_DVR_MODIFY_FAIL = 25;//·şÎñÆ÷ĞŞ¸Ä²»³É¹¦
		public const int NET_DVR_PASSWORD_FORMAT_ERROR = 26;//ÃÜÂëÊäÈë¸ñÊ½²»ÕıÈ·
		public const int NET_DVR_DISK_FORMATING = 27;//Ó²ÅÌÕıÔÚ¸ñÊ½»¯£¬²»ÄÜÆô¶¯²Ù×÷
		...
		public const int NET_DVR_DVRVOICEOPENED = 31;//·şÎñÆ÷ÓïÒô¶Ô½²±»Õ¼ÓÃ
		public const int NET_DVR_TIMEINPUTERROR = 32;//Ê±¼äÊäÈë²»ÕıÈ·
		public const int NET_DVR_NOSPECFILE = 33;//»Ø·ÅÊ±·şÎñÆ÷Ã»ÓĞÖ¸¶¨µÄÎÄ¼ş
		public const int NET_DVR_CREATEFILE_ERROR = 34;//´´½¨ÎÄ¼ş³ö´í
		public const int NET_DVR_FILEOPENFAIL = 35;//´ò¿ªÎÄ¼ş³ö´í
		public const int NET_DVR_OPERNOTFINISH = 36; //ÉÏ´ÎµÄ²Ù×÷»¹Ã»ÓĞÍê³É
		public const int NET_DVR_GETPLAYTIMEFAIL = 37;//»ñÈ¡µ±Ç°²¥·ÅµÄÊ±¼ä³ö´í
		public const int NET_DVR_PLAYFAIL = 38;//²¥·Å³ö´í
		public const int NET_DVR_FILEFORMAT_ERROR = 39;//ÎÄ¼ş¸ñÊ½²»ÕıÈ·
		...
		public const int NET_DVR_NOENOUGH_BUF = 43;//»º³åÇøÌ«Ğ¡
		public const int NET_DVR_CREATESOCKET_ERROR = 44;//´´½¨SOCKET³ö´í
		public const int NET_DVR_SETSOCKET_ERROR = 45;//ÉèÖÃSOCKET³ö´í
		public const int NET_DVR_MAX_NUM = 46;//¸öÊı´ïµ½×î´ó
		public const int NET_DVR_USERNOTEXIST = 47;//ÓÃ»§²»´æÔÚ
		public const int NET_DVR_WRITEFLASHERROR = 48;//Ğ´FLASH³ö´í
		public const int NET_DVR_UPGRADEFAIL = 49;//DVRÉı¼¶Ê§°Ü
		public const int NET_DVR_CARDHAVEINIT = 50;//½âÂë¿¨ÒÑ¾­³õÊ¼»¯¹ı
		public const int NET_DVR_PLAYERFAILED = 51;//µ÷ÓÃ²¥·Å¿âÖĞÄ³¸öº¯ÊıÊ§°Ü
		public const int NET_DVR_MAX_USERNUM = 52;//Éè±¸¶ËÓÃ»§Êı´ïµ½×î´ó
		public const int NET_DVR_GETLOCALIPANDMACFAIL = 53;//»ñµÃ¿Í»§¶ËµÄIPµØÖ·»òÎïÀíµØÖ·Ê§°Ü
		public const int NET_DVR_NOENCODEING = 54;//¸ÃÍ¨µÀÃ»ÓĞ±àÂë
		public const int NET_DVR_IPMISMATCH = 55;//IPµØÖ·²»Æ¥Åä
		public const int NET_DVR_MACMISMATCH = 56;//MACµØÖ·²»Æ¥Åä
		public const int NET_DVR_UPGRADELANGMISMATCH = 57;//Éı¼¶ÎÄ¼şÓïÑÔ²»Æ¥Åä
		public const int NET_DVR_MAX_PLAYERPORT = 58;//²¥·ÅÆ÷Â·Êı´ïµ½×î´ó
		public const int NET_DVR_NOSPACEBACKUP = 59;//±¸·İÉè±¸ÖĞÃ»ÓĞ×ã¹»¿Õ¼ä½øĞĞ±¸·İ
		public const int NET_DVR_NODEVICEBACKUP = 60;//Ã»ÓĞÕÒµ½Ö¸¶¨µÄ±¸·İÉè±¸
		public const int NET_DVR_PICTURE_BITS_ERROR = 61;//Í¼ÏñËØÎ»Êı²»·û£¬ÏŞ24É«
		public const int NET_DVR_PICTURE_DIMENSION_ERROR = 62;//Í¼Æ¬¸ß*¿í³¬ÏŞ£¬ ÏŞ128*256
		public const int NET_DVR_PICTURE_SIZ_ERROR = 63;//Í¼Æ¬´óĞ¡³¬ÏŞ£¬ÏŞ100K
		public const int NET_DVR_LOADPLAYERSDKFAILED = 64;//ÔØÈëµ±Ç°Ä¿Â¼ÏÂPlayer Sdk³ö´í
		public const int NET_DVR_LOADPLAYERSDKPROC_ERROR = 65;//ÕÒ²»µ½Player SdkÖĞÄ³¸öº¯ÊıÈë¿Ú
		public const int NET_DVR_LOADDSSDKFAILED = 66;//ÔØÈëµ±Ç°Ä¿Â¼ÏÂDSsdk³ö´í
		public const int NET_DVR_LOADDSSDKPROC_ERROR = 67;//ÕÒ²»µ½DsSdkÖĞÄ³¸öº¯ÊıÈë¿Ú
		public const int NET_DVR_DSSDK_ERROR = 68;//µ÷ÓÃÓ²½âÂë¿âDsSdkÖĞÄ³¸öº¯ÊıÊ§°Ü
		public const int NET_DVR_VOICEMONOPOLIZE = 69;//Éù¿¨±»¶ÀÕ¼
		public const int NET_DVR_JOINMULTICASTFAILED = 70;//¼ÓÈë¶à²¥×éÊ§°Ü
		public const int NET_DVR_CREATEDIR_ERROR = 71;//½¨Á¢ÈÕÖ¾ÎÄ¼şÄ¿Â¼Ê§°Ü
		public const int NET_DVR_BINDSOCKET_ERROR = 72;//°ó¶¨Ì×½Ó×ÖÊ§°Ü
		public const int NET_DVR_SOCKETCLOSE_ERROR = 73;//socketÁ¬½ÓÖĞ¶Ï£¬´Ë´íÎóÍ¨³£ÊÇÓÉÓÚÁ¬½ÓÖĞ¶Ï»òÄ¿µÄµØ²»¿É´ï
		public const int NET_DVR_USERID_ISUSING = 74;//×¢ÏúÊ±ÓÃ»§IDÕıÔÚ½øĞĞÄ³²Ù×÷
		public const int NET_DVR_SOCKETLISTEN_ERROR = 75;//¼àÌıÊ§°Ü
		public const int NET_DVR_PROGRAM_EXCEPTION = 76;//³ÌĞòÒì³£
		public const int NET_DVR_WRITEFILE_FAILED = 77;//Ğ´ÎÄ¼şÊ§°Ü
		public const int NET_DVR_FORMAT_READONLY = 78;//½ûÖ¹¸ñÊ½»¯Ö»¶ÁÓ²ÅÌ
		public const int NET_DVR_WITHSAMEUSERNAME = 79;//ÓÃ»§ÅäÖÃ½á¹¹ÖĞ´æÔÚÏàÍ¬µÄÓÃ»§Ãû
		public const int NET_DVR_DEVICETYPE_ERROR = 80;//µ¼Èë²ÎÊıÊ±Éè±¸ĞÍºÅ²»Æ¥Åä
		public const int NET_DVR_LANGUAGE_ERROR = 81;//µ¼Èë²ÎÊıÊ±ÓïÑÔ²»Æ¥Åä
		public const int NET_DVR_PARAVERSION_ERROR = 82;//µ¼Èë²ÎÊıÊ±Èí¼ş°æ±¾²»Æ¥Åä
		...
		public const int NET_DVR_IPC_COUNT_OVERFLOW = 86;//³¬³ö×î´óµÄip½ÓÈëÍ¨µÀÊı
        ...
        **************************************************/
		...
		public const int NET_DVR_SUPPORT_BLTFOURCC = 4;//ÏÔ¿¨BLTÖ§³ÖÑÕÉ«×ª»»£¬Èç¹û²»Ö§³Ö£¬²¥·ÅÆ÷»áÓÃÈí¼ş·½·¨×÷RGB×ª»»
		public const int NET_DVR_SUPPORT_BLTSHRINKX = 8;//ÏÔ¿¨BLTÖ§³ÖXÖáËõĞ¡£»Èç¹û²»Ö§³Ö£¬ÏµÍ³»áÓÃÈí¼ş·½·¨×ª»»
		public const int NET_DVR_SUPPORT_BLTSHRINKY = 16;//ÏÔ¿¨BLTÖ§³ÖYÖáËõĞ¡£»Èç¹û²»Ö§³Ö£¬ÏµÍ³»áÓÃÈí¼ş·½·¨×ª»»
		public const int NET_DVR_SUPPORT_BLTSTRETCHX = 32;//ÏÔ¿¨BLTÖ§³ÖXÖá·Å´ó£»Èç¹û²»Ö§³Ö£¬ÏµÍ³»áÓÃÈí¼ş·½·¨×ª»»
		public const int NET_DVR_SUPPORT_BLTSTRETCHY = 64;//ÏÔ¿¨BLTÖ§³ÖYÖá·Å´ó£»Èç¹û²»Ö§³Ö£¬ÏµÍ³»áÓÃÈí¼ş·½·¨×ª»»
		...
		public const int CLE_PRESET = 9;// Çå³ıÔ¤ÖÃµã 

		public const int ZOOM_IN = 11;// ½¹¾àÒÔËÙ¶ÈSS±ä´ó(±¶ÂÊ±ä´ó)
		public const int ZOOM_OUT = 12;// ½¹¾àÒÔËÙ¶ÈSS±äĞ¡(±¶ÂÊ±äĞ¡)
		...
		public const int IRIS_CLOSE = 16;// ¹âÈ¦ÒÔËÙ¶ÈSSËõĞ¡ 
		...
		public const int FILL_PRE_SEQ = 30;/* ½«Ô¤ÖÃµã¼ÓÈëÑ²º½ĞòÁĞ */
		public const int SET_SEQ_DWELL = 31;/* ÉèÖÃÑ²º½µãÍ£¶ÙÊ±¼ä */
		public const int SET_SEQ_SPEED = 32;/* ÉèÖÃÑ²º½ËÙ¶È */
		public const int CLE_PRE_SEQ = 33;/* ½«Ô¤ÖÃµã´ÓÑ²º½ĞòÁĞÖĞÉ¾³ı */
        ...
        **************************************************/
		...
		public const int NET_DVR_PLAYPAUSE = 3;//ÔİÍ£²¥·Å
		public const int NET_DVR_PLAYRESTART = 4;//»Ö¸´²¥·Å
		public const int NET_DVR_PLAYFAST = 5;//¿ì·Å
		public const int NET_DVR_PLAYSLOW = 6;//Âı·Å
		public const int NET_DVR_PLAYNORMAL = 7;//Õı³£ËÙ¶È
		...
		public const int NET_DVR_PLAYSETPOS = 12;//¸Ä±äÎÄ¼ş»Ø·ÅµÄ½ø¶È
		public const int NET_DVR_PLAYGETPOS = 13;//»ñÈ¡ÎÄ¼ş»Ø·ÅµÄ½ø¶È
		public const int NET_DVR_PLAYGETTIME = 14;//»ñÈ¡µ±Ç°ÒÑ¾­²¥·ÅµÄÊ±¼ä(°´ÎÄ¼ş»Ø·ÅµÄÊ±ºòÓĞĞ§)
		public const int NET_DVR_PLAYGETFRAME = 15;//»ñÈ¡µ±Ç°ÒÑ¾­²¥·ÅµÄÖ¡Êı(°´ÎÄ¼ş»Ø·ÅµÄÊ±ºòÓĞĞ§)
		public const int NET_DVR_GETTOTALFRAMES = 16;//»ñÈ¡µ±Ç°²¥·ÅÎÄ¼ş×ÜµÄÖ¡Êı(°´ÎÄ¼ş»Ø·ÅµÄÊ±ºòÓĞĞ§)
		public const int NET_DVR_GETTOTALTIME = 17;//»ñÈ¡µ±Ç°²¥·ÅÎÄ¼ş×ÜµÄÊ±¼ä(°´ÎÄ¼ş»Ø·ÅµÄÊ±ºòÓĞĞ§)
		public const int NET_DVR_THROWBFRAME = 20;//¶ªBÖ¡
		public const int NET_DVR_SETSPEED = 24;//ÉèÖÃÂëÁ÷ËÙ¶È
		public const int NET_DVR_KEEPALIVE = 25;//±£³ÖÓëÉè±¸µÄĞÄÌø(Èç¹û»Øµ÷×èÈû£¬½¨Òé2Ãë·¢ËÍÒ»´Î)
		public const int NET_DVR_PLAYSETTIME = 26;//°´¾ø¶ÔÊ±¼ä¶¨Î»
		public const int NET_DVR_PLAYGETTOTALLEN = 27;//»ñÈ¡°´Ê±¼ä»Ø·Å¶ÔÓ¦Ê±¼ä¶ÎÄÚµÄËùÓĞÎÄ¼şµÄ×Ü³¤¶È
		public const int NET_DVR_PLAY_FORWARD = 29;//µ¹·ÅÇĞ»»ÎªÕı·Å
		public const int NET_DVR_PLAY_REVERSE = 30;//Õı·ÅÇĞ»»Îªµ¹·Å
		public const int NET_DVR_SET_TRANS_TYPE = 32;//ÉèÖÃ×ª·â×°ÀàĞÍ
		public const int NET_DVR_PLAY_CONVERT = 33;//Õı·ÅÇĞ»»Îªµ¹·Å
		...
		public const int NET_DVR_GET_DEVICECFG = 100;//»ñÈ¡Éè±¸²ÎÊı
		public const int NET_DVR_SET_DEVICECFG = 101;//ÉèÖÃÉè±¸²ÎÊı
		public const int NET_DVR_GET_NETCFG = 102;//»ñÈ¡ÍøÂç²ÎÊı
		public const int NET_DVR_SET_NETCFG = 103;//ÉèÖÃÍøÂç²ÎÊı
		public const int NET_DVR_GET_PICCFG = 104;//»ñÈ¡Í¼Ïó²ÎÊı
		public const int NET_DVR_SET_PICCFG = 105;//ÉèÖÃÍ¼Ïó²ÎÊı
		public const int NET_DVR_GET_COMPRESSCFG = 106;//»ñÈ¡Ñ¹Ëõ²ÎÊı
		public const int NET_DVR_SET_COMPRESSCFG = 107;//ÉèÖÃÑ¹Ëõ²ÎÊı
		public const int NET_DVR_GET_RECORDCFG = 108;//»ñÈ¡Â¼ÏñÊ±¼ä²ÎÊı
		public const int NET_DVR_SET_RECORDCFG = 109;//ÉèÖÃÂ¼ÏñÊ±¼ä²ÎÊı
		public const int NET_DVR_GET_DECODERCFG = 110;//»ñÈ¡½âÂëÆ÷²ÎÊı
		public const int NET_DVR_SET_DECODERCFG = 111;//ÉèÖÃ½âÂëÆ÷²ÎÊı
		public const int NET_DVR_GET_RS232CFG = 112;//»ñÈ¡232´®¿Ú²ÎÊı
		public const int NET_DVR_SET_RS232CFG = 113;//ÉèÖÃ232´®¿Ú²ÎÊı
		public const int NET_DVR_GET_ALARMINCFG = 114;//»ñÈ¡±¨¾¯ÊäÈë²ÎÊı
		public const int NET_DVR_SET_ALARMINCFG = 115;//ÉèÖÃ±¨¾¯ÊäÈë²ÎÊı
		public const int NET_DVR_GET_ALARMOUTCFG = 116;//»ñÈ¡±¨¾¯Êä³ö²ÎÊı
		public const int NET_DVR_SET_ALARMOUTCFG = 117;//ÉèÖÃ±¨¾¯Êä³ö²ÎÊı
		public const int NET_DVR_GET_TIMECFG = 118;//»ñÈ¡DVRÊ±¼ä
		public const int NET_DVR_SET_TIMECFG = 119;//ÉèÖÃDVRÊ±¼ä
		public const int NET_DVR_GET_PREVIEWCFG = 120;//»ñÈ¡Ô¤ÀÀ²ÎÊı
		public const int NET_DVR_SET_PREVIEWCFG = 121;//ÉèÖÃÔ¤ÀÀ²ÎÊı
		public const int NET_DVR_GET_VIDEOOUTCFG = 122;//»ñÈ¡ÊÓÆµÊä³ö²ÎÊı
		public const int NET_DVR_SET_VIDEOOUTCFG = 123;//ÉèÖÃÊÓÆµÊä³ö²ÎÊı
		public const int NET_DVR_GET_USERCFG = 124;//»ñÈ¡ÓÃ»§²ÎÊı
		public const int NET_DVR_SET_USERCFG = 125;//ÉèÖÃÓÃ»§²ÎÊı
		public const int NET_DVR_GET_EXCEPTIONCFG = 126;//»ñÈ¡Òì³£²ÎÊı
		public const int NET_DVR_SET_EXCEPTIONCFG = 127;//ÉèÖÃÒì³£²ÎÊı
		public const int NET_DVR_GET_ZONEANDDST = 128;//»ñÈ¡Ê±ÇøºÍÏÄÊ±ÖÆ²ÎÊı
		public const int NET_DVR_SET_ZONEANDDST = 129;//ÉèÖÃÊ±ÇøºÍÏÄÊ±ÖÆ²ÎÊı
		public const int NET_DVR_GET_SHOWSTRING = 130;//»ñÈ¡µş¼Ó×Ö·û²ÎÊı
		public const int NET_DVR_SET_SHOWSTRING = 131;//ÉèÖÃµş¼Ó×Ö·û²ÎÊı
		public const int NET_DVR_GET_EVENTCOMPCFG = 132;//»ñÈ¡ÊÂ¼ş´¥·¢Â¼Ïñ²ÎÊı
		public const int NET_DVR_SET_EVENTCOMPCFG = 133;//ÉèÖÃÊÂ¼ş´¥·¢Â¼Ïñ²ÎÊı
		...
		public const int NET_DVR_GET_PREVIEWCFG_AUX = 142;//»ñÈ¡-sÏµÁĞË«Êä³öÔ¤ÀÀ²ÎÊı(-sÏµÁĞË«Êä³ö2006-04-13)
		public const int NET_DVR_SET_PREVIEWCFG_AUX = 143;//ÉèÖÃ-sÏµÁĞË«Êä³öÔ¤ÀÀ²ÎÊı(-sÏµÁĞË«Êä³ö2006-04-13)

		public const int NET_DVR_GET_PICCFG_EX = 200;//»ñÈ¡Í¼Ïó²ÎÊı(SDK_V14À©Õ¹ÃüÁî)
		public const int NET_DVR_SET_PICCFG_EX = 201;//ÉèÖÃÍ¼Ïó²ÎÊı(SDK_V14À©Õ¹ÃüÁî)
		public const int NET_DVR_GET_USERCFG_EX = 202;//»ñÈ¡ÓÃ»§²ÎÊı(SDK_V15À©Õ¹ÃüÁî)
		public const int NET_DVR_SET_USERCFG_EX = 203;//ÉèÖÃÓÃ»§²ÎÊı(SDK_V15À©Õ¹ÃüÁî)
		public const int NET_DVR_GET_COMPRESSCFG_EX = 204;//»ñÈ¡Ñ¹Ëõ²ÎÊı(SDK_V15À©Õ¹ÃüÁî2006-05-15)
		public const int NET_DVR_SET_COMPRESSCFG_EX = 205;//ÉèÖÃÑ¹Ëõ²ÎÊı(SDK_V15À©Õ¹ÃüÁî2006-05-15)

		public const int NET_DVR_GET_NETAPPCFG = 222;//»ñÈ¡ÍøÂçÓ¦ÓÃ²ÎÊı NTP/DDNS/EMAIL
		public const int NET_DVR_SET_NETAPPCFG = 223;//ÉèÖÃÍøÂçÓ¦ÓÃ²ÎÊı NTP/DDNS/EMAIL
		public const int NET_DVR_GET_NTPCFG = 224;//»ñÈ¡ÍøÂçÓ¦ÓÃ²ÎÊı NTP
		public const int NET_DVR_SET_NTPCFG = 225;//ÉèÖÃÍøÂçÓ¦ÓÃ²ÎÊı NTP
		public const int NET_DVR_GET_DDNSCFG = 226;//»ñÈ¡ÍøÂçÓ¦ÓÃ²ÎÊı DDNS
		public const int NET_DVR_SET_DDNSCFG = 227;//ÉèÖÃÍøÂçÓ¦ÓÃ²ÎÊı DDNS
												   //¶ÔÓ¦NET_DVR_EMAILPARA
		public const int NET_DVR_GET_EMAILCFG = 228;//»ñÈ¡ÍøÂçÓ¦ÓÃ²ÎÊı EMAIL
		public const int NET_DVR_SET_EMAILCFG = 229;//ÉèÖÃÍøÂçÓ¦ÓÃ²ÎÊı EMAIL

		public const int NET_DVR_GET_NFSCFG = 230;/* NFS disk config */
		public const int NET_DVR_SET_NFSCFG = 231;/* NFS disk config */

		public const int NET_DVR_GET_SHOWSTRING_EX = 238;//»ñÈ¡µş¼Ó×Ö·û²ÎÊıÀ©Õ¹(Ö§³Ö8Ìõ×Ö·û)
		public const int NET_DVR_SET_SHOWSTRING_EX = 239;//ÉèÖÃµş¼Ó×Ö·û²ÎÊıÀ©Õ¹(Ö§³Ö8Ìõ×Ö·û)
		public const int NET_DVR_GET_NETCFG_OTHER = 244;//»ñÈ¡ÍøÂç²ÎÊı
		public const int NET_DVR_SET_NETCFG_OTHER = 245;//ÉèÖÃÍøÂç²ÎÊı
		...
		public const int NET_DVR_GET_DDNSCFG_EX = 274;//»ñÈ¡À©Õ¹DDNS²ÎÊı
		public const int NET_DVR_SET_DDNSCFG_EX = 275;//ÉèÖÃÀ©Õ¹DDNS²ÎÊı
		...
		public const int NET_DVR_GET_AP_INFO_LIST = 305;//»ñÈ¡ÎŞÏßÍøÂç×ÊÔ´²ÎÊı
		public const int NET_DVR_SET_WIFI_CFG = 306;//ÉèÖÃIP¼à¿ØÉè±¸ÎŞÏß²ÎÊı
		public const int NET_DVR_GET_WIFI_CFG = 307;//»ñÈ¡IP¼à¿ØÉè±¸ÎŞÏß²ÎÊı
		public const int NET_DVR_SET_WIFI_WORKMODE = 308;//ÉèÖÃIP¼à¿ØÉè±¸Íø¿Ú¹¤×÷Ä£Ê½²ÎÊı
		public const int NET_DVR_GET_WIFI_WORKMODE = 309;//»ñÈ¡IP¼à¿ØÉè±¸Íø¿Ú¹¤×÷Ä£Ê½²ÎÊı 
		public const int NET_DVR_GET_WIFI_STATUS = 310; //»ñÈ¡Éè±¸µ±Ç°wifiÁ¬½Ó×´Ì¬
														/***************************DS9000ĞÂÔöÃüÁî(_V30) begin *****************************/
														//ÍøÂç(NET_DVR_NETCFG_V30½á¹¹)
		public const int NET_DVR_GET_NETCFG_V30 = 1000;//»ñÈ¡ÍøÂç²ÎÊı
		public const int NET_DVR_SET_NETCFG_V30 = 1001;//ÉèÖÃÍøÂç²ÎÊı

		//Í¼Ïó(NET_DVR_PICCFG_V30½á¹¹)
		public const int NET_DVR_GET_PICCFG_V30 = 1002;//»ñÈ¡Í¼Ïó²ÎÊı
		public const int NET_DVR_SET_PICCFG_V30 = 1003;//ÉèÖÃÍ¼Ïó²ÎÊı

		//Â¼ÏñÊ±¼ä(NET_DVR_RECORD_V30½á¹¹)
		public const int NET_DVR_GET_RECORDCFG_V30 = 1004;//»ñÈ¡Â¼Ïñ²ÎÊı
		public const int NET_DVR_SET_RECORDCFG_V30 = 1005;//ÉèÖÃÂ¼Ïñ²ÎÊı

		//ÓÃ»§(NET_DVR_USER_V30½á¹¹)
		public const int NET_DVR_GET_USERCFG_V30 = 1006;//»ñÈ¡ÓÃ»§²ÎÊı
		public const int NET_DVR_SET_USERCFG_V30 = 1007;//ÉèÖÃÓÃ»§²ÎÊı
		...
		public const int NET_DVR_GET_EMAILCFG_V30 = 1012;//»ñÈ¡EMAIL²ÎÊı 
		public const int NET_DVR_SET_EMAILCFG_V30 = 1013;//ÉèÖÃEMAIL²ÎÊı 
		...
		//ÍøÂçÓ²ÅÌ½ÓÈë½á¹¹²ÎÊı (NET_DVR_NET_DISKCFG½á¹¹)
		...
		public const int NET_DVR_GET_DECODERCFG_V30 = 1042;//»ñÈ¡½âÂëÆ÷²ÎÊı
		public const int NET_DVR_SET_DECODERCFG_V30 = 1043;//ÉèÖÃ½âÂëÆ÷²ÎÊı

		//»ñÈ¡Ô¤ÀÀ²ÎÊı (NET_DVR_PREVIEWCFG_V30½á¹¹)
		public const int NET_DVR_GET_PREVIEWCFG_V30 = 1044;//»ñÈ¡Ô¤ÀÀ²ÎÊı
		public const int NET_DVR_SET_PREVIEWCFG_V30 = 1045;//ÉèÖÃÔ¤ÀÀ²ÎÊı

		//¸¨ÖúÔ¤ÀÀ²ÎÊı (NET_DVR_PREVIEWCFG_AUX_V30½á¹¹)
		public const int NET_DVR_GET_PREVIEWCFG_AUX_V30 = 1046;//»ñÈ¡¸¨ÖúÔ¤ÀÀ²ÎÊı
		public const int NET_DVR_SET_PREVIEWCFG_AUX_V30 = 1047;//ÉèÖÃ¸¨ÖúÔ¤ÀÀ²ÎÊı

		//IP½ÓÈëÅäÖÃ²ÎÊı £¨NET_DVR_IPPARACFG½á¹¹£©
		public const int NET_DVR_GET_IPPARACFG = 1048; //»ñÈ¡IP½ÓÈëÅäÖÃĞÅÏ¢ 
		public const int NET_DVR_SET_IPPARACFG = 1049;//ÉèÖÃIP½ÓÈëÅäÖÃĞÅÏ¢

		//IP½ÓÈëÅäÖÃ²ÎÊı £¨NET_DVR_IPPARACFG_V40½á¹¹£©
		public const int NET_DVR_GET_IPPARACFG_V40 = 1062; //»ñÈ¡IP½ÓÈëÅäÖÃĞÅÏ¢ 
		public const int NET_DVR_SET_IPPARACFG_V40 = 1063;//ÉèÖÃIP½ÓÈëÅäÖÃĞÅÏ¢

		//IP±¨¾¯ÊäÈë½ÓÈëÅäÖÃ²ÎÊı £¨NET_DVR_IPALARMINCFG½á¹¹£©
		public const int NET_DVR_GET_IPALARMINCFG = 1050; //»ñÈ¡IP±¨¾¯ÊäÈë½ÓÈëÅäÖÃĞÅÏ¢ 
		public const int NET_DVR_SET_IPALARMINCFG = 1051; //ÉèÖÃIP±¨¾¯ÊäÈë½ÓÈëÅäÖÃĞÅÏ¢

		//IP±¨¾¯Êä³ö½ÓÈëÅäÖÃ²ÎÊı £¨NET_DVR_IPALARMOUTCFG½á¹¹£©
		public const int NET_DVR_GET_IPALARMOUTCFG = 1052;//»ñÈ¡IP±¨¾¯Êä³ö½ÓÈëÅäÖÃĞÅÏ¢ 
		public const int NET_DVR_SET_IPALARMOUTCFG = 1053;//ÉèÖÃIP±¨¾¯Êä³ö½ÓÈëÅäÖÃĞÅÏ¢

		//Ó²ÅÌ¹ÜÀíµÄ²ÎÊı»ñÈ¡ (NET_DVR_HDCFG½á¹¹)
		public const int NET_DVR_GET_HDCFG = 1054;//»ñÈ¡Ó²ÅÌ¹ÜÀíÅäÖÃ²ÎÊı
		public const int NET_DVR_SET_HDCFG = 1055;//ÉèÖÃÓ²ÅÌ¹ÜÀíÅäÖÃ²ÎÊı

		//ÅÌ×é¹ÜÀíµÄ²ÎÊı»ñÈ¡ (NET_DVR_HDGROUP_CFG½á¹¹)
		public const int NET_DVR_GET_HDGROUP_CFG = 1056;//»ñÈ¡ÅÌ×é¹ÜÀíÅäÖÃ²ÎÊı
		public const int NET_DVR_SET_HDGROUP_CFG = 1057;//ÉèÖÃÅÌ×é¹ÜÀíÅäÖÃ²ÎÊı

		//Éè±¸±àÂëÀàĞÍÅäÖÃ(NET_DVR_COMPRESSION_AUDIO½á¹¹)
		public const int NET_DVR_GET_COMPRESSCFG_AUD = 1058;//»ñÈ¡Éè±¸ÓïÒô¶Ô½²±àÂë²ÎÊı
		public const int NET_DVR_SET_COMPRESSCFG_AUD = 1059;//ÉèÖÃÉè±¸ÓïÒô¶Ô½²±àÂë²ÎÊı

		//IP½ÓÈëÅäÖÃ²ÎÊı £¨NET_DVR_IPPARACFG_V31½á¹¹£©
		public const int NET_DVR_GET_IPPARACFG_V31 = 1060;//»ñÈ¡IP½ÓÈëÅäÖÃĞÅÏ¢ 
		public const int NET_DVR_SET_IPPARACFG_V31 = 1061; //ÉèÖÃIP½ÓÈëÅäÖÃĞÅÏ¢

		//Éè±¸²ÎÊıÅäÖÃ £¨NET_DVR_DEVICECFG_V40½á¹¹£©
		public const int NET_DVR_GET_DEVICECFG_V40 = 1100;//»ñÈ¡Éè±¸²ÎÊı
		public const int NET_DVR_SET_DEVICECFG_V40 = 1101;//ÉèÖÃÉè±¸²ÎÊı
		...
		//NATÓ³ÉäÅäÖÃ²ÎÊı £¨NET_DVR_NAT_CFG½á¹¹£©
		public const int NET_DVR_GET_NAT_CFG = 6111;    //»ñÈ¡NATÓ³Éä²ÎÊı
		public const int NET_DVR_SET_NAT_CFG = 6112;    //ÉèÖÃNATÓ³Éä²ÎÊı  
														/*************************²ÎÊıÅäÖÃÃüÁî end*******************************/
		...
		//´ÎÀàĞÍ
		public const int MINOR_VI_LOST = 33;/* ÊÓÆµĞÅºÅ¶ªÊ§ */
		...
		public const int MINOR_FANRESUME = 50;/* ÊÓÆµ×ÛºÏÆ½Ì¨£º·çÉÈ×´Ì¬»Ö¸´Õı³£ */
		...
		public const int MINOR_LOCAL_CFG_PARM = 82;/* ±¾µØÅäÖÃ²ÎÊı */
		public const int MINOR_LOCAL_PLAYBYFILE = 83;/* ±¾µØ°´ÎÄ¼ş»Ø·Å»òÏÂÔØ */
		...
		public const int MINOR_LOCAL_MODIFY_TIME = 89;/* ±¾µØĞŞ¸ÄÊ±¼ä(±£Áô²»Ê¹ÓÃ) */
		public const int MINOR_LOCAL_UPGRADE = 90;/* ±¾µØÉı¼¶ */
		public const int MINOR_LOCAL_RECFILE_OUTPUT = 91;/* ±¾µØ±¸·İÂ¼ÏóÎÄ¼ş */
		public const int MINOR_LOCAL_FORMAT_HDD = 92;/* ±¾µØ³õÊ¼»¯Ó²ÅÌ */
		public const int MINOR_LOCAL_CFGFILE_OUTPUT = 93;/* µ¼³ö±¾µØÅäÖÃÎÄ¼ş */
		public const int MINOR_LOCAL_CFGFILE_INPUT = 94;/* µ¼Èë±¾µØÅäÖÃÎÄ¼ş */
		public const int MINOR_LOCAL_COPYFILE = 95;/* ±¾µØ±¸·İÎÄ¼ş */
		public const int MINOR_LOCAL_LOCKFILE = 96;/* ±¾µØËø¶¨Â¼ÏñÎÄ¼ş */
		public const int MINOR_LOCAL_UNLOCKFILE = 97;/* ±¾µØ½âËøÂ¼ÏñÎÄ¼ş */
		public const int MINOR_LOCAL_DVR_ALARM = 98;/* ±¾µØÊÖ¶¯Çå³ıºÍ´¥·¢±¨¾¯*/
		public const int MINOR_IPC_ADD = 99;/* ±¾µØÌí¼ÓIPC */
		public const int MINOR_IPC_DEL = 100;/* ±¾µØÉ¾³ıIPC */
		public const int MINOR_IPC_SET = 101;/* ±¾µØÉèÖÃIPC */
		public const int MINOR_LOCAL_START_BACKUP = 102;/* ±¾µØ¿ªÊ¼±¸·İ */
		public const int MINOR_LOCAL_STOP_BACKUP = 103;/* ±¾µØÍ£Ö¹±¸·İ*/
		public const int MINOR_LOCAL_COPYFILE_START_TIME = 104;/* ±¾µØ±¸·İ¿ªÊ¼Ê±¼ä*/
		public const int MINOR_LOCAL_COPYFILE_END_TIME = 105;/* ±¾µØ±¸·İ½áÊøÊ±¼ä*/
		public const int MINOR_LOCAL_ADD_NAS = 106;/*±¾µØÌí¼ÓÍøÂçÓ²ÅÌ*/
		public const int MINOR_LOCAL_DEL_NAS = 107;/* ±¾µØÉ¾³ınasÅÌ*/
		...
		public const int MINOR_REMOTE_GET_PARM = 118;/* Ô¶³Ì»ñÈ¡²ÎÊı */
		public const int MINOR_REMOTE_CFG_PARM = 119;/* Ô¶³ÌÅäÖÃ²ÎÊı */
		...
		public const int MINOR_REMOTE_UPGRADE = 126;/* Ô¶³ÌÉı¼¶ */
		public const int MINOR_REMOTE_PLAYBYFILE = 127;/* Ô¶³Ì°´ÎÄ¼ş»Ø·Å */
		...
		public const int MINOR_REMOTE_LOCKFILE = 132;/* Ô¶³ÌËø¶¨ÎÄ¼ş */
		public const int MINOR_REMOTE_UNLOCKFILE = 133;/* Ô¶³Ì½âËøÎÄ¼ş */
		public const int MINOR_REMOTE_CFGFILE_OUTPUT = 134;/* Ô¶³Ìµ¼³öÅäÖÃÎÄ¼ş */
		public const int MINOR_REMOTE_CFGFILE_INTPUT = 135;/* Ô¶³Ìµ¼ÈëÅäÖÃÎÄ¼ş */
		public const int MINOR_REMOTE_RECFILE_OUTPUT = 136;/* Ô¶³Ìµ¼³öÂ¼ÏóÎÄ¼ş */
		public const int MINOR_REMOTE_DVR_ALARM = 137;/* Ô¶³ÌÊÖ¶¯Çå³ıºÍ´¥·¢±¨¾¯*/
		public const int MINOR_REMOTE_IPC_ADD = 138;/* Ô¶³ÌÌí¼ÓIPC */
		public const int MINOR_REMOTE_IPC_DEL = 139;/* Ô¶³ÌÉ¾³ıIPC */
		...
		public const int MINOR_REMOTE_DEL_NAS = 143;/* Ô¶³ÌÉ¾³ınasÅÌ*/
		public const int MINOR_REMOTE_SET_NAS = 144;/* Ô¶³ÌÉèÖÃnasÅÌ*/

		//2009-12-16 Ôö¼ÓÊÓÆµ×ÛºÏÆ½Ì¨ÈÕÖ¾ÀàĞÍ
		public const int MINOR_SUBSYSTEMREBOOT = 160;/*ÊÓÆµ×ÛºÏÆ½Ì¨£ºdm6467 Õı³£ÖØÆô*/
		public const int MINOR_MATRIX_STARTTRANSFERVIDEO = 161; /*ÊÓÆµ×ÛºÏÆ½Ì¨£º¾ØÕóÇĞ»»¿ªÊ¼´«ÊäÍ¼Ïñ*/
		public const int MINOR_MATRIX_STOPTRANSFERVIDEO = 162;  /*ÊÓÆµ×ÛºÏÆ½Ì¨£º¾ØÕóÇĞ»»Í£Ö¹´«ÊäÍ¼Ïñ*/
		public const int MINOR_REMOTE_SET_ALLSUBSYSTEM = 163;   /*ÊÓÆµ×ÛºÏÆ½Ì¨£ºÉèÖÃËùÓĞ6467×ÓÏµÍ³ĞÅÏ¢*/
		public const int MINOR_REMOTE_GET_ALLSUBSYSTEM = 164;   /*ÊÓÆµ×ÛºÏÆ½Ì¨£º»ñÈ¡ËùÓĞ6467×ÓÏµÍ³ĞÅÏ¢*/
		...
		public const int MINOR_MATRIX_STARTTRANSFERAUDIO = 167; /*ÊÓÆµ×ÛºÏÆ½Ì¨£º¾ØÕóÇĞ»»¿ªÊ¼´«ÊäÒôÆµ*/
		public const int MINOR_MATRIX_STOPRANSFERAUDIO = 168;   /*ÊÓÆµ×ÛºÏÆ½Ì¨£º¾ØÕóÇĞ»»Í£Ö¹´«ÊäÒôÆµ*/
		...
		/*ÈÕÖ¾¸½¼ÓĞÅÏ¢*/
		//Ö÷ÀàĞÍ
		public const int MAJOR_INFORMATION = 4;/*¸½¼ÓĞÅÏ¢*/
											   //´ÎÀàĞÍ
		public const int MINOR_HDD_INFO = 161;/*Ó²ÅÌĞÅÏ¢*/
		public const int MINOR_SMART_INFO = 162;/*SMARTĞÅÏ¢*/
		public const int MINOR_REC_START = 163;/*¿ªÊ¼Â¼Ïñ*/
		public const int MINOR_REC_STOP = 164;/*Í£Ö¹Â¼Ïñ*/
		public const int MINOR_REC_OVERDUE = 165;/*¹ıÆÚÂ¼ÏñÉ¾³ı*/
		public const int MINOR_LINK_START = 166;//Á¬½ÓÇ°¶ËÉè±¸
		public const int MINOR_LINK_STOP = 167;//¶Ï¿ªÇ°¶ËÉè±¸¡¡
		public const int MINOR_NET_DISK_INFO = 168;//ÍøÂçÓ²ÅÌĞÅÏ¢
		...
		public const int PARA_FRAMETYPE = 2048;/*Ö¡¸ñÊ½*/
											   //vca
		public const int PARA_VCA_RULE = 4096;//ĞĞÎª¹æÔò
											  /************************DVRÈÕÖ¾ End***************************/


		/*******************²éÕÒÎÄ¼şºÍÈÕÖ¾º¯Êı·µ»ØÖµ*************************/
		public const int NET_DVR_FILE_SUCCESS = 1000;//»ñµÃÎÄ¼şĞÅÏ¢
		public const int NET_DVR_FILE_NOFIND = 1001;//Ã»ÓĞÎÄ¼ş
		public const int NET_DVR_ISFINDING = 1002;//ÕıÔÚ²éÕÒÎÄ¼ş
		public const int NET_DVR_NOMOREFILE = 1003;//²éÕÒÎÄ¼şÊ±Ã»ÓĞ¸ü¶àµÄÎÄ¼ş
		public const int NET_DVR_FILE_EXCEPTION = 1004;//²éÕÒÎÄ¼şÊ±Òì³£

		/*********************»Øµ÷º¯ÊıÀàĞÍ begin************************/
		public const int COMM_ALARM = 0x1100;//8000±¨¾¯ĞÅÏ¢Ö÷¶¯ÉÏ´«£¬¶ÔÓ¦NET_DVR_ALARMINFO
		public const int COMM_ALARM_RULE = 0x1102;//ĞĞÎª·ÖÎö±¨¾¯ĞÅÏ¢£¬¶ÔÓ¦NET_VCA_RULE_ALARM
		...
		public const int COMM_ALARM_FACE = 0x1106;//ÈËÁ³¼ì²âÊ¶±ğ±¨¾¯ĞÅÏ¢£¬¶ÔÓ¦NET_DVR_FACEDETECT_ALARM
		public const int COMM_RULE_INFO_UPLOAD = 0x1107;  // ÊÂ¼şÊı¾İĞÅÏ¢ÉÏ´«
		public const int COMM_ALARM_AID = 0x1110;  //½»Í¨ÊÂ¼ş±¨¾¯ĞÅÏ¢
		public const int COMM_ALARM_TPS = 0x1111;  //½»Í¨²ÎÊıÍ³¼Æ±¨¾¯ĞÅÏ¢
		public const int COMM_UPLOAD_FACESNAP_RESULT = 0x1112;  //ÈËÁ³Ê¶±ğ½á¹ûÉÏ´«
		public const int COMM_ALARM_FACE_DETECTION = 0x4010; //ÈËÁ³Õì²â±¨¾¯ĞÅÏ¢
		public const int COMM_ALARM_TFS = 0x1113;  //½»Í¨È¡Ö¤±¨¾¯ĞÅÏ¢
		public const int COMM_ALARM_TPS_V41 = 0x1114;  //½»Í¨²ÎÊıÍ³¼Æ±¨¾¯ĞÅÏ¢À©Õ¹
		public const int COMM_ALARM_AID_V41 = 0x1115;  //½»Í¨ÊÂ¼ş±¨¾¯ĞÅÏ¢À©Õ¹
		public const int COMM_ALARM_VQD_EX = 0x1116;     //ÊÓÆµÖÊÁ¿Õï¶Ï±¨¾¯
		public const int COMM_SENSOR_VALUE_UPLOAD = 0x1120;  //Ä£ÄâÁ¿Êı¾İÊµÊ±ÉÏ´«
		...
		public const int COMM_ALARMHOST_OPERATEEVENT_ALARM = 0x1124;  //²Ù×÷ÊÂ¼ş±¨¾¯ÉÏ´«
		...
		public const int COMM_ALARMHOST_DATA_UPLOAD = 0x1129;    //±¨¾¯Êı¾İÉÏ´«
		public const int COMM_ALARM_AUDIOEXCEPTION = 0x1150;     //ÉùÒô±¨¾¯ĞÅÏ¢
		public const int COMM_ALARM_DEFOCUS = 0x1151;    //Ğé½¹±¨¾¯ĞÅÏ¢
		public const int COMM_ALARM_BUTTON_DOWN_EXCEPTION = 0x1152;  //°´Å¥°´ÏÂ±¨¾¯ĞÅÏ¢
		public const int COMM_ALARM_ALARMGPS = 0x1202; //GPS±¨¾¯ĞÅÏ¢ÉÏ´«
		public const int COMM_TRADEINFO = 0x1500;  //ATMDVRÖ÷¶¯ÉÏ´«½»Ò×ĞÅÏ¢
		public const int COMM_UPLOAD_PLATE_RESULT = 0x2800;  //ÉÏ´«³µÅÆĞÅÏ¢
		public const int COMM_ITC_STATUS_DETECT_RESULT = 0x2810;  //ÊµÊ±×´Ì¬¼ì²â½á¹ûÉÏ´«(ÖÇÄÜ¸ßÇåIPC)
		public const int COMM_IPC_AUXALARM_RESULT = 0x2820;  //PIR±¨¾¯¡¢ÎŞÏß±¨¾¯¡¢ºô¾È±¨¾¯ÉÏ´«
		public const int COMM_UPLOAD_PICTUREINFO = 0x2900;   //ÉÏ´«Í¼Æ¬ĞÅÏ¢
		public const int COMM_SNAP_MATCH_ALARM = 0x2902;  //ºÚÃûµ¥±È¶Ô½á¹ûÉÏ´«
		public const int COMM_ITS_PLATE_RESULT = 0x3050;  //ÖÕ¶ËÍ¼Æ¬ÉÏ´«
		public const int COMM_ITS_TRAFFIC_COLLECT = 0x3051;  //ÖÕ¶ËÍ³¼ÆÊı¾İÉÏ´«
		public const int COMM_ITS_GATE_VEHICLE = 0x3052;  //³öÈë¿Ú³µÁ¾×¥ÅÄÊı¾İÉÏ´«
		public const int COMM_ITS_GATE_FACE = 0x3053; //³öÈë¿ÚÈËÁ³×¥ÅÄÊı¾İÉÏ´«
		public const int COMM_ITS_GATE_COSTITEM = 0x3054;  //³öÈë¿Ú¹ı³µÊÕ·ÑÃ÷Ï¸ 2013-11-19
		public const int COMM_ITS_GATE_HANDOVER = 0x3055; //³öÈë¿Ú½»½Ó°àÊı¾İ 2013-11-19
		public const int COMM_ITS_PARK_VEHICLE = 0x3056;  //Í£³µ³¡Êı¾İÉÏ´«
		public const int COMM_ITS_BLACKLIST_ALARM = 0x3057;  //ºÚÃûµ¥±¨¾¯ÉÏ´«
		public const int COMM_ALARM_V30 = 0x4000;    //9000±¨¾¯ĞÅÏ¢Ö÷¶¯ÉÏ´«
		public const int COMM_IPCCFG = 0x4001;   //9000Éè±¸IPC½ÓÈëÅäÖÃ¸Ä±ä±¨¾¯ĞÅÏ¢Ö÷¶¯ÉÏ´«
		public const int COMM_IPCCFG_V31 = 0x4002;   //9000Éè±¸IPC½ÓÈëÅäÖÃ¸Ä±ä±¨¾¯ĞÅÏ¢Ö÷¶¯ÉÏ´«À©Õ¹ 9000_1.1
		public const int COMM_IPCCFG_V40 = 0x4003; // IVMS 2000 ±àÂë·şÎñÆ÷ NVR IPC½ÓÈëÅäÖÃ¸Ä±äÊ±±¨¾¯ĞÅÏ¢ÉÏ´«
		public const int COMM_ALARM_DEVICE = 0x4004;  //Éè±¸±¨¾¯ÄÚÈİ£¬ÓÉÓÚÍ¨µÀÖµ´óÓÚ256¶øÀ©Õ¹
		public const int COMM_ALARM_CVR = 0x4005;  //CVR 2.0.XÍâ²¿±¨¾¯ÀàĞÍ
		public const int COMM_ALARM_HOT_SPARE = 0x4006;  //ÈÈ±¸Òì³£±¨¾¯£¨N+1Ä£Ê½Òì³£±¨¾¯£©
		public const int COMM_ALARM_V40 = 0x4007;   //ÒÆ¶¯Õì²â£¬ÊÓÆµ¶ªÊ§£¬ÕÚµ²£¬IOĞÅºÅÁ¿µÈ±¨¾¯ĞÅÏ¢Ö÷¶¯ÉÏ´«£¬±¨¾¯Êı¾İÎª¿É±ä³¤

		public const int COMM_ITS_ROAD_EXCEPTION = 0x4500;   //Â·¿ÚÉè±¸Òì³£±¨¾¯
		public const int COMM_ITS_EXTERNAL_CONTROL_ALARM = 0x4520;  //Íâ¿Ø±¨¾¯
		public const int COMM_SCREEN_ALARM = 0x5000;  //¶àÆÁ¿ØÖÆÆ÷±¨¾¯ÀàĞÍ
		public const int COMM_DVCS_STATE_ALARM = 0x5001;  //·Ö²¼Ê½´óÆÁ¿ØÖÆÆ÷±¨¾¯ÉÏ´«
		public const int COMM_ALARM_VQD = 0x6000;  //VQDÖ÷¶¯±¨¾¯ÉÏ´« 
		public const int COMM_PUSH_UPDATE_RECORD_INFO = 0x6001;  //ÍÆÄ£Ê½Â¼ÏñĞÅÏ¢ÉÏ´«
		public const int COMM_DIAGNOSIS_UPLOAD = 0x5100;  //Õï¶Ï·şÎñÆ÷VQD±¨¾¯ÉÏ´«
		public const int COMM_ALARM_ACS = 0x5002;  //ÃÅ½ûÖ÷»ú±¨¾¯
		public const int COMM_ID_INFO_ALARM = 0x5200;  //Éí·İÖ¤ĞÅÏ¢ÉÏ´«
		public const int COMM_PASSNUM_INFO_ALARM = 0x5201;  //Í¨ĞĞÈËÊıÉÏ±¨
		...
		/********************Ô¤ÀÀ»Øµ÷º¯Êı*********************/
		public const int NET_DVR_SYSHEAD = 1;//ÏµÍ³Í·Êı¾İ
		public const int NET_DVR_STREAMDATA = 2;//ÊÓÆµÁ÷Êı¾İ£¨°üÀ¨¸´ºÏÁ÷ºÍÒôÊÓÆµ·Ö¿ªµÄÊÓÆµÁ÷Êı¾İ£©
		public const int NET_DVR_AUDIOSTREAMDATA = 3;//ÒôÆµÁ÷Êı¾İ
		public const int NET_DVR_STD_VIDEODATA = 4;//±ê×¼ÊÓÆµÁ÷Êı¾İ
		public const int NET_DVR_STD_AUDIODATA = 5;//±ê×¼ÒôÆµÁ÷Êı¾İ

		//»Øµ÷Ô¤ÀÀÖĞµÄ×´Ì¬ºÍÏûÏ¢
		public const int NET_DVR_REALPLAYEXCEPTION = 111;//Ô¤ÀÀÒì³£
		public const int NET_DVR_REALPLAYNETCLOSE = 112;//Ô¤ÀÀÊ±Á¬½Ó¶Ï¿ª
		public const int NET_DVR_REALPLAY5SNODATA = 113;//Ô¤ÀÀ5sÃ»ÓĞÊÕµ½Êı¾İ
		public const int NET_DVR_REALPLAYRECONNECT = 114;//Ô¤ÀÀÖØÁ¬

		/********************»Ø·Å»Øµ÷º¯Êı*********************/
		public const int NET_DVR_PLAYBACKOVER = 101;//»Ø·ÅÊı¾İ²¥·ÅÍê±Ï
		public const int NET_DVR_PLAYBACKEXCEPTION = 102;//»Ø·ÅÒì³£
		public const int NET_DVR_PLAYBACKNETCLOSE = 103;//»Ø·ÅÊ±ºòÁ¬½Ó¶Ï¿ª
		public const int NET_DVR_PLAYBACK5SNODATA = 104;//»Ø·Å5sÃ»ÓĞÊÕµ½Êı¾İ

		/*********************»Øµ÷º¯ÊıÀàĞÍ end************************/
		//Éè±¸ĞÍºÅ(DVRÀàĞÍ)
		/* Éè±¸ÀàĞÍ */
		public const int DVR = 1;/*¶ÔÉĞÎ´¶¨ÒåµÄdvrÀàĞÍ·µ»ØNETRET_DVR*/
		...
		public const int LOWCOST_DVR = 19;/*7000HÏµÁĞ*/
		...
		public const int MEGA_IPCAM = 31;/*X52MFÏµÁĞ,752MF,852MF*/
		public const int IPCAM_X62MF = 32;/*X62MFÏµÁĞ¿É½ÓÈë9000Éè±¸,762MF,862MF*/
        ...
        **************************************************/
		...
		public struct NET_DVR_STRUCTHEAD {
			...
			public byte byVersion;  /*¸ßµÍ4Î»·Ö±ğ´ú±í¸ßµÍ°æ±¾£¬ºóĞø¸ù¾İ°æ±¾ºÍ³¤¶È½øĞĞÀ©Õ¹£¬²»Í¬µÄ°æ±¾µÄ³¤¶È½øĞĞÏŞÖÆ*/
			public byte byRes;
		}
		...
		public struct NET_DVR_HANDLEEXCEPTION_V41 {
			public uint dwHandleType;/*´¦Àí·½Ê½,´¦Àí·½Ê½µÄ"»ò"½á¹û*/
									 ...
									 /*0x20: ÎŞÏßÉù¹â±¨¾¯Æ÷Áª¶¯*/
									 /*0x40: Áª¶¯µç×ÓµØÍ¼(Ä¿Ç°Ö»ÓĞPCNVRÖ§³Ö)*/
									 /*0x200: ×¥Í¼²¢ÉÏ´«FTP*/
			public uint dwMaxRelAlarmOutChanNum; //´¥·¢µÄ±¨¾¯Êä³öÍ¨µÀÊı£¨Ö»¶Á£©×î´óÖ§³ÖÊı
		...
		public struct NET_DVR_HANDLEEXCEPTION_V40 {
			public uint dwHandleType;/*´¦Àí·½Ê½,´¦Àí·½Ê½µÄ"»ò"½á¹û*/
									 ...
									 /*0x200: ×¥Í¼²¢ÉÏ´«FTP*/
			public uint dwMaxRelAlarmOutChanNum; //´¥·¢µÄ±¨¾¯Êä³öÍ¨µÀÊı£¨Ö»¶Á£©×î´óÖ§³ÖÊı
			public uint dwRelAlarmOutChanNum; //´¥·¢µÄ±¨¾¯Êä³öÍ¨µÀÊı Êµ¼ÊÖ§³ÖÊı
		...
		public struct NET_DVR_DEVICECFG {
			...
			public byte[] sSerialNumber;//ĞòÁĞºÅ
			public uint dwSoftwareVersion;//Èí¼ş°æ±¾ºÅ,¸ß16Î»ÊÇÖ÷°æ±¾,µÍ16Î»ÊÇ´Î°æ±¾
			public uint dwSoftwareBuildDate;//Èí¼şÉú³ÉÈÕÆÚ,0xYYYYMMDD
			public uint dwDSPSoftwareVersion;//DSPÈí¼ş°æ±¾,¸ß16Î»ÊÇÖ÷°æ±¾,µÍ16Î»ÊÇ´Î°æ±¾
			public uint dwDSPSoftwareBuildDate;// DSPÈí¼şÉú³ÉÈÕÆÚ,0xYYYYMMDD
			public uint dwPanelVersion;// Ç°Ãæ°å°æ±¾,¸ß16Î»ÊÇÖ÷°æ±¾,µÍ16Î»ÊÇ´Î°æ±¾
			public uint dwHardwareVersion;// Ó²¼ş°æ±¾,¸ß16Î»ÊÇÖ÷°æ±¾,µÍ16Î»ÊÇ´Î°æ±¾
		...
		public struct NET_DVR_ETHERNET {
			...
			public ushort wDVRPort;//¶Ë¿ÚºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MACADDR_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byMACAddr;//·şÎñÆ÷µÄÎïÀíµØÖ·
		}
		...
		public struct NET_DVR_NETCFG_V30 {
			...
			public byte byRes3;
			public NET_DVR_IPADDR struDnsServer1IpAddr;/* ÓòÃû·şÎñÆ÷1µÄIPµØÖ· */
			public NET_DVR_IPADDR struDnsServer2IpAddr;/* ÓòÃû·şÎñÆ÷2µÄIPµØÖ· */
		...
		public struct NET_DVR_ETHERNET_MULTI {
			...
			public byte byCardType;  //Íø¿¨ÀàĞÍ£¬0-ÆÕÍ¨Íø¿¨£¬1-ÄÚÍøÍø¿¨£¬2-ÍâÍøÍø¿¨
			public byte byRes1;
			public ushort wMTU;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MACADDR_LEN, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_NETCFG {
			...
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]
			public string sIPServerIP;//IPServer·şÎñÆ÷µØÖ·
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]
		...
		public struct NET_DVR_SIP_CFG {
			...
			public byte byLoginStatus;  //×¢²á×´Ì¬£¬0-Î´×¢²á£¬1-ÒÑ×¢²á£¬´Ë²ÎÊıÖ»ÄÜ»ñÈ¡
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public NET_DVR_IPADDR stuServerIP;  //SIP·şÎñÆ÷IP
			public ushort wServerPort;    //SIP·şÎñÆ÷¶Ë¿Ú
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_IP_VIEW_AUDIO_CFG {
			...
			public byte byAudioEncPri2; //ÒôÆµ±àÂëÓÅÏÈ¼¶2£¬µ±sip·şÎñÆ÷²»Ö§³ÖÒôÆµ±àÂë1Ê±»áÊ¹ÓÃÒôÆµ±àÂë2£¬0-OggVorbis£¬1-G711_U£¬2-G711_A£¬ 5-MPEG2,6-G726£¬7-AAC
			public ushort wAudioPacketLen1; //ÒôÆµ±àÂë1Êı¾İ°ü³¤¶È
			public ushort wAudioPacketLen2; //ÒôÆµ±àÂë2Êı¾İ°ü³¤¶È
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 30, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}

		//IP·Ö»úºô½Ğ¶Ô½²²ÎÊıÅäÖÃ½á¹¹Ìå
		[StructLayoutAttribute(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
		public struct NET_DVR_IP_VIEW_CALL_CFG {
			public uint dwSize;
			public byte byEnableAutoResponse; //Ê¹ÄÜ×Ô¶¯Ó¦´ğ,0-²»Ê¹ÄÜ£¬1-Ê¹ÄÜ
			public byte byAudoResponseTime; //×Ô¶¯Ó¦´ğÊ±¼ä£¬0-30Ãë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			...
			public byte[] byRes;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_NUMBER_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byAlarmNumber1; //ºô½ĞºÅÂë1
			public byte byEnableAlarmNumber2; //Æô¶¯±¨¾¯ºÅÂë2£¬0-²»Æô¶¯£¬1-Æô¶¯
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes3;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_NUMBER_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byAlarmNumber2; //ºô½ĞºÅÂë2£¬ºô½ĞºÅÂë1Ê§°Ü»á³¢ÊÔºô½ĞºÅÂë2
		...
		public struct NET_DVR_RECORDCHAN {
			public uint dwMaxRecordChanNum;   //Éè±¸Ö§³ÖµÄ×î´ó¹ØÁªÂ¼ÏñÍ¨µÀÊı-Ö»¶Á
			public uint dwCurRecordChanNum;   //µ±Ç°Êµ¼ÊÒÑÅäÖÃµÄ¹ØÁªÂ¼ÏñÍ¨µÀÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.U4)]
			public uint dwRelRecordChan;     /* Êµ¼Ê´¥·¢Â¼ÏñÍ¨µÀ£¬°´Öµ±íÊ¾,²ÉÓÃ½ô´ÕĞÍÅÅÁĞ£¬´ÓÏÂ±ê0 - MAX_CHANNUM_V30-1ÓĞĞ§£¬Èç¹ûÖĞ¼äÓöµ½0xffffffff,ÔòºóĞøÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;          //±£Áô
		}
		...
		public struct NET_DVR_MOTION_V30 {
			...
			public byte[] byMotionScope;/*Õì²âÇøÓò,0-96Î»,±íÊ¾64ĞĞ,¹²ÓĞ96*64¸öĞ¡ºê¿é,Îª1±íÊ¾ÊÇÒÆ¶¯Õì²âÇøÓò,0-±íÊ¾²»ÊÇ*/
		...
		public struct NET_DVR_MOTION {
			...
			public byte[] byMotionScope;/*Õì²âÇøÓò,¹²ÓĞ22*18¸öĞ¡ºê¿é,Îª1±íÊ¾¸Äºê¿éÊÇÒÆ¶¯Õì²âÇøÓò,0-±íÊ¾²»ÊÇ*/
		...
		//ÕÚµ²±¨¾¯(×Ó½á¹¹)(9000À©Õ¹)  ÇøÓò´óĞ¡704*576
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_HIDEALARM_V30 {
			public uint dwEnableHideAlarm;/* ÊÇ·ñÆô¶¯ÕÚµ²±¨¾¯ ,0-·ñ,1-µÍÁéÃô¶È 2-ÖĞÁéÃô¶È 3-¸ßÁéÃô¶È*/
		...
		public struct NET_DVR_PICCFG_V30 {
			...
			public byte[] byReservedData;/*±£Áô*/
										 //ÏÔÊ¾Í¨µÀÃû
			public uint dwShowChanName;// Ô¤ÀÀµÄÍ¼ÏóÉÏÊÇ·ñÏÔÊ¾Í¨µÀÃû³Æ,0-²»ÏÔÊ¾,1-ÏÔÊ¾ ÇøÓò´óĞ¡704*576
			...
			//OSD
			public uint dwShowOsd;// Ô¤ÀÀµÄÍ¼ÏóÉÏÊÇ·ñÏÔÊ¾OSD,0-²»ÏÔÊ¾,1-ÏÔÊ¾ ÇøÓò´óĞ¡704*576
			...
			public byte byFontSize;//×ÖÌå´óĞ¡£¬16*16(ÖĞ)/8*16(Ó¢)£¬1-32*32(ÖĞ)/16*32(Ó¢)£¬2-64*64(ÖĞ)/32*64(Ó¢)  3-48*48(ÖĞ)/24*48(Ó¢) 0xff-×ÔÊÊÓ¦(adaptive)
		...
		public struct NET_DVR_COMPRESSION_INFO_V30 {
			public byte byStreamType;//ÂëÁ÷ÀàĞÍ 0-ÊÓÆµÁ÷, 1-¸´ºÏÁ÷, ±íÊ¾ÊÂ¼şÑ¹Ëõ²ÎÊıÊ±×î¸ßÎ»±íÊ¾ÊÇ·ñÆôÓÃÑ¹Ëõ²ÎÊı
			...
			public byte byBitrateType;//ÂëÂÊÀàĞÍ 0:±äÂëÂÊ, 1:¶¨ÂëÂÊ
			...
			public uint dwVideoFrameRate;//Ö¡ÂÊ 0-È«²¿; 1-1/16; 2-1/8; 3-1/4; 4-1/2; 5-1; 6-2; 7-4; 8-6; 9-8; 10-10; 11-12; 12-16; 13-20; V2.0°æ±¾ÖĞĞÂ¼Ó14-15; 15-18; 16-22;
			...
			public byte byVideoEncType;//ÊÓÆµ±àÂëÀàĞÍ 0 hik264;1±ê×¼h264; 2±ê×¼mpeg4;
			public byte byAudioEncType; //ÒôÆµ±àÂëÀàĞÍ 0£­OggVorbis
			public byte byVideoEncComplexity; //ÊÓÆµ±àÂë¸´ÔÓ¶È£¬0-µÍ£¬1-ÖĞ£¬2¸ß,0xfe:×Ô¶¯£¬ºÍÔ´Ò»ÖÂ
		...
		public struct NET_DVR_COMPRESSIONCFG_V30 {
			...
			public NET_DVR_COMPRESSION_INFO_V30 struEventRecordPara;//ÊÂ¼ş´¥·¢Ñ¹Ëõ²ÎÊı
		...
		public struct NET_DVR_COMPRESSIONCFG {
			public uint dwSize;
			public NET_DVR_COMPRESSION_INFO struRecordPara;//Â¼Ïñ/ÊÂ¼ş´¥·¢Â¼Ïñ
			public NET_DVR_COMPRESSION_INFO struNetPara;//Íø´«/±£Áô
		}

		//ÂëÁ÷Ñ¹Ëõ²ÎÊı(×Ó½á¹¹)(À©Õ¹) Ôö¼ÓIÖ¡¼ä¸ô
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		public struct NET_DVR_RECORD_V30 {
			...
			public ushort wLockDuration;  // Â¼ÏñËø¶¨Ê±³¤£¬µ¥Î»Ğ¡Ê± 0±íÊ¾²»Ëø¶¨£¬0xffff±íÊ¾ÓÀ¾ÃËø¶¨£¬Â¼Ïñ¶ÎµÄÊ±³¤´óÓÚËø¶¨µÄ³ÖĞøÊ±³¤µÄÂ¼Ïñ£¬½«²»»áËø¶¨
			public byte byRecordBackup;  // 0:Â¼Ïñ²»´æµµ 1£ºÂ¼Ïñ´æµµ
			public byte bySVCLevel; //SVC³éÖ¡ÀàĞÍ£º0-²»³é£¬1-³é¶ş·ÖÖ®Ò» 2-³éËÄ·ÖÖ®Èı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_PTZ_PROTOCOL {
			public uint dwType;/*½âÂëÆ÷ÀàĞÍÖµ£¬´Ó1¿ªÊ¼Á¬ĞøµİÔö*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = DESC_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byDescribe;/*½âÂëÆ÷µÄÃèÊö·û£¬ºÍ8000ÖĞµÄÒ»ÖÂ*/
		}
		...
		public struct NET_DVR_PTZCFG {
			...
			public NET_DVR_PTZ_PROTOCOL[] struPtz;/*×î´ó200ÖĞPTZĞ­Òé*/
			public uint dwPtzNum;/*ÓĞĞ§µÄptzĞ­ÒéÊıÄ¿£¬´Ó0¿ªÊ¼(¼´¼ÆËãÊ±¼Ó1)*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		/***************************ÔÆÌ¨ÀàĞÍ(end)******************************/

		//Í¨µÀ½âÂëÆ÷(ÔÆÌ¨)²ÎÊıÅäÖÃ(9000À©Õ¹)
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_DECODERCFG_V30 {
			...
			public ushort wDecoderType;//½âÂëÆ÷ÀàĞÍ, ´Ó0¿ªÊ¼£¬¶ÔÓ¦ptzĞ­ÒéÁĞ±í
		...
		public struct NET_DVR_DECODERCFG {
			...
			public byte byParity; // Ğ£Ñé 0£­ÎŞĞ£Ñé£¬1£­ÆæĞ£Ñé£¬2£­Å¼Ğ£Ñé;
			public byte byFlowcontrol;// 0£­ÎŞ£¬1£­ÈíÁ÷¿Ø,2-Ó²Á÷¿Ø
			public ushort wDecoderType;//½âÂëÆ÷ÀàĞÍ, 0£­YouLi£¬1£­LiLin-1016£¬2£­LiLin-820£¬3£­Pelco-p£¬4£­DM DynaColor£¬5£­HD600£¬6£­JC-4116£¬7£­Pelco-d WX£¬8£­Pelco-d PICO
			public ushort wDecoderAddress;/*½âÂëÆ÷µØÖ·:0 - 255*/
		...
		public struct NET_DVR_SINGLE_RS232 {
			...
			public byte byParity;/* Ğ£Ñé 0£­ÎŞĞ£Ñé£¬1£­ÆæĞ£Ñé£¬2£­Å¼Ğ£Ñé */
			public byte byFlowcontrol;/* 0£­ÎŞ£¬1£­ÈíÁ÷¿Ø,2-Ó²Á÷¿Ø */
			public uint dwWorkMode; /* ¹¤×÷Ä£Ê½£¬0£­232´®¿ÚÓÃÓÚPPP²¦ºÅ£¬1£­232´®¿ÚÓÃÓÚ²ÎÊı¿ØÖÆ£¬2£­Í¸Ã÷Í¨µÀ */
		}
		...
		public struct NET_DVR_RS232CFG {
			...
			public byte byParity;// Ğ£Ñé 0£­ÎŞĞ£Ñé£¬1£­ÆæĞ£Ñé£¬2£­Å¼Ğ£Ñé;
			public byte byFlowcontrol;// 0£­ÎŞ£¬1£­ÈíÁ÷¿Ø,2-Ó²Á÷¿Ø
			public uint dwWorkMode;// ¹¤×÷Ä£Ê½£¬0£­Õ­´ø´«Êä(232´®¿ÚÓÃÓÚPPP²¦ºÅ)£¬1£­¿ØÖÆÌ¨(232´®¿ÚÓÃÓÚ²ÎÊı¿ØÖÆ)£¬2£­Í¸Ã÷Í¨µÀ
		...
		public struct NET_DVR_PRESETCHAN_INFO {
			...
			public uint dwPresetPointNo;        /*µ÷ÓÃÔ¤ÖÃµãÍ¨µÀ¶ÔÓ¦µÄÔ¤ÖÃµãĞòºÅ, 0xfffffff±íÊ¾²»µ÷ÓÃÔ¤ÖÃµã¡£*/
		}

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_CRUISECHAN_INFO {
			public uint dwEnableCruiseChan; /*ÆôÓÃÑ²º½µÄÍ¨µÀ*/
			public uint dwCruiseNo;     /*Ñ²º½Í¨µÀ¶ÔÓ¦µÄÑ²º½±àºÅ, 0xfffffff±íÊ¾ÎŞĞ§*/
		}

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_PTZTRACKCHAN_INFO {
			public uint dwEnablePtzTrackChan;   /*ÆôÓÃÔÆÌ¨¹ì¼£µÄÍ¨µÀ*/
			public uint dwPtzTrackNo;       /*ÔÆÌ¨¹ì¼£Í¨µÀ¶ÔÓ¦µÄ±àºÅ, 0xfffffff±íÊ¾ÎŞĞ§*/
		}

		//±¨¾¯ÊäÈë²ÎÊıÅäÖÃ(256Â·NVRÀ©Õ¹)
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_ALARMINCFG_V40 {
			...
			public byte byChannel;                 // ±¨¾¯ÊäÈë´¥·¢ÖÇÄÜÊ¶±ğÍ¨µÀ
			public byte byRes1;                    //±£Áô			
			public uint dwHandleType;        //Òì³£´¦Àí,Òì³£´¦Àí·½Ê½µÄ"»ò"½á¹û   
											 ...
											 /*0x40: Áª¶¯µç×ÓµØÍ¼(Ä¿Ç°Ö»ÓĞPCNVRÖ§³Ö)*/
											 /*0x200: ×¥Í¼²¢ÉÏ´«FTP*/
			public uint dwMaxRelAlarmOutChanNum; //´¥·¢µÄ±¨¾¯Êä³öÍ¨µÀÊı£¨Ö»¶Á£©×î´óÖ§³ÖÊıÁ¿
			public uint dwRelAlarmOutChanNum; //´¥·¢µÄ±¨¾¯Êä³öÍ¨µÀÊı Êµ¼ÊÖ§³ÖÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ALARMOUT_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwRelAlarmOut; //´¥·¢±¨¾¯Í¨µÀ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
			...
			public uint[] dwRelRecordChan;   /* Êµ¼Ê´¥·¢Â¼ÏñÍ¨µÀ£¬°´Öµ±íÊ¾,²ÉÓÃ½ô´ÕĞÍÅÅÁĞ£¬´ÓÏÂ±ê0 - dwCurRecordChanNum -1ÓĞĞ§£¬Èç¹ûÖĞ¼äÓöµ½0xffffffff,ÔòºóĞøÎŞĞ§*/
			public uint dwMaxEnablePtzCtrlNun; //×î´ó¿ÉÆôÓÃµÄÔÆÌ¨¿ØÖÆ×ÜÊı(Ö»¶Á)
			public uint dwEnablePresetChanNum;  //µ±Ç°ÒÑÆôÓÃÔ¤ÖÃµãµÄÊıÄ¿
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_PRESETCHAN_INFO[] struPresetChanInfo; //ÆôÓÃµÄÔ¤ÖÃµãĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 516, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;                   /*±£Áô*/
			public uint dwEnableCruiseChanNum;  //µ±Ç°ÒÑÆôÓÃÑ²º½µÄÍ¨µÀÊıÄ¿
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_CRUISECHAN_INFO[] struCruiseChanInfo; //ÆôÓÃÑ²º½¹¦ÄÜÍ¨µÀµÄĞÅÏ¢
			public uint dwEnablePtzTrackChanNum;  //µ±Ç°ÒÑÆôÓÃÑ²º½µÄÍ¨µÀÊıÄ¿
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_PTZTRACKCHAN_INFO[] struPtzTrackInfo; //µ÷ÓÃÔÆÌ¨¹ì¼£µÄÍ¨µÀĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 256, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}

		//±¨¾¯ÊäÈë²ÎÊıÅäÖÃ(9000À©Õ¹)
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_ALARMINCFG_V30 {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byPresetNo;/* µ÷ÓÃµÄÔÆÌ¨Ô¤ÖÃµãĞòºÅ,Ò»¸ö±¨¾¯ÊäÈë¿ÉÒÔµ÷ÓÃ¶à¸öÍ¨µÀµÄÔÆÌ¨Ô¤ÖÃµã, 0xff±íÊ¾²»µ÷ÓÃÔ¤ÖÃµã¡£*/
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byPTZTrack;/* µ÷ÓÃµÄÔÆÌ¨µÄ¹ì¼£ĞòºÅ */
		...
		public struct STRUCT_IO_ALARM {
			public uint dwAlarmInputNo;     //·¢Éú±¨¾¯µÄ±¨¾¯ÊäÈëÍ¨µÀºÅ£¬Ò»´ÎÖ»ÓĞÒ»¸ö
			public uint dwTrigerAlarmOutNum;    /*´¥·¢µÄ±¨¾¯Êä³ö¸öÊı£¬ÓÃÓÚºóÃæ¼ÆËã±ä³¤Êı¾İ²¿·ÖÖĞËùÓĞ´¥·¢µÄ±¨¾¯Êä³öÍ¨µÀºÅ£¬ËÄ×Ö½Ú±íÊ¾Ò»¸ö*/
			public uint dwTrigerRecordChanNum;  /*´¥·¢µÄÂ¼ÏñÍ¨µÀ¸öÊı£¬ÓÃÓÚºóÃæ¼ÆËã±ä³¤Êı¾İ²¿·ÖÖĞËùÓĞ´¥·¢µÄÂ¼ÏñÍ¨µÀºÅ£¬ËÄ×Ö½Ú±íÊ¾Ò»¸ö*/
		...
		public struct STRUCT_ALARM_CHANNEL {
			public uint dwAlarmChanNum; /*·¢Éú±¨¾¯Í¨µÀÊı¾İ¸öÊı£¬ÓÃÓÚºóÃæ¼ÆËã±ä³¤Êı¾İ²¿·ÖÖĞËùÓĞ·¢ÉúµÄ±¨¾¯Í¨µÀºÅ£¬ËÄ×Ö½Ú±íÊ¾Ò»¸ö*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 124, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct STRUCT_ALARM_HD {
			public uint dwAlarmHardDiskNum; /*·¢Éú±¨¾¯µÄÓ²ÅÌÊı¾İ³¤¶È£¬ÓÃÓÚºóÃæ¼ÆËã±ä³¤Êı¾İ²¿·ÖÖĞËùÓĞ·¢Éú±¨¾¯µÄÓ²ÅÌºÅ£¬ËÄ½Ú±íÊ¾Ò»¸ö*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 124, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_ALRAM_FIXED_HEADER {
			public uint dwAlarmType;              /*0-ĞÅºÅÁ¿±¨¾¯,1-Ó²ÅÌÂú,2-ĞÅºÅ¶ªÊ§£¬3£­ÒÆ¶¯Õì²â£¬4£­Ó²ÅÌÎ´¸ñÊ½»¯,5-Ğ´Ó²ÅÌ³ö´í,6-ÕÚµ²±¨¾¯£¬7-ÖÆÊ½²»Æ¥Åä, 8-·Ç·¨·ÃÎÊ£¬9-ÊÓÆµĞÅºÅÒì³££¬10-Â¼ÏñÒì³££¬11-ÖÇÄÜ³¡¾°±ä»¯£¬12-ÕóÁĞÒì³££¬13-Ç°¶Ë/Â¼Ïñ·Ö±æÂÊ²»Æ¥Åä*/
		...
		public struct NET_DVR_ALARMINFO_V40 {
			...
			public IntPtr pAlarmData;   //±¨¾¯¿É±ä²¿·ÖÄÚÈİ
		}
		...
		public struct NET_DVR_ANALOG_ALARMINCFG {
			...
			public ushort wAlarmInUpper; //Ä£ÄâÊäÈëµçÑ¹ÉÏÏŞ£¬Êµ¼ÊÖµ³Ë10£¬·¶Î§0~360
			public ushort wAlarmInLower; //Ä£ÄâÊäÈëµçÑ¹ÏÂÏŞ£¬Êµ¼ÊÖµ³Ë10£¬·¶Î§0~360 
			public NET_DVR_HANDLEEXCEPTION_V30 struAlarmHandleType; /* ´¦Àí·½Ê½ */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_SCHEDTIME[] struAlarmTime;//²¼·ÀÊ±¼ä
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_ALARMINFO_V30 {
			public uint dwAlarmType;/*0-ĞÅºÅÁ¿±¨¾¯,1-Ó²ÅÌÂú,2-ĞÅºÅ¶ªÊ§,3£­ÒÆ¶¯Õì²â,4£­Ó²ÅÌÎ´¸ñÊ½»¯,5-¶ÁĞ´Ó²ÅÌ³ö´í,6-ÕÚµ²±¨¾¯,7-ÖÆÊ½²»Æ¥Åä, 8-·Ç·¨·ÃÎÊ, 0xa-GPS¶¨Î»ĞÅÏ¢(³µÔØ¶¨ÖÆ)*/
		...
		//ipc½ÓÈëÉè±¸ĞÅÏ¢À©Õ¹£¬Ö§³ÖipÉè±¸µÄÓòÃûÌí¼Ó
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		public struct NET_DVR_IPCHANINFO {
			...
			public byte byTransProtocol;//´«ÊäĞ­ÒéÀàĞÍ0-TCP/auto(¾ßÌåÓĞÉè±¸¾ö¶¨)£¬1-UDP 2-¶à²¥ 3-½öTCP 4-auto
		...
		public struct NET_DVR_IPPARACFG {
			...
			public byte[] byAnalogChanEnable; /* Ä£ÄâÍ¨µÀÊÇ·ñÆôÓÃ£¬´ÓµÍµ½¸ß±íÊ¾1-32Í¨µÀ£¬0±íÊ¾ÎŞĞ§ 1ÓĞĞ§ */
		...
		public struct NET_DVR_STREAM_MEDIA_SERVER_CFG {
			public byte byValid;/*ÊÇ·ñÆôÓÃÁ÷Ã½Ìå·şÎñÆ÷È¡Á÷,0±íÊ¾ÎŞĞ§£¬·Ç0±íÊ¾ÓĞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public NET_DVR_IPADDR struDevIP;
			public ushort wDevPort;/*Á÷Ã½Ìå·şÎñÆ÷¶Ë¿Ú*/
		...
		public struct NET_DVR_STREAM_MODE {
			public byte byGetStreamType;/*È¡Á÷·½Ê½£º0- Ö±½Ó´ÓÉè±¸È¡Á÷£»1- ´ÓÁ÷Ã½ÌåÈ¡Á÷£»2- Í¨¹ıIPServer»ñµÃIPµØÖ·ºóÈ¡Á÷£»
                                          * 3- Í¨¹ıIPServerÕÒµ½Éè±¸£¬ÔÙÍ¨¹ıÁ÷Ã½ÌåÈ¡Éè±¸µÄÁ÷£» 4- Í¨¹ıÁ÷Ã½ÌåÓÉURLÈ¥È¡Á÷£»
                                          * 5- Í¨¹ıhiDDNSÓòÃûÁ¬½ÓÉè±¸È»ºó´ÓÉè±¸È¡Á÷ */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		...
		public struct NET_DVR_IPPARACFG_V40 {
			...
			public byte[] byRes2; /* Ä£ÄâÍ¨µÀÊÇ·ñÆôÓÃ£¬´ÓµÍµ½¸ß±íÊ¾1-32Í¨µÀ£¬0±íÊ¾ÎŞĞ§ 1ÓĞĞ§ */
		}

		//ÎªCVRÀ©Õ¹µÄ±¨¾¯ÀàĞÍ
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_ALARMINFO_DEV {
			public uint dwAlarmType;  //0-±àÂëÆ÷(Í¨µÀ)ĞÅºÅÁ¿±¨¾¯£»1-Ë½ÓĞ¾í¶şËğ»µ£»2- NVR·şÎñÍË³ö£»
									  //3-±àÂëÆ÷×´Ì¬Òì³££»4-ÏµÍ³Ê±ÖÓÒì³££»5-Â¼Ïñ¾íÊ£ÓàÈİÁ¿¹ıµÍ£»
									  //6-±àÂëÆ÷(Í¨µÀ)ÒÆ¶¯Õì²â±¨¾¯£»7-±àÂëÆ÷(Í¨µÀ)ÕÚµ²±¨¾¯¡£
			public NET_DVR_TIME struTime;     //±¨¾¯Ê±¼ä
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;    //±£Áô
			public uint dwNumber;     //ÊıÄ¿
			public IntPtr pNO;  //dwNumber¸öWORD; Ã¿¸öWORD±íÊ¾Ò»¸öÍ¨µÀºÅ£¬»òÕß´ÅÅÌºÅ, ÎŞĞ§Ê±Îª0
		}
		...
		public struct NET_DVR_IPALARMINCFG_V40 {
			public uint dwSize;  //½á¹¹Ìå³¤¶È
			public uint dwCurIPAlarmInNum;  //µ±Ç°±¨¾¯ÊäÈë¿ÚÊı
		...
		public enum HD_STAT {
			...
			HD_RIADVD_EXPAND = 7,    /* ĞéÄâ´ÅÅÌ¿ÉÀ©Èİ */
			HD_STAT_REPARING = 10,   /* Ó²ÅÌÕıÔÚĞŞ¸´(9000 2.0) */
			HD_STAT_FORMATING = 11,   /* Ó²ÅÌÕıÔÚ¸ñÊ½»¯(9000 2.0) */
		}
		...
		public struct NET_DVR_SINGLE_HD {
			...
			public uint dwCapacity;/*Ó²ÅÌÈİÁ¿(²»¿ÉÉèÖÃ)*/
			...
			public uint dwPictureCapacity; //Ó²ÅÌÍ¼Æ¬ÈİÁ¿(²»¿ÉÉèÖÃ)£¬µ¥Î»:MB
		...
		public struct NET_DVR_SINGLE_HDGROUP_V40 {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwRelRecordChan;  //´¥·¢µÄÂ¼ÏñÍ¨µÀ£¬°´Öµ±íÊ¾£¬Óöµ½0xffffffffÊ±ºóĞøÊÓÎªÎŞĞ§    
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;                /* ±£Áô */
		}
		...
		public struct NET_DVR_HDGROUP_CFG_V40 {
			public uint dwSize;                //½á¹¹Ìå´óĞ¡
			public uint dwMaxHDGroupNum;          //Éè±¸Ö§³ÖµÄ×î´óÅÌ×éÊı-Ö»¶Á
			public uint dwCurHDGroupNum;       /*µ±Ç°ÅäÖÃµÄÅÌ×éÊı*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_HD_GROUP, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_SINGLE_HDGROUP_V40[] struHDGroupAttr; //Ó²ÅÌÏà¹Ø²Ù×÷¶¼ĞèÒªÖØÆô²ÅÄÜÉúĞ§£»
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes; //±£Áô
		}
		...
		public struct NET_DVR_HDGROUP_CFG {
			public uint dwSize;
			public uint dwHDGroupCount;/*ÅÌ×é×ÜÊı(²»¿ÉÉèÖÃ)*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_HD_GROUP, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_SINGLE_HDGROUP[] struHDGroupAttr;//Ó²ÅÌÏà¹Ø²Ù×÷¶¼ĞèÒªÖØÆô²ÅÄÜÉúĞ§
		}
		...
		public struct NET_DVR_ALARMOUTCFG_V30 {
			...
			public uint dwAlarmOutDelay;/* Êä³ö±£³ÖÊ±¼ä(-1ÎªÎŞÏŞ£¬ÊÖ¶¯¹Ø±Õ) */
		...
		public struct NET_DVR_PREVIEWCFG_V30 {
			...
			public ushort wSwitchTime;//ÇĞ»»Ê±¼ä,0-²»ÇĞ»»,1-5s,2-10s,3-20s,4-30s,5-60s,6-120s,7-300s
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_PREVIEW_MODE * MAX_WINDOW_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] bySwitchSeq;//ÇĞ»»Ë³Ğò,Èç¹ûlSwitchSeq[i]Îª 0xff±íÊ¾²»ÓÃ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_MATRIXPARA_V30 {
			...
			public ushort[] wOrder;/* Ô¤ÀÀË³Ğò, 0xff±íÊ¾ÏàÓ¦µÄ´°¿Ú²»Ô¤ÀÀ */
			public ushort wSwitchTime;// Ô¤ÀÀÇĞ»»Ê±¼ä 
		...
		public struct NET_DVR_VIDEOOUT {
			...
			public NET_DVR_VGAPARA[] struVGAPara;   /* VGA²ÎÊı */
			public NET_DVR_MATRIXPARA struMatrixPara;/* MATRIX²ÎÊı */
		}
		...
		public struct NET_DVR_USER_INFO_V40 {
			...
			public byte[] byLocalRight; /* ±¾µØÈ¨ÏŞ */
										/*Êı×é0: ±¾µØ¿ØÖÆÔÆÌ¨*/
										/*Êı×é1: ±¾µØÊÖ¶¯Â¼Ïó*/
										/*Êı×é2: ±¾µØ»Ø·Å*/
										/*Êı×é3: ±¾µØÉèÖÃ²ÎÊı*/
										...
										/*Êı×é9: ±¾µØ¹Ø»ú/ÖØÆô */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_RIGHT, ArraySubType = UnmanagedType.I1)]
			public byte[] byRemoteRight;/* Ô¶³ÌÈ¨ÏŞ */
										/*Êı×é0: Ô¶³Ì¿ØÖÆÔÆÌ¨*/
										/*Êı×é1: Ô¶³ÌÊÖ¶¯Â¼Ïó*/
										/*Êı×é2: Ô¶³Ì»Ø·Å */
										/*Êı×é3: Ô¶³ÌÉèÖÃ²ÎÊı*/
										...
										/*Êı×é13: Ô¶³Ì¹Ø»ú/ÖØÆô */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwNetPreviewRight;            /* Ô¶³Ì¿ÉÒÔÔ¤ÀÀµÄÍ¨µÀ£¬´ÓÇ°ÍùºóË³ĞòÅÅÁĞ£¬Óöµ½0xffffffffºóĞø¾ùÎªÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwLocalRecordRight;           /* ±¾µØ¿ÉÒÔÂ¼ÏñµÄÍ¨µÀ£¬´ÓÇ°ÍùºóË³ĞòÅÅÁĞ£¬Óöµ½0xffffffffºóĞø¾ùÎªÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwNetRecordRight;         /* Ô¶³Ì¿ÉÒÔÂ¼ÏñµÄÍ¨µÀ£¬´ÓÇ°ÍùºóË³ĞòÅÅÁĞ£¬Óöµ½0xffffffffºóĞø¾ùÎªÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwLocalPlaybackRight;         /* ±¾µØ¿ÉÒÔ»Ø·ÅµÄÍ¨µÀ£¬´ÓÇ°ÍùºóË³ĞòÅÅÁĞ£¬Óöµ½0xffffffffºóĞø¾ùÎªÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwNetPlaybackRight;           /* Ô¶³Ì¿ÉÒÔ»Ø·ÅµÄÍ¨µÀ£¬´ÓÇ°ÍùºóË³ĞòÅÅÁĞ£¬Óöµ½0xffffffffºóĞø¾ùÎªÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwLocalPTZRight;              /* ±¾µØ¿ÉÒÔPTZµÄÍ¨µÀ£¬´ÓÇ°ÍùºóË³ĞòÅÅÁĞ£¬Óöµ½0xffffffffºóĞø¾ùÎªÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwNetPTZRight;                /* Ô¶³Ì¿ÉÒÔPTZµÄÍ¨µÀ£¬´ÓÇ°ÍùºóË³ĞòÅÅÁĞ£¬Óöµ½0xffffffffºóĞø¾ùÎªÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwLocalBackupRight;           /* ±¾µØ±¸·İÈ¨ÏŞÍ¨µÀ£¬´ÓÇ°ÍùºóË³ĞòÅÅÁĞ£¬Óöµ½0xffffffffºóĞø¾ùÎªÎŞĞ§*/
			public NET_DVR_IPADDR struUserIP;               /* ÓÃ»§IPµØÖ·(Îª0Ê±±íÊ¾ÔÊĞíÈÎºÎµØÖ·) */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MACADDR_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byMACAddr;    /* ÎïÀíµØÖ· */
			public byte byPriority;             /* ÓÅÏÈ¼¶£¬0xff-ÎŞ£¬0--µÍ£¬1--ÖĞ£¬2--¸ß */
												...
												ÖĞ¡­¡­°üÀ¨±¾µØºÍÔ¶³Ì¿ØÖÆÔÆÌ¨,±¾µØºÍÔ¶³ÌÊÖ¶¯Â¼Ïñ,±¾µØºÍÔ¶³Ì»Ø·Å,ÓïÒô¶Ô½²ºÍÔ¶³ÌÔ¤ÀÀ¡¢±¾µØ±¸·İ,±¾µØ/Ô¶³Ì¹Ø»ú/ÖØÆô
												¸ß¡­¡­¹ÜÀíÔ± */
			public byte byAlarmOnRight;         // ±¨¾¯ÊäÈë¿Ú²¼·ÀÈ¨ÏŞ 1-ÓĞÈ¨ÏŞ£¬0-ÎŞÈ¨ÏŞ
			public byte byAlarmOffRight;         // ±¨¾¯ÊäÈë¿Ú³··ÀÈ¨ÏŞ 1-ÓĞÈ¨ÏŞ£¬0-ÎŞÈ¨ÏŞ
			public byte byBypassRight;           // ±¨¾¯ÊäÈë¿ÚÅÔÂ·È¨ÏŞ 1-ÓĞÈ¨ÏŞ£¬0-ÎŞÈ¨ÏŞ 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 118, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}

		//µ¥ÓÃ»§²ÎÊı(×Ó½á¹¹)(9000À©Õ¹)
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_USER_INFO_V30 {
			...
			public byte[] byRemoteRight;/* Ô¶³ÌÈ¨ÏŞ */
										...
										/*Êı×é13: Ô¶³Ì¹Ø»ú/ÖØÆô */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byNetPreviewRight;/* Ô¶³Ì¿ÉÒÔÔ¤ÀÀµÄÍ¨µÀ 0-ÓĞÈ¨ÏŞ£¬1-ÎŞÈ¨ÏŞ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byLocalPlaybackRight;/* ±¾µØ¿ÉÒÔ»Ø·ÅµÄÍ¨µÀ 0-ÓĞÈ¨ÏŞ£¬1-ÎŞÈ¨ÏŞ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byNetPlaybackRight;/* Ô¶³Ì¿ÉÒÔ»Ø·ÅµÄÍ¨µÀ 0-ÓĞÈ¨ÏŞ£¬1-ÎŞÈ¨ÏŞ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byLocalRecordRight;/* ±¾µØ¿ÉÒÔÂ¼ÏñµÄÍ¨µÀ 0-ÓĞÈ¨ÏŞ£¬1-ÎŞÈ¨ÏŞ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byNetRecordRight;/* Ô¶³Ì¿ÉÒÔÂ¼ÏñµÄÍ¨µÀ 0-ÓĞÈ¨ÏŞ£¬1-ÎŞÈ¨ÏŞ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byLocalPTZRight;/* ±¾µØ¿ÉÒÔPTZµÄÍ¨µÀ 0-ÓĞÈ¨ÏŞ£¬1-ÎŞÈ¨ÏŞ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byNetPTZRight;/* Ô¶³Ì¿ÉÒÔPTZµÄÍ¨µÀ 0-ÓĞÈ¨ÏŞ£¬1-ÎŞÈ¨ÏŞ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byLocalBackupRight;/* ±¾µØ±¸·İÈ¨ÏŞÍ¨µÀ 0-ÓĞÈ¨ÏŞ£¬1-ÎŞÈ¨ÏŞ*/
			public NET_DVR_IPADDR struUserIP;/* ÓÃ»§IPµØÖ·(Îª0Ê±±íÊ¾ÔÊĞíÈÎºÎµØÖ·) */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MACADDR_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byMACAddr;/* ÎïÀíµØÖ· */
			public byte byPriority;/* ÓÅÏÈ¼¶£¬0xff-ÎŞ£¬0--µÍ£¬1--ÖĞ£¬2--¸ß */
								   ...
								   ¸ß¡­¡­¹ÜÀíÔ±
								   */
			public byte byAlarmOnRight;         // ±¨¾¯ÊäÈë¿Ú²¼·ÀÈ¨ÏŞ
			public byte byAlarmOffRight;        // ±¨¾¯ÊäÈë¿Ú³··ÀÈ¨ÏŞ
			public byte byBypassRight;          // ±¨¾¯ÊäÈë¿ÚÅÔÂ·È¨ÏŞ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 14, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}

		//µ¥ÓÃ»§²ÎÊı(SDK_V15À©Õ¹)(×Ó½á¹¹)
		[StructLayoutAttribute(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
		public struct NET_DVR_USER_INFO_EX {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_RIGHT, ArraySubType = UnmanagedType.U4)]
			public uint[] dwRemoteRight;/* È¨ÏŞ */
										/*Êı×é0: Ô¶³Ì¿ØÖÆÔÆÌ¨*/
										/*Êı×é1: Ô¶³ÌÊÖ¶¯Â¼Ïó*/
										/*Êı×é2: Ô¶³Ì»Ø·Å */
										/*Êı×é3: Ô¶³ÌÉèÖÃ²ÎÊı*/
			...
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]
			public string sUserIP;/* ÓÃ»§IPµØÖ·(Îª0Ê±±íÊ¾ÔÊĞíÈÎºÎµØÖ·) */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MACADDR_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byMACAddr;/* ÎïÀíµØÖ· */
		}
		...
		public struct NET_DVR_EXCEPTION_V40 {
			public uint dwSize;             //½á¹¹Ìå´óĞ¡
			public uint dwMaxGroupNum;    //Éè±¸Ö§³ÖµÄ×î´ó×éÊı
		...
		public struct NET_DVR_EXCEPTION_V30 {
			...
			/*Êı×é0-ÅÌÂú,1- Ó²ÅÌ³ö´í,2-ÍøÏß¶Ï,3-¾ÖÓòÍøÄÚIP µØÖ·³åÍ», 4-·Ç·¨·ÃÎÊ, 5-ÊäÈë/Êä³öÊÓÆµÖÆÊ½²»Æ¥Åä, 6-ÊÓÆµĞÅºÅÒì³£, 7-Â¼ÏñÒì³£*/
		}
		...
		public struct NET_DVR_EXCEPTION {
			...
			/*Êı×é0-ÅÌÂú,1- Ó²ÅÌ³ö´í,2-ÍøÏß¶Ï,3-¾ÖÓòÍøÄÚIP µØÖ·³åÍ»,4-·Ç·¨·ÃÎÊ, 5-ÊäÈë/Êä³öÊÓÆµÖÆÊ½²»Æ¥Åä, 6-ÊÓÆµĞÅºÅÒì³£*/
		}
		...
		public struct NET_DVR_CHANNELSTATE_V30 {
			...
			public uint dwLinkNum;//¿Í»§¶ËÁ¬½ÓµÄ¸öÊı
			...
			public uint dwIPLinkNum;//Èç¹û¸ÃÍ¨µÀÎªIP½ÓÈë£¬ÄÇÃ´±íÊ¾IP½ÓÈëµ±Ç°µÄÁ¬½ÓÊı
			public byte byExceedMaxLink;        // ÊÇ·ñ³¬³öÁËµ¥Â·6Â·Á¬½ÓÊı 0 - Î´³¬³ö, 1-³¬³ö
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 7, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			public uint dwChannelNo;    //µ±Ç°µÄÍ¨µÀºÅ£¬0xffffffff±íÊ¾ÎŞĞ§
		...
		public struct NET_DVR_DISKSTATE {
			public uint dwVolume;//Ó²ÅÌµÄÈİÁ¿
			public uint dwFreeSpace;//Ó²ÅÌµÄÊ£Óà¿Õ¼ä
			public uint dwHardDiskStatic;//Ó²ÅÌµÄ×´Ì¬,0-»î¶¯,1-ĞİÃß,2-²»Õı³£
		}
		...
		public struct NET_DVR_WORKSTATE_V40 {
			public uint dwSize;            //½á¹¹Ìå´óĞ¡
			public uint dwDeviceStatic;      //Éè±¸µÄ×´Ì¬,0-Õı³£,1-CPUÕ¼ÓÃÂÊÌ«¸ß,³¬¹ı85%,2-Ó²¼ş´íÎó,ÀıÈç´®¿ÚËÀµô
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DISKNUM_V30, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_DISKSTATE[] struHardDiskStatic;   //Ó²ÅÌ×´Ì¬,Ò»´Î×î¶àÖ»ÄÜ»ñÈ¡33¸öÓ²ÅÌĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_CHANNELSTATE_V30[] struChanStatic;//Í¨µÀµÄ×´Ì¬£¬´ÓÇ°ÍùºóË³ĞòÅÅÁĞ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ALARMIN_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwHasAlarmInStatic; //ÓĞ±¨¾¯µÄ±¨¾¯ÊäÈë¿Ú£¬°´Öµ±íÊ¾£¬°´ÏÂ±êÖµË³ĞòÅÅÁĞ£¬ÖµÎª0xffffffffÊ±µ±Ç°¼°ºóĞøÖµÎŞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ALARMOUT_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwHasAlarmOutStatic; //ÓĞ±¨¾¯Êä³öµÄ±¨¾¯Êä³ö¿Ú£¬°´Öµ±íÊ¾£¬°´ÏÂ±êÖµË³ĞòÅÅÁĞ£¬ÖµÎª0xffffffffÊ±µ±Ç°¼°ºóĞøÖµÎŞĞ§
			public uint dwLocalDisplay;         //±¾µØÏÔÊ¾×´Ì¬,0-Õı³£,1-²»Õı³£
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_AUDIO_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byAudioInChanStatus;      //°´Î»±íÊ¾ÓïÒôÍ¨µÀµÄ×´Ì¬ 0-Î´Ê¹ÓÃ£¬1-Ê¹ÓÃÖĞ£¬µÚ0Î»±íÊ¾µÚ1¸öÓïÒôÍ¨µÀ
		...
		public struct NET_DVR_GETWORKSTATE_COND {
			public uint dwSize;  //½á¹¹Ìå³¤¶È
			public byte byFindHardByCond; /*0-²éÕÒÈ«²¿´ÅÅÌ(µ«Ò»´Î×î¶àÖ»ÄÜ²éÕÒ33¸ö)£¬´ËÊ±dwFindHardStatusNumÎŞĞ§*/
			public byte byFindChanByCond;  /*0-²éÕÒÈ«²¿Í¨µÀ£¬´ËÊ±dwFindChanNumÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;//±£Áô	
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DISKNUM_V30, ArraySubType = UnmanagedType.U4)]
			public uint[] dwFindHardStatus; /*Òª²éÕÒµÄÓ²ÅÌºÅ£¬°´Öµ±íÊ¾£¬¸ÃÖµ²ÉÓÃË³ĞòÅÅÁĞ£¬ Óöµ½0xffffffffÔòÈÏÎªºóĞøÎŞĞ§ */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwFindChanNo; /*Òª²éÕÒµÄÍ¨µÀºÅ£¬°´Öµ±íÊ¾£¬¸ÃÖµ²ÉÓÃË³ĞòÅÅÁĞ£¬ Óöµ½0xffffffffÔòÈÏÎªºóĞøÎŞĞ§ */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes; //±£Áô
		}
		...
		public struct NET_DVR_WORKSTATE_V30 {
			...
			public byte[] byAlarmInStatic;//±¨¾¯¶Ë¿ÚµÄ×´Ì¬,0-Ã»ÓĞ±¨¾¯,1-ÓĞ±¨¾¯
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ALARMOUT_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byAlarmOutStatic;//±¨¾¯Êä³ö¶Ë¿ÚµÄ×´Ì¬,0-Ã»ÓĞÊä³ö,1-ÓĞ±¨¾¯Êä³ö
			public uint dwLocalDisplay;//±¾µØÏÔÊ¾×´Ì¬,0-Õı³£,1-²»Õı³£
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_AUDIO_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byAudioChanStatus;//±íÊ¾ÓïÒôÍ¨µÀµÄ×´Ì¬ 0-Î´Ê¹ÓÃ£¬1-Ê¹ÓÃÖĞ, 0xffÎŞĞ§
		...
		public struct NET_DVR_LOG_V30 {
			...
			public uint dwMajorType;//Ö÷ÀàĞÍ 1-±¨¾¯; 2-Òì³£; 3-²Ù×÷; 0xff-È«²¿
			public uint dwMinorType;//´ÎÀàĞÍ 0-È«²¿;
			...
			public uint dwParaType;//²ÎÊıÀàĞÍ
			public uint dwChannel;//Í¨µÀºÅ
		...
		public struct NET_DVR_ALARMHOST_SEARCH_LOG_PARAM {
			public ushort wMajorType;       // Ö÷ÀàĞÍ
			public ushort wMinorType;       // ´ÎÀàĞÍ 
		...
		public struct NET_DVR_ALARMHOST_LOG_RET {
			...
			public ushort wMajorType;                 // Ö÷ÀàĞÍ 
			public ushort wMinorType;                 // ´ÎÀàĞÍ
			public ushort wParam;                       // ²Ù×÷²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 10, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			public uint dwInfoLen;                  // ÃèÊöĞÅÏ¢³¤¶È
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = LOG_INFO_LEN)]
			public string sInfo;       // ÃèÊöĞÅÏ¢
		}
		/*************************¶¯»·±¨¾¯¹ÜÀíÖ÷»úÈÕÖ¾²éÕÒ end***********************************************/
		...
		public struct NET_DVR_TRADEINFO {
			...
			public string cTradeType;//½»Ò×ÀàĞÍ
			public uint dwCash;//½»Ò×½ğ¶î
		}
		...
		public struct NET_DVR_FRAMEFORMAT {
			...
			public uint dwATMType;/* ATMÀàĞÍ */
			public uint dwInputMode;/* ÊäÈë·½Ê½	0-ÍøÂçÕìÌı 1-ÍøÂç½ÓÊÕ 2-´®¿ÚÖ±½ÓÊäÈë 3-´®¿ÚATMÃüÁîÊäÈë*/
			public uint dwFrameSignBeginPos;/* ±¨ÎÄ±êÖ¾Î»µÄÆğÊ¼Î»ÖÃ*/
			public uint dwFrameSignLength;/* ±¨ÎÄ±êÖ¾Î»µÄ³¤¶È */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byFrameSignContent;/* ±¨ÎÄ±êÖ¾Î»µÄÄÚÈİ */
			public uint dwCardLengthInfoBeginPos;/* ¿¨ºÅ³¤¶ÈĞÅÏ¢µÄÆğÊ¼Î»ÖÃ */
			public uint dwCardLengthInfoLength;/* ¿¨ºÅ³¤¶ÈĞÅÏ¢µÄ³¤¶È */
			public uint dwCardNumberInfoBeginPos;/* ¿¨ºÅĞÅÏ¢µÄÆğÊ¼Î»ÖÃ */
			public uint dwCardNumberInfoLength;/* ¿¨ºÅĞÅÏ¢µÄ³¤¶È */
			public uint dwBusinessTypeBeginPos;/* ½»Ò×ÀàĞÍµÄÆğÊ¼Î»ÖÃ */
			public uint dwBusinessTypeLength;/* ½»Ò×ÀàĞÍµÄ³¤¶È */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 10, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_FRAMETYPECODE[] frameTypeCode;/* ÀàĞÍ */
		}
		...
		public struct NET_DVR_IDENTIFICAT {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			public NET_DVR_FRAMETYPECODE struStartCode;/*ÆğÊ¼×Ö·û*/
		...
		public struct NET_DVR_PACKAGE_LENGTH {
			public byte byLengthMode;/*³¤¶ÈÀàĞÍ£¬0,variable;1,fix;2,get from package(ÉèÖÃ¿¨ºÅ³¤¶ÈÊ¹ÓÃ)*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			...
			public uint dwLengthPos;/*lengthModeÎª2µÄÊ±ºòÊ¹ÓÃ£¬¿¨ºÅ³¤¶ÈÔÚ±¨ÎÄÖĞµÄÎ»ÖÃ*/
		...
		public struct NET_DVR_OSD_POSITION {
			public byte byPositionMode;/*µş¼Ó·ç¸ñ£¬¹²2ÖÖ£»0£¬²»ÏÔÊ¾£»1£¬Custom*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
		...
		public struct NET_DVR_DATE_FORMAT {
			...
			public byte byDateForm;/*0~5£¬3¸öitemµÄÅÅÁĞ×éºÏ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			...
			public byte byDisplayForm;/*0~5£¬3¸öitemµÄÅÅÁĞ×éºÏ*///lili mode by lili
		...
		public struct NET_DVRT_TIME_FORMAT {
			...
			public byte[] byRes2;
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 4)]
			public string chSeprator;/*±¨ÎÄ·Ö¸ô·û£¬ÔİÊ±Ã»ÓÃ*/
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 4)]
			public string chDisplaySeprator;/*ÏÔÊ¾·Ö¸ô·û*/
			public byte byDisplayForm;/*0~5£¬3¸öitemµÄÅÅÁĞ×éºÏ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes3;
		...
		public struct NET_DVR_OVERLAY_CHANNEL {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byChannel;/*µş¼ÓµÄÍ¨µÀ*/
			public uint dwDelayTime;/*µş¼ÓÑÓÊ±Ê±¼ä*/
			public byte byEnableDelayTime;/*ÊÇ·ñÆôÓÃµş¼ÓÑÓÊ±£¬ÔÚÎŞÍË¿¨ÃüÁîÊ±ÆôÓÃ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 11, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_ATM_PACKAGE_ACTION {
			...
			public NET_DVR_FRAMETYPECODE struActionCode;/*½»Ò×ÀàĞÍµÈ¶ÔÓ¦µÄÂë*/
			public NET_DVR_FRAMETYPECODE struPreCode;/*µş¼Ó×Ö·ûÇ°µÄ×Ö·û*/
			public byte byActionCodeMode;/*½»Ò×ÀàĞÍµÈ¶ÔÓ¦µÄÂë0,ASCII;1,HEX*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 7, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_ATM_USER_DEFINE_PROTOCOL {
			...
			public NET_DVR_FILTER struFilter; //Êı¾İ°ü¹ıÂËÉèÖÃ
			public NET_DVR_ATM_PACKAGE_OTHERS struCardNoPara; //µş¼Ó¿¨ºÅÉèÖÃ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ACTION_TYPE, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_ATM_PACKAGE_ACTION[] struTradeActionPara; //µş¼Ó½»Ò×ĞĞÎªÉèÖÃ 0-9 ÒÀ´Î¶ÔÓ¦InCard OutCard OverLay SetTime GetStatus Query WithDraw Deposit ChanPass Transfer
			public NET_DVR_ATM_PACKAGE_OTHERS struAmountPara; //µş¼Ó½»Ò×½ğ¶îÉèÖÃ
			public NET_DVR_ATM_PACKAGE_OTHERS struSerialNoPara; //µş¼Ó½»Ò×ĞòºÅÉèÖÃ
			public NET_DVR_OVERLAY_CHANNEL struOverlayChan; //µş¼ÓÍ¨µÀÉèÖÃ
			public NET_DVR_ATM_PACKAGE_DATE struRes1; //µş¼ÓÈÕÆÚ£¬±£Áô
			public NET_DVR_ATM_PACKAGE_TIME struRes2; //µş¼ÓÊ±¼ä£¬±£Áô
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 124, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_ATM_FRAMEFORMAT_V30 {
			...
			public byte byInputMode;            /**ÊäÈë·½Ê½:0-ÍøÂç¼àÌı¡¢1ÍøÂçĞ­Òé¡¢2-´®¿Ú¼àÌı¡¢3-´®¿ÚĞ­Òé*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 34, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;              //±£Áô×Ö½Ú 
			public NET_DVR_IPADDR struAtmIp;                /*ATM »úIP ÍøÂç¼àÌıÊ±Ê¹ÓÃ */
			public ushort wAtmPort;             /* ÍøÂçĞ­Òé·½Ê½Ê±ÊÇÊ¹ÓÃ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;              // ±£Áô×Ö½Ú
			public uint dwAtmType;              /*ATMĞ­ÒéÀàĞÍ£¬´ÓNET_DVR_ATM_PROTOCOL½á¹¹ÖĞ»ñÈ¡£¬Èç¹ûÀàĞÍÎª×Ô¶¨ÒåÊ±Ê¹ÓÃÓÃ»§×Ô¶¨ÒåĞ­Òé*/
			public NET_DVR_ATM_USER_DEFINE_PROTOCOL struAtmUserDefineProtocol; //ÓÃ»§×Ô¶¨ÒåĞ­Òé£¬µ±ATMÀàĞÍÎª×Ô¶¨Ê±ĞèÒªÊ¹ÓÃ¸Ã¶¨Òå
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes3;
		}
		...
		public struct NET_DVR_ATM_PROTO_TYPE {
			public uint dwAtmType; //ATMĞ­ÒéÀàĞÍ£¬Í¬Ê±×÷ÎªË÷ÒıĞòºÅ ATM ÅäÖÃÖĞµÄdwAtmType ×Ô¶¨ÒåÊ±Îª1025
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = ATM_DESC_LEN)]
			public string chDesc; //ATMĞ­Òé¼òµ¥ÃèÊö
		}

		[StructLayoutAttribute(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
		public struct NET_DVR_ATM_PROTO_LIST {
			public uint dwAtmProtoNum;/*Ğ­ÒéÁĞ±íµÄ¸öÊı*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ATM_PROTOCOL_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_ATM_PROTO_TYPE[] struAtmProtoType;/*Ğ­ÒéÁĞ±íĞÅÏ¢*/
		}

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_ATM_PROTOCOL {
			public uint dwSize;
			public NET_DVR_ATM_PROTO_LIST struNetListenList;     // ÍøÂç¼àÌıĞ­ÒéÃèÊö
			public NET_DVR_ATM_PROTO_LIST struSerialListenList; //´®¿Ú¼àÌıĞ­ÒéÃèÊö
			public NET_DVR_ATM_PROTO_LIST struNetProtoList;     //ÍøÂçĞ­ÒéÃèÊö
			public NET_DVR_ATM_PROTO_LIST struSerialProtoList;   //´®¿ÚĞ­ÒéÃèÊö
			public NET_DVR_ATM_PROTO_TYPE struCustomProto;      //×Ô¶¨ÒåĞ­Òé            
		}
		...
		public struct NET_DVR_DECODERINFO {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byEncoderIP;//½âÂëÉè±¸Á¬½ÓµÄ·şÎñÆ÷IP
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byEncoderUser;//½âÂëÉè±¸Á¬½ÓµÄ·şÎñÆ÷µÄÓÃ»§Ãû
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byEncoderPasswd;//½âÂëÉè±¸Á¬½ÓµÄ·şÎñÆ÷µÄÃÜÂë
			public byte bySendMode;//½âÂëÉè±¸Á¬½Ó·şÎñÆ÷µÄÁ¬½ÓÄ£Ê½
			public byte byEncoderChannel;//½âÂëÉè±¸Á¬½ÓµÄ·şÎñÆ÷µÄÍ¨µÀºÅ
			public ushort wEncoderPort;//½âÂëÉè±¸Á¬½ÓµÄ·şÎñÆ÷µÄ¶Ë¿ÚºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] reservedData;//±£Áô
		}
		...
		public struct NET_DVR_DECODERSTATE {
			...
			public ushort wEncoderPort;//½âÂëÉè±¸Á¬½ÓµÄ·şÎñÆ÷µÄ¶Ë¿ÚºÅ
			public uint dwConnectState;//½âÂëÉè±¸Á¬½Ó·şÎñÆ÷µÄ×´Ì¬
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] reservedData;//±£Áô
		}
		...
		public struct NET_DVR_DECCFG {
			public uint dwSize;
			public uint dwDecChanNum;/*½âÂëÍ¨µÀµÄÊıÁ¿*/
		...
		public struct NET_DVR_PORTCFG {
			...
			public NET_DVR_PORTINFO[] struTransPortInfo;/* Êı×é0±íÊ¾232 Êı×é1±íÊ¾485 */
		}
		...
		public struct NET_DVR_PLAYREMOTEFILE {
			...
			public struct mode_size {
				...
				/*[FieldOffsetAttribute(0)]
                [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 100, ArraySubType = UnmanagedType.I1)]             
                public byte[] byFile;/* »Ø·ÅµÄÎÄ¼şÃû */
				/*[FieldOffsetAttribute(0)]
		...
		public struct NET_DVR_SHOWSTRINGINFO {
			public ushort wShowString;// Ô¤ÀÀµÄÍ¼ÏóÉÏÊÇ·ñÏÔÊ¾×Ö·û,0-²»ÏÔÊ¾,1-ÏÔÊ¾ ÇøÓò´óĞ¡704*576,µ¥¸ö×Ö·ûµÄ´óĞ¡Îª32*32
			public ushort wStringSize;/* ¸ÃĞĞ×Ö·ûµÄ³¤¶È£¬²»ÄÜ´óÓÚ44¸ö×Ö·û */
			...
			public string sString;/* ÒªÏÔÊ¾µÄ×Ö·ûÄÚÈİ */
		}
		...
		public struct NET_DVR_SHOWSTRING_V30 {
			...
			public NET_DVR_SHOWSTRINGINFO[] struStringInfo;/* ÒªÏÔÊ¾µÄ×Ö·ûÄÚÈİ */
		}
		...
		public struct NET_DVR_EMAILCFG_V30 {
			...
			public struct struSender {
				[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
				public byte[] sName;/* ·¢¼şÈËĞÕÃû */
				[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_EMAIL_ADDR_LEN, ArraySubType = UnmanagedType.I1)]
				public byte[] sAddress;/* ·¢¼şÈËµØÖ· */
			}

			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_EMAIL_ADDR_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sSmtpServer;/* smtp·şÎñÆ÷ */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_EMAIL_ADDR_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sPop3Server;/* pop3·şÎñÆ÷ */

			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.Struct)]
			public struReceiver[] struStringInfo;/* ×î¶à¿ÉÒÔÉèÖÃ3¸öÊÕ¼şÈË */
		...
		public struct NET_DVR_TIMEPOINT {
			...
			public uint dwWeekDate;//ĞÇÆÚ¼¸ 0£­ĞÇÆÚÈÕ 1£­ĞÇÆÚÒ» 2£­ĞÇÆÚ¶ş 3£­ĞÇÆÚÈı 4£­ĞÇÆÚËÄ 5£­ĞÇÆÚÎå 6£­ĞÇÆÚÁù
			public uint dwHour;//Ğ¡Ê±	¿ªÊ¼Ê±¼ä0£­23 ½áÊøÊ±¼ä1£­23
		...
		public struct NET_DVR_JPEGPARA {
			...
			public ushort wPicQuality;/* Í¼Æ¬ÖÊÁ¿ÏµÊı 0-×îºÃ 1-½ÏºÃ 2-Ò»°ã */
		}
		...
		public struct NET_DVR_AUXOUTCFG {
			public uint dwSize;
			public uint dwAlarmOutChan;/* Ñ¡Ôñ±¨¾¯µ¯³ö´ó±¨¾¯Í¨µÀÇĞ»»Ê±¼ä£º1»­ÃæµÄÊä³öÍ¨µÀ: 0:Ö÷Êä³ö/1:¸¨1/2:¸¨2/3:¸¨3/4:¸¨4 */
			...
			public uint[] dwAuxSwitchTime;/* ¸¨ÖúÊä³öÇĞ»»Ê±¼ä: 0-²»ÇĞ»»,1-5s,2-10s,3-20s,4-30s,5-60s,6-120s,7-300s */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_AUXOUT * MAX_WINDOW, ArraySubType = UnmanagedType.I1)]
			public byte[] byAuxOrder;/* ¸¨ÖúÊä³öÔ¤ÀÀË³Ğò, 0xff±íÊ¾ÏàÓ¦µÄ´°¿Ú²»Ô¤ÀÀ */
		}
		...
		public struct NET_DVR_NTPPARA {
			...
			public byte res1;
			public ushort wNtpPort; /* ntp server port 9000ĞÂÔö Éè±¸Ä¬ÈÏÎª123*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
			public byte[] res2;
		}
		...
		public struct NET_DVR_DDNSPARA_EX {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DOMAIN_NAME, ArraySubType = UnmanagedType.I1)]
			public byte[] sServerName;/* DDNS ¶ÔÓ¦µÄ·şÎñÆ÷µØÖ·£¬¿ÉÒÔÊÇIPµØÖ·»òÓòÃû */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct struDDNS {
			...
			public byte[] sDomainName;/* Éè±¸Åä±¸µÄÓòÃûµØÖ· */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DOMAIN_NAME, ArraySubType = UnmanagedType.I1)]
			public byte[] sServerName;/* DDNSĞ­Òé¶ÔÓ¦µÄ·şÎñÆ÷µØÖ·£¬¿ÉÒÔÊÇIPµØÖ·»òÓòÃû */
		...
		public struct NET_DVR_EMAILPARA {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] sUsername;/* ÓÊ¼şÕËºÅ/ÃÜÂë */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] sPassword;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_NETAPPCFG {
			public uint dwSize;
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]
			public string sDNSIp; /* DNS·şÎñÆ÷µØÖ· */
			public NET_DVR_NTPPARA struNtpClientParam;/* NTP²ÎÊı */
			public NET_DVR_DDNSPARA struDDNSClientParam;/* DDNS²ÎÊı */
		...
		public struct NET_DVR_ISCSI_CFG {
			public uint dwSize;                   // ½á¹¹´óĞ¡
			public ushort wVrmPort;                  // VRM ¼àÌı¶Ë¿Ú
		...
		public struct NET_DVR_MATRIX_DYNAMIC_DEC {
			public uint dwSize;
			public NET_DVR_MATRIX_DECINFO struDecChanInfo;/* ¶¯Ì¬½âÂëÍ¨µÀĞÅÏ¢ */
		}

		[StructLayoutAttribute(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
		public struct NET_DVR_MATRIX_DEC_CHAN_STATUS {
			public uint dwSize;
			public uint dwIsLinked;/* ½âÂëÍ¨µÀ×´Ì¬ 0£­ĞİÃß 1£­ÕıÔÚÁ¬½Ó 2£­ÒÑÁ¬½Ó 3-ÕıÔÚ½âÂë */
		...
		public struct NET_DVR_MATRIX_DEC_CHAN_INFO {
			public uint dwSize;
			public NET_DVR_MATRIX_DECINFO struDecChanInfo;/* ½âÂëÍ¨µÀĞÅÏ¢ */
			public uint dwDecState;/* 0-¶¯Ì¬½âÂë 1£­Ñ­»·½âÂë 2£­°´Ê±¼ä»Ø·Å 3£­°´ÎÄ¼ş»Ø·Å */
			public NET_DVR_TIME StartTime;/* °´Ê±¼ä»Ø·Å¿ªÊ¼Ê±¼ä */
			public NET_DVR_TIME StopTime;/* °´Ê±¼ä»Ø·ÅÍ£Ö¹Ê±¼ä */
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 128)]
			public string sFileName;/* °´ÎÄ¼ş»Ø·ÅÎÄ¼şÃû */
		}
		...
		public struct NET_DVR_MATRIX_DECCHANINFO {
			...
			public NET_DVR_MATRIX_DECINFO struDecChanInfo;/* ÂÖÑ­½âÂëÍ¨µÀĞÅÏ¢ */
		}
		...
		public struct NET_DVR_MATRIX_DEC_REMOTE_PLAY {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = PASSWD_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sPassword;/* ÃÜÂë */
			public uint dwPlayMode;/* 0£­°´ÎÄ¼ş 1£­°´Ê±¼ä*/
		...
		public struct NET_DVR_MATRIX_DEC_REMOTE_PLAY_CONTROL {
			public uint dwSize;
			public uint dwPlayCmd;/* ²¥·ÅÃüÁî ¼ûÎÄ¼ş²¥·ÅÃüÁî*/
			public uint dwCmdParam;/* ²¥·ÅÃüÁî²ÎÊı */
		}

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_MATRIX_DEC_REMOTE_PLAY_STATUS {
			public uint dwSize;
			public uint dwCurMediaFileLen;/* µ±Ç°²¥·ÅµÄÃ½ÌåÎÄ¼ş³¤¶È */
			public uint dwCurMediaFilePosition;/* µ±Ç°²¥·ÅÎÄ¼şµÄ²¥·ÅÎ»ÖÃ */
			public uint dwCurMediaFileDuration;/* µ±Ç°²¥·ÅÎÄ¼şµÄ×ÜÊ±¼ä */
			public uint dwCurPlayTime;/* µ±Ç°ÒÑ¾­²¥·ÅµÄÊ±¼ä */
			public uint dwCurMediaFIleFrames;/* µ±Ç°²¥·ÅÎÄ¼şµÄ×ÜÖ¡Êı */
			public uint dwCurDataType;/* µ±Ç°´«ÊäµÄÊı¾İÀàĞÍ£¬19-ÎÄ¼şÍ·£¬20-Á÷Êı¾İ£¬ 21-²¥·Å½áÊø±êÖ¾ */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 72, ArraySubType = UnmanagedType.I1)]
			public byte[] res;
		}
		...
		public struct NET_DVR_MATRIX_PASSIVEMODE {
			public ushort wTransProtol;//´«ÊäĞ­Òé£¬0-TCP, 1-UDP, 2-MCAST
			public ushort wPassivePort;//UDP¶Ë¿Ú, TCPÊ±Ä¬ÈÏ
									   // char	sMcastIP[16];		//TCP,UDPÊ±ÎŞĞ§, MCASTÊ±Îª¶à²¥µØÖ·
		...
		public struct NET_DVR_MATRIX_TRAN_CHAN_INFO_V30 {
			...
			public ushort wRemoteDevPort;/* Remote Net Communication Port */
			public byte byIsEstablished;/* Í¸Ã÷Í¨µÀ½¨Á¢³É¹¦±êÖ¾£¬0-Ã»ÓĞ³É¹¦£¬1-½¨Á¢³É¹¦ */
			public byte byRes2;/* ±£Áô */
			public TTY_CONFIG RemoteSerialDevCfg;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_MATRIX_CHAN_INFO_V30 {
			...
			public NET_DVR_DEV_CHAN_INFO struDevChanInfo;/* ÂÖÑ­½âÂëÍ¨µÀĞÅÏ¢ */
		}
		...
		public struct NET_DVR_MATRIX_DEC_CHAN_INFO_V30 {
			public uint dwSize;
			public NET_DVR_STREAM_MEDIA_SERVER_CFG streamMediaServerCfg;/*Á÷Ã½Ìå·şÎñÆ÷ÅäÖÃ*/
			public NET_DVR_DEV_CHAN_INFO struDevChanInfo;/* ½âÂëÍ¨µÀĞÅÏ¢ */
			public uint dwDecState;/* 0-¶¯Ì¬½âÂë 1£­Ñ­»·½âÂë 2£­°´Ê±¼ä»Ø·Å 3£­°´ÎÄ¼ş»Ø·Å */
			public NET_DVR_TIME StartTime;/* °´Ê±¼ä»Ø·Å¿ªÊ¼Ê±¼ä */
			public NET_DVR_TIME StopTime;/* °´Ê±¼ä»Ø·ÅÍ£Ö¹Ê±¼ä */
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 128)]
		...
		public const int MAX_RESOLUTIONNUM = 64; //Ö§³ÖµÄ×î´ó·Ö±æÂÊÊıÄ¿
		...
		public struct NET_DVR_MATRIX_ABILITY {
			...
			public byte byHDMINums;//HDMIÏÔÊ¾Í¨µÀ¸öÊı£¨´Ó25¿ªÊ¼£©
			public byte byDVINums;//DVIÏÔÊ¾Í¨µÀ¸öÊı£¨´Ó29¿ªÊ¼£©
		...
		public struct NET_DVR_DISP_LOGOCFG {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;//±£Áô
			public uint dwLogoSize;//LOGO´óĞ¡£¬°üÀ¨BMPµÄÎÄ¼şÍ·
		}
		...
		public struct NET_DVR_MATRIX_CHAN_STATUS {
			...
			public byte byStreamType;/*ÂëÁ÷ÀàĞÍ*/
			...
			public ushort wImgW;/*½âÂëÆ÷µ±Ç°µÄÍ¼Ïñ´óĞ¡,¿í*/
			public ushort wImgH; //¸ß
			public byte byVideoFormat;/*ÊÓÆµÖÆÊ½:0-NON,NTSC--1,PAL--2*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
			public uint dwDecChan; /*»ñÈ¡È«²¿½âÂëÍ¨µÀ×´Ì¬Ê±ÓĞĞ§£¬ÉèÖÃÊ±¿ÉÌî0*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes3;
		}
		...
		public struct UNION_VIDEOPLATFORM {
			/*¸÷¸ö×Ó´°¿Ú¶ÔÓ¦½âÂëÍ¨µÀËù¶ÔÓ¦µÄ½âÂë×ÓÏµÍ³µÄ²ÛÎ»ºÅ(¶ÔÓÚÊÓÆµ×ÛºÏÆ½Ì¨ÖĞ½âÂë×ÓÏµÍ³ÓĞĞ§)*/
		...
		public const int MAX_DECODECHANNUM = 32;//¶àÂ·½âÂëÆ÷×î´ó½âÂëÍ¨µÀÊı
		public const int MAX_DISPCHANNUM = 24;//¶àÂ·½âÂëÆ÷×î´óÏÔÊ¾Í¨µÀÊı
		...
		public const int PASSIVE_DEC_PAUSE = 1; /*±»¶¯½âÂëÔİÍ£(½öÎÄ¼şÁ÷ÓĞĞ§)*/
		public const int PASSIVE_DEC_RESUME = 2;    /*»Ö¸´±»¶¯½âÂë(½öÎÄ¼şÁ÷ÓĞĞ§)*/
		public const int PASSIVE_DEC_FAST = 3;   /*¿ìËÙ±»¶¯½âÂë(½öÎÄ¼şÁ÷ÓĞĞ§)*/
		public const int PASSIVE_DEC_SLOW = 4;   /*ÂıËÙ±»¶¯½âÂë(½öÎÄ¼şÁ÷ÓĞĞ§)*/
		public const int PASSIVE_DEC_NORMAL = 5;   /*Õı³£±»¶¯½âÂë(½öÎÄ¼şÁ÷ÓĞĞ§)*/
		...
		public struct NET_DVR_MATRIX_DECCHAN_CONTROL {
			...
			public byte byDecodeDelay;//½âÂëÑÓÊ±£¬0-Ä¬ÈÏ£¬1-ÊµÊ±ĞÔºÃ£¬2-ÊµÊ±ĞÔ½ÏºÃ£¬3-ÊµÊ±ĞÔÖĞ£¬Á÷³©ĞÔÖĞ£¬4-Á÷³©ĞÔ½ÏºÃ£¬5-Á÷³©ĞÔºÃ£¬0xff-×Ô¶¯µ÷Õû   
		...
		/************************************ÊÓÆµ×ÛºÏÆ½Ì¨(begin)***************************************/
		public const int MAX_SUBSYSTEM_NUM = 80;   //Ò»¸ö¾ØÕóÏµÍ³ÖĞ×î¶à×ÓÏµÍ³ÊıÁ¿
		public const int MAX_SUBSYSTEM_NUM_V40 = 120;   //Ò»¸ö¾ØÕóÏµÍ³ÖĞ×î¶à×ÓÏµÍ³ÊıÁ¿
		public const int MAX_SERIALLEN = 36;  //×î´óĞòÁĞºÅ³¤¶È
		public const int MAX_LOOPPLANNUM = 16;  //×î´ó¼Æ»®ÇĞ»»×é
		public const int DECODE_TIMESEGMENT = 4;     //¼Æ»®½âÂëÃ¿ÌìÊ±¼ä¶ÎÊı

		public const int MAX_DOMAIN_NAME = 64;  /* ×î´óÓòÃû³¤¶È */
		public const int MAX_DISKNUM_V30 = 33; //9000Éè±¸×î´óÓ²ÅÌÊı/* ×î¶à33¸öÓ²ÅÌ(°üÀ¨16¸öÄÚÖÃSATAÓ²ÅÌ¡¢1¸öeSATAÓ²ÅÌºÍ16¸öNFSÅÌ) */
		public const int MAX_DAYS = 7;       //Ã¿ÖÜÌìÊı
		...
		public const int NET_DVR_MATRIX_BIGSCREENCFG_GET = 1140;//»ñÈ¡´óÆÁÆ´½Ó²ÎÊı        

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_SUBSYSTEMINFO {
			public byte bySubSystemType;//×ÓÏµÍ³ÀàĞÍ£¬1-½âÂëÓÃ×ÓÏµÍ³£¬2-±àÂëÓÃ×ÓÏµÍ³£¬0-NULL£¨´Ë²ÎÊıÖ»ÄÜ»ñÈ¡£©
			public byte byChan;//×ÓÏµÍ³Í¨µÀÊı£¨´Ë²ÎÊıÖ»ÄÜ»ñÈ¡£©
			public byte byLoginType;//×¢²áÀàĞÍ£¬1-Ö±Á¬£¬2-DNS£¬3-»¨Éú¿Ç
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public NET_DVR_IPADDR struSubSystemIP;/*IPµØÖ·£¨¿ÉĞŞ¸Ä£©*/
			public ushort wSubSystemPort;//×ÓÏµÍ³¶Ë¿ÚºÅ£¨¿ÉĞŞ¸Ä£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
			public NET_DVR_IPADDR struSubSystemIPMask;//×ÓÍøÑÚÂë
			public NET_DVR_IPADDR struGatewayIpAddr;    /* Íø¹ØµØÖ·*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sUserName;/* ÓÃ»§Ãû £¨´Ë²ÎÊıÖ»ÄÜ»ñÈ¡£©*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = PASSWD_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sPassword;/*ÃÜÂë£¨´Ë²ÎÊıÖ»ÄÜ»ñÈ¡£©*/
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = MAX_DOMAIN_NAME)]
			public string sDomainName;//ÓòÃû(¿ÉĞŞ¸Ä)
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = MAX_DOMAIN_NAME)]
			public string sDnsAddress;/*DNSÓòÃû»òIPµØÖ·*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = SERIALNO_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sSerialNumber;//ĞòÁĞºÅ£¨´Ë²ÎÊıÖ»ÄÜ»ñÈ¡£©
		}
		...
		public struct NET_DVR_ALARMMODECFG {
			public uint dwSize;
			public byte byAlarmMode;//±¨¾¯´¥·¢ÀàĞÍ£¬1-ÂÖÑ¯£¬2-±£³Ö 
		...
		public struct NET_DVR_ASSOCIATECFG {
			public byte byAssociateType;//¹ØÁªÀàĞÍ£¬1-±¨¾¯
		...
		public struct NET_DVR_DECODESCHED {
			...
			public byte byDecodeType;/*0-ÎŞ£¬1-ÂÖÑ¯½âÂë£¬2-¶¯Ì¬½âÂë*/
		...
		public struct NET_DVR_VIDEOPLATFORM_ABILITY {
			public uint dwSize;
			public byte byCodeSubSystemNums;//±àÂë×ÓÏµÍ³ÊıÁ¿
			public byte byDecodeSubSystemNums;//½âÂë×ÓÏµÍ³ÊıÁ¿
		...
		public struct NET_DVR_SUBSYSTEM_ABILITY {
			/*×ÓÏµÍ³ÀàĞÍ£¬1-½âÂëÓÃ×ÓÏµÍ³£¬2-±àÂëÓÃ×ÓÏµÍ³£¬3-¼¶ÁªÊä³ö×ÓÏµÍ³£¬4-¼¶ÁªÊäÈë×ÓÏµÍ³£¬5-Âë·ÖÆ÷×ÓÏµÍ³£¬6-±¨¾¯Ö÷»ú×ÓÏµÍ³£¬7-ÖÇÄÜ×ÓÏµÍ³£¬8-V6½âÂë×ÓÏµÍ³£¬9-V6×ÓÏµÍ³£¬0-NULL£¨´Ë²ÎÊıÖ»ÄÜ»ñÈ¡£©*/
			public byte bySubSystemType;
			public byte byChanNum;//×ÓÏµÍ³Í¨µÀÊı
			public byte byStartChan;//×ÓÏµÍ³ÆğÊ¼Í¨µÀÊı
		...
		public struct struDecoderSystemAbility {
			public byte byVGANums;//VGAÏÔÊ¾Í¨µÀ¸öÊı£¨´Ó1¿ªÊ¼£©
			public byte byBNCNums;//BNCÏÔÊ¾Í¨µÀ¸öÊı£¨´Ó9¿ªÊ¼£©
			public byte byHDMINums;//HDMIÏÔÊ¾Í¨µÀ¸öÊı£¨´Ó25¿ªÊ¼£©
			public byte byDVINums;//DVIÏÔÊ¾Í¨µÀ¸öÊı£¨´Ó29¿ªÊ¼£©

			public byte byLayerNums;//´óÆÁÆ´½ÓÖĞ£¬×öÖ÷ÆÁÊ±ËùÖ§³ÖÍ¼²ãÊı
			public byte bySpartan;//³©ÏÔ¹¦ÄÜ£¬0-²»Ö§³Ö£¬1-Ö§³Ö
			public byte byDecType; //½âÂë×ÓÏµÍ³ÀàĞÍ£¬0-ÆÕÍ¨ĞÍ,1-ÔöÇ¿ĞÍ(ÆÕÍ¨ĞÍ·ÖÆÁÊ±Ç°4´°¿ÚĞèÊ¹ÓÃ×ÔÉí×ÊÔ´£¬ÔöÇ¿ĞÍÎŞ´ËÏŞÖÆ£¬ÔöÇ¿ĞÍ×î¶à¿É±»ÆäËû×ÓÏµÍ³½è16Â·D1½âÂë×ÊÔ´
								   //ÔöÇ¿ĞÍ±»´óÆÁ¹ØÁªÎª×ÓÆÁºó×ÊÔ´¿É±»½èÓÃ£¬ÆÕÍ¨ĞÍÔò²»ÄÜ±»½èÓÃ)
			public byte byOutputSwitch;//ÊÇ·ñÖ§³ÖHDMI/DVI»¥ÏàÇĞ»»£¬0-²»Ö§³Ö£¬1-Ö§³Ö
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 39, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public byte byDecoderType; //½âÂë°åÀàĞÍ  0-ÆÕÍ¨½âÂë°å 1-ÍòÄÜ½âÂë°å
		...
		public struct NET_DVR_VIDEOPLATFORM_ABILITY_V40 {
			...
			public byte byInputSubSystemNums;//¼¶ÁªÊäÈë×ÓÏµÍ³ÊıÁ¿
			public byte byOutputSubSystemNums;//¼¶ÁªÊä³ö×ÓÏµÍ³ÊıÁ¿
			public byte byCodeSpitterSubSystemNums;//Âë·Ö×ÓÏµÍ³ÊıÁ¿
			public byte byAlarmHostSubSystemNums;//±¨¾¯×ÓÏµÍ³ÊıÁ¿
			public byte bySupportBigScreenNum;//ËùÖ§³Ö×î¶à×é³É´óÆÁµÄ¸öÊı
			public byte byVCASubSystemNums;//ÖÇÄÜ×ÓÏµÍ³ÊıÁ¿
			public byte byV6SubSystemNums;//V6×ÓÏµÍ³ÊıÁ¿
			public byte byV6DecoderSubSystemNums;//V6½âÂë×ÓÏµÍ³ÊıÁ¿
			public byte bySupportBigScreenX;/*´óÆÁÆ´½ÓµÄÄ£Ê½£ºm¡Án*/
			public byte bySupportBigScreenY;
			public byte bySupportSceneNums;//Ö§³Ö³¡¾°Ä£Ê½µÄ¸öÊı
			public byte byVcaSupportChanMode;//ÖÇÄÜÖ§³ÖµÄÍ¨µÀÊ¹ÓÃÄ£Ê½£¬0-Ê¹ÓÃ½âÂëÍ¨µÀ£¬1-Ê¹ÓÃÏÔÊ¾Í¨µÀ¼°×ÓÍ¨µÀºÅ
			public byte bySupportScreenNums;//ËùÖ§³ÖµÄ´óÆÁµÄÆÁÄ»×î´ó¸öÊı
			public byte bySupportLayerNums;//ËùÖ§³ÖµÄÍ¼²ãÊı£¬0xff-ÎŞĞ§
			...
			public byte by485Nums;//485´®¿Ú¸öÊı
			public byte by232Nums;//232´®¿Ú¸öÊı
			public byte bySerieStartChan;//ÆğÊ¼Í¨µÀ
			public byte byScreenMode;//´óÆÁÄ£Ê½£¬0-Ö÷ÆÁÓÉ¿Í»§¶Ë·ÖÅä£¬1-Ö÷ÆÁÓÉÉè±¸¶Ë·ÖÅä
			public byte byDevVersion;//Éè±¸°æ±¾£¬0-B10/B11/B12£¬1-B20
			public byte bySupportBaseMapNums;//ËùÖ§³ÖµÄµ×Í¼Êı£¬µ×Í¼ºÅ´Ó1¿ªÊ¼
			public ushort wBaseLengthX;//Ã¿¸öÆÁ´óĞ¡µÄ»ù×¼Öµ£¬B20Ê¹ÓÃ
		...
		public struct NET_DVR_SINGLESCREENCFG {
			public byte byScreenSeq;//ÆÁÄ»ĞòºÅ£¬0xff±íÊ¾²»ÓÃ´ËÆÁ,64-T½âÂëÆ÷µÚÒ»¸ö±íÊ¾Ö÷ÆÁ
			public byte bySubSystemNum;//½âÂë×ÓÏµÍ³²ÛÎ»ºÅ,½âÂëÆ÷´ËÖµÃ»ÓĞÓÃ
			public byte byDispNum;//½âÂë×ÓÏµÍ³ÉÏ¶ÔÓ¦ÏÔÊ¾Í¨µÀºÅ£¬64-T½âÂëÆ÷ÖĞ¸ÃÖµ±íÊ¾½âÂëÆ÷µÄÏÔÊ¾Í¨µÀºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 9, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_BIGSCREENCFG {
			...
			public byte byModeY;
			public byte byMainDecodeSystem;//×ÛºÏÆ½Ì¨µÄ½âÂë°åÖĞ¸ÃÖµ±íÊ¾Ö÷ÆÁ²ÛÎ»ºÅ£¬64-T½âÂëÆ÷ÖĞ¸ÃÖµ±íÊ¾½âÂëÍ¨µÀºÅ
			public byte byMainDecoderDispChan;//Ö÷ÆÁËùÓÃÏÔÊ¾Í¨µÀºÅ£¬1.1netra°æ±¾ĞÂÔö£¬netra½âÂëÆ÷ÓĞÁ½¸öÏÔÊ¾Í¨µÀ£¬¶¼ÄÜ¹»×÷ÎªÖ÷ÆÁ¡£64-TÖĞ¸ÃÖµÎŞĞ§
			...
			//ÆğÊ¼×ø±ê±ØĞëÎª»ù×¼×ø±êµÄÕûÊı±¶
			public ushort wBigScreenX; //´óÆÁÔÚµçÊÓÇ½ÖĞÆğÊ¼X×ø±ê
			public ushort wBigScreenY; //´óÆÁÔÚµçÊÓÇ½ÖĞÆğÊ¼Y×ø±ê
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		...
		public struct NET_DVR_EMAILCFG {
			...
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 32)]
			public string sFromName;/* Sender *///×Ö·û´®ÖĞµÄµÚÒ»¸ö×Ö·ûºÍ×îºóÒ»¸ö×Ö·û²»ÄÜÊÇ"@",²¢ÇÒ×Ö·û´®ÖĞÒªÓĞ"@"×Ö·û
		...
		public struct NET_DVR_COMPRESSIONCFG_NEW {
			...
			public NET_DVR_COMPRESSION_INFO_EX struEventCompression;//ÊÂ¼ş´¥·¢Â¼Ïñ
		}

		//Çò»úÎ»ÖÃĞÅÏ¢
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_PTZPOS {
			public ushort wAction;//»ñÈ¡Ê±¸Ã×Ö¶ÎÎŞĞ§
			public ushort wPanPos;//Ë®Æ½²ÎÊı
			public ushort wTiltPos;//´¹Ö±²ÎÊı
			public ushort wZoomPos;//±ä±¶²ÎÊı
		}

		//Çò»ú·¶Î§ĞÅÏ¢
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_PTZSCOPE {
			public ushort wPanPosMin;//Ë®Æ½²ÎÊımin
			public ushort wPanPosMax;//Ë®Æ½²ÎÊımax
			public ushort wTiltPosMin;//´¹Ö±²ÎÊımin
			public ushort wTiltPosMax;//´¹Ö±²ÎÊımax
			public ushort wZoomPosMin;//±ä±¶²ÎÊımin
			public ushort wZoomPosMax;//±ä±¶²ÎÊımax
		}
		...
		public struct NET_DVR_RTSPCFG {
			...
			public ushort wPort;//rtsp·şÎñÆ÷ÕìÌı¶Ë¿Ú
		...
		public struct NET_DVR_DEVICEINFO_V30 {
			...
			public byte byIPChanNum;                    //×î´óÊı×ÖÍ¨µÀ¸öÊı£¬µÍÎ»  
			public byte byZeroChanNum;          //ÁãÍ¨µÀ±àÂë¸öÊı //2010-01-16
			public byte byMainProto;            //Ö÷ÂëÁ÷´«ÊäĞ­ÒéÀàĞÍ 0-private, 1-rtsp,2-Í¬Ê±Ö§³ÖprivateºÍrtsp
			public byte bySubProto;             //×ÓÂëÁ÷´«ÊäĞ­ÒéÀàĞÍ0-private, 1-rtsp,2-Í¬Ê±Ö§³ÖprivateºÍrtsp
			public byte bySupport;        //ÄÜÁ¦£¬Î»Óë½á¹ûÎª0±íÊ¾²»Ö§³Ö£¬1±íÊ¾Ö§³Ö£¬
										  //bySupport & 0x1, ±íÊ¾ÊÇ·ñÖ§³ÖÖÇÄÜËÑË÷
										  //bySupport & 0x2, ±íÊ¾ÊÇ·ñÖ§³Ö±¸·İ
										  //bySupport & 0x4, ±íÊ¾ÊÇ·ñÖ§³ÖÑ¹Ëõ²ÎÊıÄÜÁ¦»ñÈ¡
			...
			public byte bySupport1;        // ÄÜÁ¦¼¯À©³ä£¬Î»Óë½á¹ûÎª0±íÊ¾²»Ö§³Ö£¬1±íÊ¾Ö§³Ö
										   ...
										   //bySupport1 & 0x10, ±íÊ¾ÊÇ·ñÖ§³Ö¶à´ÅÅÌÊı£¨³¬¹ı33¸ö£©
										   //bySupport1 & 0x20, ±íÊ¾ÊÇ·ñÖ§³Örtsp over http	
										   //bySupport1 & 0x80, ±íÊ¾ÊÇ·ñÖ§³Ö³µÅÆĞÂ±¨¾¯ĞÅÏ¢2012-9-28, ÇÒ»¹±íÊ¾ÊÇ·ñÖ§³ÖNET_DVR_IPPARACFG_V40½á¹¹Ìå
			public byte bySupport2; /*ÄÜÁ¦£¬Î»Óë½á¹ûÎª0±íÊ¾²»Ö§³Ö£¬·Ç0±íÊ¾Ö§³Ö							
							bySupport2 & 0x1, ±íÊ¾½âÂëÆ÷ÊÇ·ñÖ§³ÖÍ¨¹ıURLÈ¡Á÷½âÂë
							bySupport2 & 0x2,  ±íÊ¾Ö§³ÖFTPV40
							bySupport2 & 0x4,  ±íÊ¾Ö§³ÖANR
							bySupport2 & 0x8,  ±íÊ¾Ö§³ÖCCDµÄÍ¨µÀ²ÎÊıÅäÖÃ
							bySupport2 & 0x10,  ±íÊ¾Ö§³Ö²¼·À±¨¾¯»Ø´«ĞÅÏ¢£¨½öÖ§³Ö×¥ÅÄ»ú±¨¾¯ ĞÂÀÏ±¨¾¯½á¹¹£©
							bySupport2 & 0x20,  ±íÊ¾ÊÇ·ñÖ§³Öµ¥¶À»ñÈ¡Éè±¸×´Ì¬×ÓÏî
							bySupport2 & 0x40,  ±íÊ¾ÊÇ·ñÊÇÂëÁ÷¼ÓÃÜÉè±¸*/
			public ushort wDevType;              //Éè±¸ĞÍºÅ
			public byte bySupport3; //ÄÜÁ¦¼¯À©Õ¹£¬Î»Óë½á¹ûÎª0±íÊ¾²»Ö§³Ö£¬1±íÊ¾Ö§³Ö
									//bySupport3 & 0x1, ±íÊ¾ÊÇ·ñ¶àÂëÁ÷
									// bySupport3 & 0x4 ±íÊ¾Ö§³Ö°´×éÅäÖÃ£¬ ¾ßÌå°üº¬ Í¨µÀÍ¼Ïñ²ÎÊı¡¢±¨¾¯ÊäÈë²ÎÊı¡¢IP±¨¾¯ÊäÈë¡¢Êä³ö½ÓÈë²ÎÊı¡¢
									// ÓÃ»§²ÎÊı¡¢Éè±¸¹¤×÷×´Ì¬¡¢JPEG×¥Í¼¡¢¶¨Ê±ºÍÊ±¼ä×¥Í¼¡¢Ó²ÅÌÅÌ×é¹ÜÀí 
									//bySupport3 & 0x8Îª1 ±íÊ¾Ö§³ÖÊ¹ÓÃTCPÔ¤ÀÀ¡¢UDPÔ¤ÀÀ¡¢¶à²¥Ô¤ÀÀÖĞµÄ"ÑÓÊ±Ô¤ÀÀ"×Ö¶ÎÀ´ÇëÇóÑÓÊ±Ô¤ÀÀ£¨ºóĞø¶¼½«Ê¹ÓÃÕâÖÖ·½Ê½ÇëÇóÑÓÊ±Ô¤ÀÀ£©¡£¶øµ±bySupport3 & 0x8Îª0Ê±£¬½«Ê¹ÓÃ "Ë½ÓĞÑÓÊ±Ô¤ÀÀ"Ğ­Òé¡£
									//bySupport3 & 0x10 ±íÊ¾Ö§³Ö"»ñÈ¡±¨¾¯Ö÷»úÖ÷Òª×´Ì¬£¨V40£©"¡£
									//bySupport3 & 0x20 ±íÊ¾ÊÇ·ñÖ§³ÖÍ¨¹ıDDNSÓòÃû½âÎöÈ¡Á÷

			public byte byMultiStreamProto;//ÊÇ·ñÖ§³Ö¶àÂëÁ÷,°´Î»±íÊ¾,0-²»Ö§³Ö,1-Ö§³Ö,bit1-ÂëÁ÷3,bit2-ÂëÁ÷4,bit7-Ö÷ÂëÁ÷£¬bit-8×ÓÂëÁ÷
			public byte byStartDChan;       //ÆğÊ¼Êı×ÖÍ¨µÀºÅ,0±íÊ¾ÎŞĞ§
			public byte byStartDTalkChan;   //ÆğÊ¼Êı×Ö¶Ô½²Í¨µÀºÅ£¬Çø±ğÓÚÄ£Äâ¶Ô½²Í¨µÀºÅ£¬0±íÊ¾ÎŞĞ§
			public byte byHighDChanNum;     //Êı×ÖÍ¨µÀ¸öÊı£¬¸ßÎ»
			public byte bySupport4;
			public byte byLanguageType;// Ö§³ÖÓïÖÖÄÜÁ¦,°´Î»±íÊ¾,Ã¿Ò»Î»0-²»Ö§³Ö,1-Ö§³Ö  
									   //  byLanguageType µÈÓÚ0 ±íÊ¾ ÀÏÉè±¸
									   //  byLanguageType & 0x1±íÊ¾Ö§³ÖÖĞÎÄ
		...
		public struct NET_DVR_SDKSTATE {
			public uint dwTotalLoginNum;//µ±Ç°loginÓÃ»§Êı
			public uint dwTotalRealPlayNum;//µ±Ç°realplayÂ·Êı
			public uint dwTotalPlayBackNum;//µ±Ç°»Ø·Å»òÏÂÔØÂ·Êı
			public uint dwTotalAlarmChanNum;//µ±Ç°½¨Á¢±¨¾¯Í¨µÀÂ·Êı
			public uint dwTotalFormatNum;//µ±Ç°Ó²ÅÌ¸ñÊ½»¯Â·Êı
			public uint dwTotalFileSearchNum;//µ±Ç°ÈÕÖ¾»òÎÄ¼şËÑË÷Â·Êı
			public uint dwTotalLogSearchNum;//µ±Ç°ÈÕÖ¾»òÎÄ¼şËÑË÷Â·Êı
			public uint dwTotalSerialNum;//µ±Ç°Í¸Ã÷Í¨µÀÂ·Êı
			public uint dwTotalUpgradeNum;//µ±Ç°Éı¼¶Â·Êı
			public uint dwTotalVoiceComNum;//µ±Ç°ÓïÒô×ª·¢Â·Êı
			public uint dwTotalBroadCastNum;//µ±Ç°ÓïÒô¹ã²¥Â·Êı
			public uint dwTotalListenNum;       //µ±Ç°ÍøÂç¼àÌıÂ·Êı
			public uint dwEmailTestNum;       //µ±Ç°ÓÊ¼ş¼ÆÊıÂ·Êı
			public uint dwBackupNum;          // µ±Ç°ÎÄ¼ş±¸·İÂ·Êı
			public uint dwTotalInquestUploadNum; //µ±Ç°ÉóÑ¶ÉÏ´«Â·Êı
		...
		public struct NET_DVR_SDKABL {
			public uint dwMaxLoginNum;//×î´óloginÓÃ»§Êı MAX_LOGIN_USERS
			public uint dwMaxRealPlayNum;//×î´órealplayÂ·Êı WATCH_NUM
			public uint dwMaxPlayBackNum;//×î´ó»Ø·Å»òÏÂÔØÂ·Êı WATCH_NUM
			public uint dwMaxAlarmChanNum;//×î´ó½¨Á¢±¨¾¯Í¨µÀÂ·Êı ALARM_NUM
			public uint dwMaxFormatNum;//×î´óÓ²ÅÌ¸ñÊ½»¯Â·Êı SERVER_NUM
			public uint dwMaxFileSearchNum;//×î´óÎÄ¼şËÑË÷Â·Êı SERVER_NUM
			public uint dwMaxLogSearchNum;//×î´óÈÕÖ¾ËÑË÷Â·Êı SERVER_NUM
			public uint dwMaxSerialNum;//×î´óÍ¸Ã÷Í¨µÀÂ·Êı SERVER_NUM
			public uint dwMaxUpgradeNum;//×î´óÉı¼¶Â·Êı SERVER_NUM
			public uint dwMaxVoiceComNum;//×î´óÓïÒô×ª·¢Â·Êı SERVER_NUM
			public uint dwMaxBroadCastNum;//×î´óÓïÒô¹ã²¥Â·Êı MAX_CASTNUM
		...
		public struct NET_DVR_ALARMER {
			...
			public int lUserID; /* NET_DVR_Login()·µ»ØÖµ, ²¼·ÀÊ±ÓĞĞ§ */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = SERIALNO_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sSerialNumber;/* ĞòÁĞºÅ */
			public uint dwDeviceVersion;/* °æ±¾ĞÅÏ¢ ¸ß16Î»±íÊ¾Ö÷°æ±¾£¬µÍ16Î»±íÊ¾´Î°æ±¾*/
		...
		public struct NET_DVR_FIND_DATA {
			...
			public string sFileName;//ÎÄ¼şÃû
			public NET_DVR_TIME struStartTime;//ÎÄ¼şµÄ¿ªÊ¼Ê±¼ä
			public NET_DVR_TIME struStopTime;//ÎÄ¼şµÄ½áÊøÊ±¼ä
			public uint dwFileSize;//ÎÄ¼şµÄ´óĞ¡
		}
		...
		public struct NET_DVR_FINDDATA_V30 {
			...
			public byte byFileType;  //ÎÄ¼şÀàĞÍ:0£­¶¨Ê±Â¼Ïñ,1-ÒÆ¶¯Õì²â £¬2£­±¨¾¯´¥·¢£¬
									 //3-±¨¾¯|ÒÆ¶¯Õì²â 4-±¨¾¯&ÒÆ¶¯Õì²â 5-ÃüÁî´¥·¢ 6-ÊÖ¶¯Â¼Ïñ,7£­Õğ¶¯±¨¾¯£¬8-»·¾³±¨¾¯£¬9-ÖÇÄÜ±¨¾¯£¬10-PIR±¨¾¯£¬11-ÎŞÏß±¨¾¯£¬12-ºô¾È±¨¾¯,14-ÖÇÄÜ½»Í¨ÊÂ¼ş
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_FINDDATA_V40 {
			...
			public byte byRes;
			public uint dwFileIndex; //ÎÄ¼şË÷ÒıºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
		}
		...
		public struct NET_DVR_FILECOND {
			public int lChannel;//Í¨µÀºÅ
			public uint dwFileType;//Â¼ÏóÎÄ¼şÀàĞÍ0xff£­È«²¿£¬0£­¶¨Ê±Â¼Ïñ,1-ÒÆ¶¯Õì²â £¬2£­±¨¾¯´¥·¢£¬
								   //3-±¨¾¯|ÒÆ¶¯Õì²â 4-±¨¾¯&ÒÆ¶¯Õì²â 5-ÃüÁî´¥·¢ 6-ÊÖ¶¯Â¼Ïñ
			public uint dwIsLocked;//ÊÇ·ñËø¶¨ 0-Õı³£ÎÄ¼ş,1-Ëø¶¨ÎÄ¼ş, 0xff±íÊ¾ËùÓĞÎÄ¼ş
		...
		public struct NET_DVR_AP_INFO {
			...
			public uint dwSignalStrength;/*0-100ĞÅºÅÓÉ×îÈõ±äÎª×îÇ¿*/
		...
		public struct NET_DVR_AP_INFO_LIST {
			public uint dwSize;
			public uint dwCount;/*ÎŞÏßAPÊıÁ¿£¬²»³¬¹ı20*/
		...
		public struct NET_DVR_WIFIETHERNET {
			...
			public uint dwAutoDns;/*Èç¹ûÆô¶¯dhcpÊÇ·ñ×Ô¶¯»ñÈ¡dns,0²»×Ô¶¯»ñÈ¡ 1×Ô¶¯»ñÈ¡£»¶ÔÓÚÓĞÏßÈç¹ûÆô¶¯dhcpÄ¿Ç°×Ô¶¯»ñÈ¡dns*/
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]
			public string sFirstDns; /*µÚÒ»¸ödnsÓòÃû*/
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]
			public string sSecondDns;/*µÚ¶ş¸ödnsÓòÃû*/
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]
		...
		public struct NET_DVR_WIFI_CONNECT_STATUS {
			public uint dwSize;
			public byte byCurStatus;    //1-ÒÑÁ¬½Ó£¬2-Î´Á¬½Ó£¬3-ÕıÔÚÁ¬½Ó
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;       //±£Áô
			public uint dwErrorCode;    // byCurStatus = 2Ê±ÓĞĞ§,1-ÓÃ»§Ãû»òÃÜÂë´íÎó,2-ÎŞ´ËÂ·ÓÉÆ÷,3-Î´Öª´íÎó
		...
		public struct NET_DVR_WIFI_WORKMODE {
			public uint dwSize;
			public uint dwNetworkInterfaceMode;/*0 ×Ô¶¯ÇĞ»»Ä£Ê½¡¡1 ÓĞÏßÄ£Ê½*/
		}

		//ÖÇÄÜ¿ØÖÆĞÅÏ¢
		public const int MAX_VCA_CHAN = 16;//×î´óÖÇÄÜÍ¨µÀÊı
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_VCA_CTRLINFO {
			public byte byVCAEnable;//ÊÇ·ñ¿ªÆôÖÇÄÜ
			public byte byVCAType;//ÖÇÄÜÄÜÁ¦ÀàĞÍ£¬VCA_CHAN_ABILITY_TYPE 
			public byte byStreamWithVCA;//ÂëÁ÷ÖĞÊÇ·ñ´øÖÇÄÜĞÅÏ¢
			public byte byMode;//Ä£Ê½£¬VCA_CHAN_MODE_TYPE ,atmÄÜÁ¦µÄÊ±ºòĞèÒªÅäÖÃ
			public byte byControlType;   //¿ØÖÆÀàĞÍ£¬°´Î»±íÊ¾£¬0-·ñ£¬1-ÊÇ
		...
		public struct NET_VCA_CTRLCFG {
			...
			public NET_VCA_CTRLINFO[] struCtrlInfo;//¿ØÖÆĞÅÏ¢,Êı×é0¶ÔÓ¦Éè±¸µÄÆğÊ¼Í¨µÀ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_DEV_ABILITY {
			...
			public byte byVCAChanNum;//ÖÇÄÜÍ¨µÀ¸öÊı
			public byte byPlateChanNum;//³µÅÆÍ¨µÀ¸öÊı
			public byte byBBaseChanNum;//ĞĞÎª»ù±¾°æ¸öÊı
			public byte byBAdvanceChanNum;//ĞĞÎª¸ß¼¶°æ¸öÊı
			public byte byBFullChanNum;//ĞĞÎªÍêÕû°æ¸öÊı
			public byte byATMChanNum;//ÖÇÄÜATM¸öÊı
			public byte byPDCChanNum;         //ÈËÊıÍ³¼ÆÍ¨µÀ¸öÊı
			public byte byITSChanNum;         //½»Í¨ÊÂ¼şÍ¨µÀ¸öÊı
			public byte byBPrisonChanNum;     //ĞĞÎª¼àÓü°æ(¼àÉá)Í¨µÀ¸öÊı
			public byte byFSnapChanNum;       //ÈËÁ³×¥ÅÄÍ¨µÀ¸öÊı
			public byte byFSnapRecogChanNum;  //ÈËÁ³×¥ÅÄºÍÊ¶±ğÍ¨µÀ¸öÊı
			public byte byFRetrievalChanNum;  //ÈËÁ³ºó¼ìË÷¸öÊı
			public byte bySupport;            //ÄÜÁ¦£¬Î»Óë½á¹ûÎª0±íÊ¾²»Ö§³Ö£¬1±íÊ¾Ö§³Ö
											  //bySupport & 0x1£¬±íÊ¾ÊÇ·ñÖ§³ÖÖÇÄÜ¸ú×Ù 2012-3-22
											  //bySupport & 0x2£¬±íÊ¾ÊÇ·ñÖ§³Ö128Â·È¡Á÷À©Õ¹2012-12-27
			public byte byFRecogChanNum;      //ÈËÁ³Ê¶±ğÍ¨µÀ¸öÊı
			public byte byBPPerimeterChanNum; //ĞĞÎª¼àÓü°æ(ÖÜ½ç)Í¨µÀ¸öÊı
			public byte byTPSChanNum;         //½»Í¨ÓÕµ¼Í¨µÀ¸öÊı
			public byte byTFSChanNum;         //µÀÂ·Î¥ÕÂÈ¡Ö¤Í¨µÀ¸öÊı
			public byte byFSnapBFullChanNum;  //ÈËÁ³×¥ÅÄºÍĞĞÎª·ÖÎöÍ¨µÀ¸öÊı
		...
		public enum VCA_CHAN_ABILITY_TYPE {
			VCA_BEHAVIOR_BASE = 1,          //ĞĞÎª·ÖÎö»ù±¾°æ
			VCA_BEHAVIOR_ADVANCE = 2,          //ĞĞÎª·ÖÎö¸ß¼¶°æ
			VCA_BEHAVIOR_FULL = 3,          //ĞĞÎª·ÖÎöÍêÕû°æ
			VCA_PLATE = 4,          //³µÅÆÄÜÁ¦
			VCA_ATM = 5,          //ATMÄÜÁ¦
			VCA_PDC = 6,          //ÈËÁ÷Á¿Í³¼Æ
			VCA_ITS = 7,          //ÖÇÄÜ ½»Í¨ÊÂ¼ş
			VCA_BEHAVIOR_PRISON = 8,          //ĞĞÎª·ÖÎö¼àÓü°æ(¼àÉá) 
			VCA_FACE_SNAP = 9,           //ÈËÁ³×¥ÅÄÄÜÁ¦
			VCA_FACE_SNAPRECOG = 10,          //ÈËÁ³×¥ÅÄºÍÊ¶±ğÄÜÁ¦
			VCA_FACE_RETRIEVAL = 11,          //ÈËÁ³ºó¼ìË÷ÄÜÁ¦
			VCA_FACE_RECOG = 12,          //ÈËÁ³Ê¶±ğÄÜÁ¦
			VCA_BEHAVIOR_PRISON_PERIMETER = 13, // ĞĞÎª·ÖÎö¼àÓü°æ (ÖÜ½ç)
			VCA_TPS = 14,          //½»Í¨ÓÕµ¼
			VCA_TFS = 15,          //µÀÂ·Î¥ÕÂÈ¡Ö¤
			VCA_BEHAVIOR_FACESNAP = 16           //ÈËÁ³×¥ÅÄºÍĞĞÎª·ÖÎöÄÜÁ¦
		}

		//ÖÇÄÜATMÄ£Ê½ÀàĞÍ(ATMÄÜÁ¦ÌØÓĞ)
		...
		public struct NET_VCA_BEHAVIOR_ABILITY {
			public uint dwSize;//½á¹¹³¤¶È
			public uint dwAbilityType;//Ö§³ÖµÄÄÜÁ¦ÀàĞÍ£¬°´Î»±íÊ¾£¬¼ûVCA_ABILITY_TYPE¶¨Òå
			public byte byMaxRuleNum;//×î´ó¹æÔòÊı
			public byte byMaxTargetNum;//×î´óÄ¿±êÊı
			public byte bySupport;      // Ö§³ÖµÄ¹¦ÄÜÀàĞÍ   °´Î»±íÊ¾  
		...
		public struct NET_DVR_ITS_ABILITY {
			public uint dwSize;             // ½á¹¹Ìå´óĞ¡
			public uint dwAbilityType;      // Ö§³ÖµÄÄÜÁ¦ÁĞ±í  ²ÎÕÕITS_ABILITY_TYPE
			public byte byMaxRuleNum;       //×î´ó¹æÔòÊı
			public byte byMaxTargetNum;     //×î´óÄ¿±êÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 10, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;            // ±£Áô
		...
		/************************************ÖÇÄÜ²ÎÊı½á¹¹*********************************/
		//ÖÇÄÜ¹²ÓÃ½á¹¹
		//×ø±êÖµ¹éÒ»»¯,¸¡µãÊıÖµÎªµ±Ç°»­ÃæµÄ°Ù·Ö±È´óĞ¡, ¾«¶ÈÎªĞ¡ÊıµãºóÈıÎ»
		//µã×ø±ê½á¹¹
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		public enum VCA_RULE_EVENT_TYPE_EX: ushort {
			...
			ENUM_VCA_EVENT_GET_UP = 12,  //ÆğÉí¼ì²â
			...
			ENUM_VCA_EVENT_KEY_PERSON_GET_UP = 17,  //ÖØµãÈËÔ±ÆğÉí¼ì²â
			...
			ENUM_VCA_EVENT_TOILET_TARRY = 23,  //Èç²Ş³¬Ê±
		...
		public struct NET_VCA_LINE {
			public NET_VCA_POINT struStart;//Æğµã 
		...
		//¸Ã½á¹¹»áµ¼ÖÂxaml½çÃæ³ö²»À´£¡£¡£¡£¡£¡£¡£¡£¡£¡£¿£¿ÎÊÌâÔİÊ±»¹Ã»ÓĞÕÒµ½  
		//ÔİÊ±ÆÁ±Î½á¹¹ÏÈ
		//¶à±ßĞÍ½á¹¹Ìå
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		//¸ù¾İ±¨¾¯ÑÓ³ÙÊ±¼äÀ´±êÊ¶±¨¾¯ÖĞ´øÍ¼Æ¬£¬±¨¾¯¼ä¸ôºÍIO±¨¾¯Ò»ÖÂ£¬1Ãë·¢ËÍÒ»¸ö¡£
		//ÈëÇÖ²ÎÊı
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_VCA_INTRUSION {
			public NET_VCA_POLYGON struRegion;//ÇøÓò·¶Î§
			public ushort wDuration;//±¨¾¯ÑÓ³ÙÊ±¼ä: 1-120Ãë£¬½¨Òé5Ãë£¬ÅĞ¶ÏÊÇÓĞĞ§±¨¾¯µÄÊ±¼ä
			public byte bySensitivity;        //ÁéÃô¶È²ÎÊı£¬·¶Î§[1-100]
			public byte byRate;               //Õ¼±È£ºÇøÓòÄÚËùÓĞÎ´±¨¾¯Ä¿±ê³ß´çÄ¿±êÕ¼ÇøÓòÃæ»ıµÄ±ÈÖØ£¬¹éÒ»»¯Îª£­£»
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_LOITER {
			public NET_VCA_POLYGON struRegion;//ÇøÓò·¶Î§
			public ushort wDuration;//´¥·¢ÅÇ»²±¨¾¯µÄ³ÖĞøÊ±¼ä£º1-120Ãë£¬½¨Òé10Ãë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_TAKE_LEFT {
			public NET_VCA_POLYGON struRegion;//ÇøÓò·¶Î§
			public ushort wDuration;//´¥·¢¶ª°ü/¼ñ°ü±¨¾¯µÄ³ÖĞøÊ±¼ä£º1-120Ãë£¬½¨Òé10Ãë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_PARKING {
			public NET_VCA_POLYGON struRegion;//ÇøÓò·¶Î§
			public ushort wDuration;//´¥·¢Í£³µ±¨¾¯³ÖĞøÊ±¼ä£º1-120Ãë£¬½¨Òé10Ãë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_HIGH_DENSITY {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			public ushort wDuration;      // ´¥·¢ÈËÔ±¾Û¼¯²ÎÊı±¨¾¯ãĞÖµ 20-360s
		}
		...
		public struct NET_VCA_VIOLENT_MOTION {
			public NET_VCA_POLYGON struRegion;//ÇøÓò·¶Î§
			public ushort wDuration;           //´¥·¢¾çÁÒÔË¶¯±¨¾¯ãĞÖµ£º1-50Ãë
			public byte bySensitivity;       //ÁéÃô¶È²ÎÊı£¬·¶Î§[1,5]
		...
		public struct NET_VCA_REACH_HIGHT {
			...
			public ushort wDuration; //´¥·¢ÅÊ¸ß±¨¾¯ãĞÖµ£º1-120Ãë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;           // ±£Áô×Ö½Ú
		}
		...
		public struct NET_VCA_GET_UP {
			public NET_VCA_POLYGON struRegion; //ÇøÓò·¶Î§
			public ushort wDuration;            //´¥·¢Æğ´²±¨¾¯ãĞÖµ1-100 Ãë
			public byte byMode;             //ÆğÉí¼ì²âÄ£Ê½,0-´ó´²Í¨ÆÌÄ£Ê½,1-¸ßµÍÆÌÄ£Ê½,2-´ó´²Í¨ÆÌ×øÁ¢ÆğÉíÄ£Ê½
			public byte bySensitivity;      //ÁéÃô¶È²ÎÊı£¬·¶Î§[1,10]
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;            //±£Áô×Ö½Ú
		}
		...
		public struct NET_VCA_LEFT {
			public NET_VCA_POLYGON struRegion; // ÇøÓò·¶Î§
			public ushort wDuration;       // ´¥·¢ÎïÆ·ÒÅÁô±¨¾¯ãĞÖµ 10-100Ãë
			public byte bySensitivity;   // ÁéÃô¶È²ÎÊı£¬·¶Î§[1,5] 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;        // ±£Áô×Ö½Ú
		}
		...
		public struct NET_VCA_TAKE {
			public NET_VCA_POLYGON struRegion;     // ÇøÓò·¶Î§
			public ushort wDuration;      // ´¥·¢ÎïÆ·ÄÃÈ¡±¨¾¯ãĞÖµ10-100Ãë
			public byte bySensitivity;  // ÁéÃô¶È²ÎÊı£¬·¶Î§[1,5] 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;       // ±£Áô×Ö½Ú
		}
		...
		public struct NET_VCA_OVER_TIME {
			public NET_VCA_POLYGON struRegion;    // ÇøÓò·¶Î§
			public ushort wDuration;  // ²Ù×÷±¨¾¯Ê±¼äãĞÖµ 4s-60000s
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;   // ±£Áô×Ö½Ú
		}
		...
		public struct NET_VCA_STICK_UP {
			public NET_VCA_POLYGON struRegion;//ÇøÓò·¶Î§
			public ushort wDuration;//±¨¾¯³ÖĞøÊ±¼ä£º10-60Ãë£¬½¨Òé10Ãë
			public byte bySensitivity;//ÁéÃô¶È²ÎÊı£¬·¶Î§[1,5]
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_SCANNER {
			public NET_VCA_POLYGON struRegion;//ÇøÓò·¶Î§
			public ushort wDuration;//¶Á¿¨³ÖĞøÊ±¼ä£º10-60Ãë
			public byte bySensitivity;//ÁéÃô¶È²ÎÊı£¬·¶Î§[1,5]
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_LEAVE_POSITION {
			public NET_VCA_POLYGON struRegion; //ÇøÓò·¶Î§
			public ushort wLeaveDelay;  //ÎŞÈË±¨¾¯Ê±¼ä£¬µ¥Î»£ºs£¬È¡Öµ1-1800
			public ushort wStaticDelay; //Ë¯¾õ±¨¾¯Ê±¼ä£¬µ¥Î»£ºs£¬È¡Öµ1-1800
			public byte byMode;       //Ä£Ê½£¬0-Àë¸ÚÊÂ¼ş£¬1-Ë¯¸ÚÊÂ¼ş£¬2-Àë¸ÚË¯¸ÚÊÂ¼ş
			public byte byPersonType; //Öµ¸ÚÈËÊıÀàĞÍ£¬0-µ¥ÈËÖµ¸Ú£¬1-Ë«ÈËÖµ¸Ú
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;     //±£Áô
		}
		...
		public struct NET_VCA_FALL_DOWN {
			public NET_VCA_POLYGON struRegion;//ÇøÓò·¶Î§
			public ushort wDuration;      /* ´¥·¢ÊÂ¼şãĞÖµ 1-60s*/
			public byte bySensitivity;       /* ÁéÃô¶È²ÎÊı£¬·¶Î§[1,5] */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_AUDIO_ABNORMAL {
			...
			public byte bySensitivity;  //ÁéÃô¶È²ÎÊı£¬·¶Î§[1,5] 
			public byte byAudioMode;    //ÉùÒô¼ì²âÄ£Ê½£¬0-ÁéÃô¶È¼ì²â£¬1-·Ö±´ãĞÖµ¼ì²â£¬2-ÁéÃô¶ÈÓë·Ö±´ãĞÖµ¼ì²â 
			public byte byEnable;       //Ê¹ÄÜ£¬ÊÇ·ñ¿ªÆô
			public byte byThreshold;    //ÉùÒôãĞÖµ[0,100]
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 54, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;      //±£Áô   
		}
		...
		public struct NET_DVR_AUDIO_EXCEPTION {
			...
			public uint dwMaxRelRecordChanNum;  //±¨¾¯´¥·¢µÄÂ¼ÏóÍ¨µÀ Êı£¨Ö»¶Á£©×î´óÖ§³ÖÊıÁ¿
			public uint dwRelRecordChanNum;     //±¨¾¯´¥·¢µÄÂ¼ÏóÍ¨µÀ Êı Êµ¼ÊÖ§³ÖµÄÊıÁ¿
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.U4)]
		...
		public struct NET_VCA_TOILET_TARRY {
			public NET_VCA_POLYGON struRegion;//ÇøÓò·¶Î§
			public ushort wDelay;        //Èç²Ş³¬Ê±Ê±¼ä[1,3600]£¬µ¥Î»£ºÃë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_EVENT_UNION {
			[FieldOffsetAttribute(0)]
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 23, ArraySubType = UnmanagedType.U4)]
			public uint[] uLen;//²ÎÊı

			//[FieldOffsetAttribute(0)]
			//public NET_VCA_TRAVERSE_PLANE struTraversePlane;//´©Ô½¾¯½äÃæ²ÎÊı 
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_AREA struArea;//½øÈë/Àë¿ªÇøÓò²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_INTRUSION struIntrusion;//ÈëÇÖ²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_LOITER struLoiter;//ÅÇ»²²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_TAKE_LEFT struTakeTeft;//¶ª°ü/¼ñ°ü²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_PARKING struParking;//Í£³µ²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_RUN struRun;//±¼ÅÜ²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_HIGH_DENSITY struHighDensity;//ÈËÔ±¾Û¼¯²ÎÊı  
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_VIOLENT_MOTION struViolentMotion;	//¾çÁÒÔË¶¯
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_REACH_HIGHT struReachHight;      //ÅÊ¸ß
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_GET_UP struGetUp;           //Æğ´²
			//[FieldOffsetAttribute(0)]
			...
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_SCANNER struScanner;//¶Á¿¨Æ÷²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_LEAVE_POSITION struLeavePos;        //Àë¸Ú²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_TRAIL struTrail;           //Î²Ëæ²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_FALL_DOWN struFallDown;        //µ¹µØ²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_AUDIO_ABNORMAL struAudioAbnormal;   //ÉùÇ¿Í»±ä
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_ADV_REACH_HEIGHT struReachHeight;     //ÕÛÏßÅÊ¸ß²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_TOILET_TARRY struToiletTarry;     //Èç²Ş³¬Ê±²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_YARD_TARRY struYardTarry;       //·Å·ç³¡ÖÍÁô²ÎÊı
			//[FieldOffsetAttribute(0)]
			//public NET_VCA_ADV_TRAVERSE_PLANE struAdvTraversePlane;//ÕÛÏß¾¯½äÃæ²ÎÊı            
		}

		// ³ß´ç¹ıÂËÆ÷ÀàĞÍ
		public enum SIZE_FILTER_MODE {
			IMAGE_PIX_MODE,//¸ù¾İÏñËØ´óĞ¡ÉèÖÃ
			REAL_WORLD_MODE,//¸ù¾İÊµ¼Ê´óĞ¡ÉèÖÃ
		...
		public struct NET_VCA_SIZE_FILTER {
			public byte byActive;//ÊÇ·ñ¼¤»î³ß´ç¹ıÂËÆ÷ 0-·ñ ·Ç0-ÊÇ
			public byte byMode;//¹ıÂËÆ÷Ä£Ê½SIZE_FILTER_MODE
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;//±£Áô£¬ÖÃ0
			public NET_VCA_RECT struMiniRect;//×îĞ¡Ä¿±ê¿ò,È«0±íÊ¾²»ÉèÖÃ
		...
		public struct NET_VCA_ONE_RULE {
			...
			public VCA_EVENT_TYPE dwEventType;//ĞĞÎª·ÖÎöÊÂ¼şÀàĞÍ
			public NET_VCA_EVENT_UNION uEventParam;//ĞĞÎª·ÖÎöÊÂ¼ş²ÎÊı
			public NET_VCA_SIZE_FILTER struSizeFilter;//³ß´ç¹ıÂËÆ÷
		...
		public struct NET_VCA_RULECFG {
			...
			public NET_VCA_ONE_RULE[] struRule;//¹æÔòÊı×é
		}

		//³ß´ç¹ıÂË²ßÂÔ
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_VCA_FILTER_STRATEGY {
			public byte byStrategy;      //³ß´ç¹ıÂË²ßÂÔ 0 - ²»ÆôÓÃ 1-¸ß¶ÈºÍ¿í¶È¹ıÂË,2-Ãæ»ı¹ıÂË
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 11, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;       //±£Áô
		}
		...
		public struct NET_VCA_RULE_TRIGGER_PARAM {
			public byte byTriggerMode;   //¹æÔòµÄ´¥·¢·½Ê½£¬0- ²»ÆôÓÃ£¬1- ¹ì¼£µã 2- Ä¿±êÃæ»ı 
			public byte byTriggerPoint;  //´¥·¢µã£¬´¥·¢·½Ê½Îª¹ì¼£µãÊ±ÓĞĞ§ 0- ÖĞ,1-ÉÏ,2-ÏÂ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;       //±£Áô
			public float fTriggerArea;    //´¥·¢Ä¿±êÃæ»ı°Ù·Ö±È [0,100]£¬´¥·¢·½Ê½ÎªÄ¿±êÃæ»ıÊ±ÓĞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;       //±£Áô
		}
		...
		public struct NET_VCA_ONE_RULE_V41 {
			...
			public ushort wEventTypeEx; //ĞĞÎªÊÂ¼şÀàĞÍÀ©Õ¹£¬ÓÃÓÚ´úÌæ×Ö¶ÎdwEventType£¬²Î¿¼VCA_RULE_EVENT_TYPE_EX
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byRuleName; //¹æÔòÃû³Æ
			public VCA_EVENT_TYPE dwEventType;  //ĞĞÎªÊÂ¼şÀàĞÍ£¬±£ÁôÊÇÎªÁË¼æÈİ£¬ºóĞø½¨ÒéÊ¹ÓÃwEventTypeEx»ñÈ¡ÊÂ¼şÀàĞÍ
			public NET_VCA_EVENT_UNION uEventParam; //ĞĞÎª·ÖÎöÊÂ¼ş²ÎÊı
			public NET_VCA_SIZE_FILTER struSizeFilter;  //³ß´ç¹ıÂËÆ÷
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_SCHEDTIME[] struAlarmTime;//²¼·ÀÊ±¼ä
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2; //±£Áô
			public NET_VCA_FILTER_STRATEGY struFilterStrategy; //³ß´ç¹ıÂË²ßÂÔ
			public NET_VCA_RULE_TRIGGER_PARAM struTriggerParam;   //¹æÔò´¥·¢²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_RULECFG_V41 {
			...
			public NET_DVR_JPEGPARA struPictureParam;       //Í¼Æ¬¹æ¸ñ½á¹¹	
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_RULE_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_VCA_ONE_RULE_V41[] struRule;  //¹æÔòÊı×é
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_TARGET_INFO {
			public uint dwID;//Ä¿±êID ,ÈËÔ±ÃÜ¶È¹ı¸ß±¨¾¯Ê±Îª0
			public NET_VCA_RECT struRect; //Ä¿±ê±ß½ç¿ò 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;//±£Áô
		}

		//¼ò»¯µÄ¹æÔòĞÅÏ¢, °üº¬¹æÔòµÄ»ù±¾ĞÅÏ¢
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_VCA_RULE_INFO {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byRuleName;//¹æÔòÃû³Æ
			public VCA_EVENT_TYPE dwEventType;//¾¯½äÊÂ¼şÀàĞÍ
			public NET_VCA_EVENT_UNION uEventParam;//ÊÂ¼ş²ÎÊı
		}

		//Ç°¶ËÉè±¸µØÖ·ĞÅÏ¢£¬ÖÇÄÜ·ÖÎöÒÇ±íÊ¾µÄÊÇÇ°¶ËÉè±¸µÄµØÖ·ĞÅÏ¢£¬ÆäËûÉè±¸±íÊ¾±¾»úµÄµØÖ·
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		public struct NET_VCA_RULE_ALARM {
			...
			public NET_VCA_RULE_INFO struRuleInfo;//ÊÂ¼ş¹æÔòĞÅÏ¢
			public NET_VCA_TARGET_INFO struTargetInfo;//±¨¾¯Ä¿±êĞÅÏ¢
			public NET_VCA_DEV_INFO struDevInfo;//Ç°¶ËÉè±¸ĞÅÏ¢
			public uint dwPicDataLen;//·µ»ØÍ¼Æ¬µÄ³¤¶È Îª0±íÊ¾Ã»ÓĞÍ¼Æ¬£¬´óÓÚ0±íÊ¾¸Ã½á¹¹ºóÃæ½ô¸úÍ¼Æ¬Êı¾İ*/
		...
		//ĞĞÎª·ÖÎö¹æÔòDSPĞÅÏ¢µş¼Ó½á¹¹
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_VCA_DRAW_MODE {
			public uint dwSize;
			public byte byDspAddTarget;//±àÂëÊÇ·ñµş¼ÓÄ¿±ê
			public byte byDspAddRule;//±àÂëÊÇ·ñµş¼Ó¹æÔò
			public byte byDspPicAddTarget;//×¥Í¼ÊÇ·ñµş¼ÓÄ¿±ê
			public byte byDspPicAddRule;//×¥Í¼ÊÇ·ñµş¼Ó¹æÔò
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_OBJECT_COLOR_COND {
			public uint dwChannel;   //Í¨µÀºÅ
			public uint dwObjType;   //ÎïÌåÀàĞÍ£¬²Î¼ûOBJECT_TYPE_ENUM
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;   //±£Áô
		}
		...
		public struct NET_DVR_PIC {
			public byte byPicType;        //Í¼Æ¬ÀàĞÍ£¬1-jpg
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;        //±£Áô
			public uint dwPicWidth;       //Í¼Æ¬¿í¶È
			public uint dwPicHeight;      //Í¼Æ¬¸ß¶È
			public uint dwPicDataLen;     //Í¼Æ¬Êı¾İÊµ¼Ê´óĞ¡
			public uint dwPicDataBuffLen; //Í¼Æ¬Êı¾İ»º³åÇø´óĞ¡
			public IntPtr byPicDataBuff;    //Í¼Æ¬Êı¾İ»º³åÇø
		...
		public struct NET_DVR_AUXAREA {
			public uint dwAreaType;   //ÇøÓòÀàĞÍ£¬²Î¼ûAREA_TYPE_ENUM
			public byte byEnable;     //0-²»ÆôÓÃ£¬1-ÆôÓÃ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;     //±£Áô
		...
		public struct NET_DVR_SLAVE_CHANNEL_UNION {
			[FieldOffsetAttribute(0)]
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 152, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;        //ÁªºÏÌå´óĞ¡
		}

		//´ÓÍ¨µÀ²ÎÊı½á¹¹Ìå
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_SLAVE_CHANNEL_PARAM {
			public byte byChanType;   //´ÓÍ¨µÀÀàĞÍ£¬1-±¾»úÍ¨µÀ£¬2-Ô¶³ÌÍ¨µÀ 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;    //±£Áô
		...
		public struct NET_DVR_SLAVE_CHANNEL_CFG {
			...
			public NET_DVR_SLAVE_CHANNEL_PARAM[] struChanParam;//´ÓÍ¨µÀ²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;  //±£Áô
		}

		//ÊÓÆµÖÊÁ¿Õï¶Ï¼ì²âÊÂ¼ş
		public enum VQD_EVENT_ENUM {
			ENUM_VQD_EVENT_BLUR = 1,  //Í¼ÏñÄ£ºı
			...
			ENUM_VQD_EVENT_SIGNAL_LOSS = 7,  //ĞÅºÅ¶ªÊ§
		...
		//ÊÓÆµÖÊÁ¿Õï¶ÏÊÂ¼şÌõ¼ş½á¹¹Ìå
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_VQD_EVENT_COND {
			public uint dwChannel;   //Í¨µÀºÅ
			public uint dwEventType; //¼ì²âÊÂ¼şÀàĞÍ£¬²Î¼ûVQD_EVENT_ENUM
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;   //±£Áô
		}

		//ÊÓÆµÖÊÁ¿Õï¶ÏÊÂ¼ş²ÎÊı
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_VQD_EVENT_PARAM {
			public byte byThreshold;    //±¨¾¯ãĞÖµ£¬·¶Î§[0,100]
			public byte byTriggerMode;  //1-³ÖĞø´¥·¢£¬2-µ¥´Î´¥·¢
			public byte byUploadPic;    //0-²»ÉÏ´«Í¼Æ¬£¬1-ÉÏ´«Í¼Æ¬£¬ÎŞÂÛÊÇ·ñÉÏ´«Í¼Æ¬£¬ÊÂºó¶¼¿ÉÒÔ´ÓÉè±¸»ñÈ¡¸ÃÊÂ¼şËù¶ÔÓ¦×îĞÂµÄÒ»ÕÅ±¨¾¯Í¼Æ¬£¬²Î¼û½Ó¿ÚNET_DVR_StartDownload
			public byte byRes1;         //±£Áô
			public uint dwTimeInterval; //³ÖĞø´¥·¢±¨¾¯Ê±¼ä¼ä¸ô£¬·¶Î§[0,3600] µ¥Î»£ºÃë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;     //±£Áô
		}

		//ÊÓÆµÖÊÁ¿Õï¶ÏÊÂ¼ş¹æÔò
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_VQD_EVENT_RULE {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;    //±£Áô
			public NET_DVR_VQD_EVENT_PARAM struEventParam; //ÊÓÆµÖÊÁ¿Õï¶ÏÊÂ¼ş²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
		...
		public struct NET_DVR_CONTROL_BASELINE_SCENE_PARAM {
			public uint dwSize;     //½á¹¹Ìå´óĞ¡
			public uint dwChannel;  //Í¨µÀºÅ
			public byte byCommand;  //²Ù×÷ÀàĞÍ£¬1-´Ë×Ö¶Î±£Áô£¬Ôİ²»Ê¹ÓÃ£¬2-¸üĞÂ»ù×¼³¡¾°
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 127, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;  //±£Áô
		}
		...
		public struct NET_DVR_VQD_ALARM {
			...
			public uint dwAbsTime;            //¾ø¶ÔÊ±±ê
			public NET_VCA_DEV_INFO struDevInfo; //Ç°¶ËÉè±¸ĞÅÏ¢ 
			public uint dwEventType;           //ÊÂ¼şÀàĞÍ£¬²Î¿¼VQD_EVENT_ENUM
			public float fThreshold;            //±¨¾¯ãĞÖµ[0.000,1.000]
			public uint dwPicDataLen;          //Í¼Æ¬³¤¶È£¬Îª0±íÊ¾Ã»ÓĞÍ¼Æ¬
			public IntPtr pImage;               //Ö¸ÏòÍ¼Æ¬µÄÖ¸Õë 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;            //±£Áô
		}
		...
		public struct NET_DVR_TRACK_CALIBRATION_PARAM {
			public byte byPointNum;         //ÓĞĞ§±ê¶¨µã¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		...
		public struct NET_IVMS_RULECFG {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_RULE_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_IVMS_ONE_RULE[] struRule; //¹æÔòÊı×é
		}
		...
		public struct NET_IVMS_DEVSCHED {
			public NET_DVR_SCHEDTIME struTime;//Ê±¼ä²ÎÊı
			public NET_DVR_PU_STREAM_CFG struPUStream;//Ç°¶ËÈ¡Á÷²ÎÊı
		}

		//ÖÇÄÜ·ÖÎöÒÇ²ÎÊıÅäÖÃ½á¹¹
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_IVMS_STREAMCFG {
			public uint dwSize;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT, ArraySubType = UnmanagedType.Struct)]
			public NET_IVMS_DEVSCHED[] struDevSched;//°´Ê±¼ä¶ÎÅäÖÃÇ°¶ËÈ¡Á÷ÒÔ¼°¹æÔòĞÅÏ¢
		}
		...
		public struct NET_VCA_MASK_REGION {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;//±£Áô£¬ÖÃ0
			public NET_VCA_POLYGON struPolygon;//ÆÁ±Î¶à±ßĞÎ
		}
		...
		public struct NET_VCA_MASK_REGION_LIST {
			...
			public NET_VCA_MASK_REGION[] struMask;//ÆÁ±ÎÇøÓòÊı×é
		}
		...
		public struct NET_IVMS_SEARCHCFG {
			...
			public NET_IVMS_RULECFG struRuleCfg;//IVMS ĞĞÎª¹æÔòÅäÖÃ
		}
		...
		public enum MAIN_EVENT_TYPE {
			...
			EVENT_VCA_BEHAVIOR = 2,//ĞĞÎª·ÖÎö
			EVENT_INQUEST = 3,       //ÉóÑ¶ÊÂ¼ş
			EVENT_VCA_DETECTION = 4, //ÖÇÄÜÕì²â
			EVENT_STREAM_INFO = 100  //Á÷IDĞÅÏ¢
		}

		public const int INQUEST_START_INFO = 0x1001;      /*Ñ¶ÎÊ¿ªÊ¼ĞÅÏ¢*/
		public const int INQUEST_STOP_INFO = 0x1002;       /*Ñ¶ÎÊÍ£Ö¹ĞÅÏ¢*/
		public const int INQUEST_TAG_INFO = 0x1003;       /*ÖØµã±ê¼ÇĞÅÏ¢*/
		public const int INQUEST_SEGMENT_INFO = 0x1004;      /*ÉóÑ¶Æ¬¶Ï×´Ì¬ĞÅÏ¢*/
		...
		public enum VCA_DETECTION_MINOR_TYPE: uint {
			...
			EVENT_VIRTUAL_FOCUS_ALARM, /*Ğé½¹Õì²â*/
			EVENT_SCENE_CHANGE_ALARM, /*³¡¾°±ä¸üÕì²â*/
			EVENT_ALL = 0xffffffff              //±íÊ¾È«²¿
		}

		//ĞĞÎª·ÖÎöÖ÷ÀàĞÍ¶ÔÓ¦µÄ´ËÀàĞÍ£¬ 0xffff±íÊ¾È«²¿
		...
		//ÊÂ¼şËÑË÷Ìõ¼ş 200-04-07 9000_1.1
		...
		public struct EVENT_ALARM_BYBIT {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ALARMIN_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byAlarmInNo;//±¨¾¯ÊäÈëºÅ£¬byAlarmInNo[0]ÈôÖÃ1Ôò±íÊ¾²éÕÒÓÉ±¨¾¯ÊäÈë1´¥·¢µÄÊÂ¼ş
		...
		public struct EVENT_ALARM_BYVALUE {
			...
			public ushort[] wAlarmInNo;//±¨¾¯ÊäÈëºÅ£¬byAlarmInNo[0]ÈôÖÃ1Ôò±íÊ¾²éÕÒÓÉ±¨¾¯ÊäÈë1´¥·¢µÄÊÂ¼ş
		...
		public struct EVENT_MOTION_BYBIT {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byMotDetChanNo;//ÒÆ¶¯Õì²âÍ¨µÀ£¬byMotDetChanNo[0]ÈôÖÃ1Ôò±íÊ¾²éÕÒÓÉÍ¨µÀ1·¢ÉúÒÆ¶¯Õì²â´¥·¢µÄÊÂ¼ş
		...
		public struct EVENT_MOTION_BYVALUE {
			...
			public ushort[] wMotDetChanNo;//±¨¾¯ÊäÈëºÅ£¬byAlarmInNo[0]ÈôÖÃ1Ôò±íÊ¾²éÕÒÓÉ±¨¾¯ÊäÈë1´¥·¢µÄÊÂ¼ş
		...
		public struct EVENT_VCA_BYBIT {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byChanNo;//´¥·¢ÊÂ¼şµÄÍ¨µÀ
		...
		public struct EVENT_VCA_BYVALUE {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.U2)]
			public ushort[] wChanNo;    //´¥·¢ÊÂ¼şµÄÍ¨µÀ			
			public byte byRuleID;      //ĞĞÎª·ÖÎöÀàĞÍ£¬¹æÔò0xff±íÊ¾È«²¿£¬´Ó0¿ªÊ¼
		...
		public struct EVENT_VCADETECT_BYBIT {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 256, ArraySubType = UnmanagedType.I1)]
			public byte[] byChan;//´¥·¢ÖÇÄÜÕì²âµÄÍ¨µÀºÅ£¬°´Êı×éÏÂ±ê±íÊ¾£¬byChan[0]ÈôÖÃ1Ôò±íÊ¾²éÕÒÓÉÍ¨µÀ1·¢ÉúÒÆ¶¯Õì²â´¥·¢µÄÊÂ¼ş 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 44, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;     //±£Áô
			public void init()
			{
		...
		public struct EVENT_VCADETECT_BYVALUE {
			...
			public uint[] dwChanNo;// ´¥·¢Í¨µÀºÅ,°´Öµ±íÊ¾£¬0xffffffffÎŞĞ§£¬ÇÒºóĞøÊı¾İÒ²±íÊ¾ÎŞĞ§Öµ
		...
		public struct EVENT_STREAMID_PARAM {
			public NET_DVR_STREAM_INFO struIDInfo; // Á÷idĞÅÏ¢£¬72×Ö½Ú³¤
			public uint dwCmdType;  // Íâ²¿´¥·¢ÀàĞÍ£¬NVR½ÓÈëÔÆ´æ´¢Ê¹ÓÃ
		...
		public struct NET_DVR_SEARCH_EVENT_PARAM {
			public ushort wMajorType;//0-ÒÆ¶¯Õì²â£¬1-±¨¾¯ÊäÈë, 2-ÖÇÄÜÊÂ¼ş
			public ushort wMinorType;//ËÑË÷´ÎÀàĞÍ- ¸ù¾İÖ÷ÀàĞÍ±ä»¯£¬0xffff±íÊ¾È«²¿
			public NET_DVR_TIME struStartTime;//ËÑË÷µÄ¿ªÊ¼Ê±¼ä£¬Í£Ö¹Ê±¼ä: Í¬Ê±Îª(0, 0) ±íÊ¾´Ó×îÔçµÄÊ±¼ä¿ªÊ¼£¬µ½×îºó£¬×îÇ°ÃæµÄ4000¸öÊÂ¼ş
		...
		public struct EVENT_VCA_RET {
			public uint dwChanNo;//´¥·¢ÊÂ¼şµÄÍ¨µÀºÅ
			public byte byRuleID;//¹æÔòID
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;//±£Áô
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byRuleName;//¹æÔòÃû³Æ
			public NET_VCA_EVENT_UNION uEvent;//ĞĞÎªÊÂ¼ş²ÎÊı£¬wMinorType = VCA_EVENT_TYPE¾ö¶¨ÊÂ¼şÀàĞÍ
		...
		public struct EVENT_INQUEST_RET {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;  //±£Áô            
			public uint dwSegmentNo;     //±¾Æ¬¶ÏÔÚ±¾´ÎÉóÑ¶ÖĞµÄĞòºÅ,´Ó1¿ªÊ¼ 
			public ushort wSegmetSize;     //±¾Æ¬¶ÏµÄ´óĞ¡, µ¥Î»M 
			public ushort wSegmentState;   //±¾Æ¬¶Ï×´Ì¬ 0 ¿ÌÂ¼Õı³££¬1 ¿ÌÂ¼Òì³££¬2 ²»¿ÌÂ¼ÉóÑ¶
		...
		public struct EVENT_STREAMID_RET {
			public uint dwRecordType;   //Â¼ÏñÀàĞÍ 0-¶¨Ê±Â¼Ïñ 1-ÒÆ¶¯Õì²â 2-±¨¾¯Â¼Ïñ 3-±¨¾¯|ÒÆ¶¯Õì²â 4-±¨¾¯&ÒÆ¶¯Õì²â 5-ÃüÁî´¥·¢ 6-ÊÖ¶¯Â¼Ïñ 7-Õğ¶¯±¨¾¯ 8-»·¾³´¥·¢ 9-ÖÇÄÜ±¨¾¯ 10-»Ø´«Â¼Ïñ
			public uint dwRecordLength; //Â¼Ïñ´óĞ¡
			public byte byLockFlag;    // Ëø¶¨±êÖ¾ 0£ºÃ»Ëø¶¨ 1£ºËø¶¨
			public byte byDrawFrameType;    // 0£º·Ç³éÖ¡Â¼Ïñ 1£º³éÖ¡Â¼Ïñ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byFileName;   //ÎÄ¼şÃû
			public uint dwFileIndex;            // ´æµµ¾íÉÏµÄÎÄ¼şË÷Òı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 256, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		...
		public enum tagCALIBRATE_TYPE {
			...
			BEHAVIOR_OUT_CALIBRATE = 0x02, //ĞĞÎªÊÒÍâ³¡¾°±ê¶¨  
			BEHAVIOR_IN_CALIBRATE = 0x03,    // ĞĞÎªÊÒÄÚ³¡¾°±ê¶¨ 
			ITS_CALBIRETE = 0x04      //  ½»Í¨ÊÂ¼ş±ê¶¨
		}

		public const int MAX_RECT_NUM = 6;
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_RECT_LIST {
			public byte byRectNum;    // ¾ØĞÎ¿òµÄ¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 11, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;  //±£Áô×Ö½Ú 
		...
		public struct NET_DVR_PDC_CALIBRATION {
			public NET_DVR_RECT_LIST struRectList;       // ±ê¶¨¾ØĞÎ¿òÁĞ±í
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 120, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;       // ±£Áô×Ö½Ú 
		}

		// ±ê¶¨ÏßµÄÊôĞÔÀà±ğ£¬ÓÃÀ´±íÊ¾µ±Ç°±ê¶¨ÏßÔÚÊµ¼Ê±íÊ¾µÄÊÇ¸ß¶ÈÏß»¹ÊÇ³¤¶ÈÏß¡£
		public enum LINE_MODE {
			HEIGHT_LINE,        //¸ß¶ÈÑù±¾Ïß
			LENGTH_LINE        //³¤¶ÈÑù±¾Ïß
		}
		/*ÔÚÉèÖÃ±ê¶¨ĞÅÏ¢µÄÊ±ºò£¬Èç¹ûÏàÓ¦Î»ÉèÖÃÁËÊ¹ÄÜ£¬²¢ÉèÖÃÏà¹Ø²ÎÊı£¬ÈôÃ»ÓĞÉèÖÃÊ¹ÄÜ£¬Ôò±ê¶¨ºó¿ÉÒÔ»ñÈ¡Ïà¹ØµÄÉãÏñ»ú²ÎÊı*/
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_CAMERA_PARAM {
			...
			public float fHorizon;         // ³¡¾°ÖĞµÄµØÆ½Ïß
		}

		/*µ±fValue±íÊ¾Ä¿±ê¸ß¶ÈµÄÊ±ºò£¬struStartPointºÍstruEndPoint·Ö±ğ±íÊ¾Ä¿±êÍ·²¿µãºÍ½Å²¿µã¡£
         * µ±fValue±íÊ¾Ïß¶Î³¤¶ÈµÄÊ±ºò£¬struStartPointºÍstruEndPoint·Ö±ğ±íÊ¾Ïß¶ÎÆğÊ¼µãºÍÖÕµã£¬
		...
		/*±ê¶¨Ñù±¾ÏßÄ¿Ç°ĞèÒª4-8µ÷Ñù±¾Ïß£¬ÒÔ»ñÈ¡ÉãÏñ»úÏà¹Ø²ÎÊı*/
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_BEHAVIOR_OUT_CALIBRATION {
			public uint dwLineSegNum;          // Ñù±¾Ïß¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_LINE_SEG_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_LINE_SEGMENT[] struLineSegment;    // Ñù±¾Ïß×î´ó¸öÊı
			public NET_DVR_CAMERA_PARAM struCameraParam;    // ÉãÏñ»ú²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}

		/*¸Ã½á¹¹Ìå±íÊ¾IASÖÇÄÜ¿â±ê¶¨Ñù±¾£¬ÆäÖĞ°üÀ¨Ò»¸öÄ¿±ê¿òºÍÒ»Ìõ¶ÔÓ¦µÄ¸ß¶È±ê¶¨Ïß£»
         * Ä¿±ê¿òÎªÕ¾Á¢µÄÈËÌåÍâ½Ó¾ØĞÎ¿ò£»¸ß¶ÈÏßÑù±¾±êÊ¶´ÓÈËÍ·¶¥µãµ½½ÅµãµÄ±ê¶¨Ïß£»ÓÃ¹éÒ»»¯×ø±ê±íÊ¾£»*/
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		// ±ê¶¨²ÎÊıÁªºÏÌå
		// ºóĞøµÄÏà¹Ø±ê¶¨²ÎÊı¿ÉÒÔ·ÅÔÚ¸Ã½á¹¹ÀïÃæ
		[StructLayoutAttribute(LayoutKind.Explicit)]
		public struct NET_DVR_CALIBRATION_PRARM_UNION {
			[FieldOffsetAttribute(0)]
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 240, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;  //ÁªºÏÌå½á¹¹´óĞ¡
								  /*[FieldOffsetAttribute(0)]
								  public NET_DVR_PDC_CALIBRATION struPDCCalibration;  //PDC ±ê¶¨²ÎÊı
								  [FieldOffsetAttribute(0)]
								  public NET_DVR_BEHAVIOR_OUT_CALIBRATION  struBehaviorOutCalibration;  //  ĞĞÎªÊÒÍâ³¡¾°±ê¶¨  Ö÷ÒªÓ¦ÓÃÓÚIVSµÈ
								  [FieldOffsetAttribute(0)]
								  public NET_DVR_BEHAVIOR_IN_CALIBRATION  struBehaviorInCalibration;     // ĞĞÎªÊÒÄÚ³¡¾°±ê¶¨£¬Ö÷ÒªÓ¦ÓÃIASµÈ 
								  [FieldOffsetAttribute(0)]
		...
		public struct NET_DVR_CALIBRATION_CFG {
			public uint dwSize;               //±ê¶¨½á¹¹´óĞ¡
			public byte byEnable;           // ÊÇ·ñÆôÓÃ±ê¶¨
			public byte byCalibrationType;    // ±ê¶¨ÀàĞÍ ¸ù¾İ²»Í¬ÀàĞÍÔÚÁªºÏÌåÀàÑ¡Ôñ²»Í¬µÄ±ê¶¨ ²Î¿¼CALIBRATE_TYPE
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public NET_DVR_CALIBRATION_PRARM_UNION uCalibrateParam;  // ±ê¶¨²ÎÊıÁªºÏÌå
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_PDC_ENTER_DIRECTION {
			public NET_VCA_POINT struStartPoint; //Á÷Á¿Í³¼Æ·½ÏòÆğÊ¼µã
		...
		public struct NET_DVR_PDC_RULE_CFG {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 23, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;       // ±£Áô×Ö½Ú 
			public NET_VCA_POLYGON struPolygon;            // ¶à±ßĞÎ
		...
		public struct NET_DVR_PDC_RULE_CFG_V41 {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_SCHEDTIME struAlarmTime;//²¼·ÀÊ±¼ä
			public NET_DVR_TIME_EX struDayStartTime; //°×Ìì¿ªÊ¼Ê±¼ä£¬Ê±·ÖÃëÓĞĞ§
			public NET_DVR_TIME_EX struNightStartTime; //Ò¹Íí¿ªÊ¼Ê±¼ä£¬Ê±·ÖÃëÓĞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 100, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;       // ±£Áô×Ö½Ú
		}
		...
		public struct NET_DVR_TRIAL_VERSION_CFG {
			public uint dwSize;
			public ushort wReserveTime; //ÊÔÓÃÆÚÊ£ÓàÊ±¼ä£¬0xffff±íÊ¾ÎŞĞ§£¬µ¥Î»£ºÌì
		...
		public struct NET_DVR_RESET_COUNTER_CFG {
			...
			public byte[] byRes1;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_TIME_EX[] struTime;//Êı¾İÇåÁãÊ±¼ä£¬Ê±·ÖÃëÓĞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_VCA_CTRLINFO_CFG {
			...
			public byte byVCAType;       //ÖÇÄÜÄÜÁ¦ÀàĞÍ£¬VCA_CHAN_ABILITY_TYPE 
			public byte byStreamWithVCA; //ÂëÁ÷ÖĞÊÇ·ñ´øÖÇÄÜĞÅÏ¢
			public byte byMode;         //Ä£Ê½£¬ATM ÄÜÁ¦Ê±²ÎÕÕVCA_CHAN_MODE_TYPE ,TFS ÄÜÁ¦Ê±²ÎÕÕ TFS_CHAN_MODE_TYPE£¬ĞĞÎª·ÖÎöÍêÕû°æÊ±²ÎÕÕBEHAVIOR_SCENE_MODE_TYPE
			public byte byControlType;   //¿ØÖÆÀàĞÍ£¬°´Î»±íÊ¾£¬0-·ñ£¬1-ÊÇ
										 //byControlType &1 ÊÇ·ñÆôÓÃ×¥ÅÄ¹¦ÄÜ
		...
		/*ÉèÖÃÈËÁ÷Á¿Í³¼Æ²ÎÊı  ¸´ÓÃĞĞÎªÄÚ²¿¹Ø¼ü×Ö²ÎÊı
         * HUMAN_GENERATE_RATE
         * Ä¿±êÉú³ÉËÙ¶È²ÎÊı£¬¿ØÖÆPDC¿âÉú³ÉÄ¿±êµÄËÙ¶È¡£ËÙ¶ÈÔ½¿ì£¬Ä¿±êÔ½ÈİÒ×Éú³É¡£
         * µ±ÊäÈëÊÓÆµ¹âÕÕÌõ¼ş½Ï²î£¬¶Ô±È¶È½ÏµÍÊ±£¬»òÕßÉèÖÃµÄ¹æÔòÇøÓò½ÏĞ¡Ê±£¬Ó¦¼Ó¿ìÄ¿±êÉú³ÉËÙ¶È£¬ ±ÜÃâÄ¿±êµÄÂ©¼ì£»
         * µ±ÊäÈëÊÓÆµÖĞ¶Ô±È¶È½Ï¸ßÊ±£¬»òÕß¹æÔòÇøÓò½Ï´óÊ±£¬Ó¦¸Ã½µµÍÄ¿±êÉú³ÉËÙ¶È£¬ÒÔ¼õÉÙÎó¼ì¡£
         * Ä¿±êÉú³ÉËÙ¶È²ÎÊı¹²ÓĞ5¼¶£¬1¼¶ËÙ¶È×îÂı£¬5¼¶×î¿ì£¬Ä¬ÈÏ²ÎÊıÎª3¡£
         *
         * DETECT_SENSITIVE
         * Ä¿±ê¼ì²âÁéÃô¶È¿ØÖÆ²ÎÊı£¬¿ØÖÆPDC¿âÖĞÒ»¸ö¾ØĞÎÇøÓò±»¼ì²âÎªÄ¿±êµÄÁéÃô¶È¡£
         * ÁéÃô¶ÈÔ½¸ß£¬¾ØĞÎÇøÓòÔ½ÈİÒ×±»¼ì²âÎªÄ¿±ê£¬ÁéÃô¶ÈÔ½µÍÔòÔ½ÄÑ¼ì²âÎªÄ¿±ê¡£
         * µ±ÊäÈëÊÓÆµ¹âÕÕÌõ¼ş½Ï²î£¬¶Ô±È¶È½ÏµÍÊ±£¬Ó¦Ìá¸ß¼ì²âÁéÃô¶È£¬ ±ÜÃâÄ¿±êµÄÂ©¼ì£»
         * µ±ÊäÈëÊÓÆµÖĞ¶Ô±È¶È½Ï¸ßÊ±£¬Ó¦¸Ã½µµÍ¼ì²âÁéÃô¶È£¬ÒÔ¼õÉÙÎó¼ì¡£
         * ¶ÔÓ¦²ÎÊı¹²ÓĞ5¼¶£¬¼¶±ğ1ÁéÃô¶È×îµÍ£¬5¼¶×î¸ß£¬Ä¬ÈÏ¼¶±ğÎª3¡£
         * 
         * TRAJECTORY_LEN
         * ¹ì¼£Éú³É³¤¶È¿ØÖÆ²ÎÊı£¬±íÊ¾Éú³É¹ì¼£Ê±ÒªÇóÄ¿±êµÄ×î´óÎ»ÒÆÏñËØ¡£
         * ¶ÔÓ¦²ÎÊı¹²ÓĞ5¼¶£¬¼¶±ğ1£¬Éú³É³¤¶È×î³¤£¬¹ì¼£Éú³É×îÂı£¬5¼¶Éú³É³¤¶È×î¶Ì£¬¹ì¼£Éú³É×î¿ì£¬Ä¬ÈÏ¼¶±ğÎª3¡£
         * 
         * TRAJECT_CNT_LEN
         * ¹ì¼£¼ÆÊı³¤¶È¿ØÖÆ²ÎÊı£¬±íÊ¾¹ì¼£¼ÆÊıÊ±ÒªÇóÄ¿±êµÄ×î´óÎ»ÒÆÏñËØ¡£
         * ¶ÔÓ¦²ÎÊı¹²ÓĞ5¼¶£¬¼¶±ğ1£¬¼ÆÊıÒªÇó³¤¶È×î³¤£¬¹ì¼£¼ÆÊı×îÂı£¬5¼¶¼ÆÊıÒªÇó³¤¶È×î¶Ì£¬¹ì¼£¼ÆÊı×î¿ì£¬Ä¬ÈÏ¼¶±ğÎª3¡£
         * 
         * PREPROCESS
         * Í¼ÏñÔ¤´¦Àí¿ØÖÆ²ÎÊı£¬0 - ²»´¦Àí£»1 - ´¦Àí¡£Ä¬ÈÏÎª0£»
         * 
         * CAMERA_ANGLE
         * ÉãÏñ»ú½Ç¶ÈÊäÈë²ÎÊı£¬ 0 - ÇãĞ±£» 1 - ´¹Ö±¡£Ä¬ÈÏÎª0£»
         */
		...
		public struct UNION_STATTIME {
			public NET_DVR_TIME tmStart; // Í³¼ÆÆğÊ¼Ê±¼ä 
		...
		public struct NET_DVR_PDC_ALRAM_INFO {
			public uint dwSize;           // PDCÈËÁ÷Á¿±¨¾¯ÉÏ´«½á¹¹Ìå´óĞ¡
			public byte byMode;            // 0 µ¥Ö¡Í³¼Æ½á¹û 1×îĞ¡Ê±¼ä¶ÎÍ³¼Æ½á¹û  
			public byte byChannel;           // ±¨¾¯ÉÏ´«Í¨µÀºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;         // ±£Áô×Ö½Ú   
			public NET_VCA_DEV_INFO struDevInfo;                //Ç°¶ËÉè±¸ĞÅÏ¢
			public UNION_PDCPARAM uStatModeParam;
			public uint dwLeaveNum;        // Àë¿ªÈËÊı
			public uint dwEnterNum;        // ½øÈëÈËÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;           // ±£Áô×Ö½Ú
		}
		...
		public struct NET_DVR_PTZ_POSITION {
			// ÊÇ·ñÆôÓÃ³¡¾°£¬ÔÚÉèÖÃ³¡¾°ĞĞÎª¹æÔòµÄÊ±ºò¸Ã×Ö¶ÎÎŞĞ§£¬ÔÚÉèÖÃÇò»ú±¾µØÅäÖÃ³¡¾°Î»ÖÃĞÅÏ¢Ê±×÷ÎªÊ¹ÄÜÎ»
			public byte byEnable;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;  //±£Áô
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_POSITION_RULE_CFG {
			public uint dwSize;             // ½á¹¹´óĞ¡ 
			public NET_DVR_PTZ_POSITION struPtzPosition;    // ³¡¾°Î»ÖÃĞÅÏ¢
			public NET_VCA_RULECFG struVcaRuleCfg;     //ĞĞÎª¹æÔòÅäÖÃ
		...
		public struct NET_DVR_POSITION_RULE_CFG_V41 {
			public uint dwSize;             // ½á¹¹´óĞ¡ 
			public NET_DVR_PTZ_POSITION struPtzPosition;    // ³¡¾°Î»ÖÃĞÅÏ¢
			public NET_VCA_RULECFG_V41 struVcaRuleCfg;     //ĞĞÎª¹æÔòÅäÖÃ
			public byte byTrackEnable; //ÊÇ·ñÆôÓÃ¸ú×Ù
			public byte byRes1;
			public ushort wTrackDuration; //¸ú×Ù³ÖĞøÊ±¼ä£¬µ¥Î»s
		...
		public struct NET_DVR_LIMIT_ANGLE {
			public byte byEnable;   // ÊÇ·ñÆôÓÃ³¡¾°ÏŞÎ»¹¦ÄÜ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public NET_DVR_PTZPOS struUp;     // ÉÏÏŞÎ»
			public NET_DVR_PTZPOS struDown;   // ÏÂÏŞÎ»
			public NET_DVR_PTZPOS struLeft;   // ×óÏŞÎ»
			public NET_DVR_PTZPOS struRight;  // ÓÒÏŞÎ»
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_TRACK_PARAMCFG {
			...
			public ushort wTrackHoldTime;     // ±¨¾¯¸ú×Ù³ÖĞøÊ±¼ä  ·¶Î§0-300Ãë
			public byte byTrackMode;        //  ²ÎÕÕ IPDOME_TRACK_MODE
			public byte byPreDirection; // ¸ú×Ù·½ÏòÔ¤ÅĞ 0-²»ÆôÓÃ 1-ÆôÓÃ
			public byte byTrackSmooth;      // ¸ú×ÙÁ¬Ğø  0-²»ÆôÓÃ 1-ÆôÓÃ
			public byte byZoomAdjust;   // ±¶ÂÊÏµÊıµ÷Õû ²Î¼ûÏÂ±í
			public byte byMaxTrackZoom; //×î´ó¸ú×Ù±¶ÂÊÏµÊı,0-±íÊ¾Ä¬ÈÏ±¶ÂÊÏµÊı,µÈ¼¶6-±ê¶¨Öµ*1.0(Ä¬ÈÏ),1-5ÎªËõĞ¡±ê¶¨Öµ£¬ÖµÔ½Ğ¡£¬ËõĞ¡µÄ±ÈÀıÔ½´ó,7-15Îª·Å´ó£¬ÖµÔ½´ó£¬·Å´óµÄ±ÈÀıÔ½´ó
			public byte byStopTrackWhenFindFace;  //ÈËÁ³¼ì²âµ½ºóÊÇ·ñÍ£Ö¹¸ú×Ù 0-·ñ 1-ÊÇ
			public byte byStopTrackThreshold;   //¸ú×ÙÖÕÖ¹ÆÀ·ÖãĞÖµ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 9, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;          //  ±£Áô×Ö½Ú                
		}
		...
		public struct NET_DVR_DOME_MOVEMENT_PARAM {
			public ushort wMaxZoom;   // Çò»ú×î´ó±¶ÂÊÏµÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 42, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;  // ±£Áô×Ö½Ú
		}

		/********************************ÖÇÄÜ½»Í¨ÊÂ¼ş begin****************************************/
		public const int MAX_REGION_NUM = 8;  // ÇøÓòÁĞ±í×î´óÊıÄ¿
		public const int MAX_TPS_RULE = 8;   // ×î´ó²ÎÊı¹æÔòÊıÄ¿
		public const int MAX_AID_RULE = 8;   // ×î´óÊÂ¼ş¹æÔòÊıÄ¿
		public const int MAX_LANE_NUM = 8;   // ×î´ó³µµÀÊıÄ¿
		...
		public enum TRAFFIC_AID_TYPE {
			...
			PARKING = 0x02,    //Í£³µ  
			INVERSE = 0x04,    //ÄæĞĞ
			PEDESTRIAN = 0x08,    //ĞĞÈË                      
			DEBRIS = 0x10,    //ÒÅÁôÎï Å×È÷ÎïËéÆ¬ 
			SMOKE = 0x20,    //ÑÌÎí  
			OVERLINE = 0x40,     //Ñ¹Ïß
			VEHICLE_CONTROL_LIST = 0x80,  //ºÚÃûµ¥Êı¾İ
			SPEED = 0x100  //³¬ËÙ
		}
		...
		public enum ITS_ABILITY_TYPE {
			...
			ITS_INVERSE_ABILITY = 0x04,      //ÄæĞĞ
			ITS_PEDESTRIAN_ABILITY = 0x08,      //ĞĞÈË                      
			ITS_DEBRIS_ABILITY = 0x10,      //ÒÅÁôÎï Å×È÷ÎïËéÆ¬
			ITS_SMOKE_ABILITY = 0x20,      //ÑÌÎí-ËíµÀ
			ITS_OVERLINE_ABILITY = 0x40,      //Ñ¹Ïß
			ITS_VEHICLE_CONTROL_LIST_ABILITY = 0x80,        //ºÚÃûµ¥Êı¾İ
			...
			ITS_TIME_OCCUPANCY_RATIO_ABILITY = 0x100000,  //³µµÀÕ¼ÓĞÂÊ£¬£¨Ê±¼äÉÏ)
			ITS_SPACE_OCCUPANCY_RATIO_ABILITY = 0x200000,  //³µµÀÕ¼ÓĞÂÊ£¬°Ù·Ö±È¼ÆËã£¨¿Õ¼äÉÏ)
			ITS_LANE_QUEUE_ABILITY = 0x400000,  //ÅÅ¶Ó³¤¶È
			ITS_VEHICLE_TYPE_ABILITY = 0x800000,  //³µÁ¾ÀàĞÍ
		...
		public enum ITS_TPS_TYPE {
			...
			TIME_OCCUPANCY_RATIO = 0x10,    //³µµÀÕ¼ÓĞÂÊ (Ê±¼äÉÏ)
			SPACE_OCCUPANCY_RATIO = 0x20,    //³µµÀÕ¼ÓĞÂÊ£¬°Ù·Ö±È¼ÆËã(¿Õ¼äÉÏ)
			QUEUE = 0x40,    //ÅÅ¶Ó³¤¶È
			VEHICLE_TYPE = 0x80,    //³µÁ¾ÀàĞÍ
		...
		public struct NET_DVR_DIRECTION {
			public NET_VCA_POINT struStartPoint;   // ·½ÏòÆğÊ¼µã
		...
		public struct NET_DVR_LANE_CFG {
			...
			public NET_DVR_ONE_LANE[] struLane; // ³µµÀ²ÎÊı Êı×éÏÂ±ê×÷Îª³µµÀID
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;    // ±£Áô×Ö½Ú
		}
		...
		public struct NET_DVR_AID_PARAM {
			...
			public ushort wPedestrianDuration;    // ĞĞÈË³ÖĞøÊ±¼ä    1-120s
			public ushort wDebrisDuration;        // Å×È÷Îï³ÖĞøÊ±¼ä  10-120s
			public ushort wCongestionLength;      // Óµ¶Â³¤¶ÈãĞÖµ    5-200£¨Ã×£©
			public ushort wCongestionDuration;    // Óµ¶Â³ÖĞø²ÎÊı    10-120s
			public ushort wInverseDuration;       // ÄæĞĞ³ÖĞøÊ±¼ä    1-10s
			public ushort wInverseDistance;       // ÄæĞĞ¾àÀëãĞÖµ µ¥Î»m ·¶Î§[2-100] Ä¬ÈÏ 10Ã×
			public ushort wInverseAngleTolerance; // ÔÊĞí½Ç¶ÈÆ«²î 90-180¶È,³µÁ÷ÓëÄæĞĞÔÊĞíµÄ¼Ğ½Ç
			public ushort wIllegalParkingTime;    // Î¥Í£Ê±¼ä[4,60]£¬µ¥Î»£º·ÖÖÓ ,TFS(½»Í¨Î¥ÕÂÈ¡Ö¤) ³ÇÊĞÄ£Ê½ÏÂ
			public ushort wIllegalParkingPicNum;  // Î¥Í£Í¼Æ¬ÊıÁ¿[1,6], TFS(½»Í¨Î¥ÕÂÈ¡Ö¤) ³ÇÊĞÄ£Ê½ÏÂ
			public byte byMergePic;             // Í¼Æ¬Æ´½Ó,TFS ³ÇÊĞÄ£Ê½ÏÂ 0- ²»Æ´½Ó 1- Æ´½Ó
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 23, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;             // ±£Áô×Ö½Ú
		}

		//µ¥Ìõ½»Í¨ÊÂ¼ş¹æÔò½á¹¹Ìå
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_ONE_AID_RULE {
			public byte byEnable;                   // ÊÇ·ñÆôÓÃÊÂ¼ş¹æÔò
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;                  // ±£Áô×Ö½Ú
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byRuleName;       // ¹æÔòÃû³Æ 
			public uint dwEventType;                // ½»Í¨ÊÂ¼ş¼ì²âÀàĞÍ TRAFFIC_AID_TYPE
			public NET_VCA_SIZE_FILTER struSizeFilter; // ³ß´ç¹ıÂËÆ÷
			public NET_VCA_POLYGON struPolygon;    // ¹æÔòÇøÓò
			public NET_DVR_AID_PARAM struAIDParam;   //  ÊÂ¼ş²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_2, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_SCHEDTIME[] struAlarmTime;//²¼·ÀÊ±¼ä
			public NET_DVR_HANDLEEXCEPTION_V30 struHandleType;    //´¦Àí·½Ê½
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_AID_RULECFG_V41 {
			...
			public NET_DVR_JPEGPARA struPictureParam;   // Í¼Æ¬¹æ¸ñ½á¹¹
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_AID_RULE, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_ONE_AID_RULE_V41[] struAIDRule;  //¹æÔòÊı×é
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;                //±£Áô
		}
		...
		public struct NET_DVR_ONE_TPS_RULE {
			public byte byEnable;                   //ÊÇ·ñÊ¹ÄÜ³µµÀ½»Í¨¹æÔò²ÎÊı
			public byte byLaneID;                   //³µµÀID
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public uint dwCalcType;                 //Í³¼Æ²ÎÊıÀàĞÍITS_TPS_TYPE
			public NET_VCA_SIZE_FILTER struSizeFilter; //³ß´ç¹ıÂËÆ÷ 
			public NET_VCA_POLYGON struVitrualLoop;    //ĞéÄâÏßÈ¦
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_2, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_SCHEDTIME[] struAlarmTime;//²¼·ÀÊ±¼ä
			public NET_DVR_HANDLEEXCEPTION_V30 struHandleType;  //´¦Àí·½Ê½,Ò»°ãÎª´¦ÀíÊÇ·ñÉÏ´«ÖĞĞÄ£¬ÆäËû¹¦ÄÜ²»ĞèÒª
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;                         //±£Áô×Ö½Ú
		}

		//½»Í¨²ÎÊıÍ³¼Æ¹æÔòÅäÖÃ½á¹¹Ìå
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_TPS_RULECFG {
			...
			public NET_DVR_ONE_TPS_RULE[] struOneTpsRule; // ÏÂ±ê¶ÔÓ¦½»Í¨²ÎÊıID
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;         // ±£Áô×Ö½Ú
		}
		...
		//½»Í¨²ÎÊıÍ³¼Æ¹æÔòÅäÖÃ½á¹¹Ìå(À©Õ¹)
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_TPS_RULECFG_V41 {
			public uint dwSize;         // ½á¹¹´óĞ¡
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_TPS_RULE, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_ONE_TPS_RULE_V41[] struOneTpsRule; // ÏÂ±ê¶ÔÓ¦½»Í¨²ÎÊıID
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;     // ±£Áô
		}
		...
		public struct NET_DVR_AID_INFO {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byRuleName; //  ¹æÔòÃû³Æ
			public uint dwAIDType;  // ±¨¾¯ÊÂ¼şÀàĞÍ
		...
		public struct NET_DVR_AID_ALARM {
			...
			public uint dwAbsTime;      // ¾ø¶ÔÊ±±ê
			public NET_VCA_DEV_INFO struDevInfo;    // Ç°¶ËÉè±¸ĞÅÏ¢
			public NET_DVR_AID_INFO struAIDInfo;    // ½»Í¨ÊÂ¼şĞÅÏ¢
			public uint dwPicDataLen;   // ·µ»ØÍ¼Æ¬µÄ³¤¶È Îª0±íÊ¾Ã»ÓĞÍ¼Æ¬£¬´óÓÚ0±íÊ¾¸Ã½á¹¹ºóÃæ½ô¸úÍ¼Æ¬Êı¾İ
			public IntPtr pImage;        // Ö¸ÏòÍ¼Æ¬µÄÖ¸Õë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;      // ±£Áô×Ö½Ú  
		...
		public struct NET_DVR_LANE_QUEUE {
			public NET_VCA_POINT struHead;       //¶ÓÁĞÍ·
			public NET_VCA_POINT struTail;       //¶ÓÁĞÎ²
			public uint dwLength;      //Êµ¼Ê¶ÓÁĞ³¤¶È µ¥Î»ÎªÃ× [0-500]
		}

		public enum TRAFFIC_DATA_VARY_TYPE {
			NO_VARY,         //ÎŞ±ä»¯ 
			VEHICLE_ENTER,   //³µÁ¾½øÈëĞéÄâÏßÈ¦
			VEHICLE_LEAVE,   //³µÁ¾Àë¿ªĞéÄâÏßÈ¦ 
			UEUE_VARY        //¶ÓÁĞ±ä»¯             
		}
		...
		public struct NET_DVR_LANE_PARAM {
			...
			public byte byRuleID;              //¹æÔòĞòºÅ£¬Îª¹æÔòÅäÖÃ½á¹¹ÏÂ±ê£¬0-7 
			public byte byVaryType;            //³µµÀ½»Í¨²ÎÊı±ä»¯ÀàĞÍ ²ÎÕÕ TRAFFIC_DATA_VARY_TYPE
			public byte byLaneType;            //³µµÀÉÏĞĞ»òÏÂĞĞ
			public byte byRes1;
			public uint dwLaneVolume;         //³µµÀÁ÷Á¿ £¬Í³¼ÆÓĞ¶àÉÙ³µ×ÓÍ¨¹ı
			...
			public float fSpaceOccupyRation;    //³µµÀÕ¼ÓĞÂÊ£¬°Ù·Ö±È¼ÆËã£¨¿Õ¼äÉÏ)
			public NET_DVR_LANE_QUEUE struLaneQueue;    //³µµÀ¶ÓÁĞ³¤¶È
			public NET_VCA_POINT struRuleLocation; //ÏßÈ¦¹æÔòµÄÖĞĞÄµãÎ»ÖÃ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_TPS_INFO {
			public uint dwLanNum;   // ½»Í¨²ÎÊıµÄ³µµÀÊıÄ¿
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_TPS_RULE, ArraySubType = UnmanagedType.Struct)]
		...
		public struct NET_DVR_TPS_ALARM {
			...
			public uint dwAbsTime;       //¾ø¶ÔÊ±±ê
			public NET_VCA_DEV_INFO struDevInfo;     //Ç°¶ËÉè±¸ĞÅÏ¢
			public NET_DVR_TPS_INFO struTPSInfo;     //½»Í¨ÊÂ¼şĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;      //±£Áô×Ö½Ú
		}

		public enum TRAFFIC_DATA_VARY_TYPE_EX_ENUM {
			ENUM_TRAFFIC_VARY_NO = 0x00,   //ÎŞ±ä»¯
			ENUM_TRAFFIC_VARY_VEHICLE_ENTER = 0x01,   //³µÁ¾½øÈëĞéÄâÏßÈ¦
			ENUM_TRAFFIC_VARY_VEHICLE_LEAVE = 0x02,   //³µÁ¾Àë¿ªĞéÄâÏßÈ¦
			ENUM_TRAFFIC_VARY_QUEUE = 0x04,   //¶ÓÁĞ±ä»¯
			ENUM_TRAFFIC_VARY_STATISTIC = 0x08,   //Í³¼ÆÊı¾İ±ä»¯£¨Ã¿·ÖÖÓ±ä»¯Ò»´Î°üÀ¨Æ½¾ùËÙ¶È£¬³µµÀ¿Õ¼ä/Ê±¼äÕ¼ÓĞÂÊ£¬½»Í¨×´Ì¬£©        
		}
		...
		public struct NET_DVR_LANE_PARAM_V41 {
			...
			public byte byRuleID;             // ¹æÔòĞòºÅ£¬Îª¹æÔòÅäÖÃ½á¹¹ÏÂ±ê£¬0-7 
			public byte byLaneType;          // ³µµÀÉÏĞĞ»òÏÂĞĞ
			public byte byTrafficState;       // ³µµÀµÄ½»Í¨×´Ì¬£¬0-ÎŞĞ§£¬1-³©Í¨£¬2-Óµ¼·£¬3-¶ÂÈû
			public byte byRes1;               // ±£Áô
			public uint dwVaryType;           // ³µµÀ½»Í¨²ÎÊı±ä»¯ÀàĞÍ²ÎÕÕ  TRAFFIC_DATA_VARY_TYPE_EX_ENUM£¬°´Î»Çø·Ö
			public uint dwTpsType;            // Êı¾İ±ä»¯ÀàĞÍ±êÖ¾£¬±íÊ¾µ±Ç°ÉÏ´«µÄÍ³¼Æ²ÎÊıÖĞ£¬ÄÄĞ©Êı¾İÓĞĞ§£¬²ÎÕÕITS_TPS_TYPE,°´Î»Çø·Ö
			public uint dwLaneVolume;        // ³µµÀÁ÷Á¿£¬Í³¼ÆÓĞ¶àÉÙ³µ×ÓÍ¨¹ı
			public uint dwLaneVelocity;       // ³µµÀËÙ¶È£¬¹«Àï¼ÆËã
			public uint dwTimeHeadway;       // ³µÍ·Ê±¾à£¬ÒÔÃë¼ÆËã
			public uint dwSpaceHeadway;       // ³µÍ·¼ä¾à£¬ÒÔÃ×À´¼ÆËã
			public float fSpaceOccupyRation;   // ³µµÀÕ¼ÓĞÂÊ£¬°Ù·Ö±È¼ÆËã£¨¿Õ¼äÉÏ)
			public float fTimeOccupyRation;    // Ê±¼äÕ¼ÓĞÂÊ£¬°Ù·Ö±È¼ÆËã
			public uint dwLightVehicle;       // Ğ¡ĞÍ³µÊıÁ¿
			public uint dwMidVehicle;         // ÖĞĞÍ³µÊıÁ¿
			public uint dwHeavyVehicle;       // ÖØĞÍ³µÊıÁ¿
			public NET_DVR_LANE_QUEUE struLaneQueue;        // ³µµÀ¶ÓÁĞ³¤¶È
			public NET_VCA_POINT struRuleLocation;     // ¹æÔòÎ»ÖÃĞéÄâÏßÈ¦µÄÖĞĞÄ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;           // ±£Áô
		}
		...
		public struct NET_DVR_FACEDETECT_RULECFG {
			...
			public byte byEventType;            //¾¯½äÊÂ¼şÀàĞÍ£¬ 0-Òì³£ÈËÁ³; 1-Õı³£ÈËÁ³;2-Òì³£ÈËÁ³&Õı³£ÈËÁ³;
			public byte byUpLastAlarm;       //2011-04-06 ÊÇ·ñÏÈÉÏ´«×î½üÒ»´ÎµÄ±¨¾¯
			...
			public ushort wDuration;      // ´¥·¢ÈËÁ³±¨¾¯Ê±¼äãĞÖµ
			public NET_DVR_JPEGPARA struPictureParam;       //Í¼Æ¬¹æ¸ñ½á¹¹
			public NET_VCA_SIZE_FILTER struSizeFilter;         //³ß´ç¹ıÂËÆ÷
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_2, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_SCHEDTIME[] struAlarmTime;//²¼·ÀÊ±¼ä
		...
		public struct NET_DVR_FACE_PIPCFG {
			public byte byEnable; //ÊÇ·ñ¿ªÆô»­ÖĞ»­
			public byte byBackChannel; //±³¾°Í¨µÀºÅ£¨Ãæ°åÍ¨µÀ£©
			public byte byPosition; //µş¼ÓÎ»ÖÃ£¬0-×óÉÏ,1-×óÏÂ,2-ÓÒÉÏ,3-ÓÒÏÂ
			public byte byPIPDiv; //·ÖÆÁÏµÊı(ÈËÁ³»­Ãæ:Ãæ°å»­Ãæ)£¬0-1:4,1-1:9,2-1:16
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_FACEDETECT_RULECFG_V41 {
			...
			public NET_DVR_FACE_PIPCFG struFacePIP; //2012-11-7»­ÖĞ»­²ÎÊı
		...
		public struct NET_DVR_FACEDETECT_ALARM {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public uint dwFacePicDataLen;           //ÈËÁ³Í¼Æ¬µÄ³¤¶È Îª0±íÊ¾Ã»ÓĞÍ¼Æ¬£¬´óÓÚ0±íÊ¾¸Ã½á¹¹ºóÃæ½ô¸úÍ¼Æ¬Êı¾İ*/
		...
		public struct NET_DVR_EVENT_PARAM_UNION {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.U4)]
			public uint[] uLen;         // ÁªºÏÌå´óĞ¡Îª12×Ö½Ú
			public uint dwHumanIn;      //ÓĞÎŞÈË½Ó½ü 0 - ÎŞÈË 1- ÓĞÈË  
			public float fCrowdDensity;  // ÈËÔ±¾Û¼¯Öµ
		}

		//Ä¿Ç°Ö»ÓĞÓĞÈËÎŞÈËÊÂ¼şºÍÈËÔ±¾Û¼¯ÊÂ¼şÊµÊ±±¨¾¯ÉÏ´«
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		public struct NET_DVR_EVENT_INFO_LIST {
			public byte byNum;      // ÊÂ¼şÊµÊ±ĞÅÏ¢¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;           // ±£Áô×Ö½Ú
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_RULE_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_EVENT_INFO[] struEventInfo;  // ÊÂ¼ÊÊµÊ±ĞÅÏ¢
		}
		...
		public struct NET_DVR_RULE_INFO_ALARM {
			...
			public uint dwAbsTime;          // ¾ø¶ÔÊ±±ê
			public NET_VCA_DEV_INFO struDevInfo;        // Ç°¶ËÉè±¸ĞÅÏ¢
			public NET_DVR_EVENT_INFO_LIST struEventInfoList;   //ÊÂ¼şĞÅÏ¢ÁĞ±í
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;           // ±£Áô×Ö½Ú
		}
		...
		public struct NET_DVR_ONE_SCENE_TIME {
			public byte byActive;                     //0 -ÎŞĞ§,1¨CÓĞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;                    //±£Áô
			public uint dwSceneID;                    //³¡¾°ID
			public NET_DVR_SCHEDTIME struEffectiveTime;   //³¡¾°ÆğĞ§Ê±¼ä
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;                   //±£Áô
		}
		...
		public struct NET_DVR_SCENE_TIME_CFG {
			...
			public NET_DVR_ONE_SCENE_TIME[] struSceneTime; //³¡¾°Ê±¼ä¶ÎÊı×é
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;                                            //±£Áô
		}
		...
		public struct NET_DVR_ONE_SCENE_CFG {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;                //±£Áô
			public uint dwSceneID;                //³¡¾°ID(Ö»¶Á), 0 - ±íÊ¾¸Ã³¡¾°ÎŞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] bySceneName;    //³¡¾°Ãû³Æ
			public NET_DVR_PTZPOS struPtzPos;       //ptz ×ø±ê
			public uint dwTrackTime;              //Çò»ú¸ú×ÙÊ±¼ä[5,300] Ãë£¬TFS(½»Í¨È¡Ö¤)Ä£Ê½ÏÂÓĞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;               //±£Áô
		}
		...
		public struct NET_DVR_SCENE_CFG {
			...
			public NET_DVR_ONE_SCENE_CFG[] struSceneCfg; //³¡¾°ÅäÖÃĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;                                      //±£Áô
		}
		...
		public struct NET_DVR_SCENE_COND {
			public uint dwSize;       //½á¹¹´óĞ¡
			public Int32 lChannel;     //Í¨µÀºÅ
			public uint dwSceneID;    //³¡¾°ID, 0-±íÊ¾¸Ã³¡¾°ÎŞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 48, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;    //±£Áô
		}
		...
		public struct NET_DVR_AID_ALARM_V41 {
			...
			public NET_VCA_DEV_INFO struDevInfo;            //Ç°¶ËÉè±¸ĞÅÏ¢
			public NET_DVR_AID_INFO struAIDInfo;         //½»Í¨ÊÂ¼şĞÅÏ¢
			public NET_DVR_SCENE_INFO struSceneInfo;       //³¡¾°ĞÅÏ¢
		...
		public struct NET_DVR_TPS_ALARM_V41 {
			...
			public uint dwAbsTime;       // ¾ø¶ÔÊ±±ê
			public NET_VCA_DEV_INFO struDevInfo;     // Ç°¶ËÉè±¸ĞÅÏ¢
			public NET_DVR_TPS_INFO_V41 struTPSInfo;     // ½»Í¨²ÎÊıÍ³¼ÆĞÅÏ¢ 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;      // ±£Áô
		}
		...
		public struct NET_DVR_VCA_VERSION {
			...
			public ushort wRevisionNumber;  // ĞŞÕıºÅ
		...
		public struct NET_DVR_PLATE_PARAM {
			public byte byPlateRecoMode;    //³µÅÆÊ¶±ğµÄÄ£Ê½,Ä¬ÈÏÎª1(ÊÓÆµ´¥·¢Ä£Ê½)
			public byte byBelive;   /*ÕûÅÆÖÃĞÅ¶ÈãĞÖµ, Ö»ÓÃÓÚÊÓÆµÊ¶±ğ·½Ê½, ¸ù¾İ±³¾°¸´ÔÓ³Ì¶ÈÉèÖÃ, Îó´¥·¢ÂÊ¸ß¾ÍÉè¸ß, Â©³µÂÊ¸ß¾ÍÉèµÍ, 
                                     * ½¨ÒéÔÚ80-90·¶Î§ÄÚ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 22, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;          //±£Áô×Ö½Ú
		}
		...
		public struct NET_DVR_PLATECFG {
			public uint dwSize;
			public uint dwEnable;                          /* ÊÇ·ñÆôÓÃÊÓÆµ³µÅÆÊ¶±ğ 0£­·ñ 1£­ÊÇ */
			public byte byPicProType;   //±¨¾¯Ê±Í¼Æ¬´¦Àí·½Ê½ 0-²»´¦Àí ·Ç0-ÉÏ´«
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;  // ±£Áô×Ö½Ú
			public NET_DVR_JPEGPARA struPictureParam;       //Í¼Æ¬¹æ¸ñ½á¹¹
			public NET_DVR_PLATE_PARAM struPlateParam;   // ³µÅÆÊ¶±ğ²ÎÊıÅäÖÃ
		...
		public struct NET_DVR_PLATE_INFO {
			public byte byPlateType; //³µÅÆÀàĞÍ
			public byte byColor; //³µÅÆÑÕÉ«
			public byte byBright; //³µÅÆÁÁ¶È
			public byte byLicenseLen;   //³µÅÆ×Ö·û¸öÊı
			public byte byEntireBelieve;//Õû¸ö³µÅÆµÄÖÃĞÅ¶È£¬0-100
			public byte byRegion;                       // ÇøÓòË÷ÒıÖµ 0-±£Áô£¬1-Å·ÖŞ(EU)£¬2-¶íÓïÇøÓò(ER)£¬3-Å·ÖŞ&¶íÂŞË¹(EU&CIS) ,4-ÖĞ¶«(ME),0xff-ËùÓĞ
			public byte byCountry;                      // ¹ú¼ÒË÷ÒıÖµ£¬²ÎÕÕÃ¶¾ÙCOUNTRY_INDEX£¨²»Ö§³Ö"COUNTRY_ALL = 0xff, //ALL  È«²¿"£©
			public byte byArea;                         //ÇøÓò£¨Ê¡·İ£©£¬¸÷¹ú¼ÒÄÚ²¿ÇøÓòÃ¶¾Ù£¬°¢ÁªÇõ²ÎÕÕ EMI_AREA
			public byte byPlateSize;                    //³µÅÆ³ß´ç£¬0~Î´Öª£¬1~long, 2~short(ÖĞ¶«³µÅÆÊ¹ÓÃ)
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 15, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;                       //±£Áô
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CATEGORY_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sPlateCategory;//³µÅÆ¸½¼ÓĞÅÏ¢, ¼´ÖĞ¶«³µÅÆÖĞ³µÅÆºÅÂëÅÔ±ßµÄĞ¡×ÖĞÅÏ¢£¬(Ä¿Ç°Ö»ÓĞÖĞ¶«µØÇøÖ§³Ö)
			public uint dwXmlLen;                        //XML±¨¾¯ĞÅÏ¢³¤¶È
			public IntPtr pXmlBuf;                      // XML±¨¾¯ĞÅÏ¢Ö¸Õë,±¨¾¯ÀàĞÍÎª COMM_ITS_PLATE_RESULÊ±ÓĞĞ§£¬ÆäXML¶ÔÓ¦µ½EventNotificationAlert XML Block
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_LICENSE_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byBelieve; //¸÷¸öÊ¶±ğ×Ö·ûµÄÖÃĞÅ¶È£¬Èç¼ì²âµ½³µÅÆ"ÕãA12345", ÖÃĞÅ¶ÈÎª,20,30,40,50,60,70£¬Ôò±íÊ¾"Õã"×ÖÕıÈ·µÄ¿ÉÄÜĞÔÖ»ÓĞ%£¬"A"×ÖµÄÕıÈ·µÄ¿ÉÄÜĞÔÊÇ%
		}
		...
		public struct NET_DVR_PLATERECO_RESULE {
			...
			public uint dwRelativeTime; //Ïà¶ÔÊ±±ê
			public uint dwAbsTime;  //¾ø¶ÔÊ±±ê
			public NET_VCA_DEV_INFO struDevInfo; // Ç°¶ÎÉè±¸ĞÅÏ¢
		...
		public struct NET_DVR_IO_INCFG {
			public uint dwSize;
			public byte byIoInStatus;//ÊäÈëµÄIO¿Ú×´Ì¬£¬0-ÏÂ½µÑØ£¬1-ÉÏÉıÑØ£¬2-ÉÏÉıÑØºÍÏÂ½µÑØ£¬3-¸ßµçÆ½£¬4-µÍµçÆ½
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;//±£Áô×Ö½Ú
		}
		...
		public struct NET_DVR_IO_OUTCFG {
			...
			public byte byIoOutStatus;//IOÆğĞ§Ê±×´Ì¬£º0-µÍµçÆ½£¬1-¸ßµçÆ½£¬2-Âö³å
			public ushort wAheadTime;//Êä³öIOÌáÇ°Ê±¼ä£¬µ¥Î»us
			public uint dwTimePluse;//Âö³å¼ä¸ôÊ±¼ä£¬µ¥Î»us
			public uint dwTimeDelay;//IOÓĞĞ§³ÖĞøÊ±¼ä£¬µ¥Î»us
			public byte byFreqMulti;        //±¶Æµ£¬ÊıÖµ·¶Î§[1,15]
		...
		public struct NET_DVR_FLASH_OUTCFG {
			...
			public byte byRelatedIoIn;//ÉÁ¹âµÆ¹ØÁªµÄÊäÈëIOºÅ£¨¹ØÁªÉÁÊ±´Ë²ÎÊıÓĞĞ§£©
			...
			public byte byBrightnessThreld;/*Ê¹ÄÜÉÁ¹âµÆÁÁ¶ÈãĞÖµ£¬·¶Î§[0,100],¸ßÓÚãĞÖµÉÁ*/
			public byte byStartHour;        //¿ªÊ¼Ê±¼ä-Ğ¡Ê±,È¡Öµ·¶Î§0-23
			public byte byStartMinute;      //¿ªÊ¼Ê±¼ä-·Ö,È¡Öµ·¶Î§0-59
			public byte byEndHour;          //½áÊøÊ±¼ä-Ğ¡Ê±,È¡Öµ·¶Î§0-23
		...
		public struct NET_DVR_LIGHTSNAPCFG {
			...
			public byte bySnapTimes1; //ºìµÆ×¥ÅÄ´ÎÊı1£¬0-²»×¥ÅÄ£¬·Ç0-Á¬ÅÄ´ÎÊı£¬×î´ó5´Î 
			public byte bySnapTimes2; //ÂÌµÆ×¥ÅÄ´ÎÊı2£¬0-²»×¥ÅÄ£¬·Ç0-Á¬ÅÄ´ÎÊı£¬×î´ó5´Î 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
		...
		public struct NET_DVR_MEASURESPEEDCFG {
			...
			public byte byCapSpeed;//²âËÙÄ£Ê½ÆğÅÄËÙ¶È£¬µ¥Î»km/h
			public byte bySpeedLimit;//ÏŞËÙÖµ£¬µ¥Î»km/h
			public byte bySnapTimes1; //ÏßÈ¦1×¥ÅÄ´ÎÊı£¬0-²»×¥ÅÄ£¬·Ç0-Á¬ÅÄ´ÎÊı£¬×î´ó5´Î 
			public byte bySnapTimes2; //ÏßÈ¦2×¥ÅÄ´ÎÊı£¬0-²»×¥ÅÄ£¬·Ç0-Á¬ÅÄ´ÎÊı£¬×î´ó5´Î 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_INTERVAL_NUM, ArraySubType = UnmanagedType.U2)]
		...
		public struct NET_DVR_VIDEOEFFECT {
			...
			public byte byEnableFunc; //Ê¹ÄÜ£¬°´Î»±íÊ¾£¬bit0-SMART IR(·À¹ıÆØ)£¬bit1-µÍÕÕ¶È,bit2-Ç¿¹âÒÖÖÆÊ¹ÄÜ£¬0-·ñ£¬1-ÊÇ
		...
		public struct NET_DVR_WHITEBALANCE {
			...
			public byte byWhiteBalanceModeRGain; /*ÊÖ¶¯°×Æ½ºâÊ±ÓĞĞ§£¬ÊÖ¶¯°×Æ½ºâ RÔöÒæ*/
			public byte byWhiteBalanceModeBGain; /*ÊÖ¶¯°×Æ½ºâÊ±ÓĞĞ§£¬ÊÖ¶¯°×Æ½ºâ BÔöÒæ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_EXPOSURE {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			public uint dwVideoExposureSet; /* ×Ô¶¨ÒåÊÓÆµÆØ¹âÊ±¼ä£¨µ¥Î»us£©*//*×¢:×Ô¶¯ÆØ¹âÊ±¸ÃÖµÎªÆØ¹â×îÂıÖµ ĞÂÔö20-1s(1000000us)*/
		...
		public struct NET_DVR_DAYNIGHT {
			...
			public byte bySwitchScheduleEnabled; /*0 dsibale  1 enable,(±£Áô)*/
												 //¶¨Ê±Ä£Ê½²ÎÊı
			public byte byBeginTime; /*¿ªÊ¼Ê±¼ä£¨Ğ¡Ê±£©£¬0-23*/
			public byte byEndTime; /*½áÊøÊ±¼ä£¨Ğ¡Ê±£©£¬0-23*/
								   //Ä£Ê½2
		...
		public struct NET_DVR_NOISEREMOVE {
			public byte byDigitalNoiseRemoveEnable; /*0-²»ÆôÓÃ£¬1-ÆÕÍ¨Ä£Ê½Êı×Ö½µÔë£¬2-×¨¼ÒÄ£Ê½Êı×Ö½µÔë*/
			...
			public byte byDigitalNoiseRemove2DLevel;            /* ×¥ÅÄÖ¡2D½µÔë¼¶±ğ£¬0-100 */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_CAMERAPARAMCFG {
			...
			public byte byDigitalZoom;  /*Êı×ÖËõ·Å:0 dsibale  1 enable*/
			...
			public byte byLineCoding; //ÊÇ·ñ¿ªÆôĞĞ±àÂë£º0-·ñ£¬1-ÊÇ
			...
			public NET_DVR_CMOSMODECFG struCmosModeCfg;//CMOSÄ£Ê½ÏÂÇ°¶Ë²ÎÊıÅäÖÃ£¬¾µÍ·Ä£Ê½´ÓÄÜÁ¦¼¯»ñÈ¡
		...
		//SMART IR(·À¹ıÆØ)ÅäÖÃ²ÎÊı
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_SMARTIR_PARAM {
			public byte byMode;//0¡«ÊÖ¶¯£¬1¡«×Ô¶¯
			public byte byIRDistance;//ºìÍâ¾àÀëµÈ¼¶(µÈ¼¶£¬¾àÀëÕı±ÈÀı)level:1~100 Ä¬ÈÏ:50£¨ÊÖ¶¯Ä£Ê½ÏÂÔö¼Ó£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}

		//ÔÚbyIrisMode ÎªP-Iris1Ê±ÉúĞ§£¬ÅäÖÃºìÍâ¹âÈ¦´óĞ¡µÈ¼¶£¬ÅäÖÃÄ£Ê½
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_PIRIS_PARAM {
			public byte byMode;//0-×Ô¶¯£¬1-ÊÖ¶¯
			public byte byPIrisAperture;//ºìÍâ¹âÈ¦´óĞ¡µÈ¼¶(µÈ¼¶,¹âÈ¦´óĞ¡Õı±ÈÀı)level:1~100 Ä¬ÈÏ:50£¨ÊÖ¶¯Ä£Ê½ÏÂÔö¼Ó£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_CAMERAPARAMCFG_EX {
			...
			public byte byAutoCompensationInterval; //¶¨Ê±×Ô¶¯¿ìÃÅ²¹³¥£º1-120£¬µ¥Î»£º·ÖÖÓ
			public byte bySceneMode;  //³¡¾°Ä£Ê½£º0-ÊÒÍâ£¬1-ÊÒÄÚ£¬2-Ä¬ÈÏ£¬3-Èõ¹â
			public NET_DVR_DEFOGCFG struDefogCfg;//Í¸Îí²ÎÊı
			...
			public byte byExposureSegmentEnable; //0~²»ÆôÓÃ,1~ÆôÓÃ  ÆØ¹âÊ±¼äºÍÔöÒæ³Ê½×Ìİ×´µ÷Õû£¬±ÈÈçÆØ¹âÍùÉÏµ÷ÕûÊ±£¬ÏÈÌá¸ßÆØ¹âÊ±¼äµ½ÖĞ¼äÖµ£¬È»ºóÌá¸ßÔöÒæµ½ÖĞ¼äÖµ£¬ÔÙÌá¸ßÆØ¹âµ½×î´óÖµ£¬×îºóÌá¸ßÔöÒæµ½×î´óÖµ
			...
			public NET_DVR_SMARTIR_PARAM struSmartIRParam; //ºìÍâ·Å¹ı±¬ÅäÖÃĞÅÏ¢
			public NET_DVR_PIRIS_PARAM struPIrisParam;//PIrisÅäÖÃĞÅÏ¢¶ÔÓ¦byIrisMode×Ö¶Î´Ó2-PIris1¿ªÊ¼ÉúĞ§
		...
		public enum VCA_PLATE_TYPE {
			...
			VCA_JINGCHE_PLATE,//¾¯³µ
			STANDARD92_BACK_PLATE,//ÃñÓÃ³µË«ĞĞÎ²ÅÆ
			VCA_SHIGUAN_PLATE,          //Ê¹¹İ³µÅÆ
			VCA_NONGYONG_PLATE,         //Å©ÓÃ³µ
			VCA_MOTO_PLATE              //Ä¦ÍĞ³µ
		}
		...
		public struct NET_DVR_VEHICLE_INFO {
			...
			public byte byVehicleLogoRecog; //²Î¿¼Ã¶¾ÙÀàĞÍ VLR_VEHICLE_CLASS
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2; //±£Áô
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byCustomInfo;  //×Ô¶¨ÒåĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		...
		public struct NET_DVR_PLATE_RESULT {
			...
			public ushort wAlarmRecordID;   //±¨¾¯Â¼ÏñID(ÓÃÓÚ²éÑ¯Â¼Ïñ£¬½öµ±byResultTypeÎª2Ê±ÓĞĞ§)
			...
			public byte byVehicleType; //0- Î´Öª£¬1- ¿Í³µ£¬2- »õ³µ£¬3- ½Î³µ£¬4- Ãæ°ü³µ£¬5- Ğ¡»õ³µ
		...
		public struct NET_DVR_IMAGEOVERLAYCFG {
			public uint dwSize;
			public byte byOverlayInfo;//µş¼ÓÊ¹ÄÜ¿ª¹Ø£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayMonitorInfo;//ÊÇ·ñµş¼Ó¼à²âµãĞÅÏ¢£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayTime;//ÊÇ·ñµş¼ÓÊ±¼ä£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlaySpeed;//ÊÇ·ñµş¼ÓËÙ¶È£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlaySpeeding;//ÊÇ·ñµş¼Ó³¬ËÙ±ÈÀı£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayLimitFlag;//ÊÇ·ñµş¼ÓÏŞËÙ±êÖ¾£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayPlate;//ÊÇ·ñµş¼Ó³µÅÆºÅ£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayColor;//ÊÇ·ñµş¼Ó³µÉíÑÕÉ«£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayLength;//ÊÇ·ñµş¼Ó³µ³¤£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayType;//ÊÇ·ñµş¼Ó³µĞÍ£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayColorDepth;//ÊÇ·ñµş¼Ó³µÉíÑÕÉ«ÉîÇ³£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayDriveChan;//ÊÇ·ñµş¼Ó³µµÀ£¬0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayMilliSec; //µş¼ÓºÁÃëĞÅÏ¢ 0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayIllegalInfo; //µş¼ÓÎ¥ÕÂĞÅÏ¢ 0-²»µş¼Ó£¬1-µş¼Ó
			public byte byOverlayRedOnTime;  //µş¼ÓºìµÆÒÑÁÁÊ±¼ä 0-²»µş¼Ó£¬1-µş¼Ó
			public byte byFarAddPlateJpeg;      //Ô¶¾°Í¼ÊÇ·ñµş¼Ó³µÅÆ½ØÍ¼,0-²»µş¼Ó,1-µş¼Ó
			public byte byNearAddPlateJpeg;      //½ü¾°Í¼ÊÇ·ñµş¼Ó³µÅÆ½ØÍ¼,0-²»µş¼Ó,1-µş¼Ó
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;    //±£Áô
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byMonitorInfo1;    //¼à²âµãĞÅÏ¢1
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 44, ArraySubType = UnmanagedType.I1)]
			public byte[] byMonitorInfo2; //¼ì²âµãĞÅÏ¢2
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 52, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2; //±£Áô
		}
		...
		public enum ITC_RECOG_REGION_TYPE {
			ITC_REGION_RECT = 0x0,   //¾ØĞÎ
			ITC_REGION_POLYGON = 0x1,  //¶à±ßĞÎ
		}

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_SNAP_ABILITY {
			public uint dwSize;
			public byte byIoInNum;//IOÊäÈë¿ÚÊı
			public byte byIoOutNum;//IOÊä³ö¿ÚÊı
			public byte bySingleSnapNum;//µ¥IO´¥·¢×éÊı
			public byte byLightModeArrayNum;//ºìÂÌµÆÄ£Ê½×éÊı
			public byte byMeasureModeArrayNum;//²âËÙÄ£Ê½×éÊı
			public byte byPlateEnable; //³µÅÆÊ¶±ğÄÜÁ¦
			...
			public byte byIoSpeedGroup; //Ö§³ÖµÄIO²âËÙ×éÊı
			public byte byIoLightGroup; //Ö§³ÖµÄIOºìÂÌµÆ×éÊı
			public byte byRecogRegionType; //ÅÆÊ¶ÇøÓòÖ§³ÖµÄÀàĞÍ£¬Ïê¼û¶¨ÒåITC_RECOG_REGION_TYPE
			public byte bySupport; //Éè±¸ÄÜÁ¦£¬°´Î»±íÊ¾£¬0-²»Ö§³Ö£¬1-Ö§³Ö
								   // bySupport&0x1£¬±íÊ¾ÊÇ·ñÖ§³ÖÀ©Õ¹µÄ×Ö·ûµş¼ÓÅäÖÃ
								   // bySupport&0x2£¬±íÊ¾ÊÇ·ñÖ§³ÖÀ©Õ¹µÄĞ£Ê±ÅäÖÃ½á¹¹
								   // bySupport&0x4, ±íÊ¾ÊÇ·ñÖ§³Ö¶àÍø¿¨(¶àÍø¸ôÀë)
								   // bySupport&0x8, ±íÊ¾ÊÇ·ñÖ§³ÖÍø¿¨µÄbonding¹¦ÄÜ(ÍøÂçÈİ´í)
			...
			public ushort wSupportMultiRadar;// Éè±¸ÄÜÁ¦£¬°´Î»±íÊ¾£¬0-²»Ö§³Ö£¬1-Ö§³Ö
											 ...
											 // wSupportMultiRadar&0x2£¬±íÊ¾ ¿¨¿ÚĞéÄâÏßÈ¦ Ö§³Ö³µµÀ¹ØÁªÀ×´ï´¦Àí
											 // wSupportMultiRadar&0x4£¬±íÊ¾ »ìĞĞ¿¨¿Ú Ö§³Ö³µµÀ¹ØÁªÀ×´ï´¦Àí
											 // wSupportMultiRadar&0x8£¬±íÊ¾ ÊÓÆµ¼ì²â Ö§³Ö³µµÀ¹ØÁªÀ×´ï´¦Àí
			public byte byICRPresetNum;
			// ±íÊ¾Ö§³ÖµÄICRÔ¤ÖÃµã£¨ÂË¹âÆ¬Æ«ÒÆµã£©Êı
			public byte byICRTimeSlot;//±íÊ¾Ö§³ÖµÄICRµÄÊ±¼ä¶ÎÊı£¨1¡«8£©
			public byte bySupportRS485Num;//±íÊ¾Ö§³ÖµÄRS485¿ÚµÄÊıÁ¿
			...
			public byte byExpandRs485SupportSignalLampDet;// Éè±¸ÄÜÁ¦£¬°´Î»±íÊ¾£¬0-²»Ö§³Ö£¬1-Ö§³Ö
														  // byExpandRs485SupportSignalLampDet &0x1£¬±íÊ¾µç¾¯³µ¼ìÆ÷Ö§³ÖÍâ½ÓĞÅºÅµÆ¼ì²âÆ÷
														  // byExpandRs485SupportSignalLampDet &0x2£¬±íÊ¾¿¨Ê½µç¾¯³µ¼ìÆ÷Ö§³ÖÍâ½ÓĞÅºÅµÆ¼ì²âÆ÷
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 13, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_ITC_ICRTIMECFG {
			...
			public byte byAssociateRresetNo;//Ô¤ÖÃµãºÅ1¡«8 , 0´ú±íÎŞ
			public byte bySubSwitchMode;//1~°×Ìì£¬2~ÍíÉÏ (µ±Ô¤ÖÃµãµÈÓÚ0 µÄÊ±ºòÉúĞ§)
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 10, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_ITC_ICR_TIMESWITCH_PARAM {
			...
			public NET_ITC_ICRTIMECFG[] struAutoCtrlTime;//×Ô¶¯ÇĞ»»Ê±¼ä¶Î (×Ô¶¯ÇĞ»»ÏÂ Ê±¿ÕÏÂÉúĞ§ ÏÖÔÚÖ§³Ö4×é£¬Ô¤Áô4×é)
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ICR_NUM, ArraySubType = UnmanagedType.I1)]
			public byte[] byICRPreset; //Êµ¼ÊÉúĞ§¸ù¾İÄÜÁ¦¼¯¶¯Ì¬ÏÔÊ¾ [0~100] Êı×éÏÂ±ê±íÊ¾Ô¤ÖÃµãºÅ1¡«8 £¨0¡«7 Ïà¶ÔÓ¦£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_ITC_ICR_MANUALSWITCH_PARAM {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ICR_NUM, ArraySubType = UnmanagedType.I1)]
			public byte[] byICRPreset; //Êµ¼ÊÉúĞ§¸ù¾İÄÜÁ¦¼¯¶¯Ì¬ÏÔÊ¾ [0~100]
		...
		public struct NET_ITC_ICRCFG {
			public uint dwSize;
			public byte bySwitchType;//1~×Ô¶¯ÇĞ»»£¬2~ÊÖ¶¯ÇĞ»» ,3~¶¨Ê±ÇĞ»» 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		...
		public struct NET_ITC_HANDLEEXCEPTION {
			...
			public byte byEnable; //0¡«²»ÆôÓÃ£¬1¡«ÆôÓÃ
			public byte byRes;
			public ushort wDuration;//³ÖĞøÊ±¼ä(µ¥Î»/s)
		...
		public struct NET_ITC_EXCEPTION {
			...
			//Êı×éµÄÃ¿¸öÔªËØ¶¼±íÊ¾Ò»ÖÖÒì³££¬Êı×é0- Ó²ÅÌ³ö´í,1-ÍøÏß¶Ï,2-IP µØÖ·³åÍ», 3-³µ¼ìÆ÷Òì³£, 4-ĞÅºÅµÆ¼ì²âÆ÷Òì³£
		}

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_TRIGCOORDINATE {
			public ushort wTopLeftX; /*ÏßÈ¦×óÉÏ½Çºá×ø±ê£¨2¸ö×Ö½Ú£©*/
			public ushort wTopLeftY; /*ÏßÈ¦×óÉÏ½Ç×İ×ø±ê£¨2¸ö×Ö½Ú£©*/
		...
		public struct NET_DVR_GEOGLOCATION {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.U4)]
			public int[] iRes; /*±£Áô*/
			public uint dwCity; /*³ÇÊĞ£¬Ïê¼ûPROVINCE_CITY_IDX */
		}
		...
		public struct NET_DVR_VTPARAM {
			public uint dwSize;
			public byte byEnable;  /* ÊÇ·ñÊ¹ÄÜĞéÄâÏßÈ¦£¬0-²»Ê¹ÓÃ£¬1-Ê¹ÓÃ*/
			public byte byIsDisplay; /* ÊÇ·ñÏÔÊ¾ĞéÄâÏßÈ¦£¬0-²»ÏÔÊ¾£¬1-ÏÔÊ¾*/
			...
			public byte byTotalLaneNum;/*ÊÓÆµ´¥·¢µÄ³µµÀÊı1*/
			public byte byPolarLenType; /*Æ«Õñ¾µÀàĞÍ£¬0£º²»¼ÓÆ«Õñ¾µ£»1£º¼ÓÊ©ÄÍµÂÆ«Õñ¾µ¡£*/
			public byte byDayAuxLightMode; /*°×Ìì¸¨ÖúÕÕÃ÷Ä£Ê½£¬0£ºÎŞ¸¨ÖúÕÕÃ÷£»1£ºLEDµÆÕÕÃ÷£»2£ºÉÁ¹âµÆÕÕÃ÷*/
			public byte byLoopToCalRoadBright; /*ÓÃÒÔ¼ÆËãÂ·ÃæÁÁ¶ÈµÄ³µµÀ(ĞéÄâÏßÈ¦)*/
			public byte byRoadGrayLowTh; /*Â·ÃæÁÁ¶ÈµÍãĞÖµ³õÊ¼»¯Öµ1*/
			public byte byRoadGrayHighTh; /*Â·ÃæÁÁ¶È¸ßãĞÖµ³õÊ¼»¯Öµ140*/
			public ushort wLoopPosBias; /*Íí¼ä´¥·¢ÏßÈ¦Î»ÒÆ30*/
			public uint dwHfrShtterInitValue; /*Á¬ĞøÍ¼ÏñÆØ¹âÊ±¼äµÄ³õÊ¼Öµ2000*/
			public uint dwSnapShtterInitValue; /*×¥ÅÄÍ¼ÏñÆØ¹âÊ±¼äµÄ³õÊ¼Öµ500*/
			public uint dwHfrShtterMaxValue; /*Á¬ĞøÍ¼ÏñÆØ¹âÊ±¼äµÄ×î´óÖµ20000*/
			public uint dwSnapShtterMaxValue; /*×¥ÅÄÍ¼ÏñÆØ¹âÊ±¼äµÄ×î´óÖµ1500*/
			public uint dwHfrShtterNightValue; /*Íí¼äÁ¬ĞøÍ¼ÏñÆØ¹âÊ±¼äµÄÉèÖÃÖµ3000*/
			public uint dwSnapShtterNightMinValue; /*Íí¼ä×¥ÅÄÍ¼ÏñÆØ¹âÊ±¼äµÄ×îĞ¡Öµ3000*/
		...
		public struct NET_DVR_SNAPENABLECFG {
			public uint dwSize;
			public byte byPlateEnable;//ÊÇ·ñÖ§³Ö³µÅÆÊ¶±ğ£¬0-²»Ö§³Ö£¬1-Ö§³Ö
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;   //±£Áô
			...
			public byte byLightSyncPower;  //ÊÇ·ñĞÅºÅµÆµçÔ´Í¬²½£¬0-²»Í¬²½£»1-Í¬²½
			public byte byFrequency;        //ĞÅºÅÆµÂÊ
			public byte byUploadSDEnable;  //ÊÇ·ñ×Ô¶¯ÉÏ´«SDÍ¼Æ¬£¬0-·ñ£»1-ÊÇ
			public byte byPlateMode; //Ê¶±ğÄ£Ê½²ÎÊı:0-ÊÓÆµ´¥·¢,1-Íâ²¿´¥·¢
			public byte byUploadInfoFTP; //ÊÇ·ñÉÏ´«×¥ÅÄ¸½¼ÓĞÅÏ¢µ½FTP£¬0-·ñ£¬1-ÊÇ
			public byte byAutoFormatSD; //ÊÇ·ñ×Ô¶¯¸ñÊ½»¯SD¿¨£¬0-·ñ£¬1-ÊÇ
			public ushort wJpegPicSize; //JpegÍ¼Æ¬´óĞ¡[64-8196]
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 56, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes; //±£Áô
		}
		...
		public struct NET_DVR_FTPCFG {
			...
			public ushort wTopDirMode;  /* Ò»¼¶Ä¿Â¼£¬0x1 = Ê¹ÓÃÉè±¸Ãû,0x2 = Ê¹ÓÃÉè±¸ºÅ,0x3 = Ê¹ÓÃÉè±¸ipµØÖ·£¬0x4=Ê¹ÓÃ¼à²âµã,0x5=Ê¹ÓÃÊ±¼ä(ÄêÔÂ),0x=6×Ô¶¨Òå,0x7=Î¥¹æÀàĞÍ,0x8=·½Ïò,0x9=µØµã*/
			public ushort wSubDirMode;  /* ¶ş¼¶Ä¿Â¼£¬0x1 = Ê¹ÓÃÍ¨µÀÃû,0x2 = Ê¹ÓÃÍ¨µÀºÅ£¬,0x3=Ê¹ÓÃÊ±¼ä(ÄêÔÂÈÕ),0x4=Ê¹ÓÃ³µµÀºÅ,0x=5×Ô¶¨Òå,0x6=Î¥¹æÀàĞÍ,0x7=·½Ïò,0x8=µØµã*/
		...
		public const int PICNAME_ITEM_PIC_NUMBER = 13;  //Í¼Æ¬ĞòºÅ
		public const int PICNAME_ITEM_CAR_NUMBER = 14;  //³µÁ¾ĞòºÅ

		public const int PICNAME_ITEM_SPEED_LIMIT_VALUES = 15; //ÏŞËÙÖµ
		...
		public struct NET_DVR_PICTURE_NAME {
			...
			public byte[] byItemOrder;  /*	èñÊı×é¶¨ÒåÎÄ¼şÃüÃûµÄ¹æÔò */
		...
		public struct NET_DVR_SERIAL_CATCHPIC_PARA {
			public byte byStrFlag;  /*´®¿ÚÊı¾İ¿ªÊ¼·û*/
			public byte byEndFlag;  /*½áÊø·û*/
			public ushort wCardIdx; /*¿¨ºÅÏà¶ÔÆğÊ¼Î»*/
		...
		public struct NET_DVR_JPEGCFG_V30 {
			public uint dwSize;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_JPEGPARA[] struJpegPara; /*Ã¿¸öÍ¨µÀµÄÍ¼Ïñ²ÎÊı*/
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.U4)]
			public uint[] dwTriggerPicTimes;    /* Ã¿¸öÍ¨µÀÒ»´Î´¥·¢ÅÄÕÕ´ÎÊı */
		...
		public struct NET_DVR_SPRCFG {
			...
			public byte[] byDefaultCHN; /*Éè±¸ÔËĞĞÊ¡·İµÄºº×Ö¼òĞ´*/
			...
			public byte byTotalLaneNum;  /*Ê¶±ğµÄ³µµÀÊı*/
			public byte byRes1;      /*±£Áô*/
			public ushort wRecognizedLane;  /*Ê¶±ğµÄ³µµÀºÅ£¬°´Î»±íÊ¾£¬bit0±íÊ¾³µµÀ1ÊÇ·ñÊ¶±ğ£¬0-²»Ê¶±ğ£¬1-Ê¶±ğ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_LANERECT_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_VCA_RECT[] struLaneRect;  /*³µµÀÊ¶±ğÇøÓò*/
			public uint dwRecogMode;  /*Ê¶±ğµÄÀàĞÍ£¬
	        bit0-±³ÏòÊ¶±ğ£º0-ÕıÏò³µÅÆÊ¶±ğ£¬1-±³ÏòÊ¶±ğ(Î²ÅÆÊ¶±ğ) £» 
		    bit1-´ó³µÅÆÊ¶±ğ»òĞ¡³µÅÆÊ¶±ğ£º0-Ğ¡³µÅÆÊ¶±ğ£¬1-´ó³µÅÆÊ¶±ğ £»
		    bit2-³µÉíÑÕÉ«Ê¶±ğ£º0-²»²ÉÓÃ³µÉíÑÕÉ«Ê¶±ğ£¬ÔÚ±³ÏòÊ¶±ğ»òĞ¡³µÅÆÊ¶±ğÊ±½ûÖ¹ÆôÓÃ£¬1-³µÉíÑÕÉ«Ê¶±ğ£»
		    bit3-Å©ÓÃ³µÊ¶±ğ£º0-²»²ÉÓÃÅ©ÓÃ³µÊ¶±ğ£¬1-Å©ÓÃ³µÊ¶±ğ£» 
		    bit4-Ä£ºıÊ¶±ğ£º0-²»²ÉÓÃÄ£ºıÊ¶±ğ£¬1-Ä£ºıÊ¶±ğ£»
		    bit5-Ö¡¶¨Î»»ò³¡¶¨Î»£º0-Ö¡¶¨Î»£¬1-³¡¶¨Î»£»
		    bit6-Ö¡Ê¶±ğ»ò³¡Ê¶±ğ£º0-Ö¡Ê¶±ğ£¬1-³¡Ê¶±ğ£» 
		    bit7-ÍíÉÏ»ò°×Ìì£º0-°×Ìì£¬1-ÍíÉÏ */
			public byte bySendPRRaw;        //ÊÇ·ñ·¢ËÍÔ­Í¼£º0-²»·¢ËÍ£¬1-·¢ËÍ 
			public byte bySendBinImage;     //ÊÇ·ñ·¢ËÍ³µÅÆ¶şÖµÍ¼£º0-²»·¢ËÍ£¬1-·¢ËÍ 
		...
		public struct NET_DVR_PLCCFG {
			...
			public byte byTradeoffFlash;     //ÊÇ·ñ¿¼ÂÇÉÁ¹âµÆµÄÓ°Ïì: 0 - ·ñ;  1 - ÊÇ(Ä¬ÈÏ); 
											 //Ê¹ÓÃÉÁ¹âµÆ²¹¹âÊ±, Èç¹û¿¼ÂÇ¼õÈõÉÁ¹âµÆµÄÁÁ¶ÈÔöÇ¿Ğ§Ó¦, ÔòĞèÒªÉèÎª1;·ñÔòÎª0
			public byte byCorrectFactor;     //¾ÀÕıÏµÊı, ·¶Î§[0, 100], Ä¬ÈÏÖµ50 (ÔÚtradeoff_flashÇĞ»»Ê±,»Ö¸´Ä¬ÈÏÖµ£©
			public ushort wLoopStatsEn;  //ÊÇ·ñ¸ÃÏßÈ¦µÄÁÁ¶È£¬°´Î»±íÊ¾£¬0-²»Í³¼Æ£¬1-Í³¼Æ
			public byte byPlcBrightOffset;// ³µÅÆÁÁ¶È²¹³¥ÁéÃô¶È(ĞéÄâÏßÈ¦Ä£Ê½ÆğĞ§)£¬È¡Öµ·¶Î§1~100
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 19, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_DEVICESTATECFG {
			public uint dwSize;
			public ushort wPreviewNum; //Ô¤ÀÀÁ¬½Ó¸öÊı
			public ushort wFortifyLinkNum; //²¼·ÀÁ¬½Ó¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_LINK, ArraySubType = UnmanagedType.Struct)]
			...
			public byte byStreamType; //´«ÊäÀàĞÍ£º0-Ö÷ÂëÁ÷£»1-×ÓÂëÁ÷
			public byte byTriggerType; //´¥·¢Ä£Ê½£º0-ÊÓÆµ´¥·¢£»1-ÆÕÍ¨´¥·¢
			public uint dwSDVolume;  //SD¿¨ÈİÁ¿
			...
			public byte[] byDetectorState;  //³µ¼ìÆ÷×´Ì¬£º0-Î´Ê¹ÓÃ£»1-Õı³££»2-Òì³£
			public byte byDetectorLinkState; //³µ¼ìÆ÷Á¬½Ó×´Ì¬£º0-Î´Á¬½Ó£»1-Á¬½Ó
			public byte bySDStatus;    //SD¿¨×´Ì¬ 0£­»î¶¯£»1£­ĞİÃß£»2£­Òì³££¬3-ÎŞsd¿¨
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_FORTIFY_NUM, ArraySubType = UnmanagedType.I1)]
			public byte[] byFortifyLevel; //²¼·ÀµÈ¼¶£¬0-ÎŞ£¬1-Ò»µÈ¼¶£¨¸ß£©£¬2-¶şµÈ¼¶£¨ÖĞ£©£¬3-ÈıµÈ¼¶£¨µÍ£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 116, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2; //±£Áô
		}
		...
		public struct NET_DVR_POSTEPOLICECFG {
			...
			public uint[] dwLightChan;  //ĞÅºÅµÆÍ¨µÀºÅ
			public byte byCapSpeed;//±êÖ¾ÏŞËÙ£¬µ¥Î»km/h£¬È¡Öµ·¶Î§[0,255]
			public byte bySpeedLimit;//ÏŞËÙÖµ£¬µ¥Î»km/h£¬È¡Öµ·¶Î§[0,255]
		...
		/***************************** end *********************************************/
		public const int IPC_PROTOCOL_NUM = 50;  //ipc Ğ­Òé×î´ó¸öÊı

		//Ğ­ÒéÀàĞÍ
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_PROTO_TYPE {
			public uint dwType;               /*ipcĞ­ÒéÖµ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = DESC_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byDescribe; /*Ğ­ÒéÃèÊö×Ö¶Î*/
		}
		...
		public struct NET_DVR_IPC_PROTO_LIST {
			public uint dwSize;
			public uint dwProtoNum;           /*ÓĞĞ§µÄipcĞ­ÒéÊıÄ¿*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = IPC_PROTOCOL_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_PROTO_TYPE[] struProto;   /*ÓĞĞ§µÄipcĞ­Òé*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}

		public const int MAX_ALERTLINE_NUM = 8; //×î´ó¾¯½äÏßÌõÊı	
		...
		public struct NET_DVR_TRAVERSE_PLANE_SEARCHCOND {
			...
			public NET_VCA_TRAVERSE_PLANE[] struVcaTraversePlane;  //´©Ô½¾³½çÃæ²ÎÊı
		...
		public const int MAX_INTRUSIONREGION_NUM = 8; //×î´óÇøÓòÊıÊı
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		public struct NET_DVR_AREA_SMARTSEARCH_COND_UNION {
			...
			public byte[] byLen;  //½á¹¹Ìå³¤¶È
								  ...
								  public byte[] byMotionScope; //Õì²âÇøÓò 0-96Î»±íÊ¾64ĞĞ£¬¹²ÓĞ96*64¸öĞ¡ºê¿é£¬1-ÊÇÒÆ¶¯Õì²âÇøÓò£¬0-·ÇÒÆ¶¯Õì²âÇøÓò 
								  [FieldOffsetAttribute(0)]
		...
		public struct NET_DVR_SMART_SEARCH_PARAM {
			...
			public byte bySearchCondType; //ÖÇÄÜ²éÕÒÁªºÏÌåNET_DVR_AREA_SMARTSEARCH_COND_UNIONµÄË÷Òı     
			...
			public NET_DVR_AREA_SMARTSEARCH_COND_UNION uSmartSearchCond;  //ÖÇÄÜ²éÕÒÌõ¼ş
		...
		public struct NET_DVR_SMART_SEARCH_RET {
			...
			public NET_DVR_TIME struEndTime;   //ÊÂ¼şÍ£Ö¹µÄÊ±¼ä
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_IPSAN_SERACH_RET {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
			public byte[] byDirectory;  // ·µ»ØµÄÎÄ¼şÄ¿Â¼
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_DEVICECFG_V40 {
			...
			public byte byAuxoutNum;            //¸¨¿ÚµÄ¸öÊı
			public byte byAudioNum;         //ÓïÒô¿ÚµÄ¸öÊı
			public byte byIPChanNum;            //×î´óÊı×ÖÍ¨µÀÊı µÍ8Î»£¬¸ß8Î»¼ûbyHighIPChanNum 
			public byte byZeroChanNum;          //ÁãÍ¨µÀ±àÂë¸öÊı
			public byte bySupport;        //ÄÜÁ¦£¬Î»Óë½á¹ûÎª0±íÊ¾²»Ö§³Ö£¬1±íÊ¾Ö§³Ö£¬
										  //bySupport & 0x1, ±íÊ¾ÊÇ·ñÖ§³ÖÖÇÄÜËÑË÷
										  //bySupport & 0x2, ±íÊ¾ÊÇ·ñÖ§³Ö±¸·İ
										  //bySupport & 0x4, ±íÊ¾ÊÇ·ñÖ§³ÖÑ¹Ëõ²ÎÊıÄÜÁ¦»ñÈ¡
										  ...
										  //bySupport & 0x80, ±íÊ¾Ö§³Örtp over rtsp
			public byte byEsataUseage;      //EsataµÄÄ¬ÈÏÓÃÍ¾£¬0-Ä¬ÈÏ±¸·İ£¬1-Ä¬ÈÏÂ¼Ïñ
			...
			public byte[] byDevTypeName;//Éè±¸ĞÍºÅÃû³Æ 
			public byte bySupport2; //ÄÜÁ¦¼¯À©Õ¹£¬Î»Óë½á¹ûÎª0±íÊ¾²»Ö§³Ö£¬1±íÊ¾Ö§³Ö
									//bySupport2 & 0x1, ±íÊ¾ÊÇ·ñÖ§³ÖÀ©Õ¹µÄOSD×Ö·ûµş¼Ó(ÖÕ¶ËºÍ×¥ÅÄ»úÀ©Õ¹Çø·Ö)
			public byte byAnalogAlarmInPortNum; //Ä£Äâ±¨¾¯ÊäÈë¸öÊı
			public byte byStartAlarmInNo;    //Ä£Äâ±¨¾¯ÊäÈëÆğÊ¼ºÅ
			public byte byStartAlarmOutNo;  //Ä£Äâ±¨¾¯Êä³öÆğÊ¼ºÅ
			public byte byStartIPAlarmInNo;  //IP±¨¾¯ÊäÈëÆğÊ¼ºÅ  0-ÎŞĞ§
			public byte byStartIPAlarmOutNo; //IP±¨¾¯Êä³öÆğÊ¼ºÅ 0-ÎŞĞ§
			public byte byHighIPChanNum;     //Êı×ÖÍ¨µÀ¸öÊı£¬¸ß8Î» 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 9, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;           //±£Áô
		}
		...
		public struct NET_DVR_ZERO_ZOOMCFG {
			public uint dwSize;             //½á¹¹³¤¶È
			public NET_VCA_POINT struPoint; //»­ÃæÖĞµÄ×ø±êµã
			public byte byState;         //ÏÖÔÚµÄ×´Ì¬£¬0-ËõĞ¡£¬1-·Å´ó  
			public byte byPreviewNumber;       //Ô¤ÀÀÊıÄ¿,0-1»­Ãæ,1-4»­Ãæ,2-9»­Ãæ,3-16»­Ãæ ¸Ã²ÎÊıÖ»¶Á
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_WINDOW_V30, ArraySubType = UnmanagedType.I1)]
			public byte[] byPreviewSeq;//»­ÃæÍ¨µÀĞÅÏ¢ ¸Ã²ÎÊıÖ»¶Á
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 30, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;                //±£Áô 
		}
		...
		public struct NET_DVR_SNMPCFG {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byWriteCommunity;//Ğ´¹²Í¬Ìå,×î¶à31 ×Ö½Ú,Ä¬ÈÏ "private"
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = DESC_LEN_64, ArraySubType = UnmanagedType.I1)]
			public byte[] byTrapHostIP; //×ÔÏİÖ÷»úipµØÖ·ÃèÊö£¬Ö§³ÖIPV4 IPV6ºÍÓòÃûÃèÊö    
		...
		public struct NET_DVR_SNMPv3_USER {
			...
			public byte bySecLevel; //°²È«¼¶±ğ 1-ÎŞĞ£Ñé 2-ÎŞÊÚÈ¨Ğ£Ñé 3-ÊÚÈ¨Ğ£Ñé
			public byte byAuthtype; //ÈÏÖ¤ÀàĞÍ 0-MD5ÈÏÖ¤ 1-SHAÈÏÖ¤ 2: none
		...
		public struct NET_DVR_SNMPCFG_V30 {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
			public NET_DVR_SNMPv3_USER struRWUser;    // ¶ÁĞ´ÓÃ»§
			public NET_DVR_SNMPv3_USER struROUser;    // Ö»¶ÁÓÃ»§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byTrapName;
		}

		public const int PROCESSING = 0;    //ÕıÔÚ´¦Àí
		public const int PROCESS_SUCCESS = 100;   //¹ı³ÌÍê³É
		public const int PROCESS_EXCEPTION = 400;   //¹ı³ÌÒì³£
		public const int PROCESS_FAILED = 500;   //¹ı³ÌÊ§°Ü
		...
		public const int MAX_SADP_NUM = 256;  //ËÑË÷µ½Éè±¸×î´óÊıÄ¿
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_SADPINFO_LIST {
			public uint dwSize;   //  ½á¹¹´óĞ¡
			public ushort wSadpNum;   // ËÑË÷µ½Éè±¸ÊıÄ¿
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;   // ±£Áô×Ö½Ú
		...
		public const int MAX_NODE_NUM = 256;  //½Úµã¸öÊı
		...
		public struct NET_DVR_DESC_NODE {
			...
			public uint dwFreeSpace; //»ñÈ¡´ÅÅÌÁĞ±í×¨ÓÃ,µ¥Î»ÎªM
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;              //±£Áô  
		}
		...
		public struct NET_DVR_DISKABILITY_LIST {
			public uint dwSize;            //½á¹¹³¤¶È
			public uint dwNodeNum;       //ÄÜÁ¦½áµã¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_NODE_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_DESC_NODE[] struDescNode;  //ÃèÊö²ÎÊı  
		}

		//±¸·İ½ø¶ÈÁĞ±í
		public const int BACKUP_SUCCESS = 100;  //±¸·İÍê³É
		public const int BACKUP_CHANGE_DEVICE = 101;  //±¸·İÉè±¸ÒÑÂú£¬¸ü»»Éè±¸¼ÌĞø±¸·İ

		public const int BACKUP_SEARCH_DEVICE = 300;  //ÕıÔÚËÑË÷±¸·İÉè±¸
		public const int BACKUP_SEARCH_FILE = 301;  //ÕıÔÚËÑË÷Â¼ÏñÎÄ¼ş
		public const int BACKUP_SEARCH_LOG_FILE = 302;  //ÕıÔÚËÑË÷ÈÕÖ¾ÎÄ¼ş

		public const int BACKUP_EXCEPTION = 400;  //±¸·İÒì³£
		public const int BACKUP_FAIL = 500;  //±¸·İÊ§°Ü

		public const int BACKUP_TIME_SEG_NO_FILE = 501;  //Ê±¼ä¶ÎÄÚÎŞÂ¼ÏñÎÄ¼ş
		public const int BACKUP_NO_RESOURCE = 502;  //ÉêÇë²»µ½×ÊÔ´
		public const int BACKUP_DEVICE_LOW_SPACE = 503;  //±¸·İÉè±¸ÈİÁ¿²»×ã
		public const int BACKUP_DISK_FINALIZED = 504;  //¿ÌÂ¼¹âÅÌ·âÅÌ
		public const int BACKUP_DISK_EXCEPTION = 505;  //¿ÌÂ¼¹âÅÌÒì³£
		public const int BACKUP_DEVICE_NOT_EXIST = 506;  //±¸·İÉè±¸²»´æÔÚ
		public const int BACKUP_OTHER_BACKUP_WORK = 507;  //ÓĞÆäËû±¸·İ²Ù×÷ÔÚ½øĞĞ
		public const int BACKUP_USER_NO_RIGHT = 508;  //ÓÃ»§Ã»ÓĞ²Ù×÷È¨ÏŞ
		public const int BACKUP_OPERATE_FAIL = 509;  //²Ù×÷Ê§°Ü
		public const int BACKUP_NO_LOG_FILE = 510;  //Ó²ÅÌÖĞÎŞÈÕÖ¾

		//±¸·İ¹ı³Ì½Ó¿Ú¶¨Òå
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_BACKUP_NAME_PARAM {
			public uint dwFileNum;   //ÎÄ¼ş¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_RECORD_FILE_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_FINDDATA_V30[] struFileList; //ÎÄ¼şÁĞ±í
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = DESC_LEN_32, ArraySubType = UnmanagedType.I1)]
			public byte[] byDiskDes;   //±¸·İ´ÅÅÌÃèÊö
			public byte byWithPlayer;      //ÊÇ·ñ±¸·İ²¥·ÅÆ÷
			public byte byContinue;    /*ÊÇ·ñ¼ÌĞø±¸·İ 0²»¼ÌĞø 1¼ÌĞø*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 34, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;         //±£Áô
		}
		...
		public struct NET_DVR_BACKUP_TIME_PARAM {
			public int lChannel;        //°´Ê±¼ä±¸·İµÄÍ¨µÀ
			public NET_DVR_TIME struStartTime;   //±¸·İµÄÆğÊ¼Ê±¼ä
			public NET_DVR_TIME struStopTime;    //±¸·İµÄÖÕÖ¹Ê±¼ä
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = DESC_LEN_32, ArraySubType = UnmanagedType.I1)]
			public byte[] byDiskDes;     //±¸·İ´ÅÅÌÃèÊö
			public byte byWithPlayer;               //ÊÇ·ñ±¸·İ²¥·ÅÆ÷
			public byte byContinue;                 //ÊÇ·ñ¼ÌĞø±¸·İ 0²»¼ÌĞø 1¼ÌĞø
		...
		public enum COMPRESSION_ABILITY_TYPE {
			COMPRESSION_STREAM_ABILITY = 0, //ÂëÁ÷Ñ¹ËõÀàĞÍ
			MAIN_RESOLUTION_ABILITY = 1,    //Ö÷ÂëÁ÷Ñ¹Ëõ·Ö±æÂÊ
			SUB_RESOLUTION_ABILITY = 2, //×ÓÂëÁ÷Ñ¹Ëõ·Ö±æÂÊ
			EVENT_RESOLUTION_ABILITY = 3,  //ÊÂ¼şÑ¹Ëõ²ÎÊı·Ö±æÂÊ
			FRAME_ABILITY = 4,              //Ö¡ÂÊÄÜÁ¦
			BITRATE_TYPE_ABILITY = 5,       //Î»ÂÊÀàĞÍÄÜÁ¦
			BITRATE_ABILITY = 6,            //Î»ÂÊÉÏÏŞ
			THIRD_RESOLUTION_ABILITY = 7,   //ÈıÂëÁ÷Ñ¹Ëõ·Ö±æÂÊ
			STREAM_TYPE_ABILITY = 8,        //ÂëÁ÷ÀàĞÍ
		...
		public struct NET_DVR_ABILITY_LIST {
			public uint dwAbilityType;  //ÄÜÁ¦ÀàĞÍ COMPRESSION_ABILITY_TYPE
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;        //±£Áô×Ö½Ú
			public uint dwNodeNum;      //ÄÜÁ¦½áµã¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_NODE_NUM, ArraySubType = UnmanagedType.Struct)]
		...
		public struct NET_DVR_HOLIDATE_MODEB {
			...
			public byte byStartWeekNum; // µÚ¼¸¸öĞÇÆÚ ´Ó1¿ªÊ¼ 
			public byte byStartWeekday; // ĞÇÆÚ¼¸
			public byte byEndMonth;     // ´Ó1¿ªÊ¼
			public byte byEndWeekNum;   // µÚ¼¸¸öĞÇÆÚ ´Ó1¿ªÊ¼ 
			public byte byEndWeekday;   // ĞÇÆÚ¼¸
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;        // ±£Áô×Ö½Ú 
		}
		...
		public struct NET_DVR_HOLIDAY_PARAM_CFG {
			...
			public NET_DVR_HOLIDAY_PARAM[] struHolidayParam;    // ¼ÙÈÕ²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;        // ±£Áô²ÎÊı
		}
		...
		public struct NET_DVR_HOLIDAY_RECORD {
			public uint dwSize;
			public NET_DVR_RECORDDAY struRecDay;     // Â¼Ïñ²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
		...
		public struct NET_DVR_DISK_QUOTA {
			public byte byQuotaType;     // ´ÅÅÌÅä¶îÀàĞÍ,1 - °´ÈİÁ¿ 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 7, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;       // ±£Áô×Ö½Ú
			public uint dwHCapacity;     // ·ÖÅäµÄ´ÅÅÌÈİÁ¿¸ß32Î» µ¥Î»MB
			public uint dwLCapacity;     // ·ÖÅäµÄ´ÅÅÌÈİÁ¿µÍ32Î» µ¥Î»MB
			public uint dwHUsedSpace;    // ÒÑÊ¹ÓÃµÄ´ÅÅÌ´óĞ¡¸ß32Î» µ¥Î»MB
			public uint dwLUsedSpace;    // ÒÑÊ¹ÓÃµÄ´ÅÅÌ´óĞ¡µÍ32Î» µ¥Î»MB
			public byte byQuotaRatio;    //	·ÖÅäµÄ´ÅÅÌ±ÈÀı,µ¥Î»:%
		...
		public struct NET_DVR_REL_CAPTURE_CHAN_V40 {
			public uint dwMaxRelCaptureChanNum;  //×î´ó¿É´¥·¢µÄ¹ØÁªÍ¨µÀÊı-Ö»¶ÁÊôĞÔ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
			public uint[] dwChanNo; //´¥·¢µÄ¹ØÁª×¥Í¼Í¨µÀºÅ£¬°´Öµ±íÊ¾£¬²ÉÓÃ½ô´ÕĞÍÅÅÁĞ,0xffffffff±íÊ¾ºóĞøÎŞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_EVENT_CAPTURE_V40 {
			public NET_DVR_JPEGPARA struJpegPara;   // ÊÂ¼ş×¥Í¼Í¼Æ¬ÖÊÁ¿
			public uint dwPicInterval;   // ÊÂ¼ş×¥Í¼Ê±¼ä¼ä¸ô  µ¥Î»ÎªÃë 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_PIC_EVENT_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_REL_CAPTURE_CHAN_V40[] struRelCaptureChan;   // Êı×éÏÂ±ê 0 ÒÆ¶¯Õì²â´¥·¢×¥Í¼ 1 ÊÓÆµÕÚµ²´¥·¢×¥Í¼ 2 ÊÓÆµ¶ªÊ§´¥·¢×¥Í¼,Êı×é3±íÊ¾PIR±¨¾¯×¥Í¼£¬Êı×é4±íÊ¾ÎŞÏß±¨¾¯×¥Í¼£¬Êı×é5±íÊ¾ºô¾È±¨¾¯×¥Í¼,Êı×é6±íÊ¾ÖÇÄÜ×¥Í¼
			...
			public uint dwMaxGroupNum;  //Éè±¸Ö§³ÖµÄ×î´ó±¨¾¯ÊäÈë×éÊı£¬Ã¿×é16¸ö±¨¾¯ÊäÈë
			public byte byCapTimes; //×¥Í¼ÕÅÊı
		...
		public struct NET_DVR_EVENT_CAPTURE {
			public NET_DVR_JPEGPARA struJpegPara;   // ÊÂ¼ş×¥Í¼Í¼Æ¬ÖÊÁ¿
			public uint dwPicInterval;  /*ÊÂ¼ş×¥Í¼Ê±¼ä¼ä¸ô  µ¥Î»ÎªÃë  1-1s 2-2s 3-3s 4-4s 5-5s 
                                             * 6-10m 7-30m 8-1h 9-12h 10-24h*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_PIC_EVENT_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_REL_CAPTURE_CHAN[] struRelCaptureChan; /* Êı×éÏÂ±ê 0 ÒÆ¶¯Õì²â´¥·¢×¥Í¼ 1 ÊÓÆµÕÚµ²´¥·¢×¥Í¼,
                                                                   * 2 ÊÓÆµ¶ªÊ§´¥·¢×¥Í¼,Êı×é3±íÊ¾PIR±¨¾¯×¥Í¼£¬Êı×é4±íÊ¾ÎŞÏß±¨¾¯×¥Í¼£¬
                                                                   * Êı×é5±íÊ¾ºô¾È±¨¾¯×¥Í¼,Êı×é6±íÊ¾ÖÇÄÜ×¥Í¼£¬ Êı×é7±íÊ¾ÈËÁ³Õì²â*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ALARMIN_CAPTURE, ArraySubType = UnmanagedType.Struct)]
		...
		public struct NET_DVR_CAPTURE_DAY {
			...
			public byte byCaptureType;      // ×¥Í¼ÀàĞÍ£º0-¶¨Ê±×¥Í¼£¬1-ÒÆ¶¯Õì²â×¥Í¼£¬2-±¨¾¯×¥Í¼£¬3-ÒÆ¶¯Õì²â»ò±¨¾¯×¥Í¼£¬4-ÒÆ¶¯Õì²âºÍ±¨¾¯×¥Í¼£¬6-ÖÇÄÜ±¨¾¯×¥Í¼
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_SCHED_CAPTURECFG {
			...
			public uint dwRecorderDuration; //×¥Í¼±£´æ×î³¤Ê±¼ä 0xffffffff±íÊ¾¸ÃÖµÎŞĞ§ 
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;            //±£Áô×Ö½Ú
		}
		...
		public struct NET_DVR_FLOW_INFO {
			public uint dwSize;             //½á¹¹´óĞ¡
			public uint dwSendFlowSize;     //·¢ËÍÁ÷Á¿´óĞ¡,µ¥Î»kbps
			public uint dwRecvFlowSize;     //½ÓÊÕÁ÷Á¿´óĞ¡,µ¥Î»kbps
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;          //±£Áô 
		}
		...
		public struct NET_DVR_RECORD_LABEL {
			...
			public byte byQuickAdd;             // ÊÇ·ñ¿ìËÙÌí¼Ó ¿ìËÙÌí¼ÓÊ±±êÇ©Ãû³ÆÎŞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;               // ±£Áô×Ö½Ú
		...
		public const int MAX_DEL_LABEL_IDENTIFY = 20;// É¾³ıµÄ×î´ó±êÇ©±êÊ¶¸öÊı

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_DEL_LABEL_PARAM {
			public uint dwSize;       // ½á¹¹Ìå´óĞ¡
			public byte byMode;   // °´Î»±íÊ¾,0x01±íÊ¾°´±êÊ¶É¾³ı
			public byte byRes1;
			public ushort wLabelNum;      // ±êÇ©ÊıÄ¿   
		...
		public struct NET_DVR_MOD_LABEL_PARAM {
			public NET_DVR_LABEL_IDENTIFY struIndentify; //ÒªĞŞ¸ÄµÄ±êÇ©±êÊ¶
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = LABEL_NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sLabelName;   //ĞŞ¸ÄºóµÄ±êÇ©Ãû³Æ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_FIND_LABEL {
			...
			public NET_DVR_TIME struStopTime;   // ½áÊøÊ±¼ä
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = LABEL_NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sLabelName;   //  Â¼Ïñ±êÇ©Ãû³Æ Èç¹û±êÇ©Ãû³ÆÎª¿Õ£¬ÔòËÑË÷ÆğÖ¹Ê±¼äËùÓĞ±êÇ©
		...
		public struct NET_DVR_FIND_PICTURE_PARAM {
			public uint dwSize;        //½á¹¹Ìå´óĞ¡ 
			public int lChannel;       //Í¨µÀºÅ
			public byte byFileType;   /* ²éÕÒµÄÍ¼Æ¬ÀàĞÍ:0¶¨Ê±×¥Í¼1 ÒÆ¶¯Õì²â×¥Í¼ 2 ±¨¾¯×¥Í¼3  ±¨¾¯ | ÒÆ¶¯Õì²â×¥Í¼ 4 ±¨¾¯ & ÒÆ¶¯Õì²â×¥Í¼
                                       * 6 ÊÖ¶¯×¥Í¼ ,9-ÖÇÄÜÍ¼Æ¬,10- PIR±¨¾¯£¬11- ÎŞÏß±¨¾¯£¬12- ºô¾È±¨¾¯,0xa Ô¤ÀÀÊ±½ØÍ¼£¬0xd ÈËÁ³Õì²â, 
                                       * 0xe Ô½½çÕì²â£¬0xf ÈëÇÖÇøÓòÕì²â£¬0x10 ³¡¾°±ä¸üÕì²â, 0x11-Éè±¸±¾µØ»Ø·ÅÊ±½ØÍ¼, 0x12-ÖÇÄÜÕì²â£¬
                                       * 0xff- È«²¿ÀàĞÍ 2013-07-16*/
			public byte byNeedCard;     //ÊÇ·ñĞèÒª¿¨ºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;      // ±£Áô×Ö½Ú
		...
		public struct NET_DVR_FIND_PICTURE {
			...
			public uint dwFileSize;//Í¼Æ¬µÄ´óĞ¡
		...
		public const int MAX_RECORD_PICTURE_NUM = 50;   //×î´ó±¸·İÍ¼Æ¬ÕÅÊı  
		...
		public struct NET_DVR_COMPRESSION_LIMIT {
			public uint dwSize;           //½á¹¹Ìå´óĞ¡
			public uint dwChannel;        //Í¨µÀºÅ
			public byte byCompressType;   //´ı»ñÈ¡µÄÑ¹Ëõ²ÎÊıÀàĞÍ1,Ö÷ÂëÁ÷2,×ÓÂëÁ÷3,ÊÂ¼ş
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 15, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;        //±£Áô
			public NET_DVR_COMPRESSIONCFG_V30 struCurrentCfg; //µ±Ç°Ñ¹Ëõ²ÎÊıÅäÖÃ
		}

		public const int STEP_READY = 0;    //×¼±¸Éı¼¶
		public const int STEP_RECV_DATA = 1;    //½ÓÊÕÉı¼¶°üÊı¾İ
		public const int STEP_UPGRADE = 2;    //Éı¼¶ÏµÍ³
		public const int STEP_BACKUP = 3;    //±¸·İÏµÍ³
		public const int STEP_SEARCH = 255;  //ËÑË÷Éı¼¶ÎÄ¼ş
		...
		public struct NET_DVR_VIDEO_INPUT_EFFECT {
			...
			public byte[] byRes1;        //±£Áô
			public NET_DVR_VIDEO_EFFECT struVideoEffect;    //ÊÓÆµĞ§¹û²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 60, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;           //±£Áô
		}
		...
		public struct NET_DVR_VIDEOPARA_V40 {
			public uint dwChannel;          // Í¨µÀºÅ
			public uint dwVideoParamType;   // ÊÓÆµ²ÎÊıÀàĞÍ 0-ÁÁ¶È 1-¶Ô±È¶È 2-±¥ºÍ¶È 3-É«¶È 4-Èñ¶È 5-È¥Ôë
			public uint dwVideoParamValue;  //¶ÔÓ¦µÄÊÓÆµ²ÎÊıÖµ£¬·¶Î§ÒÀ¾İÄÜÁ¦¼¯
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_ENCODE_JOINT_PARAM {
			public uint dwSize;         // ½á¹¹Ìå´óĞ¡
			public byte byJointed;      //  0 Ã»ÓĞ¹ØÁª 1 ÒÑ¾­¹ØÁª
			public byte byDevType;      // ±»¹ØÁªµÄÉè±¸ÀàĞÍ  1 ´ú±íÖÇÄÜÉè±¸
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;       // ±£Áô×Ö½Ú
		...
		public struct NET_DVR_VCA_DEV_WORKSTATUS {
			public uint dwSize;         // ½á¹¹Ìå´óĞ¡
			public byte byDeviceStatus; // Éè±¸µÄ×´Ì¬0 - Õı³£¹¤×÷ 1- ²»Õı³£¹¤×÷
			public byte byCpuLoad;      // CPUÊ¹ÓÃÂÊ0-100 ·Ö±ğ´ú±íÊ¹ÓÃ°Ù·ÖÂÊ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_VCA_CHAN, ArraySubType = UnmanagedType.Struct)]
		...
		public struct UNION_VIDEOPLATFORM_V40 {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_WINDOWS, ArraySubType = UnmanagedType.I1)]
			public byte[] byJoinDecoderId;
			//ÏÔÊ¾´°¿ÚËù½âÊÓÆµ·Ö±æÂÊ£¬1-D1,2-720P,3-1080P£¬Éè±¸¶ËĞèÒª¸ù¾İ´Ë//·Ö±æÂÊ½øĞĞ½âÂëÍ¨µÀµÄ·ÖÅä£¬Èç1·ÖÆÁÅäÖÃ³É1080P£¬ÔòÉè±¸»á°Ñ4¸ö½âÂëÍ¨
			//µÀ¶¼·ÖÅä¸ø´Ë½âÂëÍ¨µÀ
		...
		public const int MAX_REDAREA_NUM = 6;   //×î´óºìÂÌµÆÇøÓò¸öÊı

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_REDAREACFG {
			public uint dwSize;
			public uint dwCorrectEnable; //ÊÇ·ñ¿ªÆôĞ£Õı¹¦ÄÜ£¬0-¹Ø±Õ£¬1-¿ªÆô
			public uint dwCorrectLevel; //Ğ£Õı¼¶±ğ£¬1(Ğ£Õı¶È×îµÍ)-10(Ğ£Õı¶È×î¸ß),Ä¬ÈÏÎª5
			public uint dwAreaNum; //Ğ£ÕıÇøÓò¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_REDAREA_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_VCA_RECT[] struLaneRect; //Ğ£ÕıÇøÓò
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2; //±£Áô
		}
		...
		public struct NET_DVR_HISTORICDATACFG {
			public uint dwSize;
			public uint dwTotalNum;  //ÀúÊ·Êı¾İ¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}

		public const int INQUEST_MESSAGE_LEN = 44;    //ÉóÑ¶ÖØµã±ê¼ÇĞÅÏ¢³¤¶È
		public const int INQUEST_MAX_ROOM_NUM = 2;    //×î´óÉóÑ¶ÊÒ¸öÊı
		public const int MAX_RESUME_SEGMENT = 2;     //Ö§³ÖÍ¬Ê±»Ö¸´µÄÆ¬¶ÎÊıÄ¿
		...
		public struct NET_DVR_INQUEST_MESSAGE {
			...
			public string sMessage; //ÖØµã±ê¼ÇĞÅÏ¢
		...
		public struct NET_DVR_INQUEST_SENSOR_DEVICE {
			public ushort wDeviceType;  //Êı¾İ²É¼¯Éè±¸ĞÍºÅ:0-ÎŞ 1-Ã×ÀÖ 2-ÀØ²Ê 3-ÓÅÁ¦ 4-¼ÑÃË 5-ÓÀ¿Ø¡¢6-ÛâÉÏ¡¢7-Î¬ÄÉË¹´ï
			public ushort wDeviceAddr;  //Êı¾İ²É¼¯Éè±¸µØÖ·	
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 28, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;        //±£Áô
		}
		...
		public struct NET_DVR_INQUEST_SENSOR_INFO {
			...
			public uint dwSupportPro;      //Ö§³ÖĞ­ÒéÀàĞÍ,°´Î»±íÊ¾, ĞÂ°æ±¾×ßÄÜÁ¦¼¯£¬²»ÔÙÀ©Õ¹´Ë×Ö¶Î
		...
		public struct NET_DVR_INQUEST_ROOM_INFO {
			...
			public struct uCalcMode {
				[FieldOffsetAttribute(0)]
				public byte byBitRate;  // byCalcTypeÎª0Ê±ÓĞĞ§£¬(0-32¡¢1-48¡¢2-64¡¢3-80¡¢4-96¡¢5-128¡¢
				...
				[FieldOffsetAttribute(0)]
				public byte byInquestTime;  // byCalcTypeÎª1Ê±ÓĞĞ§£¬0-1Ğ¡Ê±, 1-2Ğ¡Ê±,2-3Ğ¡Ê±,3-4Ğ¡Ê±, 4-6Ğ¡Ê±,5-8Ğ¡Ê±
											//8-16Ğ¡Ê±, 9-20Ğ¡Ê±,10-22Ğ¡Ê±,11-24Ğ¡Ê±
			}
			public byte byCalcType;         //¿ÌÂ¼¼ÆËãÀàĞÍ0-°´ÂëÂÊ 1-°´Ê±¼ä
			public byte byAutoDelRecord;    // ÊÇ·ñ×Ô¶¯É¾³ıÂ¼Ïñ£¬0-²»É¾³ı£¬¼´½áÊøÊ±±£´æÂ¼Ïñ 1-É¾³ı
		...
		public struct NET_DVR_INQUEST_SYSTEM_INFO {
			public uint dwRecordMode;         //¿ÌÂ¼Ä£Ê½:1 µ¥ÊÒË«¿ÌÄ£Ê½ 2 µ¥ÊÒÂÖ¿ÌÄ£Ê½ 3 Ë«ÊÒË«¿ÌÄ£Ê½£¨ĞŞ¸ÄĞèÒªÖØÆôÉè±¸£©
			public uint dwWorkMode;           //¹¤×÷Ä£Ê½:0 ±ê×¼Ä£Ê½ 1 Í¨ÓÃÄ£Ê½(±£Áô£¬Ä¿Ç°Ö»ÓĞ±ê×¼Ä£Ê½)
			public uint dwResolutionMode;     //Éè±¸·Ö±æÂÊ£¬0:±êÇå 1:D1 2:720P 3:1080P£¨¸ßÇåÉóÑ¶»ú²»ÓÃ´Ë×Ö¶Î£©
			public NET_DVR_INQUEST_SENSOR_INFO struSensorInfo;  //ÎÂÊª¶È´«¸ĞÆ÷ÅäÖÃ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = INQUEST_MAX_ROOM_NUM, ArraySubType = UnmanagedType.Struct)]
		...
		public struct NET_DVR_INQUEST_RESUME_SEGMENT {
			public NET_DVR_TIME struStartTime; //ÊÂ¼şÆğÊ¼Ê±¼ä
			public NET_DVR_TIME struStopTime;  //ÊÂ¼şÖÕÖ¹Ê±¼ä
			public byte byRoomIndex;         //ÉóÑ¶ÊÒ±àºÅ,´Ó1¿ªÊ¼
			public byte byDriveIndex;        //¿ÌÂ¼»ú±àºÅ,´Ó1¿ªÊ¼
			public ushort wSegmetSize;         //±¾Æ¬¶ÏµÄ´óĞ¡, µ¥Î»M 
			public uint dwSegmentNo;         //±¾Æ¬¶ÏÔÚ±¾´ÎÉóÑ¶ÖĞµÄĞòºÅ,´Ó1¿ªÊ¼ 
		...
		public struct NET_DVR_INQUEST_RESUME_EVENT {
			public uint dwResumeNum;       //Ğè»Ö¸´µÄÊÂ¼ş¸öÊı
		...
		public struct NET_DVR_INQUEST_DEVICE_VERSION {
			...
			public byte byUpgradeVersion;      //Éı¼¶°æ±¾,Î´Éı¼¶Îª0
		...
		public struct NET_DVR_SYNCHRONOUS_IPC {
			public uint dwSize;    //½á¹¹Ìå´óĞ¡
			public byte byEnable;  //ÊÇ·ñÆôÓÃ£ºÎªÇ°¶ËIPCÍ¬²½Éè±¸²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 7, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;  //±£Áô
		}
		...
		public struct NET_DVR_IPC_PASSWD {
			...
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = PASSWD_LEN)]
			public string sNewPasswd;  //IPCµÄĞÂÃÜÂë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}

		//Í¨¹ı»ñÈ¡DVRµÄÍøÂç×´Ì¬£ºµ¥Î»bps
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DEVICE_NET_USING_INFO {
			...
			public uint dwNetDiskRW; //ÍøÅÌ¶ÁĞ´
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] res;
		}

		//Í¨¹ıDVRÉèÖÃÇ°¶ËIPCµÄIPµØÖ·
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		public struct NET_DVR_TIME_LOCK {
			...
			public uint dwChannel;        //Í¨µÀºÅ, 0xff±íÊ¾ËùÓĞÍ¨µÀ
			public uint dwRecordType;     //Â¼ÏñÀàĞÍ:  0xffffffff£­È«²¿£¬0£­¶¨Ê±Â¼Ïñ£¬1-ÒÆ¶¯Õì²â£¬2£­±¨¾¯´¥·¢£¬3-±¨¾¯´¥·¢»òÒÆ¶¯Õì²â£¬4-±¨¾¯´¥·¢ºÍÒÆ¶¯Õì²â£¬5-ÃüÁî´¥·¢£¬6-ÊÖ¶¯Â¼Ïñ£¬7-ÖÇÄÜÂ¼Ïñ(Í¬ÎÄ¼ş²éÕÒ)
			public uint dwLockDuration;   //Ëø¶¨³ÖĞøÊ±¼ä,µ¥Î»Ãë,0xffffffff±íÊ¾ÓÀ¾ÃËø¶¨
			public NET_DVR_TIME_EX strUnlockTimePoint;  //¼ÓËøÊ±ÓĞĞ§£¬µ±dwLockDuration²»ÎªÓÀ¾ÃËø¶¨Ê±£¬Ëø¶¨³ÖĞøµÄÊ±¼äµ½´ËÊ±¼äµã¾Í×Ô¶¯½âËø
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_BONJOUR_CFG {
			...
			public byte[] byRes1;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DOMAIN_NAME, ArraySubType = UnmanagedType.I1)]
			public byte[] byFriendlyName;   // ·şÎñÃû
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_QOS_CFG {
			public uint dwSize;
			public byte byManageDscp;   // ¹ÜÀíÊı¾İµÄDSCPÖµ [0-63]
			public byte byAlarmDscp;    // ±¨¾¯Êı¾İµÄDSCPÖµ [0-63]
			public byte byVideoDscp;    // ÊÓÆµÊı¾İµÄDSCPÖµ [0-63]£¬byFlagÎª0Ê±£¬±íÊ¾ÒôÊÓÆµ
			public byte byAudioDscp;    // ÒôÆµÊı¾İµÄDSCPÖµ [0-63]£¬byFlagÎª1Ê±ÓĞĞ§
		...
		public struct NET_DVR_CERT_PARAM {
			...
			public ushort wCertType; //Ö¤ÊéÀàĞÍ£¬0-CA£¬1-Certificate,2-Ë½Ô¿ÎÄ¼ş
			public byte byFileType; //Ö¤ÊéÎÄ¼şÀàĞÍ£¬0-PEM,1-PFX
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 35, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_CERT_INFO {
			public uint dwSize;
			public NET_DVR_CERT_PARAM struCertParam;    //Ö¤Êé²ÎÊı
			public uint dwValidDays;   //ÓĞĞ§ÌìÊı£¬ÀàĞÍÎª×ÔÇ©ÃûÊ±ÓĞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byPasswd;   //Ë½Ô¿ÃÜÂë
			public NET_DVR_CERT_NAME struCertName;    // Ö¤ÊéÃû³Æ
			public NET_DVR_CERT_NAME struIssuerName;    // Ö¤Êé·¢ĞĞÕßÃû³Æ£¨×ÔÇ©ÃûÖ¤ÊéĞÅÏ¢»ñÈ¡Ê±ÓĞĞ§£©
			public NET_DVR_TIME_EX struBeginTime;   //Ö¤Êé´´½¨Ê±¼ä£¨×ÔÇ©ÃûÖ¤ÊéĞÅÏ¢»ñÈ¡Ê±ÓĞĞ§£©
			public NET_DVR_TIME_EX struEndTime;   //Ö¤Êé½ØÖ¹Ê±¼ä£¨×ÔÇ©ÃûÖ¤ÊéĞÅÏ¢»ñÈ¡Ê±ÓĞĞ§£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] serialNumber;   //Ö¤Êé±êÊ¶Âë£¨×ÔÇ©ÃûÖ¤ÊéĞÅÏ¢»ñÈ¡Ê±ÓĞĞ§£©
			public byte byVersion;
			public byte byKeyAlgorithm;         //¼ÓÃÜÀàĞÍ 0-RSA  1-DSA
			public byte byKeyLen;               //¼ÓÃÜ³¤¶È 0-512  1-1024¡¢ 2-2048
			public byte bySignatureAlgorithm; //Ç©ÃûËã·¨ÀàĞÍ£¨×ÔÇ©ÃûÖ¤ÊéĞÅÏ¢»ñÈ¡Ê±ÓĞĞ§£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_CHANS_RECORD_STATUS {
			public byte byValid;       //ÊÇ·ñÓĞĞ§
			public byte byRecord;      /*(Ö»¶Á)Â¼ÏñÀàĞÍ, °´Î»±íÊ¾:0: ²»ÔÚÂ¼Ïñ£»1£ºÔÚÂ¼Ïñ 2-¿ÕÏĞ 
						3-ÎŞÁ¬½Ó 4-ÎŞÊäÈëÊÓÆµ 5-Î´¼ÓÔØ 6-´æµµÖĞ
							7-»Ø´«ÖĞ 8-ÓÃ»§Ãû»òÃÜÂë´í 9-Î´ÑéÖ¤
							10-´æµµÖĞºÍÂ¼ÏñÖĞ 11-Â¼Ïñ»Ø´«ÖĞºÍÂ¼ÏñÖĞ*/
		...
		public struct NET_DVR_IP_ALARM_GROUP_NUM {
			public uint dwSize;
			public uint dwIPAlarmInGroup;      //IPÍ¨µÀ±¨¾¯ÊäÈë×éÊı
			public uint dwIPAlarmInNum;       //IPÍ¨µÀ±¨¾¯ÊäÈë¸öÊı
			public uint dwIPAlarmOutGroup;     //IPÍ¨µÀ±¨¾¯Êä³ö×éÊı
			public uint dwIPAlarmOutNum;      //IPÍ¨µÀ±¨¾¯Êä³ö¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_RECTCFG {
			public ushort wXCoordinate; /*¾ØĞÎ×óÉÏ½ÇÆğÊ¼µãX×ø±ê*/
			public ushort wYCoordinate; /*¾ØĞÎ×óÉÏ½ÇY×ø±ê*/
			public ushort wWidth;       /*¾ØĞÎ¿í¶È*/
			public ushort wHeight;      /*¾ØĞÎ¸ß¶È*/
		}
		...
		public struct NET_DVR_WINCFG {
			public uint dwSize;
			public byte byVaild;
			public byte byInputIdx;          /*ÊäÈëÔ´Ë÷Òı*/
		...
		public struct NET_MATRIX_CAMERAINFO {
			...
			public byte byValid;    /*ÊÇ·ñÓĞĞ§£¬0-·ñ£¬1-ÊÇ*/
			public byte byPtzCtrl; /* ÊÇ·ñ¿É¿Ø£¬0-·ñ£¬1-ÊÇ*/
			public byte byUseType; //*Ê¹ÓÃÀàĞÍ£¬0-²»×÷Îª¸ÉÏßÊ¹ÓÃ£¬1-BNC£¬2-SP3,3-V6¹âÏË£¬4-ÆäËû¹âÏË*/ 
			public byte byUsedByTrunk;//µ±Ç°Ê¹ÓÃ×´Ì¬£¬0-Ã»ÓĞ±»Ê¹ÓÃ£¬1-±»¸ÉÏßÊ¹ÓÃ 
		...
		public struct NET_MATRIX_MONITORINFO {
			...
			public byte byValid;    /*ÊÇ·ñÓĞĞ§£¬0-·ñ£¬1-ÊÇ*/
			public byte byTrunkType; /*Ê¹ÓÃÀàĞÍ£¬0-²»×÷Îª¸ÉÏßÊ¹ÓÃ£¬1-BNC£¬2-SP3,3-V6¹âÏË£¬4-ÆäËû¹âÏË*/
			public byte byUsedByTrunk;//µ±Ç°Ê¹ÓÃ×´Ì¬£¬0-Ã»ÓĞ±»Ê¹ÓÃ£¬1-±»¸ÉÏßÊ¹ÓÃ 
		...
		public struct NET_MATRIX_DIGITALMATRIX {
			public NET_DVR_IPADDR struAddress; /*Éè±¸ÎªÊı×ÖÉè±¸Ê±µÄIPĞÅÏ¢*/
			public ushort wPort;
			public byte byNicNum; /*0 - eth0, 1 - eth1, ¿¼ÂÇË«Íø¿ÚÈçºÎÍ¨ĞÅ¼ÓÈë°ó¶¨µÄÍø¿Ú*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 69, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_MATRIX_ANALOGMATRIX {
			...
			public byte byMatrixSerPortType;/* ¾ØÕó½ÓÈëÍø¹ØµÄ´®¿ÚÓëÄ£Äâ¾ØÕóµÄ¼üÅÌ¿Ú(¼üÅÌĞ­Òé)Á¬½Ó»¹ÊÇÓë¾ØÕóÍ¨ĞÅ¿Ú£¨¾ØÕóĞ­Òé£©Á¬½Ó £¬0 --- ¾ØÕóĞ­ÒéÍ¨Ñ¶¿Ú 1 --- ¼üÅÌÍ¨Ñ¶¿Ú*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public NET_DVR_SINGLE_RS232 struRS232;  //232´®¿Ú²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 200, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_MATRIXLIST {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			public uint dwMatrixNum;//Éè±¸·µ»ØµÄ¾ØÕóÊıÁ¿
			public IntPtr pBuffer;//¾ØÕóĞÅÏ¢»º³åÇø
			public uint dwBufLen;//Ëù·ÖÅäÖ¸Õë³¤¶È£¬ÊäÈë²ÎÊı
		}
		...
		public struct NET_MATRIX_UARTPARAM {
			...
			public ushort wUserId; /*ÓÃ»§±àºÅ£¬µ±Á¬½ÓÉè±¸Îª¼üÅÌÊ±£¬°ó¶¨Ò»¸öÓÃ»§£¬ÓÃÓÚÈ¨ÏŞ¹ÜÀí*/
			public byte byPortType;    /*´®¿ÚÀàĞÍ£¬ÈıÖÖ0-RS232/1-RS485/2-RS422*/
			public byte byFuncType; /*´®¿ÚÁ¬½ÓµÄÉè±¸µÄÀàĞÍ0-¿ÕÏĞ£¬1-¼üÅÌ£¬2-ÓÃ×÷Í¸Ã÷Í¨µÀ(485´®¿Ú²»¿ÉÅäÖÃ³ÉÍ¸Ã÷Í¨µÀ),3-Ä£Äâ¾ØÕó*/
			public byte byProtocolType;  /*´®¿ÚÖ§³ÖµÄĞ­ÒéÀàĞÍ, µ±Á¬½Ó¼üÅÌÉè±¸Ê±ĞèÒª¸ÃĞÅÏ¢,»ñÈ¡¼üÅÌÖ§³ÖĞ­ÒéµÄ±àºÅ¼°ÃèÊö·û*/
			public byte byBaudRate;
			public byte byDataBits;
			public byte byStopBits;   /*Í£Ö¹Î»*/
			public byte byParity;      /*Ğ£Ñé*/
			public byte byFlowCtrl;   /*Á÷¿Ø£¬Èí¼şÁ÷¿Ø£¬ÎŞÁ÷¿Ø*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 22, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_MATRIX_USERPARAM {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = PASSWD_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sPassword;
			public byte byRole;/*ÓÃ»§½ÇÉ«:0-¹ÜÀíÔ±,1-²Ù×÷Ô±£»Ö»ÓĞÒ»¸öÏµÍ³¹ÜÀíÔ±£¬255¸ö²Ù×÷Ô±*/
			public byte byLevel;  /*Í³Ò»¼¶±ğ£¬ÓÃÓÚ²Ù×÷¼¶±ğ¹ÜÀí,1- 255*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 18, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_MATRIX_USERGROUPPARAM {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byPermission;//È¨ÏŞ£¬Êı×é0-ptzÈ¨ÏŞ¡¢ÇĞ»»È¨ÏŞ¡¢²éÑ¯È¨ÏŞ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_MATRIX_TRUNKPARAM {
			...
			public byte byTrunkType;  /*Ê¹ÓÃÀàĞÍ  1-BNC£¬2-SP3¹âÏË¸ßÇå£¬3-SP3¹âÏËD1£¬ 4-V6¹âÏË£¬5-ÆäËû¹âÏË*/
			public byte byAbility;     /*±íÊ¾¹âÏËµÄ´ø¿í£¬¿ÉÒÔ´«Êä¼¸Â·*/
			public byte bySubChan;   /*Õë¶Ô¹âÏË¸ÉÏß¶øÑÔ£¬±íÊ¾×ÓÍ¨µÀºÅ*/
			public byte byLevel;        /* ¸ÉÏß¼¶±ğ 1-255*/
		...
		public struct NET_DVR_MATRIX_TRUNKLIST {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			public uint dwTrunkNum;//Éè±¸·µ»ØµÄ¸ÉÏßÊıÁ¿
			public IntPtr pBuffer;//¸ÉÏßĞÅÏ¢»º³åÇø
			public uint dwBufLen;//Ëù·ÖÅäÖ¸Õë³¤¶È£¬ÊäÈë²ÎÊı
		}

		public const int MATRIX_PROTOCOL_NUM = 20;    //Ö§³ÖµÄ×î´ó¾ØÕóĞ­ÒéÊı
		public const int KEYBOARD_PROTOCOL_NUM = 20;    //Ö§³ÖµÄ×î´ó¼üÅÌĞ­ÒéÊı

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_PROTO_TYPE_EX {
			public ushort wType;               /*ipcĞ­ÒéÖµ*/
			public ushort wCommunitionType;     /*0£ºÄ£Äâ 1£ºÊı×Ö 2£º¼æÈİÄ£Äâ¡¢Êı×Ö*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = DESC_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byDescribe; /*Ğ­ÒéÃèÊö×Ö¶Î*/
		}
		...
		public struct NET_DVR_MATRIXMANAGE_ABIILITY {
			public uint dwSize;
			public uint dwMaxCameraNum;//×î´óCameraÊıÁ¿
			public uint dwMaxMonitorNum;//×î´ó¼àÊÓÆ÷ÊıÁ¿
			public ushort wMaxMatrixNum;//×î´ó¾ØÕóÊıÁ¿
			public ushort wMaxSerialNum;//´®¿ÚÊıÁ¿
			public ushort wMaxUser;//×î´óÓÃ»§Êı
			public ushort wMaxResourceArrayNum;//×î´ó×ÊÔ´×éÊı
			public ushort wMaxUserArrayNum;//×î´óÓÃ»§×éÊı
			public ushort wMaxTrunkNum;//×î´ó¸ÉÏßÊı
			public byte nStartUserNum;//ÆğÊ¼ÓÃ»§ºÅ
			public byte nStartUserGroupNum;//ÆğÊ¼ÓÃ»§×éºÅ
			public byte nStartResourceGroupNum;//ÆğÊ¼×ÊÔ´×éºÅ
			public byte nStartSerialNum;//ÆğÊ¼´®¿ÚºÅ
			public uint dwMatrixProtoNum;     /*ÓĞĞ§µÄ¾ØÕóĞ­ÒéÊıÄ¿£¬´Ó0¿ªÊ¼*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MATRIX_PROTOCOL_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_PROTO_TYPE_EX[] struMatrixProto;/*×î´óĞ­ÒéÁĞ±í³¤¶È*/
			public uint dwKeyBoardProtoNum;     /*ÓĞĞ§µÄ¼üÅÌĞ­ÒéÊıÄ¿£¬´Ó0¿ªÊ¼*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MATRIX_PROTOCOL_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_PROTO_TYPE_EX[] struKeyBoardProto;/*×î´óĞ­ÒéÁĞ±í³¤¶È*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_VCA_SINGLE_FACESNAPCFG {
			...
			public byte[] byRes;     //±£Áô
			public NET_VCA_SIZE_FILTER struSizeFilter;   //³ß´ç¹ıÂËÆ÷
			public NET_VCA_POLYGON struVcaPolygon;      //ÈËÁ³Ê¶±ğÇøÓò
		}
		...
		public struct NET_VCA_FACESNAPCFG {
			public uint dwSize;
			public byte bySnapTime;                 //µ¥¸öÄ¿±êÈËÁ³µÄ×¥ÅÄ´ÎÊı0-10
			public byte bySnapInterval;                 //×¥ÅÄ¼ä¸ô£¬µ¥Î»£ºÖ¡
			public byte bySnapThreshold;               //×¥ÅÄãĞÖµ£¬0-100
			...
			public byte byMatchThreshold;  //2012-5-3ÊµÊ±±È¶ÔãĞÖµ£¬0~100
			public NET_DVR_JPEGPARA struPictureParam; //Í¼Æ¬¹æ¸ñ½á¹¹
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_RULE_NUM, ArraySubType = UnmanagedType.Struct)]
		...
		public struct NET_VCA_FACESNAP_RESULT {
			...
			public byte byAlarmEndMark;//±¨¾¯½áÊø±ê¼Ç0-±£Áô£¬1-½áÊø±ê¼Ç£¨¸Ã×Ö¶Î½áºÏÈËÁ³ID×Ö¶ÎÊ¹ÓÃ£¬±íÊ¾¸ÃID¶ÔÓ¦µÄÏÂ±¨¾¯½áÊø£¬Ö÷ÒªÌá¹©¸øNVRÊ¹ÓÃ£¬ÓÃÓÚÅĞ¶Ï±¨¾¯½áÊø£¬ÌáÈ¡Ê¶±ğÍ¼Æ¬Êı¾İÖĞ£¬ÇåÎú¶È×î¸ßµÄÍ¼Æ¬£©
			public byte byRepeatTimes;   //ÖØ¸´±¨¾¯´ÎÊı£¬0-ÎŞÒâÒå
			public byte byUploadEventDataType;//ÈËÁ³Í¼Æ¬Êı¾İ³¤´«·½Ê½£º0-¶ş½øÖÆÊı¾İ£¬1-URL
			public NET_VCA_HUMAN_FEATURE struFeature;  //ÈËÌåÊôĞÔ
			public float fStayDuration;  //Í£Áô»­ÃæÖĞÊ±¼ä(µ¥Î»: Ãë)
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] sStorageIP;        //´æ´¢·şÎñIPµØÖ·
			public ushort wStoragePort;            //´æ´¢·şÎñ¶Ë¿ÚºÅ
			public ushort wDevInfoIvmsChannelEx;     //ÓëNET_VCA_DEV_INFOÀïµÄbyIvmsChannelº¬ÒåÏàÍ¬£¬ÄÜ±íÊ¾¸ü´óµÄÖµ¡£ÀÏ¿Í»§¶ËÓÃbyIvmsChannelÄÜ¼ÌĞø¼æÈİ£¬µ«ÊÇ×î´óµ½255¡£ĞÂ¿Í»§¶Ë°æ±¾ÇëÊ¹ÓÃwDevInfoIvmsChannelEx¡£
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 7, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;              // ±£Áô×Ö½Ú
			public byte byBrokenNetHttp;     //¶ÏÍøĞø´«±êÖ¾Î»£¬0-²»ÊÇÖØ´«Êı¾İ£¬1-ÖØ´«Êı¾İ
			public IntPtr pBuffer1;//Ö¸ÏòÈËÁ³×ÓÍ¼µÄÍ¼Æ¬Êı¾İ
			public IntPtr pBuffer2;//±³¾°Í¼µÄÍ¼Æ¬Êı¾İ£¨±£Áô£¬Í¨¹ı²éÕÒ±³¾°Í¼½Ó¿Ú¿ÉÒÔ»ñÈ¡±³¾°Í¼£©
		}
		...
		public struct NET_DVR_FACE_DETECTION {
			...
			public byte[] byRes;//±£Áô
			public IntPtr pBackgroundPicpBuffer;//±³¾°Í¼µÄÍ¼Æ¬Êı¾İ
		}
		...
		public struct NET_DVR_DEFOCUS_ALARM {
			public uint dwSize;     /*½á¹¹³¤¶È*/
			public NET_VCA_DEV_INFO struDevInfo;/*Éè±¸ĞÅÏ¢*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;        // ±£Áô×Ö½Ú
		}
		...
		public struct NET_DVR_AUDIOEXCEPTION_ALARM {
			public uint dwSize;     /*½á¹¹³¤¶È*/
			public byte byAlarmType;//±¨¾¯ÀàĞÍ£¬1-ÒôÆµÊäÈëÒì³££¬2-ÒôÆµÊäÈëÍ»±ä
			public byte byRes1;
		...
		public struct NET_VCA_FD_IMAGE_CFG {
			public uint dwWidth;                  //»Ò¶ÈÍ¼ÏñÊı¾İ¿í¶È
			public uint dwHeight;                 //»Ò¶ÈÍ¼Ïñ¸ß¶È
			public uint dwImageLen;  //»Ò¶ÈÍ¼ÏñÊı¾İ³¤¶È
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;  //±£Áô
			public IntPtr pImage;    //»Ò¶ÈÍ¼ÏñÊı¾İ
		}
		...
		public struct NET_VCA_FD_PROCIMG_CFG {
			...
			public NET_VCA_SIZE_FILTER struSizeFilter;  //³ß´ç¹ıÂËÆ÷
			public NET_VCA_POLYGON struPolygon;    //¶à±ßĞÎ
			public NET_VCA_FD_IMAGE_CFG struFDImage;  //Í¼Æ¬ĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;    //±£Áô
		}
		...
		public struct NET_VCA_FD_PROCIMG_RESULT {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes; //±£Áô
			public uint dwSubImageNum;  //ÈËÁ³×ÓÍ¼ÕÅÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_TARGET_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_VCA_SUB_PROCIMG[] struProcImg;  //µ¥ÕÅ×ÓÍ¼ĞÅÏ¢
		}

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_VCA_PICMODEL_RESULT {
			public uint dwImageLen;  //Í¼Æ¬Êı¾İ³¤¶È
			public uint dwModelLen;  //Ä£ĞÍÊı¾İ³¤¶È
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes; //±£Áô
			public IntPtr pImage;  //ÈËÁ³Í¼Æ¬Êı¾İÖ¸Õë
			public IntPtr pModel;  //Ä£ĞÍÊı¾İÖ¸Õë
		}
		...
		public struct NET_VCA_HUMAN_ATTRIBUTE {
			public byte bySex;//ĞÔ±ğ£º0-ÄĞ£¬1-Å®
			public byte byCertificateType;//Ö¤¼şÀàĞÍ£º0-Éí·İÖ¤£¬1-¾¯¹ÙÖ¤
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byName; //ĞÕÃû
			public NET_DVR_AREAINFOCFG struNativePlace;//¼®¹á²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byCertificateNumber; //Ö¤¼şºÅ
			public uint dwPersonInfoExtendLen;// ÈËÔ±±êÇ©ĞÅÏ¢À©Õ¹³¤¶È
			public IntPtr pPersonInfoExtend;  //ÈËÔ±±êÇ©ĞÅÏ¢À©Õ¹ĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;//±£Áô
		}
		...
		public struct NET_VCA_HUMANATTRIBUTE_COND {
			public byte bySex; //ĞÔ±ğ£º0-²»ÆôÓÃ£¬1-ÄĞ£¬2-Å®
			public byte byCertificateType; //Ö¤¼şÀàĞÍ£º0-²»ÆôÓÃ£¬1-Éí·İÖ¤£¬2-¾¯¹ÙÖ¤
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_HUMAN_BIRTHDATE_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byStartBirthDate; //ÆğÊ¼³öÉúÄêÔÂ£¬Èç£º201106
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_HUMAN_BIRTHDATE_LEN, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_VCA_BLACKLIST_INFO {
			...
			public byte byLevel;//ºÚÃûµ¥µÈ¼¶£¬0-È«²¿£¬1-µÍ£¬2-ÖĞ£¬3-¸ß
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;//±£Áô
			public NET_VCA_HUMAN_ATTRIBUTE struAttribute;//ÈËÔ±ĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byRemark;//±¸×¢ĞÅÏ¢
			public uint dwFDDescriptionLen;//ÈËÁ³¿âÃèÊöÊı¾İ³¤¶È
			public IntPtr pFDDescriptionBuffer;//ÈËÁ³¿âÃèÊöÊı¾İÖ¸Õë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;//±£Áô
		}
		...
		public struct NET_VCA_BLACKLIST_PARA {
			public uint dwSize;   //½á¹¹´óĞ¡
			public NET_VCA_BLACKLIST_INFO struBlackListInfo;  //ºÚÃûµ¥»ù±¾²ÎÊı
			public uint dwRegisterPicNum;  //ºÚÃûµ¥Í¼¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_HUMAN_PICTURE_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_VCA_PICMODEL_RESULT[] struRegisterPic;  //ºÚÃûµ¥Í¼Æ¬ĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 40, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes; //±£Áô
		}
		...
		public struct NET_VCA_BLACKLIST_PIC {
			public uint dwSize;   //½á¹¹´óĞ¡
			public uint dwFacePicNum;  //ÈËÁ³Í¼¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes; //±£Áô
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_HUMAN_PICTURE_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_VCA_PICMODEL_RESULT[] struBlackListPic;  //µ¥ÕÅÕÕÆ¬ĞÅÏ¢
		}
		...
		public const int MAX_FACE_PIC_LEN = 6144;   //×î´óÈËÁ³Í¼Æ¬Êı¾İ³¤¶È

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_VCA_SUB_SNAPPIC_DATA {
			public uint dwFacePicID; //ÈËÁ³Í¼ID
			public uint dwFacePicLen;  //ÈËÁ³Í¼Êı¾İ³¤¶È
			...
			public string sPicBuf;  //Í¼Æ¬Êı¾İ
		}
		...
		public struct NET_VCA_FIND_PICTURECOND_ADVANCE {
			...
			public NET_DVR_TIME struStartTime;//¿ªÊ¼Ê±¼ä
			public NET_DVR_TIME struStopTime;//½áÊøÊ±¼ä
			public byte byThreshold;  //ãĞÖµ£¬0-100
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 23, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes; //±£Áô
			public VCA_FIND_SNAPPIC_TYPE dwFindType;//¼ìË÷ÀàĞÍ£¬Ïê¼ûVCA_FIND_SNAPPIC_TYPE
			public NET_VCA_FIND_SNAPPIC_UNION uFindParam; //¼ìË÷²ÎÊı
		}
		...
		public struct NET_VCA_FACESNAP_INFO_ALARM {
			...
			public uint dwSnapFacePicLen;        //×¥ÅÄÈËÁ³×ÓÍ¼µÄ³¤¶È£¬Îª0±íÊ¾Ã»ÓĞÍ¼Æ¬£¬´óÓÚ0±íÊ¾ÓĞÍ¼Æ¬
			public NET_VCA_DEV_INFO struDevInfo;   //Ç°¶ËÉè±¸ĞÅÏ¢
			public byte byFaceScore;        //ÈËÁ³ÆÀ·Ö£¬Ö¸ÈËÁ³×ÓÍ¼µÄÖÊÁ¿µÄÆÀ·Ö,0-100
			public byte bySex;//ĞÔ±ğ£¬0-Î´Öª£¬1-ÄĞ£¬2-Å®
			public byte byGlasses;//ÊÇ·ñ´øÑÛ¾µ£¬0-Î´Öª£¬1-ÊÇ£¬2-·ñ
								  /*
								   * Ê¶±ğÈËÁ³µÄÄêÁä¶Î·¶Î§[byAge-byAgeDeviation,byAge+byAgeDeviation]
								   */
			public byte byAge;//ÄêÁä
			public byte byAgeDeviation;//ÄêÁäÎó²îÖµ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;              // ±£Áô×Ö½Ú
			public IntPtr pBuffer1;  //×¥ÅÄÈËÁ³×ÓÍ¼µÄÍ¼Æ¬Êı¾İ
		}
		...
		public struct NET_VCA_BLACKLIST_INFO_ALARM {
			...
			public uint dwBlackListPicLen;       //ºÚÃûµ¥ÈËÁ³×ÓÍ¼µÄ³¤¶È£¬Îª0±íÊ¾Ã»ÓĞÍ¼Æ¬£¬´óÓÚ0±íÊ¾ÓĞÍ¼Æ¬
			...
			public ushort wThresholdValue; //ÈËÁ³¿âãĞÖµ[0,100]
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;//±£Áô
		...
		public struct NET_VCA_FACESNAP_MATCH_ALARM {
			...
			public NET_VCA_FACESNAP_INFO_ALARM struSnapInfo; //×¥ÅÄĞÅÏ¢
			public NET_VCA_BLACKLIST_INFO_ALARM struBlackListInfo; //ºÚÃûµ¥ĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 16)]
			public string sStorageIP;        //´æ´¢·şÎñIPµØÖ·
			public ushort wStoragePort;            //´æ´¢·şÎñ¶Ë¿ÚºÅ
			public byte byMatchPicNum; //Æ¥ÅäÍ¼Æ¬µÄÊıÁ¿£¬0-±£Áô£¨ÀÏÉè±¸Õâ¸öÖµÄ¬ÈÏ0£¬ĞÂÉè±¸Õâ¸öÖµÎª0Ê±±íÊ¾ºóĞøÃ»ÓĞÆ¥ÅäµÄÍ¼Æ¬ĞÅÏ¢£©
			public byte byPicTransType;//Í¼Æ¬Êı¾İ´«Êä·½Ê½: 0-¶ş½øÖÆ£»1-url
			public uint dwSnapPicLen;//Éè±¸Ê¶±ğ×¥ÅÄÍ¼Æ¬³¤¶È
			public IntPtr pSnapPicBuffer;//Éè±¸Ê¶±ğ×¥ÅÄÍ¼Æ¬Ö¸Õë
			public NET_VCA_RECT struRegion;//Ä¿±ê±ß½ç¿ò£¬Éè±¸Ê¶±ğ×¥ÅÄÍ¼Æ¬ÖĞ£¬ÈËÁ³×ÓÍ¼×ø±ê
			public uint dwModelDataLen;//½¨Ä£Êı¾İ³¤¶È
			public IntPtr pModelDataBuffer;// ½¨Ä£Êı¾İÖ¸Õë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;  // ±£Áô×Ö½Ú
		}
		...
		public struct NET_VCA_BLACKLIST_INFO_ALARM_LOG {
			public NET_VCA_BLACKLIST_INFO struBlackListInfo; //ºÚÃûµ¥»ù±¾ĞÅÏ¢
		...
		public struct NET_VCA_FACESNAP_MATCH_ALARM_LOG {
			public uint dwSize;             // ½á¹¹´óĞ¡
			public float fSimilarity; //ÏàËÆ¶È£¬[0.001,1]
			public NET_VCA_FACESNAP_INFO_ALARM_LOG struSnapInfoLog; //×¥ÅÄĞÅÏ¢
			public NET_VCA_BLACKLIST_INFO_ALARM_LOG struBlackListInfoLog; //ºÚÃûµ¥ĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 60, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;              // ±£Áô×Ö½Ú
		}
		...
		public struct NET_VCA_FACEMATCH_PICTURE {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;              //±£Áô×Ö½Ú
			public IntPtr pSnapFace;  //×¥ÅÄÈËÁ³×ÓÍ¼µÄÍ¼Æ¬Êı¾İ
			public IntPtr pBlackListFace;  //±È¶ÔµÄºÚÃûµ¥ÈËÁ³×ÓÍ¼Êı¾İ
		}
		...
		public struct NET_VCA_BLACKLIST_FASTREGISTER_PARA {
			public uint dwSize;   //½á¹¹´óĞ¡
			public NET_VCA_BLACKLIST_INFO struBlackListInfo;  //ºÚÃûµ¥»ù±¾²ÎÊı
			public uint dwImageLen;  //Í¼ÏñÊı¾İ³¤¶È
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 124, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;  //±£Áô
			public IntPtr pImage;    //Í¼ÏñÊı¾İ
		}
		...
		public struct NET_VCA_SINGLE_PATH {
			...
			public byte byType;   //0-´æ´¢×¥ÅÄ£¬1-´æ´¢ºÚÃûµ¥±È¶Ô±¨¾¯£¬2-´æ´¢×¥ÅÄºÍºÚÃûµ¥±È¶Ô±¨¾¯£¬0xff-ÎŞĞ§
			public byte bySaveAlarmPic; //ÊÇ·ñÓÃÓÚ±£´æ¶ÏÍøµÄ±¨¾¯Í¼Æ¬£¬0-·ñ£¬1-ÊÇ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1; //±£Áô
			public uint dwDiskDriver;   //ÅÌ·ûºÅ£¬´Ó0¿ªÊ¼
			public uint dwLeftSpace;   //Ô¤ÁôÈİÁ¿£¨µ¥Î»ÎªG£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2; //±£Áô
		}
		...
		public struct NET_DVR_DISPWINDOWMODE {
			public byte byDispChanType;//ÏÔÊ¾Í¨µÀÀàĞÍ£º0-VGA, 1-BNC, 2-HDMI, 3-DVI
			public byte byDispChanSeq;//ÏÔÊ¾Í¨µÀĞòºÅ,´Ó1¿ªÊ¼£¬Èç¹ûÀàĞÍÊÇVGA£¬Ôò±íÊ¾µÚ¼¸¸öVGA
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		...
		public struct NET_DVR_DISPINFO {
			public byte byChanNums;//Í¨µÀ¸öÊı
			public byte byStartChan;//ÆğÊ¼Í¨µÀ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		...
		public struct NET_DVR_SCREENINFO {
			public byte bySupportBigScreenNums;//×î¶à´óÆÁÆ´½ÓÊıÁ¿
			public byte byStartBigScreenNum;//´óÆÁÆ´½ÓÆğÊ¼ºÅ
		...
		public struct NET_DVR_MATRIX_ABILITY_V41 {
			public uint dwSize;
			public byte byDspNums;//DSP¸öÊı  
			public byte byDecChanNums;//½âÂëÍ¨µÀÊı
			public byte byStartChan;//ÆğÊ¼½âÂëÍ¨µÀ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;

			public NET_DVR_DISPINFO struVgaInfo;//VGAÏÔÊ¾Í¨µÀĞÅÏ¢
			public NET_DVR_DISPINFO struBncInfo;//BNCÏÔÊ¾Í¨µÀĞÅÏ¢
			public NET_DVR_DISPINFO struHdmiInfo;//HDMIÏÔÊ¾Í¨µÀĞÅÏ¢
			public NET_DVR_DISPINFO struDviInfo;//DVIÏÔÊ¾Í¨µÀĞÅÏ¢
		...
		public const int MAX_WINDOWS = 16;//×î´ó´°¿ÚÊı
		...
		public struct VideoPlatform {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_WINDOWS_V41, ArraySubType = UnmanagedType.I1)]
			public byte[] byDecResolution;
			public NET_DVR_RECTCFG struPosition; //ÏÔÊ¾Í¨µÀÔÚµçÊÓÇ½ÖĞÎ»ÖÃ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 80, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_MATRIX_VOUTCFG {
			...
			public byte byAudio;            /*ÒôÆµÊÇ·ñ¿ªÆô*/
			public byte byAudioWindowIdx;      /*ÒôÆµ¿ªÆô×Ó´°¿Ú*/
			public byte byDispChanType;      /*ÏÔÊ¾Í¨µÀÀàĞÍ£º0-BNC£¬1-VGA£¬2-HDMI£¬3-DVI£¬4-YPbPr(½âÂë¿¨·şÎñÆ÷DECODER_SERVER×¨ÓÃ)*/
			public byte byVedioFormat;         /*1:NTSC,2:PAL£¬0-NULL*/
			public uint dwResolution;//·Ö±æÂÊ
			public uint dwWindowMode;       /*»­ÃæÄ£Ê½£¬ÄÜÁ¦¼¯»ñÈ¡*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_WINDOWS_V41, ArraySubType = UnmanagedType.I1)]
			public byte[] byJoinDecChan;/*¸÷¸ö×Ó´°¿Ú¹ØÁªµÄ½âÂëÍ¨µÀ,Éè±¸Ö§³Ö½âÂë×ÊÔ´×Ô¶¯·ÖÅäÊ±´Ë²ÎÊı²»ÓÃÌî³ä*/
			public byte byEnlargeStatus;          /*ÊÇ·ñ´¦ÓÚ·Å´ó×´Ì¬£¬0£º²»·Å´ó£¬1£º·Å´ó*/
			public byte byEnlargeSubWindowIndex;//·Å´óµÄ×Ó´°¿ÚºÅ
			public byte byScale; /*ÏÔÊ¾Ä£Ê½£¬0---ÕæÊµÏÔÊ¾£¬1---Ëõ·ÅÏÔÊ¾( Õë¶ÔBNC )*/
			public byte byUnionType;/*Çø·Ö¹²ÓÃÌå,0-ÊÓÆµ×ÛºÏÆ½Ì¨ÄÚ²¿½âÂëÆ÷ÏÔÊ¾Í¨µÀÅäÖÃ£¬1-ÆäËû½âÂëÆ÷ÏÔÊ¾Í¨µÀÅäÖÃ*/
			public NET_DVR_VIDEO_PLATFORM struDiff;
			public uint dwDispChanNum; //ÏÔÊ¾Êä³öºÅ£¬´Ë²ÎÊıÔÚÈ«²¿»ñÈ¡Ê±ÓĞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 76, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_DISP_CHAN_STATUS_V41 {
			public byte byDispStatus;      /*ÏÔÊ¾×´Ì¬£º0£ºÎ´ÏÔÊ¾£¬1£ºÆô¶¯ÏÔÊ¾*/
			public byte byBVGA;              /*0-BNC£¬1-VGA£¬ 2-HDMI£¬3-DVI£¬0xff-ÎŞĞ§*/
			public byte byVideoFormat;     /*ÊÓÆµÖÆÊ½£¬1:NTSC,2:PAL,0-NON*/
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public uint dwDispChan; /*»ñÈ¡È«²¿ÏÔÊ¾Í¨µÀ×´Ì¬Ê±ÓĞĞ§£¬ÉèÖÃÊ±¿ÉÌî0*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_SCENEDISPCFG {
			...
			public byte[] byJoinDecoderId;/*²ÛÎ»ºÅ*/
										  //ÏÔÊ¾´°¿ÚËù½âÊÓÆµ·Ö±æÂÊ£¬1-D1,2-720P,3-1080P£¬Éè±¸¶ËĞèÒª¸ù¾İ´Ë//·Ö±æÂÊ½øĞĞ½âÂëÍ¨µÀµÄ·ÖÅä£¬Èç1·ÖÆÁÅäÖÃ³É1080P£¬ÔòÉè±¸»á°Ñ4¸ö½âÂëÍ¨µÀ¶¼·ÖÅä¸ø´Ë½âÂëÍ¨µÀ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_WINDOWS_V41, ArraySubType = UnmanagedType.I1)]
			public byte[] byDecResolution;
			public byte byRow;//´óÆÁËùÔÚµÄĞĞµÄĞòºÅ
			public byte byColumn;//´óÆÁËùÔÚµÄÁĞµÄĞòºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		...
		public struct NET_DVR_DEV_CHAN_INFO_SCENE {
			...
			public byte byTransProtocol;        /* ´«ÊäĞ­ÒéÀàĞÍ0-TCP£¬1-UDP £¬2-MCAST£¬3-RTP*/
			public byte byTransMode;            /* ´«ÊäÂëÁ÷Ä£Ê½ 0£­Ö÷ÂëÁ÷ 1£­×ÓÂëÁ÷*/
			public byte byFactoryType;              /*Ç°¶ËÉè±¸³§¼ÒÀàĞÍ*/
			public byte byDeviceType;           //Éè±¸ÀàĞÍ£¬1-IPC£¬2- ENCODER
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sUserName;    /* ¼à¿ØÖ÷»úµÇÂ½ÕÊºÅ */
		...
		public struct NET_DVR_STREAM_MEDIA_SERVER_CFG_SCENE {
			public byte byValid;            /*ÊÇ·ñÆôÓÃÁ÷Ã½Ìå·şÎñÆ÷È¡Á÷,0±íÊ¾ÎŞĞ§*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public NET_DVR_IPADDR struDevIP;    /*Á÷Ã½Ìå·şÎñÆ÷µØÖ·*/
			public ushort wDevPort;         /*Á÷Ã½Ìå·şÎñÆ÷¶Ë¿Ú*/
			public byte byTransmitType;     /*´«ÊäĞ­ÒéÀàĞÍ0-TCP£¬1-UDP */
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_CYC_SUR_CHAN_ELE_SCENE {
			...
			public NET_DVR_DEV_CHAN_INFO_SCENE struDecChanInfo; /*ÂÖÑ²½âÂëÍ¨µÀĞÅÏ¢*/
		}
		...
		public struct NET_DVR_BIGSCREENCFG_SCENE {
			public byte byAllValid; /*ÂşÓÎÊ¹ÄÜ±êÖ¾ */
			public byte byAssociateBaseMap;//¹ØÁªµÄµ×Í¼ĞòºÅ£¬0´ú±í²»¹ØÁª
		...
		public struct NET_DVR_MATRIX_SCENECFG {
			...
			public byte byBigScreenNums;//´óÆÁµÄ¸öÊı£¬×î´óÖµÍ¨¹ıÄÜÁ¦¼¯»ñÈ¡
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public ushort wDecChanNums;//³¡¾°ÖĞ½âÂëÍ¨µÀµÄ¸öÊı
			public ushort wDispChanNums;//³¡¾°ÖĞÏÔÊ¾Í¨µÀµÄ¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		...
		public const int NET_DVR_GET_ALLWINCFG = 1503; //´°¿Ú²ÎÊı»ñÈ¡
		...
		/*******************************´°¿ÚÉèÖÃ*******************************/
		public const int MAX_WIN_COUNT = 224; //Ö§³ÖµÄ×î´ó¿ª´°Êı
		...
		public struct NET_DVR_SCREEN_WINCFG {
			...
			public ushort wInputIdx;            /*ÊäÈëÔ´Ë÷Òı*/
			public uint dwLayerIdx;         /*Í¼²ã£¬0Îª×îµ×²ã*/
			public NET_DVR_RECTCFG struWin; //Ä¿µÄ´°¿Ú(Ïà¶ÔÏÔÊ¾Ç½)
			public byte byWndIndex;         //´°¿ÚºÅ
			public byte byCBD;              //0-ÎŞ£¬1-´ø±³¾°£¬2-²»´ø±³¾°
			public byte bySubWnd;           //0²»ÊÇ£¬1ÊÇ
			public byte byRes1;
			public uint dwDeviceIndex;//Éè±¸ĞòºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_WINLIST {
			public uint dwSize;
			public ushort wScreenSeq;   //Éè±¸ĞòºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 10, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			public uint dwWinNum;   //Éè±¸·µ»ØµÄ´°¿ÚÊıÁ¿
			public IntPtr pBuffer;  //´°¿ÚĞÅÏ¢»º³åÇø£¬×î´óÎª224*sizeof(NET_DVR_WINCFG)
			public uint dwBufLen;   //Ëù·ÖÅäÖ¸Õë³¤¶È
		}

		public const int MAX_LAYOUT_COUNT = 16;     //×î´ó²¼¾ÖÊı

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_LAYOUTCFG {
			public uint dwSize;
			public byte byValid;                                //²¼¾ÖÊÇ·ñÓĞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			...
			public NET_DVR_SCREEN_WINCFG[] struWinCfg;  //²¼¾ÖÄÚ´°¿Ú²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_LAYOUT_LIST {
			...
			public NET_DVR_LAYOUTCFG[] struLayoutInfo;   //ËùÓĞ²¼¾Ö
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_INPUTSTREAMCFG {
			public uint dwSize;
			public byte byValid;
			public byte byCamMode;                      //ĞÅºÅÊäÈëÔ´ÀàĞÍ£¬¼ûNET_DVR_CAM_MODE
			public ushort wInputNo;                     //ĞÅºÅÔ´ĞòºÅ0-224
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sCamName;         //ĞÅºÅÊäÈëÔ´Ãû³Æ
			public NET_DVR_VIDEOEFFECT struVideoEffect; //ÊÓÆµ²ÎÊı
			public NET_DVR_PU_STREAM_CFG struPuStream;  //ipÊäÈëÊ±Ê¹ÓÃ
			public ushort wBoardNum;                        //ĞÅºÅÔ´ËùÔÚµÄ°å¿¨ºÅ
			public ushort wInputIdxOnBoard;             //ĞÅºÅÔ´ÔÚ°å¿¨ÉÏµÄÎ»ÖÃ
			public ushort wResolutionX;                 //·Ö±æÂÊ
			public ushort wResolutionY;
			public byte byVideoFormat;                  //ÊÓÆµÖÆÊ½£¬0-ÎŞ£¬1-NTSC£¬2-PAL
			public byte byNetSignalResolution;  //; 1-CIF 2-4CIF 3-720P 4-1080P 5-500wp ¡£ÍøÂçĞÅºÅÔ´µÄ·Ö±æÂÊ£¬ÔÚÌí¼ÓÍøÂçĞÅºÅÔ´Ê±´«¸øÉè±¸£¬Éè±¸¸ù¾İÕâ¸ö·Ö±æÂÊÀ´·ÖÅä½âÂë×ÊÔ´¡£
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sGroupName;   //ÍøÂçĞÅºÅÔ´·Ö×é ×éÃû
		...
		public struct NET_DVR_INPUTSTREAM_LIST {
			...
			public NET_DVR_INPUTSTREAMCFG[] struInputStreamInfo; //ËùÓĞĞÅºÅÔ´
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_OUTPUTPARAM {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public uint dwResolution;   /*·Ö±æÂÊ£¬¸ù¾İÄÜÁ¦¼¯»ñÈ¡ËùÖ§³ÖµÄ½øĞĞÉèÖÃ*/
			public NET_DVR_VIDEOEFFECT struVideoEffect; /*Êä³öÍ¨µÀÊÓÆµ²ÎÊıÅäÖÃ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_OUTPUTCFG {
			...
			public byte byScreenLayY;                       //´óÆÁ²¼¾Ö-×İ×ø±ê
			public ushort wOutputChanNum;                   //Êä³öÍ¨µÀ¸öÊı£¬0±íÊ¾Éè±¸Ö§³ÖµÄ×î´óÊä³öÍ¨µÀ¸öÊı£¬×î´ó¸öÊı´ÓÄÜÁ¦¼¯»ñÈ¡£¬ÆäËûÖµ±íÊ¾Êµ¼ÊÊä³öÍ¨µÀ¸öÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public NET_DVR_OUTPUTPARAM struOutputParam; /*Êä³öÍ¨µÀÊÓÆµ²ÎÊıÅäÖÃ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
		...
		/*******************************ÄÜÁ¦¼¯*******************************/
		public const int SCREEN_PROTOCOL_NUM = 20;   //Ö§³ÖµÄ×î´ó´óÆÁ¿ØÖÆÆ÷Ğ­ÒéÊı

		//¶àÆÁ·şÎñÆ÷ÄÜÁ¦¼¯
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_SCREENSERVER_ABILITY {
			public uint dwSize;             /*½á¹¹³¤¶È*/
			public byte byIsSupportScreenNum; /*ËùÖ§³Ö´óÆÁ¿ØÖÆÆ÷µÄÊıÄ¿*/
			public byte bySerialNums;           //´®¿Ú¸öÊı
			public byte byMaxInputNums;
			public byte byMaxLayoutNums;
			public byte byMaxWinNums;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 19, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public byte byMaxScreenLayX;//´óÆÁ²¼¾Ö-×î´óºá×ø±ê´óÆÁÊı
			public byte byMaxScreenLayY;//´óÆÁ²¼¾Ö-×î´ó×İ×ø±ê´óÆÁÊı
			public ushort wMatrixProtoNum; /*ÓĞĞ§µÄ´óÆÁĞ­ÒéÊıÄ¿*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = SCREEN_PROTOCOL_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_PROTO_TYPE[] struScreenProto;/*×î´óĞ­ÒéÁĞ±í*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_SCREENCONTROL_ABILITY {
			public uint dwSize;         /*½á¹¹³¤¶È*/
			public byte byLayoutNum;        /* ²¼¾Ö¸öÊı*/
			public byte byWinNum;           /*ÆÁÄ»´°¿Ú¸öÊı*/
			public byte byOsdNum;       /*OSD¸öÊı*/
			public byte byLogoNum;      /*Logo¸öÊı*/
			public byte byInputStreamNum;  //ÊäÈëÔ´¸öÊı ---Éè±¸Ö§³Ö×î´óÊäÈëÍ¨µÀ¸öÊı£¨°üÀ¨±¾µØÊäÈëÔ´ºÍÍøÂçÊäÈëÔ´£©
			public byte byOutputChanNum;    //Êä³öÍ¨µÀ¸öÊı---Éè±¸Ö§³Ö×î´óÊä³öÍ¨µÀ¸öÊı
			public byte byCamGroupNum;      /*·Ö×é¸öÊı*/
			public byte byPlanNum;          /*Ô¤°¸¸öÊı*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public byte byIsSupportPlayBack;  /*ÊÇ·ñÖ§³Ö»Ø·Å*/
			public byte byMatrixInputNum;  //Ö§³ÖÊäÈë¾ØÕó×î´ó¸öÊı
			public byte byMatrixOutputNum; //Ö§³ÖÊä³ö¾ØÕó×î´ó¸öÊı
			public NET_DVR_DISPINFO struVgaInfo;//VGAÊä³öĞÅÏ¢
			public NET_DVR_DISPINFO struBncInfo;//BNCÊä³öĞÅÏ¢
			public NET_DVR_DISPINFO struHdmiInfo;//HDMIÊä³öĞÅÏ¢
			public NET_DVR_DISPINFO struDviInfo;//DVIÊä³öĞÅÏ¢
			public byte byMaxUserNums;//Ö§³ÖÓÃ»§Êı
			public byte byPicSpan;      //µ×Í¼¿ç¶È£¬Ò»ÕÅµ×Í¼×î¶à¿É¸²¸ÇµÄÆÁÄ»Êı
			public ushort wDVCSDevNum;  //·Ö²¼Ê½´óÆÁ¿ØÖÆÆ÷×î´óÉè±¸Êı
			public ushort wNetSignalNum;    //×î´óÍøÂçÊäÈëÔ´¸öÊı
			public ushort wBaseCoordinateX;//»ù×¼×ø±ê
			public ushort wBaseCoordinateY;
			public byte byExternalMatrixNum;    //×î´óÍâ½Ó¾ØÕó¸öÊı
		...
		public struct NET_DVR_ANALOGINPUTSTATUS {
			public uint dwLostFrame;        /*ÊÓÆµÊäÈë¶ªÖ¡Êı*/
			public byte byHaveSignal;       /*ÊÇ·ñÓĞÊÓÆµĞÅºÅÊäÈë*/
			public byte byVideoFormat;      /*ÊÓÆµÖÆÊ½£¬1£ºNTSC,2£ºPAL,0£ºÎŞ*/
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 46, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_INPUTSTATUS {
			public ushort wInputNo;     /*ĞÅºÅÔ´ĞòºÅ*/
		...
		public struct NET_DVR_SCREENINPUTSTATUS {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 12, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
			public uint dwNums;     //Éè±¸·µ»ØµÄÊäÈëÔ´×´Ì¬µÄÊıÁ¿
		...
		public struct NET_DVR_SCREENALARMCFG {
			public uint dwSize;
			public byte byAlarmType;    //±¨¾¯ÀàĞÍ£¬1-×Ó°å°Î³ö£¬2-×Ó°å²åÈë£¬3-×ÓÏµÍ³×´Ì¬Òì³££¬4-×ÓÏµÍ³»Ö¸´»Ö¸´ 5-ÊäÈëÔ´Òì³£   6-ÎÂ¶È±¨¾¯ 7-FPGA°æ±¾²»Æ¥Åä 8-Ô¤°¸¿ªÊ¼ 9-Ô¤°¸½áÊø 10-½âÂë°å¶ÏÍø 11-½âÂë°åIPµØÖ·³åÍ»£¬12-·çÉÈÒì³£
			public byte byBoardType;    // 1-ÊäÈë°å 2-Êä³ö°å £¬3-Ö÷°å£¬4-±³°å£¬±¨¾¯ÀàĞÍÎª1£¬2£¬3£¬6µÄÊ±ºòÊ¹ÓÃ 
			public byte bySubException; //ÊäÈëÒì³£Ê±¾ßÌå×ÓÒì³£ 1- ·Ö±æÂÊÕı³£¸Ä±ä 2-ÊäÈë¶Ë¿ÚÀàĞÍ¸Ä±ä3-·Ö±æÂÊ´íÎó4-·Ö±æÂÊ¸Ä±äµ¼ÖÂ½âÂë×ÊÔ´²»×ã£¬¹Ø±Õ¸ÃÊäÈëÔ´¶ÔÓ¦´°¿Ú¡£5-·Ö±æÂÊ¸Ä±ä£¬µ¼ÖÂÒÑ¿ª´°µÄËõ·Å±ÈÀı²»ÔÚ1/8µ½8±¶·¶Î§¡£6-·Ö±æÂÊ»Ö¸´Õı³£,7-·Ö±æÂÊ¸Ä±äµ¼ÖÂÊä³ö°åÊı¾İÁ¿³¬ÏŞ,Éè±¸¹Ø±Õ´°¿Ú 
			public byte byRes1;
			public ushort wStartInputNum; // Òì³£ÊäÈëÔ´£¨Òì³£Æğµã£© 
		...
		public struct NET_DVR_MATRIX_CFG {
			public byte byValid;                //ÅĞ¶ÏÊÇ·ñÊÇÄ£Äâ¾ØÕó£¨ÊÇ·ñÓĞĞ§£©
		...
		public struct NET_DVR_SCREEN_SCREENINFO {
			...
			public byte byDeviceType;           //Éè±¸ĞÍºÅ£¬ÄÜÁ¦¼¯»ñÈ¡
			public byte byScreenLayX;           //´óÆÁ²¼¾Ö-ºá×ø±ê
			public byte byScreenLayY;           //´óÆÁ²¼¾Ö-×İ×ø±ê
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			...
			public byte byInputNum;         // ÊäÈëÔ´¸öÊı
			public byte byOutputNum;            // Êä³öÔ´¸öÊı
			public byte byCBDNum;               //CBD¸öÊı
		...
		public struct NET_DVR_BASEMAP_CFG {
			public byte byScreenIndex;         //ÆÁÄ»µÄĞòºÅ
		...
		public struct NET_DVR_OSDCFG {
			public uint dwSize;
			public byte byValid;    /*ÊÇ·ñÓĞĞ§ 0ÎŞĞ§ 1ÓĞĞ§*/
			public byte byDispMode;  //ÏÔÊ¾Ä£Ê½£¬1-Í¸Ã÷£¬2-°ëÍ¸Ã÷£¬3-¸²¸ÇÈıÖÖÄ£Ê½
		...
		public struct NET_DVR_DISPLAY_COLOR_CTRL {
			...
			public char byScale;            //-1 ¡¢0¡¢+1Èı¸öÖµ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 14, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_SCREEN_CONTROL {
			...
			public byte byProtocol;      //´®¿ÚĞ­ÒéÀàĞÍ,1:LCD-S1,2:LCD-S2
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
		...
		public struct NET_DVR_SCREEN_CONTROL_V41 {
			...
			public byte byProtocol;            // ´®¿ÚĞ­ÒéÀàĞÍ  1-LCD-S1 , 2-LCD-S2 , 3-LCD-L1 £¬ 4-LCD-DLP£¬ 5-LCD-S3 , 6-LCD-H1 
			public uint dwCommand;      /* ¿ØÖÆ·½·¨ 1-¿ª 2-¹Ø 3-ÆÁÄ»ÊäÈëÔ´Ñ¡Ôñ 4-ÏÔÊ¾µ¥ÔªÑÕÉ«¿ØÖÆ 5-ÏÔÊ¾µ¥ÔªÎ»ÖÃ¿ØÖÆ*/
			public NET_DVR_SCREEN_CONTROL_PARAM struControlParam;
		...
		/*******************************Ô¤°¸¹ÜÀí*******************************/
		public const int MAX_PLAN_ACTION_NUM = 32;  //Ô¤°¸¶¯×÷¸öÊı
		public const int DAYS_A_WEEK = 7;   //Ò»ÖÜ7Ìì
		public const int MAX_PLAN_COUNT = 16;   //Ô¤°¸¸öÊı

		public enum NET_DVR_PLAN_OPERATE_TYPE {
			NET_DVR_SWITCH_LAYOUT = 1,      // ²¼¾ÖÇĞ»» Ä¬ÈÏ
		...
		public struct NET_DVR_PLAN_INFO {
			public byte byValid;        // ¸ÃÏîÊÇ·ñÓĞĞ§
			public byte byType;         // ¼û¶¨ÒåNET_DVR_PLAN_OPERATE_TYPE
			public ushort wLayoutNo;    // ²¼¾ÖºÅ
			public byte byScreenStyle;    //ÆÁÄ»ĞÍºÅ£¬¿ª¹Ø»úËùÓÃ£¬1ÊÇµÍÁÁ£¬2ÊÇ¸ßÁÁ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public uint dwDelayTime;    // Ò»¸öÏîµÄÔËĞĞÊ±¼ä, µ¥Î»Ãë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_PLAN_CFG {
			public uint dwSize;
			public byte byValid;        // ¸ÃÔ¤°¸ÊÇ·ñÓĞĞ§
			...
			public NET_DVR_CYCLE_TIME[] struTimeCycle; /*Ñ­»·Ê±¼ä£¬ÖÜÆÚÎªÒ»¸öĞÇÆÚ£¬Äê¡¢ÔÂ¡¢ÈÕÈı¸ö²ÎÊı²»Ê¹ÓÃ¡£Èç£ºstruTimeCycle[0]ÖĞµÄbyValidµÄÖµÊÇ1£¬±íÊ¾ĞÇÆÚÌìÖ´ĞĞ¸ÃÔ¤°¸¡£ĞÇÆÚÈ¡ÖµÇø¼äÎª[0,6]£¬ÆäÖĞ0´ú±íĞÇÆÚÌì£¬1´ú±íĞÇÆÚÒ»£¬ÒÔ´ËÀàÍÆ*/
			public uint dwWorkCount;    // Ô¤°¸ÄÚÈİÖ´ĞĞ´ÎÊı£¬0ÎªÒ»Ö±Ñ­»·²¥·Å£¬ÆäËûÖµ±íÊ¾´ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_PLAN_ACTION_NUM, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_PLAN_INFO[] strPlanEntry;  // Ô¤°¸Ö´ĞĞµÄÄÚÈİ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_PLAN_LIST {
			public uint dwSize;
			public uint dwPlanNums;         //Éè±¸ÊäÈëĞÅºÅÔ´ÊıÁ¿
			public IntPtr pBuffer;          //Ö¸ÏòdwInputSignalNums¸öNET_DVR_PLAN_CFG½á¹¹´óĞ¡µÄ»º³åÇø
			public byte byWallNo;           //Ç½ºÅ£¬´Ó1¿ªÊ¼
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public uint dwBufLen;           //Ëù·ÖÅä»º³åÇø³¤¶È£¬ÊäÈë²ÎÊı£¨´óÓÚµÈÓÚdwInputSignalNums¸öNET_DVR_PLAN_CFG½á¹¹´óĞ¡£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_CONTROL_PARAM {
			...
			public byte byIndex;             //¿ØÖÆË÷Òı£¬¸ù¾İÃüÁîÈ·¶¨¾ßÌå±íÊ¾Ê²Ã´Ë÷Òı
			public byte byRes1;
		...
		//91ÏµÁĞHD-SDI¸ßÇåDVR Ïà»úĞÅÏ¢
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_ACCESS_CAMERA_INFO {
			public uint dwSize;
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 32)]
			public string sCameraInfo;      // Ç°¶ËÏà»úĞÅÏ¢
			public byte byInterfaceType;        // Ç°¶Ë½ÓÈë½Ó¿ÚÀàĞÍ£¬1:VGA, 2:HDMI, 3:YPbPr 4:SDI 5:FC
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public uint dwChannel;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_DVR_AUDIO_INPUT_PARAM {
			public byte byAudioInputType;  //ÒôÆµÊäÈëÀàĞÍ£¬0-mic in£¬1-line in
			public byte byVolume; //volume,[0-100]
			public byte byEnableNoiseFilter; //ÊÇ·ñ¿ªÆôÉùÒô¹ıÂË-¹Ø£¬-¿ª
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 5, ArraySubType = UnmanagedType.I1)]
			public byte[] byres;
		}
		...
		public struct NET_DVR_INPUT_SIGNAL_LIST {
			public uint dwSize;
			public uint dwInputSignalNums;  //Éè±¸ÊäÈëĞÅºÅÔ´ÊıÁ¿
			public IntPtr pBuffer;          //Ö¸ÏòdwInputSignalNums¸öNET_DVR_INPUTSTREAMCFG½á¹¹´óĞ¡µÄ»º³åÇø
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
			public uint dwBufLen;           //Ëù·ÖÅä»º³åÇø³¤¶È£¬ÊäÈë²ÎÊı£¨´óÓÚµÈÓÚdwInputSignalNums¸öNET_DVR_INPUTSTREAMCFG½á¹¹´óĞ¡£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public const int PULL_DISK_PROCESSING = 3;  // ÕıÔÚÍ£Ö¹ÕóÁĞ
		public const int PULL_DISK_NO_ARRAY = 4;    // ÕóÁĞ²»´æÔÚ 
		public const int PULL_DISK_NOT_SUPPORT = 5; // ²»Ö§³Ö°²È«°ÎÅÌ

		//É¨ÃèÕóÁĞ×´Ì¬
		public const int SCAN_RAID_SUC = 1;     // É¨ÃèÕóÁĞ³É¹¦
		public const int SCAN_RAID_FAIL = 2;    // É¨ÃèÕóÁĞÊ§°Ü
		public const int SCAN_RAID_PROCESSING = 3;  // ÕıÔÚÉ¨ÃèÕóÁĞ
		public const int SCAN_RAID_NOT_SUPPORT = 4; // ²»Ö§³ÖÕóÁĞÉ¨Ãè

		//ÉèÖÃÇ°¶ËÏà»úÀàĞÍ×´Ì¬
		public const int SET_CAMERA_TYPE_SUCCESS = 1;  // ³É¹¦
		public const int SET_CAMERA_TYPE_FAIL = 2;  // Ê§°Ü
		public const int SET_CAMERA_TYPE_PROCESSING = 3;   // ÕıÔÚ´¦Àí

		//9000 2.2
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_RECORD_TIME_SPAN_INQUIRY {
			public uint dwSize;    //½á¹¹Ìå´óĞ¡
			public byte byType;    //0 Õı³£ÒôÊÓÆµÂ¼Ïñ, 1Í¼Æ¬Í¨µÀÂ¼Ïñ, 2ANRÍ¨µÀÂ¼Ïñ, 3³éÖ¡Í¨µÀÂ¼Ïñ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 63, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes; //±£Áô
		}
		...
		public struct NET_DVR_UPNP_PORT_STATE {
			...
			public uint dwStatus;//¶Ë¿ÚÓ³Éä×´Ì¬£º0- Î´ÉúĞ§£»1- Î´ÉúĞ§£ºÓ³ÉäÔ´¶Ë¿ÚÓëÄ¿µÄ¶Ë¿ÚĞèÒ»ÖÂ£»2- Î´ÉúĞ§£ºÓ³Éä¶Ë¿ÚºÅÒÑ±»Ê¹ÓÃ£»3- ÉúĞ§
		...
		public struct NET_DVR_UPNP_NAT_STATE {
			...
			public NET_DVR_UPNP_PORT_STATE[] strUpnpPort;//¶Ë¿ÚÓ³Éä×´Ì¬:£ºÊı×é0- web server¶Ë¿Ú£¬Êı×é1- ¹ÜÀí¶Ë¿Ú£¬Êı×é2- rtsp¶Ë
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 200, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;//±£Áô
		}
		...
		public struct NET_DVR_VOD_PARA {
			public uint dwSize; //½á¹¹Ìå´óĞ¡
			public NET_DVR_STREAM_INFO struIDInfo; //Á÷IDĞÅÏ¢
			...
			public byte byVolumeType;//0-ÆÕÍ¨Â¼Ïñ¾í£¬1-´æµµ¾í£¬ÊÊÓÃÓÚCVRÉè±¸£¬ÆÕÍ¨¾íÓÃÓÚÍ¨µÀÂ¼Ïñ£¬´æµµ¾íÓÃÓÚ±¸·İÂ¼Ïñ
			public byte byVolumeNum;//´æµµ¾íºÅ 
			public byte byRes1;//±£Áô
			public uint dwFileIndex;//´æµµ¾íÉÏµÄÂ¼ÏñÎÄ¼şË÷Òı£¬ËÑË÷´æµµ¾íÂ¼ÏñÊ±·µ»ØµÄÖµ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;    //±£Áô
		}
		...
		public struct NET_DVR_ATMFINDINFO {
			public byte byTransactionType;       //½»Ò×ÀàĞÍ 0-È«²¿£¬1-²éÑ¯£¬ 2-È¡¿î£¬ 3-´æ¿î£¬ 4-ĞŞ¸ÄÃÜÂë£¬5-×ªÕË£¬ 6-ÎŞ¿¨²éÑ¯ 7-ÎŞ¿¨´æ¿î£¬ 8-ÍÌ³® 9-ÍÌ¿¨ 10-×Ô¶¨Òå
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;    //±£Áô
			public uint dwTransationAmount;     //½»Ò×½ğ¶î ;
		}
		...
		public struct NET_DVR_FILECOND_V40 {
			...
			public byte bySpecialFindInfoType;    //×¨ÓĞ²éÑ¯Ìõ¼şÀàĞÍ 0-ÎŞĞ§£¬ 1-´øATM²éÑ¯Ìõ¼ş  
			...
			public byte[] byWorkingDeviceGUID;    //¹¤×÷»úGUID£¬Í¨¹ı»ñÈ¡N+1µÃµ½
			public NET_DVR_SPECIAL_FINDINFO_UNION uSpecialFindInfo;   //×¨ÓĞ²éÑ¯Ìõ¼ş
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;    //±£Áô
		}
		...
		public const int MAX_PRO_PATH = 256; //×î´óĞ­ÒéÂ·¾¶³¤¶È

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_DVR_CUSTOM_PROTOCAL {
			public uint dwSize;              //½á¹¹Ìå´óĞ¡
			public uint dwEnabled;           //ÊÇ·ñÆôÓÃ¸ÃĞ­Òé0 ²»ÆôÓÃ 1 ÆôÓÃ
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = DESC_LEN)]
			public string sProtocalName;   //×Ô¶¨ÒåĞ­ÒéÃû³Æ, 16Î»
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;          //±£Áô,ÓÃÓÚĞ­ÒéÃû³ÆÀ©Õ¹
			public uint dwEnableSubStream;   //×ÓÂëÁ÷ÊÇ·ñÆôÓÃ0 ²»ÆôÓÃ 1 ÆôÓÃ	
			public byte byMainProType;        //Ö÷ÂëÁ÷Ğ­ÒéÀàĞÍ 1 RTSP
			public byte byMainTransType;        //Ö÷ÂëÁ÷´«ÊäÀàĞÍ 0£ºAuto 1£ºudp 2£ºrtp over rtsp
			...
			public byte bySubProType;         //×ÓÂëÁ÷Ğ­ÒéÀàĞÍ 1 RTSP
			public byte bySubTransType;     //×ÓÂëÁ÷´«ÊäÀàĞÍ 0£ºAuto 1£ºudp 2£ºrtp over rtsp
		...
		public struct NET_DVR_PREVIEWINFO {
			public Int32 lChannel;//Í¨µÀºÅ
			public uint dwStreamType;   // ÂëÁ÷ÀàĞÍ£¬0-Ö÷ÂëÁ÷£¬1-×ÓÂëÁ÷£¬2-ÂëÁ÷3£¬3-ÂëÁ÷4 µÈÒÔ´ËÀàÍÆ
			public uint dwLinkMode;// 0£ºTCP·½Ê½,1£ºUDP·½Ê½,2£º¶à²¥·½Ê½,3 - RTP·½Ê½£¬4-RTP/RTSP,5-RSTP/HTTP 
			public IntPtr hPlayWnd;//²¥·Å´°¿ÚµÄ¾ä±ú,ÎªNULL±íÊ¾²»²¥·ÅÍ¼Ïó
			public bool bBlocked;  //0-·Ç×èÈûÈ¡Á÷, 1-×èÈûÈ¡Á÷, Èç¹û×èÈûSDKÄÚ²¿connectÊ§°Ü½«»áÓĞ5sµÄ³¬Ê±²ÅÄÜ¹»·µ»Ø,²»ÊÊºÏÓÚÂÖÑ¯È¡Á÷²Ù×÷.
			public bool bPassbackRecord; //0-²»ÆôÓÃÂ¼Ïñ»Ø´«,1ÆôÓÃÂ¼Ïñ»Ø´«
			public byte byPreviewMode;//Ô¤ÀÀÄ£Ê½£¬0-Õı³£Ô¤ÀÀ£¬1-ÑÓ³ÙÔ¤ÀÀ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = STREAM_ID_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byStreamID;//Á÷ID£¬lChannelÎª0xffffffffÊ±ÆôÓÃ´Ë²ÎÊı
			public byte byProtoType; //Ó¦ÓÃ²ãÈ¡Á÷Ğ­Òé£¬0-Ë½ÓĞĞ­Òé£¬1-RTSPĞ­Òé
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;
		...
		///×¥ÅÄ»ú
		///
		public const int MAX_OVERLAP_ITEM_NUM = 50;       //×î´ó×Ö·ûµş¼ÓÖÖÊı
		public const int NET_ITS_GET_OVERLAP_CFG = 5072;//»ñÈ¡×Ö·ûµş¼Ó²ÎÊıÅäÖÃ£¨Ïà»ú»òITSÖÕ¶Ë£©
		public const int NET_ITS_SET_OVERLAP_CFG = 5073;//ÉèÖÃ×Ö·ûµş¼Ó²ÎÊıÅäÖÃ£¨Ïà»ú»òITSÖÕ¶Ë£©

		//×Ö·ûµş¼ÓÅäÖÃÌõ¼ş²ÎÊı½á¹¹Ìå
		[StructLayoutAttribute(LayoutKind.Sequential)]
		...
		//µ¥Ìõ×Ö·ûµş¼ÓĞÅÏ¢½á¹¹Ìå
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_ITS_OVERLAP_SINGLE_ITEM_PARAM {
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;//±£Áô
			public byte byItemType;//ÀàĞÍ
			public byte byChangeLineNum;//µş¼ÓÏîºóµÄ»»ĞĞÊı£¬È¡Öµ·¶Î§£º[0,10]£¬Ä¬ÈÏ£º0 
			public byte bySpaceNum;//µş¼ÓÏîºóµÄ¿Õ¸ñÊı£¬È¡Öµ·¶Î§£º[0-255]£¬Ä¬ÈÏ£º0
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 15, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;//±£Áô
		}
		...
		public struct NET_ITS_OVERLAP_ITEM_PARAM {
			...
			public NET_ITS_OVERLAP_SINGLE_ITEM_PARAM[] struSingleItem;//×Ö·û´®ÄÚÈİĞÅÏ¢
			...
			public uint dwBackClorRGB;//±³¾°É«µÄRGBÖµ£¬Ö»¶ÔÍ¼Æ¬Íâµş¼ÓÓĞĞ§£¬bit0~bit7: B£¬bit8~bit15: G£¬bit16~bit23: R£¬Ä¬ÈÏ£ºx00000000-ºÚ 
		...
		public struct NET_ITS_OVERLAP_INFO_PARAM {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;//ÕâÀï±£ÁôÒôÆµµÄÑ¹Ëõ²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 44, ArraySubType = UnmanagedType.I1)]
			public byte[] byMonitoringSite1;//
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byMonitoringSite2;//ÕâÀï±£ÁôÒôÆµµÄÑ¹Ëõ²ÎÊı
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;//ÕâÀï±£ÁôÒôÆµµÄÑ¹Ëõ²ÎÊı 
		}
		...
		public struct NET_ITS_OVERLAP_CFG {
			...
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes1;//ÕâÀï±£ÁôÒôÆµµÄÑ¹Ëõ²ÎÊı
			public NET_ITS_OVERLAP_ITEM_PARAM struOverLapItem;//×Ö·û´®²ÎÊı
			public NET_ITS_OVERLAP_INFO_PARAM struOverLapInfo;//×Ö·û´®ÄÚÈİĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;//ÕâÀï±£ÁôÒôÆµµÄÑ¹Ëõ²ÎÊı 
		}
		...
		public struct NET_DVR_SETUPALARM_PARAM {
			public uint dwSize;
			public byte byLevel;//²¼·ÀÓÅÏÈ¼¶£º0- Ò»µÈ¼¶£¨¸ß£©£¬1- ¶şµÈ¼¶£¨ÖĞ£©£¬2- ÈıµÈ¼¶£¨µÍ£¬±£Áô£©
			public byte byAlarmInfoType;//ÉÏ´«±¨¾¯ĞÅÏ¢ÀàĞÍ£¨ÖÇÄÜ½»Í¨ÉãÏñ»úÖ§³Ö£©£º0- ÀÏ±¨¾¯ĞÅÏ¢£¨NET_DVR_PLATE_RESULT£©£¬1- ĞÂ±¨¾¯ĞÅÏ¢(NET_ITS_PLATE_RESULT) 
		...
		public struct NET_ITS_PLATE_RESULT {
			public uint dwSize;        //½á¹¹³¤¶È
			public uint dwMatchNo;        //Æ¥ÅäĞòºÅ,ÓÉ(³µÁ¾ĞòºÅ,Êı¾İÀàĞÍ,³µµÀºÅ)×é³ÉÆ¥ÅäÂë
			public byte byGroupNum;    //Í¼Æ¬×éÊıÁ¿£¨Ò»Á¾¹ı³µÏà»ú¶à´Î×¥ÅÄµÄÊıÁ¿£¬´ú±íÒ»×éÍ¼Æ¬µÄ×ÜÊı£¬ÓÃÓÚÑÓÊ±Æ¥ÅäÊı¾İ£©
			public byte byPicNo;        //Á¬ÅÄµÄÍ¼Æ¬ĞòºÅ£¨½ÓÊÕµ½Í¼Æ¬×éÊıÁ¿ºó£¬±íÊ¾½ÓÊÕÍê³É;½ÓÊÕ³¬Ê±²»×ãÍ¼Æ¬×éÊıÁ¿Ê±£¬¸ù¾İĞèÒª±£Áô»òÉ¾³ı£©
			public byte bySecondCam;    //ÊÇ·ñµÚ¶şÏà»ú×¥ÅÄ£¨ÈçÔ¶½ü¾°×¥ÅÄµÄÔ¶¾°Ïà»ú£¬»òÇ°ºó×¥ÅÄµÄºóÏà»ú£¬ÌØÊâÏîÄ¿ÖĞ»áÓÃµ½£©
			public byte byFeaturePicNo; //´³ºìµÆµç¾¯£¬È¡µÚ¼¸ÕÅÍ¼×÷ÎªÌØĞ´Í¼,0xff-±íÊ¾²»È¡
			public byte byDriveChan;        //´¥·¢³µµÀºÅ
			public byte byVehicleType;     //³µÁ¾ÀàĞÍ£¬²Î¿¼VTR_RESULT
			public byte byDetSceneID;//¼ì²â³¡¾°ºÅ[1,4], IPCÄ¬ÈÏÊÇ0
									 //³µÁ¾ÊôĞÔ£¬°´Î»±íÊ¾£¬0- ÎŞ¸½¼ÓÊôĞÔ(ÆÕÍ¨³µ)£¬bit1- »Æ±ê³µ(ÀàËÆÄê¼ìµÄ±êÖ¾)£¬bit2- Î£ÏÕÆ·³µÁ¾£¬Öµ£º0- ·ñ£¬1- ÊÇ
									 //¸Ã½ÚµãÒÑ²»ÔÙÊ¹ÓÃ,Ê¹ÓÃÏÂÃæµÄbyYellowLabelCarºÍbyDangerousVehiclesÅĞ¶ÏÊÇ·ñ»Æ±ê³µºÍÎ£ÏÕÆ·³µ
			public byte byVehicleAttribute;
			public ushort wIllegalType;       //Î¥ÕÂÀàĞÍ²ÉÓÃ¹ú±ê¶¨Òå
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 8, ArraySubType = UnmanagedType.I1)]
			public byte[] byIllegalSubType;   //Î¥ÕÂ×ÓÀàĞÍ
			public byte byPostPicNo;    //Î¥ÕÂÊ±È¡µÚ¼¸ÕÅÍ¼Æ¬×÷Îª¿¨¿ÚÍ¼,0xff-±íÊ¾²»È¡
										//Í¨µÀºÅ(ÓĞĞ§£¬±¨¾¯Í¨µÀºÅºÍËùÔÚÉè±¸ÉÏ´«±¨¾¯Í¨µÀºÅÒ»ÖÂ£¬ÔÚºó¶ËºÍËù½ÓÈëµÄ Í¨µÀºÅÒ»ÖÂ)
			public byte byChanIndex;
			public ushort wSpeedLimit;        //ÏŞËÙÉÏÏŞ£¨³¬ËÙÊ±ÓĞĞ§£©
			public byte byChanIndexEx;      //byChanIndexEx*256+byChanIndex±íÊ¾ÕæÊµÍ¨µÀºÅ¡£
			public byte byRes2;
			public NET_DVR_PLATE_INFO struPlateInfo;     //³µÅÆĞÅÏ¢½á¹¹
			public NET_DVR_VEHICLE_INFO struVehicleInfo;    //³µÁ¾ĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 48, ArraySubType = UnmanagedType.I1)]
			public byte[] byMonitoringSiteID;        //¼à²âµã±àºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 48, ArraySubType = UnmanagedType.I1)]
			public byte[] byDeviceID;                //Éè±¸±àºÅ
			public byte byDir;            //¼à²â·½Ïò£¬1-ÉÏĞĞ£¨·´Ïò£©£¬2-ÏÂĞĞ(ÕıÏò)£¬3-Ë«Ïò£¬4-ÓÉ¶«ÏòÎ÷£¬5-ÓÉÄÏÏò±±,6-ÓÉÎ÷Ïò¶«£¬7-ÓÉ±±ÏòÄÏ£¬8-ÆäËü
			public byte byDetectType;    //¼ì²â·½Ê½,1-µØ¸Ğ´¥·¢£¬2-ÊÓÆµ´¥·¢£¬3-¶àÖ¡Ê¶±ğ£¬4-À×´ï´¥·¢
										 //¹ØÁª³µµÀ·½ÏòÀàĞÍ£¬²Î¿¼ITC_RELA_LANE_DIRECTION_TYPE
										 //¸Ã²ÎÊıÎª³µµÀ·½Ïò²ÎÊı£¬Óë¹ØÁª³µµÀºÅ¶ÔÓ¦£¬È·±£³µµÀÎ¨Ò»ĞÔ¡£
			public byte byRelaLaneDirectionType;
			public byte byCarDirectionType; //³µÁ¾¾ßÌåĞĞÊ»µÄ·½Ïò£¬0±íÊ¾´ÓÉÏÍùÏÂ£¬1±íÊ¾´ÓÏÂÍùÉÏ£¨¸ù¾İÊµ¼Ê³µÁ¾µÄĞĞÊ»·½ÏòÀ´µÄÇø·Ö£©
											//µ±wIllegalType²ÎÊıÎª¿ÕÊ±£¬Ê¹ÓÃ¸Ã²ÎÊı¡£ÈôwIllegalType²ÎÊıÎªÓĞÖµÊ±£¬ÒÔwIllegalType²ÎÊıÎª×¼£¬¸Ã²ÎÊıÎŞĞ§¡£
			public uint dwCustomIllegalType; //Î¥ÕÂÀàĞÍ¶¨Òå(ÓÃ»§×Ô¶¨Òå)
											 /*Îª0~Êı×Ö¸ñÊ½Ê±£¬ÎªÀÏµÄÎ¥ÕÂÀàĞÍ£¬wIllegalType¡¢dwCustomIllegalType²ÎÊıÉúĞ§£¬¸³Öµ¹ú±êÎ¥·¨´úÂë¡£
											  * Îª1~×Ö·û¸ñÊ½Ê±£¬pIllegalInfoBuf²ÎÊıÉúĞ§¡£ÀÏµÄÎ¥ÕÂÀàĞÍ£¬wIllegalType¡¢dwCustomIllegalType²ÎÊıÒÀÈ»¸³Öµ¹ú±êÎ¥·¨´úÂë*/
			public IntPtr pIllegalInfoBuf;    //Î¥·¨´úÂë×Ö·ûĞÅÏ¢½á¹¹ÌåÖ¸Õë£»Ö¸ÏòNET_ITS_ILLEGAL_INFO 
			public byte byIllegalFromatType; //Î¥ÕÂĞÅÏ¢¸ñÊ½ÀàĞÍ£» 0~Êı×Ö¸ñÊ½£¬ 1~×Ö·û¸ñÊ½
			public byte byPendant;// 0-±íÊ¾Î´Öª,1-³µ´°ÓĞĞü¹ÒÎï£¬2-³µ´°ÎŞĞü¹ÒÎï
			public byte byDataAnalysis;            //0-Êı¾İÎ´·ÖÎö, 1-Êı¾İÒÑ·ÖÎö
			public byte byYellowLabelCar;        //0-±íÊ¾Î´Öª, 1-·Ç»Æ±ê³µ,2-»Æ±ê³µ
			public byte byDangerousVehicles;    //0-±íÊ¾Î´Öª, 1-·ÇÎ£ÏÕÆ·³µ,2-Î£ÏÕÆ·³µ
												//ÒÔÏÂ×Ö¶Î°üº¬Pilot×Ö·û¾ùÎªÖ÷¼İÊ»£¬º¬Copilot×Ö·û¾ùÎª¸±¼İÊ»
			...
			public byte byPilotCall;// 0-±íÊ¾Î´Öª, 1-²»´òµç»°,2-´òµç»°
									//0-¿ªÕ¢£¬1-Î´¿ªÕ¢ (×¨ÓÃÓÚÀúÊ·Êı¾İÖĞÏà»ú¸ù¾İºÚ°×Ãûµ¥Æ¥Åäºó£¬ÊÇ·ñ¿ªÕ¢³É¹¦µÄ±êÖ¾)
			public byte byBarrierGateCtrlType;
			public byte byAlarmDataType;//0-ÊµÊ±Êı¾İ£¬1-ÀúÊ·Êı¾İ
			public NET_DVR_TIME_V30 struSnapFirstPicTime;//¶ËµãÊ±¼ä(ms)£¨×¥ÅÄµÚÒ»ÕÅÍ¼Æ¬µÄÊ±¼ä£©
			public uint dwIllegalTime;//Î¥·¨³ÖĞøÊ±¼ä£¨ms£© = ×¥ÅÄ×îºóÒ»ÕÅÍ¼Æ¬µÄÊ±¼ä - ×¥ÅÄµÚÒ»ÕÅÍ¼Æ¬µÄÊ±¼ä
			public uint dwPicNum;        //Í¼Æ¬ÊıÁ¿£¨ÓëpicGroupNum²»Í¬£¬´ú±í±¾ÌõĞÅÏ¢¸½´øµÄÍ¼Æ¬ÊıÁ¿£¬Í¼Æ¬ĞÅÏ¢ÓÉstruVehicleInfoEx¶¨Òå    
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.Struct)]
			public NET_ITS_PICTURE_INFO[] struPicInfo;         //Í¼Æ¬ĞÅÏ¢,µ¥ÕÅ»Øµ÷£¬×î¶à6ÕÅÍ¼£¬ÓÉĞòºÅÇø·Ö
		}
		...
		public struct NET_DVR_DIAGNOSIS_UPLOAD {
			...
			public string sStreamID;    ///< Á÷ID£¬³¤¶ÈĞ¡ÓÚ32¸ö×Ö½Ú
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 64)]
			...
			public byte byResult;  ///0-Î´¼ì²â 1-Õı³£ 2-Òì³£ 3-µÇÂ¼Ê§°Ü 4-È¡Á÷Òì³£
			public byte bySignalResult; ///< ÊÓÆµ¶ªÊ§¼ì²â½á¹û 0-Î´¼ì²â 1-Õı³£ 2-Òì³£
			public byte byBlurResult;  ///< Í¼ÏñÄ£ºı¼ì²â½á¹û£¬0-Î´¼ì²â 1-Õı³£ 2-Òì³£
			public byte byLumaResult;  ///< Í¼Ïñ¹ıÁÁ¼ì²â½á¹û£¬0-Î´¼ì²â 1-Õı³£ 2-Òì³£
			public byte byChromaResult;  ///< Æ«É«¼ì²â½á¹û£¬0-Î´¼ì²â 1-Õı³£ 2-Òì³£
			public byte bySnowResult;  ///< ÔëÉù¸ÉÈÅ¼ì²â½á¹û£¬0-Î´¼ì²â 1-Õı³£ 2-Òì³£
			public byte byStreakResult;  ///< ÌõÎÆ¸ÉÈÅ¼ì²â½á¹û£¬0-Î´¼ì²â 1-Õı³£ 2-Òì³£
			public byte byFreezeResult;  ///< »­Ãæ¶³½á¼ì²â½á¹û£¬0-Î´¼ì²â 1-Õı³£ 2-Òì³£
			public byte byPTZResult;  ///< ÔÆÌ¨¼ì²â½á¹û£¬0-Î´¼ì²â 1-Õı³£ 2-Òì³£
			public byte byContrastResult;     //¶Ô±È¶ÈÒì³£¼ì²â½á¹û£¬0-Î´¼ì²â£¬1-Õı³££¬2-Òì³£
			public byte byMonoResult;         //ºÚ°×Í¼Ïñ¼ì²â½á¹û£¬0-Î´¼ì²â£¬1-Õı³££¬2-Òì³£
			public byte byShakeResult;        //ÊÓÆµ¶¶¶¯¼ì²â½á¹û£¬0-Î´¼ì²â£¬1-Õı³££¬2-Òì³£
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 256)]
			public string sSNapShotURL; ///<Í¼Æ¬URLµØÖ·
			public byte byFlashResult;        //ÊÓÆµ¾ç±ä¼ì²â½á¹û£¬0-Î´¼ì²â£¬1-Õı³££¬2-Òì³£
			public byte byCoverResult;        //ÊÓÆµÕÚµ²¼ì²â½á¹û£¬0-Î´¼ì²â£¬1-Õı³££¬2-Òì³£
			public byte bySceneResult;        //³¡¾°±ä¸ü¼ì²â½á¹û£¬0-Î´¼ì²â£¬1-Õı³££¬2-Òì³£
			public byte byDarkResult;         //Í¼Ïñ¹ı°µ¼ì²â½á¹û£¬0-Î´¼ì²â£¬1-Õı³££¬2-Òì³£
			public byte byStreamType;       //ÂëÁ÷ÀàĞÍ£¬0-ÎŞĞ§£¬1-Î´Öª£¬2-¹ú±êÀàĞÍ£¬3-·Ç¹ú±êÀàĞÍ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 59, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_DVR_CID_ALARM {
			...
			public byte[] sCIDCode;    //CIDÊÂ¼şºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sCIDDescribe;    //CIDÊÂ¼şÃû
			...
			public byte[] sCenterAccount;    //ÖĞĞÄÕÊºÅ
			public byte byReportType;                    //¼û¶¨ÒåNET_DVR_ALARMHOST_REPORT_TYPE
			public byte byUserType;                        //ÓÃ»§ÀàĞÍ£¬0-ÍøÂçÓÃ»§ 1-¼üÅÌÓÃ»§,2-ÊÖ»úÓÃ»§,3-ÏµÍ³ÓÃ»§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sUserName;        //ÍøÂçÓÃ»§ÓÃ»§Ãû
			public ushort wKeyUserNo;                        //¼üÅÌÓÃ»§ºÅ    0xFFFF±íÊ¾ÎŞĞ§
			public byte byKeypadNo;                        //¼üÅÌºÅ        0xFF±íÊ¾ÎŞĞ§
			public byte bySubSysNo;                        //×ÓÏµÍ³ºÅ        0xFF±íÊ¾ÎŞĞ§
			public ushort wDefenceNo;                        //·ÀÇøºÅ        0xFFFF±íÊ¾ÎŞĞ§
			public byte byVideoChanNo;                    //ÊÓÆµÍ¨µÀºÅ    0xFF±íÊ¾ÎŞĞ§
			public byte byDiskNo;                        //Ó²ÅÌºÅ        0xFF±íÊ¾ÎŞĞ§
			public ushort wModuleAddr;                    //Ä£¿éµØÖ·        0xFFFF±íÊ¾ÎŞĞ§
			public byte byCenterType;                    //0-ÎŞĞ§, 1-ÖĞĞÄÕËºÅ(³¤¶È6),2-À©Õ¹µÄÖĞĞÄÕËºÅ(³¤¶È9)
			public byte byRes1;
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = ACCOUNTNUM_LEN_32, ArraySubType = UnmanagedType.I1)]
			public byte[] sCenterAccountV40;    //ÖĞĞÄÕËºÅV40,Ê¹ÓÃ´Ë×Ö¶ÎÊ±sCenterAccountÎŞĞ§
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 28, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
		}
		...
		public struct NET_PTZ_INFO {
			...
			public float fTilt;
			public float fZoom;
			public uint dwFocus;// ¾Û½¹²ÎÊı£¬¾Û½¹·¶Î§£º¹éÒ»»¯0-100000
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_FIREDETECTION_ALARM {
			...
			public IntPtr pBuffer;    //Êı¾İÖ¸Õë
			public NET_VCA_RECT struRect;//»ğµã¿ò 
			public NET_VCA_POINT struPoint;//»ğµã¿òÄÚ×î¸ßÎÂ¶Èµã×ø±ê
			public ushort wFireMaxTemperature;//»ğµã×î¸ßÎÂ¶È[300¡æ~4000¡æ]
			public ushort wTargetDistance;//Ä¿±ê¾àÀë[100m ~ 10000m]
			public byte byStrategyType;//²ßÂÔÀàĞÍ£»0~ÈÎÒâ±¨¾¯£¬1~Ğ­Í¬±¨¾¯£¬2~¶àÏµÍ³±¨¾¯£¬3~Ö¸¶¨»ğµã±¨¾¯£¬4~Ö¸¶¨ÑÌÎí±¨¾¯
			public byte byAlarmSubType;//±¨¾¯×ÓÀàĞÍ¡£0~»ğµã¼ì²â±¨¾¯£¬1~ÑÌÎí¼ì²â±¨¾¯£¬2~ÑÌ»ğ±¨¾¯
									   /*ÊÇ·ñÆôÓÃPTZ×ø±êÀ©Õ¹£¬
									   0~²»ÆôÓÃ£¬PTZ×ø±êÖµÒÔwPanPos¡¢wTiltPos¡¢wZoomPosÎª×¼¡£
									   1~ÆôÓÃ£¬PTZ×ø±êÖµÒÔstruPtzPosExÎª×¼¡£µ«ÊÇĞÂÀÏPTZ¶¼Ğè·µ»Ø¡£struPtzPosExµÄÖµĞè×ª»¯ÎªwPanPos¡¢wTiltPos¡¢wZoomPosÖµ¡£
									   */
			public byte byPTZPosExEnable;
			public byte byRes2;
			public NET_PTZ_INFO struPtzPosEx;// ptz×ø±êÀ©Õ¹(Ö§³Ö¸ß¾«¶ÈPTZÖµ£¬¾«È·µ½Ğ¡ÊıµãºóÈıÎ»)
			public uint dwVisiblePicLen;//¿É¼û¹âÍ¼Æ¬³¤¶È
			public IntPtr pVisiblePicBuf;    //¿É¼û¹âÍ¼Æ¬Êı¾İÖ¸Õë
											 // pSmokeBuf²ÎÊıµ±byAlarmSubType±¨¾¯×ÓÀàĞÍÎª1£¨ÑÌÎí¼ì²â±¨¾¯£©¡¢2£¨ÑÌ»ğ±¨¾¯£©Ê±ÉúĞ§¡£
			public IntPtr pSmokeBuf;    //ÑÌÎí¼ì²â±¨¾¯Êı¾İÖ¸Õë£¬Ö¸ÏòÒ»¸öNET_DVR_SMOKEDETECTION_ALARM½á¹¹Ìå
			public ushort wDevInfoIvmsChannelEx;     //ÓëNET_VCA_DEV_INFOÀïµÄbyIvmsChannelº¬ÒåÏàÍ¬£¬ÄÜ±íÊ¾¸ü´óµÄÖµ¡£ÀÏ¿Í»§¶ËÓÃbyIvmsChannelÄÜ¼ÌĞø¼æÈİ£¬µ«ÊÇ×î´óµ½255¡£ĞÂ¿Í»§¶Ë°æ±¾ÇëÊ¹ÓÃwDevInfoIvmsChannelEx¡£
		...
		public const int MAX_ID_NUM_LEN = 32;  //×î´óÉí·İÖ¤ºÅ³¤¶È
		public const int MAX_ID_NAME_LEN = 128;   //×î´óĞÕÃû³¤¶È
		...
		public struct NET_DVR_ACS_EVENT_INFO {
			...
			public byte[] byCardNo; //¿¨ºÅ£¬Îª0ÎŞĞ§
			public byte byCardType; //¿¨ÀàĞÍ£¬1-ÆÕÍ¨¿¨£¬2-²Ğ¼²ÈË¿¨£¬3-ºÚÃûµ¥¿¨£¬4-Ñ²¸ü¿¨£¬5-Ğ²ÆÈ¿¨£¬6-³¬¼¶¿¨£¬7-À´±ö¿¨£¬Îª0ÎŞĞ§
			public byte byWhiteListNo; //°×Ãûµ¥µ¥ºÅ,1-8£¬Îª0ÎŞĞ§
			public byte byReportChannel; //±¨¸æÉÏ´«Í¨µÀ£¬1-²¼·ÀÉÏ´«£¬2-ÖĞĞÄ×é1ÉÏ´«£¬3-ÖĞĞÄ×é2ÉÏ´«£¬Îª0ÎŞĞ§
			public byte byCardReaderKind; //¶Á¿¨Æ÷ÊôÓÚÄÄÒ»Àà£¬0-ÎŞĞ§£¬1-IC¶Á¿¨Æ÷£¬2-Éí·İÖ¤¶Á¿¨Æ÷£¬3-¶şÎ¬Âë¶Á¿¨Æ÷,4-Ö¸ÎÆÍ·
			public uint dwCardReaderNo; //¶Á¿¨Æ÷±àºÅ£¬Îª0ÎŞĞ§
			public uint dwDoorNo; //ÃÅ±àºÅ(Â¥²ã±àºÅ)£¬Îª0ÎŞĞ§
			public uint dwVerifyNo; //¶àÖØ¿¨ÈÏÖ¤ĞòºÅ£¬Îª0ÎŞĞ§
			public uint dwAlarmInNo;  //±¨¾¯ÊäÈëºÅ£¬Îª0ÎŞĞ§
			public uint dwAlarmOutNo; //±¨¾¯Êä³öºÅ£¬Îª0ÎŞĞ§
			public uint dwCaseSensorNo; //ÊÂ¼ş´¥·¢Æ÷±àºÅ
			public uint dwRs485No;    //RS485Í¨µÀºÅ£¬Îª0ÎŞĞ§
			public uint dwMultiCardGroupNo; //Èº×é±àºÅ
			public ushort wAccessChannel;    //ÈËÔ±Í¨µÀºÅ
			public byte byDeviceNo;    //Éè±¸±àºÅ£¬Îª0ÎŞĞ§
			public byte byDistractControlNo;//·Ö¿ØÆ÷±àºÅ£¬Îª0ÎŞĞ§
			public uint dwEmployeeNo; //¹¤ºÅ£¬Îª0ÎŞĞ§
			public ushort wLocalControllerID; //¾ÍµØ¿ØÖÆÆ÷±àºÅ£¬0-ÃÅ½ûÖ÷»ú£¬1-64´ú±í¾ÍµØ¿ØÖÆÆ÷
			public byte byInternetAccess; //Íø¿ÚID£º£¨1-ÉÏĞĞÍø¿Ú1,2-ÉÏĞĞÍø¿Ú2,3-ÏÂĞĞÍø¿Ú1£©
			public byte byType;     //·ÀÇøÀàĞÍ£¬0:¼´Ê±·ÀÇø,1-24Ğ¡Ê±·ÀÇø,2-ÑÓÊ±·ÀÇø ,3-ÄÚ²¿·ÀÇø£¬4-Ô¿³×·ÀÇø 5-»ğ¾¯·ÀÇø 6-ÖÜ½ç·ÀÇø 7-24Ğ¡Ê±ÎŞÉù·ÀÇø  8-24Ğ¡Ê±¸¨Öú·ÀÇø£¬9-24Ğ¡Ê±Õğ¶¯·ÀÇø,10-ÃÅ½û½ô¼±¿ªÃÅ·ÀÇø£¬11-ÃÅ½û½ô¼±¹ØÃÅ·ÀÇø 0xff-ÎŞ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MACADDR_LEN, ArraySubType = UnmanagedType.I1)]
			public byte[] byMACAddr; //ÎïÀíµØÖ·£¬Îª0ÎŞĞ§
			public byte bySwipeCardType;//Ë¢¿¨ÀàĞÍ£¬0-ÎŞĞ§£¬1-¶şÎ¬Âë
			public byte byRes2;
			public uint dwSerialNo; //ÊÂ¼şÁ÷Ë®ºÅ£¬Îª0ÎŞĞ§
			public byte byChannelControllerID; //Í¨µÀ¿ØÖÆÆ÷ID£¬Îª0ÎŞĞ§£¬1-Ö÷Í¨µÀ¿ØÖÆÆ÷£¬2-´ÓÍ¨µÀ¿ØÖÆÆ÷
			public byte byChannelControllerLampID; //Í¨µÀ¿ØÖÆÆ÷µÆ°åID£¬Îª0ÎŞĞ§£¨ÓĞĞ§·¶Î§1-255£©
			public byte byChannelControllerIRAdaptorID; //Í¨µÀ¿ØÖÆÆ÷ºìÍâ×ª½Ó°åID£¬Îª0ÎŞĞ§£¨ÓĞĞ§·¶Î§1-255£©
			public byte byChannelControllerIREmitterID; //Í¨µÀ¿ØÖÆÆ÷ºìÍâ¶ÔÉäID£¬Îª0ÎŞĞ§£¨ÓĞĞ§·¶Î§1-255£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public struct NET_DVR_ACS_ALARM_INFO {
			public uint dwSize;
			public uint dwMajor; //±¨¾¯Ö÷ÀàĞÍ£¬²Î¿¼ºê¶¨Òå
			public uint dwMinor; //±¨¾¯´ÎÀàĞÍ£¬²Î¿¼ºê¶¨Òå
			public NET_DVR_TIME struTime; //Ê±¼ä
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_NAMELEN, ArraySubType = UnmanagedType.I1)]
			public byte[] sNetUser;//ÍøÂç²Ù×÷µÄÓÃ»§Ãû
			public NET_DVR_IPADDR struRemoteHostAddr;//Ô¶³ÌÖ÷»úµØÖ·
			public NET_DVR_ACS_EVENT_INFO struAcsEventInfo; //ÏêÏ¸²ÎÊı
			public uint dwPicDataLen;   //Í¼Æ¬Êı¾İ´óĞ¡£¬²»Îª0ÊÇ±íÊ¾ºóÃæ´øÊı¾İ
		...
		public struct NET_DVR_ID_CARD_INFO {
			...
			public byte[] byIDNum;   //Éí·İÖ¤ºÅÂë
			...
			public NET_DVR_DATE struStartDate;  //ÓĞĞ§¿ªÊ¼ÈÕÆÚ
			public NET_DVR_DATE struEndDate;  //ÓĞĞ§½ØÖ¹ÈÕÆÚ
			public byte byTermOfValidity;  //ÊÇ·ñ³¤ÆÚÓĞĞ§£¬ 0-·ñ£¬1-ÊÇ£¨ÓĞĞ§½ØÖ¹ÈÕÆÚÎŞĞ§£©
			public byte bySex;  //ĞÔ±ğ£¬1-ÄĞ£¬2-Å®
			public byte byNation;    //Ãñ×å£¬1-"ºº"£¬2-"ÃÉ¹Å"£¬3-"»Ø",4-"²Ø",5-"Î¬Îá¶û",6-"Ãç",7-"ÒÍ",8-"×³",9-"²¼ÒÀ",10-"³¯ÏÊ",
									 //11-"Âú",12-"¶±",13-"Ñş",14-"°×",15-"ÍÁ¼Ò",16-"¹şÄá",17-"¹şÈø¿Ë",18-"´ö",19-"Àè",20-"ÀüËÛ",
									 //21-"Øô",22-"î´",23-"¸ßÉ½",24-"À­ìï",25-"Ë®",26-"¶«Ïç",27-"ÄÉÎ÷",28-"¾°ÆÄ",29-"¿Â¶û¿Ë×Î",30-"ÍÁ",
									 //31-"´ïÎÓ¶û",32-"ØïÀĞ",33-"Ç¼",34-"²¼ÀÊ",35-"ÈöÀ­",36-"Ã«ÄÏ",37-"ØîÀĞ",38-"Îı²®",39-"°¢²ı",40-"ÆÕÃ×",
									 //41-"Ëş¼ª¿Ë",42-"Å­",43-"ÎÚ×Î±ğ¿Ë",44-"¶íÂŞË¹",45-"¶õÎÂ¿Ë",46-"µÂ°º",47-"±£°²",48-"Ô£¹Ì",49-"¾©",50-"ËşËş¶û",
		...
		public struct NET_DVR_ID_CARD_INFO_ALARM {
			public uint dwSize;        //½á¹¹³¤¶È
			public NET_DVR_ID_CARD_INFO struIDCardCfg;//Éí·İÖ¤ĞÅÏ¢
			public uint dwMajor; //±¨¾¯Ö÷ÀàĞÍ£¬²Î¿¼ºê¶¨Òå
			public uint dwMinor; //±¨¾¯´ÎÀàĞÍ£¬²Î¿¼ºê¶¨Òå
			...
			public NET_DVR_IPADDR struRemoteHostAddr;//Ô¶³ÌÖ÷»úµØÖ·
			public uint dwCardReaderNo; //¶Á¿¨Æ÷±àºÅ£¬Îª0ÎŞĞ§
			public uint dwDoorNo; //ÃÅ±àºÅ£¬Îª0ÎŞĞ§
			public uint dwPicDataLen;   //Í¼Æ¬Êı¾İ´óĞ¡£¬²»Îª0ÊÇ±íÊ¾ºóÃæ´øÊı¾İ
			public IntPtr pPicData;
			public byte byCardType; //¿¨ÀàĞÍ£¬1-ÆÕÍ¨¿¨£¬2-²Ğ¼²ÈË¿¨£¬3-ºÚÃûµ¥¿¨£¬4-Ñ²¸ü¿¨£¬5-Ğ²ÆÈ¿¨£¬6-³¬¼¶¿¨£¬7-À´±ö¿¨£¬8-½â³ı¿¨£¬Îª0ÎŞĞ§
			public byte byDeviceNo;                             // Éè±¸±àºÅ£¬Îª0Ê±ÎŞĞ§£¨ÓĞĞ§·¶Î§1-255£©
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes2;
			public uint dwFingerPrintDataLen;                  // Ö¸ÎÆÊı¾İ´óĞ¡£¬²»Îª0ÊÇ±íÊ¾ºóÃæ´øÊı¾İ
			public IntPtr pFingerPrintData;
			public uint dwCapturePicDataLen;                   // ×¥ÅÄÍ¼Æ¬Êı¾İ´óĞ¡£¬²»Îª0ÊÇ±íÊ¾ºóÃæ´øÊı¾İ
        ...
        Desc:		³õÊ¼»¯SDK£¬µ÷ÓÃÆäËûSDKº¯ÊıµÄÇ°Ìá¡£
        Input:	
        Output:	
		...
		**********************************************************/
        ...
        Input:	lUserID [in] NET_DVR_Login()»òNET_DVR_Login_V30()µÄ·µ»ØÖµ 
                lpClientInfo [in] Ô¤ÀÀ²ÎÊı 
                cbRealDataCallBack [in] ÂëÁ÷Êı¾İ»Øµ÷º¯Êı 
                pUser [in] ÓÃ»§Êı¾İ 
                bBlocked [in] ÇëÇóÂëÁ÷¹ı³ÌÊÇ·ñ×èÈû£º0£­·ñ£»1£­ÊÇ 
        Output:	
        Return:	1±íÊ¾Ê§°Ü£¬ÆäËûÖµ×÷ÎªNET_DVR_StopRealPlayµÈº¯ÊıµÄ¾ä±ú²ÎÊı
        **********************************************************/
        ...
        Input:	lUserID [in] NET_DVR_Login()»òNET_DVR_Login_V30()µÄ·µ»ØÖµ 
                lpPreviewInfo [in] Ô¤ÀÀ²ÎÊı 
                fRealDataCallBack_V30 [in] ÂëÁ÷Êı¾İ»Øµ÷º¯Êı 
                pUser [in] ÓÃ»§Êı¾İ 
        Output:	
        Return:	1±íÊ¾Ê§°Ü£¬ÆäËûÖµ×÷ÎªNET_DVR_StopRealPlayµÈº¯ÊıµÄ¾ä±ú²ÎÊı
        **********************************************************/
        ...
        **********************************************************/
		...
		public const int NET_DVR_HIDELOGO = 2;/*Òş²ØLOGO*/
		...
		//SDK_V222
		//ÖÇÄÜÉè±¸ÀàĞÍ
		public const int DS6001_HF_B = 60;//ĞĞÎª·ÖÎö£ºDS6001-HF/B
		public const int DS6001_HF_P = 61;//³µÅÆÊ¶±ğ£ºDS6001-HF/P
		public const int DS6002_HF_B = 62;//Ë«»ú¸ú×Ù£ºDS6002-HF/B
		public const int DS6101_HF_B = 63;//ĞĞÎª·ÖÎö£ºDS6101-HF/B
		public const int IDS52XX = 64;//ÖÇÄÜ·ÖÎöÒÇIVMS
		public const int DS9000_IVS = 65;//9000ÏµÁĞÖÇÄÜDVR
		public const int DS8004_AHL_A = 66;//ÖÇÄÜATM, DS8004AHL-S/A
		public const int DS6101_HF_P = 67;//³µÅÆÊ¶±ğ£ºDS6101-HF/P

		//ÄÜÁ¦»ñÈ¡ÃüÁî
		public const int VCA_DEV_ABILITY = 256;//Éè±¸ÖÇÄÜ·ÖÎöµÄ×ÜÄÜÁ¦
		public const int VCA_CHAN_ABILITY = 272;//ĞĞÎª·ÖÎöÄÜÁ¦
		public const int MATRIXDECODER_ABILITY = 512;//¶àÂ·½âÂëÆ÷ÏÔÊ¾¡¢½âÂëÄÜÁ¦
													 //»ñÈ¡/ÉèÖÃ´ó½Ó¿Ú²ÎÊıÅäÖÃÃüÁî
													 //³µÅÆÊ¶±ğ£¨NET_VCA_PLATE_CFG£©
		public const int NET_DVR_SET_PLATECFG = 150;//ÉèÖÃ³µÅÆÊ¶±ğ²ÎÊı
		public const int NET_DVR_GET_PLATECFG = 151;//»ñÈ¡³µÅÆÊ¶±ğ²ÎÊı
													//ĞĞÎª¶ÔÓ¦£¨NET_VCA_RULECFG£©
		public const int NET_DVR_SET_RULECFG = 152;//ÉèÖÃĞĞÎª·ÖÎö¹æÔò
		public const int NET_DVR_GET_RULECFG = 153;//»ñÈ¡ĞĞÎª·ÖÎö¹æÔò

		//Ë«ÉãÏñ»ú±ê¶¨²ÎÊı£¨NET_DVR_LF_CFG£©
		public const int NET_DVR_SET_LF_CFG = 160;//ÉèÖÃË«ÉãÏñ»úµÄÅäÖÃ²ÎÊı
		public const int NET_DVR_GET_LF_CFG = 161;//»ñÈ¡Ë«ÉãÏñ»úµÄÅäÖÃ²ÎÊı

		//ÖÇÄÜ·ÖÎöÒÇÈ¡Á÷ÅäÖÃ½á¹¹
		public const int NET_DVR_SET_IVMS_STREAMCFG = 162;//ÉèÖÃÖÇÄÜ·ÖÎöÒÇÈ¡Á÷²ÎÊı
		public const int NET_DVR_GET_IVMS_STREAMCFG = 163;//»ñÈ¡ÖÇÄÜ·ÖÎöÒÇÈ¡Á÷²ÎÊı

		//ÖÇÄÜ¿ØÖÆ²ÎÊı½á¹¹
		public const int NET_DVR_SET_VCA_CTRLCFG = 164;//ÉèÖÃÖÇÄÜ¿ØÖÆ²ÎÊı
		public const int NET_DVR_GET_VCA_CTRLCFG = 165;//»ñÈ¡ÖÇÄÜ¿ØÖÆ²ÎÊı

		//ÆÁ±ÎÇøÓòNET_VCA_MASK_REGION_LIST
		public const int NET_DVR_SET_VCA_MASK_REGION = 166;//ÉèÖÃÆÁ±ÎÇøÓò²ÎÊı
		public const int NET_DVR_GET_VCA_MASK_REGION = 167;//»ñÈ¡ÆÁ±ÎÇøÓò²ÎÊı

		//ATM½øÈëÇøÓò NET_VCA_ENTER_REGION
		public const int NET_DVR_SET_VCA_ENTER_REGION = 168;//ÉèÖÃ½øÈëÇøÓò²ÎÊı
		public const int NET_DVR_GET_VCA_ENTER_REGION = 169;//»ñÈ¡½øÈëÇøÓò²ÎÊı
		...
		public const int NET_DVR_SET_IVMS_MASK_REGION = 172;//ÉèÖÃIVMSÆÁ±ÎÇøÓò²ÎÊı
		public const int NET_DVR_GET_IVMS_MASK_REGION = 173;//»ñÈ¡IVMSÆÁ±ÎÇøÓò²ÎÊı
															// ivms½øÈë¼ì²âÇøÓòNET_IVMS_ENTER_REGION
		public const int NET_DVR_SET_IVMS_ENTER_REGION = 174;//ÉèÖÃIVMS½øÈëÇøÓò²ÎÊı
		public const int NET_DVR_GET_IVMS_ENTER_REGION = 175;//»ñÈ¡IVMS½øÈëÇøÓò²ÎÊı

		public const int NET_DVR_SET_IVMS_BEHAVIORCFG = 176;//ÉèÖÃÖÇÄÜ·ÖÎöÒÇĞĞÎª¹æÔò²ÎÊı
		public const int NET_DVR_GET_IVMS_BEHAVIORCFG = 177;//»ñÈ¡ÖÇÄÜ·ÖÎöÒÇĞĞÎª¹æÔò²ÎÊı

		// IVMS »Ø·Å¼ìË÷
		public const int NET_DVR_IVMS_SET_SEARCHCFG = 178;//ÉèÖÃIVMS»Ø·Å¼ìË÷²ÎÊı
		public const int NET_DVR_IVMS_GET_SEARCHCFG = 179;//»ñÈ¡IVMS»Ø·Å¼ìË÷²ÎÊı        

		//½á¹¹²ÎÊıºê¶¨Òå 
		public const int VCA_MAX_POLYGON_POINT_NUM = 10;//¼ì²âÇøÓò×î¶àÖ§³Ö10¸öµãµÄ¶à±ßĞÎ
		public const int MAX_RULE_NUM = 8;//×î¶à¹æÔòÌõÊı
		public const int MAX_TARGET_NUM = 30;//×î¶àÄ¿±ê¸öÊı
		public const int MAX_CALIB_PT = 6;//×î´ó±ê¶¨µã¸öÊı
		public const int MIN_CALIB_PT = 4;//×îĞ¡±ê¶¨µã¸öÊı
		public const int MAX_TIMESEGMENT_2 = 2;//×î´óÊ±¼ä¶ÎÊı
		public const int MAX_LICENSE_LEN = 16;//³µÅÆºÅ×î´ó³¤¶È
		public const int MAX_PLATE_NUM = 3;//³µÅÆ¸öÊı
		public const int MAX_MASK_REGION_NUM = 4;//×î¶àËÄ¸öÆÁ±ÎÇøÓò
		public const int MAX_SEGMENT_NUM = 6;//ÉãÏñ»ú±ê¶¨×î´óÑù±¾ÏßÊıÄ¿
		public const int MIN_SEGMENT_NUM = 3;//ÉãÏñ»ú±ê¶¨×îĞ¡Ñù±¾ÏßÊıÄ¿   
		public const int MAX_CATEGORY_LEN = 8; //³µÅÆ¸½¼ÓĞÅÏ¢×î´ó×Ö·û
											   /*********************************************************
		...
		public enum IVS_PARAM_KEY {
			...
			BACKGROUND_UPDATE_RATE = 2,//±³¾°¸üĞÂËÙ¶È
			SCENE_CHANGE_RATIO = 3,//³¡¾°±ä»¯¼ì²â×îĞ¡Öµ
			SUPPRESS_LAMP = 4,//ÊÇ·ñÒÖÖÆ³µÍ·µÆ
			MIN_OBJECT_SIZE = 5,//ÄÜ¼ì²â³öµÄ×îĞ¡Ä¿±ê´óĞ¡
			OBJECT_GENERATE_RATE = 6,//Ä¿±êÉú³ÉËÙ¶È
			MISSING_OBJECT_HOLD = 7,//Ä¿±êÏûÊ§ºó¼ÌĞø¸ú×ÙÊ±¼ä
			MAX_MISSING_DISTANCE = 8,//Ä¿±êÏûÊ§ºó¼ÌĞø¸ú×Ù¾àÀë
			OBJECT_MERGE_SPEED = 9,//¶à¸öÄ¿±ê½»´íÊ±£¬Ä¿±êµÄÈÚºÏËÙ¶È
			REPEATED_MOTION_SUPPRESS = 10,//ÖØ¸´ÔË¶¯ÒÖÖÆ
			ILLUMINATION_CHANGE = 11,//¹âÓ°±ä»¯ÒÖÖÆ¿ª¹Ø
			TRACK_OUTPUT_MODE = 12,//¹ì¼£Êä³öÄ£Ê½£º0-Êä³öÄ¿±êµÄÖĞĞÄ£¬1-Êä³öÄ¿±êµÄµ×²¿ÖĞĞÄ
			ENTER_CHANGE_HOLD = 13,//¼ì²âÇøÓò±ä»¯ãĞÖµ
			RESUME_DEFAULT_PARAM = 255,//»Ö¸´Ä¬ÈÏ¹Ø¼ü×Ö²ÎÊı
		}
		...
		public enum VCA_RECOGNIZE_SCENE {
			VCA_LOW_SPEED_SCENE = 0,//µÍËÙÍ¨¹ı³¡¾°£¨ÊÕ·ÑÕ¾¡¢Ğ¡ÇøÃÅ¿Ú¡¢Í£³µ³¡£©
			VCA_HIGH_SPEED_SCENE = 1,//¸ßËÙÍ¨¹ı³¡¾°£¨¿¨¿Ú¡¢¸ßËÙ¹«Â·¡¢ÒÆ¶¯»ü²é)
			VCA_MOBILE_CAMERA_SCENE = 2,//ÒÆ¶¯ÉãÏñ»úÓ¦ÓÃ£© 
		}

		//Ê¶±ğ½á¹û±êÖ¾
		public enum VCA_RECOGNIZE_RESULT {
			VCA_RECOGNIZE_FAILURE = 0,//Ê¶±ğÊ§°Ü
			VCA_IMAGE_RECOGNIZE_SUCCESS,//Í¼ÏñÊ¶±ğ³É¹¦
			VCA_VIDEO_RECOGNIZE_SUCCESS_OF_BEST_LICENSE,//ÊÓÆµÊ¶±ğ¸üÓÅ½á¹û
			VCA_VIDEO_RECOGNIZE_SUCCESS_OF_NEW_LICENSE,//ÊÓÆµÊ¶±ğµ½ĞÂµÄ³µÅÆ
			VCA_VIDEO_RECOGNIZE_FINISH_OF_CUR_LICENSE,//ÊÓÆµÊ¶±ğ³µÅÆ½áÊø
		}
		...
		public enum VCA_TRIGGER_TYPE {
			INTER_TRIGGER = 0,// Ä£¿éÄÚ²¿´¥·¢Ê¶±ğ
			EXTER_TRIGGER = 1,// Íâ²¿ÎïÀíĞÅºÅ´¥·¢£ºÏßÈ¦¡¢À×´ï¡¢ÊÖ¶¯´¥·¢ĞÅºÅ£»
		}

		public const int MAX_CHINESE_CHAR_NUM = 64;    // ×î´óºº×ÖÀà±ğÊıÁ¿
													   //³µÅÆ¿É¶¯Ì¬ĞŞ¸Ä²ÎÊı
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_VCA_PLATE_PARAM {
			public NET_VCA_RECT struSearchRect;//ËÑË÷ÇøÓò(¹éÒ»»¯)
			public NET_VCA_RECT struInvalidateRect;//ÎŞĞ§ÇøÓò£¬ÔÚËÑË÷ÇøÓòÄÚ²¿ (¹éÒ»»¯)
			public ushort wMinPlateWidth;//³µÅÆ×îĞ¡¿í¶È
			public ushort wTriggerDuration;//´¥·¢³ÖĞøÖ¡Êı
		...
		/*wMinPlateWidth:¸Ã²ÎÊıÄ¬ÈÏÅäÖÃÎª80ÏñËØ£»¸Ã²ÎÊıµÄÅäÖÃ¶ÔÓÚ³µÅÆº£¿µÍşÊÓ³µÅÆÊ¶±ğËµÃ÷ÎÄµµ 
	    Ê¶±ğÓĞÓ°Ïì£¬Èç¹ûÉèÖÃ¹ı´ó£¬ÄÇÃ´Èç¹û³¡¾°ÖĞ³öÏÖĞ¡³µÅÆ¾Í»áÂ©Ê¶±ğ£»Èç¹û³¡¾°ÖĞ³µÅÆ¿í¶ÈÆÕ±é½Ï´ó£¬¿ÉÒÔ°Ñ¸Ã²ÎÊıÉèÖÃÉÔ´ó£¬±ãÓÚ¼õÉÙ¶ÔĞé¼Ù³µÅÆµÄ´¦Àí¡£ÔÚ±êÇåÇé¿öÏÂ½¨ÒéÉèÖÃÎª80£¬ ÔÚ¸ßÇåÇé¿öÏÂ½¨ÒéÉèÖÃÎª120
        wTriggerDuration £­ Íâ²¿´¥·¢ĞÅºÅ³ÖĞøÖ¡ÊıÁ¿£¬Æäº¬ÒåÊÇ´Ó´¥·¢ĞÅºÅ¿ªÊ¼Ê¶±ğµÄÖ¡ÊıÁ¿¡£¸ÃÖµÔÚµÍËÙ³¡¾°½¨ÒéÉèÖÃÎª50¡«100£»¸ßËÙ³¡¾°½¨ÒéÉèÖÃÎª15¡«25£»ÒÆ¶¯Ê¶±ğÊ±Èç¹ûÒ²ÓĞÍâ²¿´¥·¢£¬ÉèÖÃÎª15¡«25£»¾ßÌå¿ÉÒÔ¸ù¾İÏÖ³¡Çé¿ö½øĞĞÅäÖÃ
        */
		//³µÅÆÊ¶±ğ²ÎÊı×Ó½á¹¹
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct NET_VCA_PLATEINFO {
			public VCA_RECOGNIZE_SCENE eRecogniseScene;//Ê¶±ğ³¡¾°(µÍËÙºÍ¸ßËÙ)
			public NET_VCA_PLATE_PARAM struModifyParam;//³µÅÆ¿É¶¯Ì¬ĞŞ¸Ä²ÎÊı
		}
		...
		public struct NET_VCA_PLATECFG {
			...
			public byte[] byRes;//±£Áô£¬ÉèÖÃÎª0
			public NET_DVR_JPEGPARA struPictureParam;//Í¼Æ¬¹æ¸ñ½á¹¹
			public NET_VCA_PLATEINFO struPlateInfo;//³µÅÆĞÅÏ¢
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_2, ArraySubType = UnmanagedType.Struct)]
			public NET_DVR_SCHEDTIME[] struAlarmTime;//²¼·ÀÊ±¼ä
			public NET_DVR_HANDLEEXCEPTION_V30 struHandleType;//´¦Àí·½Ê½
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V30, ArraySubType = UnmanagedType.I1)]
		...
		public struct NET_VCA_PLATE_INFO {
			public VCA_RECOGNIZE_RESULT eResultFlag;//Ê¶±ğ½á¹û±êÖ¾ 
			public VCA_PLATE_TYPE ePlateType;//³µÅÆÀàĞÍ
			...
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = MAX_LICENSE_LEN)]
			public string sBelieve;//¸÷¸öÊ¶±ğ×Ö·ûµÄÖÃĞÅ¶È£¬Èç¼ì²âµ½³µÅÆ"ÕãA12345", ÖÃĞÅ¶ÈÎª10,20,30,40,50,60,70£¬Ôò±íÊ¾"Õã"×ÖÕıÈ·µÄ¿ÉÄÜĞÔÖ»ÓĞ10%£¬"A"×ÖµÄÕıÈ·µÄ¿ÉÄÜĞÔÊÇ20%
		}
		...
		public struct NET_DVR_PLATE_RET {
			...
			public byte byVehicleType;// ³µÀàĞÍ
			public byte byTrafficLight;//0-ÂÌµÆ£»1-ºìµÆ
			public byte byPlateColor;//³µÅÆÑÕÉ«
			public byte byDriveChan;//´¥·¢³µµÀºÅ
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
			public byte[] byTimeInfo;/*Ê±¼äĞÅÏ¢*///plate_172.6.113.64_20090724155526948_197170484 
		...
		/*×¢£ººóÃæ½ô¸ú dwPicLen ³¤¶ÈµÄ Í¼Æ¬ ĞÅÏ¢*/
		...
		public struct NET_DVR_CCD_CFG {
			...
			public byte byBlcMode;/*blcÀàĞÍ0-×Ô¶¨Òå1-ÉÏ£»2-ÏÂ£»3-×ó£»4-ÓÒ£»5-ÖĞ£»×¢£º´ËÏîÔÚblcÎª on Ê±²ÅÆğĞ§*/
			public byte byAwb;/*×Ô¶¯°×Æ½ºâ0-×Ô¶¯1; 1-×Ô¶¯2; 2-×Ô¶¯¿ØÖÆ*/
			public byte byAgc;/*×Ô¶¯ÔöÒæ0-¹Ø; 1-µÍ; 2-ÖĞ; 3-¸ß*/
			public byte byDayNight;/*ÈÕÒ¹×ª»»£»0 ²ÊÉ«£»1ºÚ°×£»2×Ô¶¯*/
			public byte byMirror;/*¾µÏñ0-¹Ø;1-×óÓÒ;2-ÉÏÏÂ;3-ÖĞĞÄ*/
			public byte byShutter;/*¿ìÃÅ0-×Ô¶¯; 1-1/25; 2-1/50; 3-1/100; 4-1/250;5-1/500; 6-1/1k ;7-1/2k; 8-1/4k; 9-1/10k; 10-1/100k;*/
			public byte byIrCutTime;/*IRCUTÇĞ»»Ê±¼ä£¬5, 10, 15, 20, 25*/
			public byte byLensType;/*¾µÍ·ÀàĞÍ0-µç×Ó¹âÈ¦; 1-×Ô¶¯¹âÈ¦*/
			...
			public byte byEnRecognise;/*1-Ö§³ÖÊ¶±ğ£»0-²»Ö§³ÖÊ¶±ğ*/
		}
		...
		public struct tagCAMERAPARAMCFG {
			...
			public uint dwWhiteBalanceMode;/*0ÊÖ¶¯°×Æ½ºâ; 1×Ô¶¯°×Æ½ºâ1£¨·¶Î§Ğ¡£©; 2 ×Ô¶¯°×Æ½ºâ2£¨·¶Î§¿í£¬2200K-15000K£©;3×Ô¶¯¿ØÖÆ3*/
			public uint dwWhiteBalanceModeRGain;/*ÊÖ¶¯°×Æ½ºâÊ±ÓĞĞ§£¬ÊÖ¶¯°×Æ½ºâ RÔöÒæ*/
			public uint dwWhiteBalanceModeBGain;/*ÊÖ¶¯°×Æ½ºâÊ±ÓĞĞ§£¬ÊÖ¶¯°×Æ½ºâ BÔöÒæ*/
			...
			public uint dwExposureTarget;/*ÊÖ¶¯ÆØ¹âÊ±¼ä ·¶Î§£¨ManumalÓĞĞ§£¬Î¢Ãë£©*/
			...
			public uint dwDayNightFilterType;/*ÈÕÒ¹ÇĞ»»£º0 day,1 night,2 auto */
			...
			public uint dwDigitalNoiseRemoveEnable; /*Êı×ÖÈ¥Ôë£º0 dsibale  1 enable*/
			public uint dwDigitalNoiseRemoveLevel;/*0x0-0xF*/
			public uint dwMirror; /* ¾µÏñ£º0 Left;1 Right,;2 Up;3Down */
			public uint dwDigitalZoom;/*Êı×ÖËõ·Å:0 dsibale  1 enable*/
		...
		public const int NET_DVR_GET_CCDPARAMCFG = 1067;       //IPC»ñÈ¡CCD²ÎÊıÅäÖÃ
		public const int NET_DVR_SET_CCDPARAMCFG = 1068;      //IPCÉèÖÃCCD²ÎÊıÅäÖÃ
		...
		//Í¼ÏñÔöÇ¿¡¢È¥Ôë¼¶±ğ¼°ÎÈ¶¨ĞÔÊ¹ÄÜÅäÖÃ
		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct tagIMAGESUBPARAM {
			public NET_DVR_SCHEDTIME struImageStatusTime;//Í¼Ïñ×´Ì¬Ê±¼ä¶Î
			public byte byImageEnhancementLevel;//Í¼ÏñÔöÇ¿µÄ¼¶±ğ£¬0-7£¬0±íÊ¾¹Ø±Õ
			public byte byImageDenoiseLevel;//Í¼ÏñÈ¥ÔëµÄ¼¶±ğ£¬0-7£¬0±íÊ¾¹Ø±Õ
			public byte byImageStableEnable;//Í¼ÏñÎÈ¶¨ĞÔÊ¹ÄÜ£¬0±íÊ¾¹Ø±Õ£¬1±íÊ¾´ò¿ª
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 9, ArraySubType = UnmanagedType.I1)]
			public byte[] byRes;
		}
		...
		public const int NET_DVR_GET_IMAGEPARAM = 1064;       // Í¼ÏñÔöÇ¿ÒÇÍ¼Ïñ²ÎÊı(È¥Ôë¡¢ÔöÇ¿¼¶±ğ£¬ÎÈ¶¨ĞÔÊ¹ÄÜ)»ñÈ¡
		public const int NET_DVR_SET_IMAGEPARAM = 1065;       // Í¼ÏñÔöÇ¿ÒÇÍ¼Ïñ²ÎÊı(È¥Ôë¡¢ÔöÇ¿¼¶±ğ£¬ÎÈ¶¨ĞÔÊ¹ÄÜ)ÉèÖÃ

		[StructLayoutAttribute(LayoutKind.Sequential)]
		public struct tagIMAGEPARAM {
			public uint dwSize;
			//Í¼ÏñÔöÇ¿Ê±¼ä¶Î²ÎÊıÅäÖÃ£¬ÖÜÈÕ¿ªÊ¼	
			[MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT, ArraySubType = UnmanagedType.Struct)]
        ...
        Output:	lpDeviceInfo [out] Éè±¸ĞÅÏ¢ 
        ...
        **********************************************************/
		...
		public const int WM_STREAMEND = 0x0400 + 103;         //ÎÄ¼ş²¥·Å½áÊø

		public const int FILE_HEAD = 0;      //ÎÄ¼şÍ·
		...
		public struct VODSEARCHPARAM {
			...
			[MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 128)]
			public string SerialNumber;                                     //  [in]Éè±¸µÄĞòÁĞºÅ
		}
        ...
        ******************************************************************************/
		...
		public const int DATASTREAM_HEAD = 0;       //Êı¾İÍ·
		public const int DATASTREAM_BITBLOCK = 1;       //×Ö½ÚÊı¾İ
		public const int DATASTREAM_KEYFRAME = 2;       //¹Ø¼üÖ¡Êı¾İ
		public const int DATASTREAM_NORMALFRAME = 3;        //·Ç¹Ø¼üÖ¡Êı¾İ
		...
		public struct tagVEDIOPLATLOG {
			public byte bySearchCondition;//ËÑË÷Ìõ¼ş£¬0-°´²ÛÎ»ºÅËÑË÷£¬1-°´ĞòÁĞºÅËÑË÷ 2-°´MACµØÖ·½øĞĞËÑË÷
