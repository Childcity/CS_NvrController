namespace CS_NVRController.Hickvision {
	...
	public enum CompressionResolution {
		p528x384_528x320_CIF = 0, p352x288or352x240_CIF = 1, p176x144or176x120_QCIF = 2, p704x576or704x480_OR_D1_720x576or720x486_CIF4 = 3,
		p704x288or704x240_CIF2 = 4, p320x240_QVGA = 6, p160x120_QQVGA = 7, p384x288 = 12, p576x576 = 13, p640x480_VGA = 16, p1600x1200_UXGA = 17, p800x600_SVGA = 18,
		p1280x720_HD720P = 19, p1280x960_XVGA = 20, p1600x900_HD900P = 21, p1360x1024 = 22, p1536x1536 = 23, p1920x1920 = 24, p1920x1080 = 27, p2560x1920 = 28,
		p1600x304 = 29, p2048x1536 = 30, p2448x2048 = 31, ps2448x1200 = 32, p2448x800 = 33, p1024x768_XGA = 34, p1280x1024_SXGA = 35, p960x576or960x480_WD1 = 36,
		p1920x1080_1080i = 37, p1440x900_WXGA = 38, p1920x1080or1280x720_HD_F = 39, p1920x540or1280x360_HD_H = 40, p960x540or630x360_HD_Q = 41, p2336x1744 = 42,
		...
		p2048x2048 = 53, p2560x2048 = 54, p3072x2048 = 55, p2304x1296 = 56, p1280x800_WXGA = 57, p1600x600 = 58, p1600x900 = 59, p2752x2208 = 60, p384x288_Retain = 61, p4000x3000 = 62,
		...
		p325x256 = 84, p256x192 = 85, p640x360 = 86, p1776x1340 = 87, p1936x1092 = 88, p2080x784 = 89, p2144x604 = 90, p1920x1200 = 91, p4064x3040 = 92, p3040x3040 = 93,
	...
	public enum CompressionBitrateType { VBR, CBR }
	...
	public enum CompressionIntervalBPFrame { BBP, BP, PSingleFrame, Invalid = 0xff }
	...
	public enum CompressionFormatType { Undefined, ExposedStream, RTP, PS, TS, Private, FLV, ASF, _3GP, RTP_PS, Invalid = 0xff }

	public enum CompressionAudioBitrate { Default, b8Kb, b16Kb, b32Kb, b64Kb, b128Kb, b192Kb, b40Kb, b48Kb, b56Kb, b80Kb, b96Kb, b112Kb, b144Kb, b160Kb, b224Kb, b256Kb, b320Kb }
